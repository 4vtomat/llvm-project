...
// CHECK: [[P4CHAR_0]] = !{[[P4CHAR:!.+]], [[P4CHAR]], i64 0, i64 8}
// CHECK: [[P4CHAR]] = !{[[ANY_POINTER]], i64 8, !"p4 omnipotent char"}
// CHECK: [[P3CHAR_0]] = !{[[P3CHAR:!.+]], [[P3CHAR]], i64 0, i64 8}
// CHECK: [[P3CHAR]] = !{[[ANY_POINTER]], i64 8, !"p3 omnipotent char"}
// CHECK: [[P2CHAR_0]] = !{[[P2CHAR:!.+]], [[P2CHAR]], i64 0, i64 8}
// CHECK: [[P2CHAR]] = !{[[ANY_POINTER]], i64 8, !"p2 omnipotent char"}
// CHECK: [[P1CHAR_0]] = !{[[P1CHAR:!.+]], [[P1CHAR]], i64 0, i64 8}
// CHECK: [[P1CHAR]] = !{[[ANY_POINTER]], i64 8, !"p1 omnipotent char"}
