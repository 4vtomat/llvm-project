...
//
vuint32mf2_t test_vsm3me_vv_u32mf2_ta(vuint32mf2_t op1, vuint32mf2_t op2, size_t vl) {
  return vsm3me_vv_u32mf2_ta(op1, op2, vl);
}
// CHECK-RV64-LABEL: @test_vsm3me_vv_u32mf2_tu(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x i32> @llvm.riscv.vsm3me.nxv1i32.nxv1i32.i64(<vscale x 1 x i32> [[MERGE:%.*]], <vscale x 1 x i32> [[OP1:%.*]], <vscale x 1 x i32> [[OP2:%.*]], i64 [[VL:%.*]])
// CHECK-RV64-NEXT:    ret <vscale x 1 x i32> [[TMP0]]
//
...
//
vuint32m1_t test_vsm3me_vv_u32m1_ta(vuint32m1_t op1, vuint32m1_t op2, size_t vl) {
  return vsm3me_vv_u32m1_ta(op1, op2, vl);
}
// CHECK-RV64-LABEL: @test_vsm3me_vv_u32m1_tu(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x i32> @llvm.riscv.vsm3me.nxv2i32.nxv2i32.i64(<vscale x 2 x i32> [[MERGE:%.*]], <vscale x 2 x i32> [[OP1:%.*]], <vscale x 2 x i32> [[OP2:%.*]], i64 [[VL:%.*]])
// CHECK-RV64-NEXT:    ret <vscale x 2 x i32> [[TMP0]]
//
...
//
vuint32m2_t test_vsm3me_vv_u32m2_ta(vuint32m2_t op1, vuint32m2_t op2, size_t vl) {
  return vsm3me_vv_u32m2_ta(op1, op2, vl);
}
// CHECK-RV64-LABEL: @test_vsm3me_vv_u32m2_tu(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x i32> @llvm.riscv.vsm3me.nxv4i32.nxv4i32.i64(<vscale x 4 x i32> [[MERGE:%.*]], <vscale x 4 x i32> [[OP1:%.*]], <vscale x 4 x i32> [[OP2:%.*]], i64 [[VL:%.*]])
// CHECK-RV64-NEXT:    ret <vscale x 4 x i32> [[TMP0]]
//
...
//
vuint32m4_t test_vsm3me_vv_u32m4_ta(vuint32m4_t op1, vuint32m4_t op2, size_t vl) {
  return vsm3me_vv_u32m4_ta(op1, op2, vl);
}
// CHECK-RV64-LABEL: @test_vsm3me_vv_u32m4_tu(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x i32> @llvm.riscv.vsm3me.nxv8i32.nxv8i32.i64(<vscale x 8 x i32> [[MERGE:%.*]], <vscale x 8 x i32> [[OP1:%.*]], <vscale x 8 x i32> [[OP2:%.*]], i64 [[VL:%.*]])
// CHECK-RV64-NEXT:    ret <vscale x 8 x i32> [[TMP0]]
//
...
//
vuint32m8_t test_vsm3me_vv_u32m8_ta(vuint32m8_t op1, vuint32m8_t op2, size_t vl) {
  return vsm3me_vv_u32m8_ta(op1, op2, vl);
}
// CHECK-RV64-LABEL: @test_vsm3me_vv_u32m8_tu(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 16 x i32> @llvm.riscv.vsm3me.nxv16i32.nxv16i32.i64(<vscale x 16 x i32> [[MERGE:%.*]], <vscale x 16 x i32> [[OP1:%.*]], <vscale x 16 x i32> [[OP2:%.*]], i64 [[VL:%.*]])
// CHECK-RV64-NEXT:    ret <vscale x 16 x i32> [[TMP0]]
//
