...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    tail call void asm sideeffect "csrw\09vstart, ${0:z}", "rJ,~{memory},~{vl},~{vtype}"(i64 [[VALUE:%.*]]) #[[ATTR1:[0-9]+]], !srcloc [[META6:![0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    tail call void asm sideeffect "csrw\09vxsat, ${0:z}", "rJ,~{memory},~{vl},~{vtype}"(i64 [[VALUE:%.*]]) #[[ATTR1]], !srcloc [[META7:![0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    tail call void asm sideeffect "csrw\09vxrm, ${0:z}", "rJ,~{memory},~{vl},~{vtype}"(i64 [[VALUE:%.*]]) #[[ATTR1]], !srcloc [[META8:![0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    tail call void asm sideeffect "csrw\09vcsr, ${0:z}", "rJ,~{memory},~{vl},~{vtype}"(i64 [[VALUE:%.*]]) #[[ATTR1]], !srcloc [[META9:![0-9]+]]
// CHECK-NEXT:    ret void
//
