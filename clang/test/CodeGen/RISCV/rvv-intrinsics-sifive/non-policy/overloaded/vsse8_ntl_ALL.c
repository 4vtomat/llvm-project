...
// CHECK-LABEL: @test_vsse8_v_i8mf8_ntl_ALL(
// CHECK-NEXT:  entry:
...
void test_vsse8_v_i8mf8_ntl_ALL(int8_t *base, ptrdiff_t bstride, vint8mf8_t value, size_t vl, int domain) {
  return __riscv_vsse8_ntl(base, bstride, value, vl, __RISCV_NTLH_ALL);
}

// CHECK-LABEL: @test_vsse8_v_i8mf4_ntl_ALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vsse8_v_i8mf2_ntl_ALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vsse8_v_i8m1_ntl_ALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vsse8_v_i8m2_ntl_ALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vsse8_v_i8m4_ntl_ALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vsse8_v_i8m8_ntl_ALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vsse8_v_u8mf8_ntl_ALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vsse8_v_u8mf4_ntl_ALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vsse.nxv2i8.i64(<vscale x 2 x i8> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[BSTRIDE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vsse8_v_u8mf2_ntl_ALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vsse.nxv4i8.i64(<vscale x 4 x i8> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[BSTRIDE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vsse8_v_u8m1_ntl_ALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vsse.nxv8i8.i64(<vscale x 8 x i8> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[BSTRIDE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vsse8_v_u8m2_ntl_ALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vsse.nxv16i8.i64(<vscale x 16 x i8> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[BSTRIDE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vsse8_v_u8m4_ntl_ALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vsse.nxv32i8.i64(<vscale x 32 x i8> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[BSTRIDE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vsse8_v_u8m8_ntl_ALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vsse.nxv64i8.i64(<vscale x 64 x i8> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[BSTRIDE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vsse8_v_i8mf8_m_ntl_ALL(
// CHECK-NEXT:  entry:
...
void test_vsse8_v_i8mf8_m_ntl_ALL(vbool64_t mask, int8_t *base, ptrdiff_t bstride, vint8mf8_t value, size_t vl, int domain) {
  return __riscv_vsse8_ntl(mask, base, bstride, value, vl, __RISCV_NTLH_ALL);
}

// CHECK-LABEL: @test_vsse8_v_i8mf4_m_ntl_ALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vsse8_v_i8mf2_m_ntl_ALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vsse8_v_i8m1_m_ntl_ALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vsse8_v_i8m2_m_ntl_ALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vsse8_v_i8m4_m_ntl_ALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vsse8_v_i8m8_m_ntl_ALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vsse8_v_u8mf8_m_ntl_ALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vsse.mask.nxv1i8.i64(<vscale x 1 x i8> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[BSTRIDE:%.*]], <vscale x 1 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vsse8_v_u8mf4_m_ntl_ALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vsse.mask.nxv2i8.i64(<vscale x 2 x i8> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[BSTRIDE:%.*]], <vscale x 2 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vsse8_v_u8mf2_m_ntl_ALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vsse.mask.nxv4i8.i64(<vscale x 4 x i8> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[BSTRIDE:%.*]], <vscale x 4 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vsse8_v_u8m1_m_ntl_ALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vsse.mask.nxv8i8.i64(<vscale x 8 x i8> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[BSTRIDE:%.*]], <vscale x 8 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vsse8_v_u8m2_m_ntl_ALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vsse.mask.nxv16i8.i64(<vscale x 16 x i8> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[BSTRIDE:%.*]], <vscale x 16 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vsse8_v_u8m4_m_ntl_ALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vsse.mask.nxv32i8.i64(<vscale x 32 x i8> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[BSTRIDE:%.*]], <vscale x 32 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vsse8_v_u8m8_m_ntl_ALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vsse.mask.nxv64i8.i64(<vscale x 64 x i8> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[BSTRIDE:%.*]], <vscale x 64 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
