...
// CHECK-LABEL: @test_vse16_v_f16mf4_ntl_PALL(
// CHECK-NEXT:  entry:
...
void test_vse16_v_f16mf4_ntl_PALL(_Float16 *base, vfloat16mf4_t value, size_t vl, int domain) {
  return __riscv_vse16_ntl(base, value, vl, __RISCV_NTLH_ALL_PRIVATE);
}

// CHECK-LABEL: @test_vse16_v_f16mf2_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_f16m1_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_f16m2_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_f16m4_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_f16m8_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_i16mf4_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_i16mf2_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_i16m1_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_i16m2_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_i16m4_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_i16m8_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_u16mf4_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.nxv1i16.i64(<vscale x 1 x i16> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse16_v_u16mf2_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.nxv2i16.i64(<vscale x 2 x i16> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse16_v_u16m1_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.nxv4i16.i64(<vscale x 4 x i16> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse16_v_u16m2_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.nxv8i16.i64(<vscale x 8 x i16> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse16_v_u16m4_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.nxv16i16.i64(<vscale x 16 x i16> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse16_v_u16m8_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.nxv32i16.i64(<vscale x 32 x i16> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse16_v_f16mf4_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
void test_vse16_v_f16mf4_m_ntl_PALL(vbool64_t mask, _Float16 *base, vfloat16mf4_t value, size_t vl, int domain) {
  return __riscv_vse16_ntl(mask, base, value, vl, __RISCV_NTLH_ALL_PRIVATE);
}

// CHECK-LABEL: @test_vse16_v_f16mf2_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_f16m1_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_f16m2_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_f16m4_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_f16m8_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_i16mf4_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_i16mf2_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_i16m1_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_i16m2_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_i16m4_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_i16m8_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse16_v_u16mf4_m_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.mask.nxv1i16.i64(<vscale x 1 x i16> [[VALUE:%.*]], ptr [[BASE:%.*]], <vscale x 1 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse16_v_u16mf2_m_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.mask.nxv2i16.i64(<vscale x 2 x i16> [[VALUE:%.*]], ptr [[BASE:%.*]], <vscale x 2 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse16_v_u16m1_m_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.mask.nxv4i16.i64(<vscale x 4 x i16> [[VALUE:%.*]], ptr [[BASE:%.*]], <vscale x 4 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse16_v_u16m2_m_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.mask.nxv8i16.i64(<vscale x 8 x i16> [[VALUE:%.*]], ptr [[BASE:%.*]], <vscale x 8 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse16_v_u16m4_m_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.mask.nxv16i16.i64(<vscale x 16 x i16> [[VALUE:%.*]], ptr [[BASE:%.*]], <vscale x 16 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse16_v_u16m8_m_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.mask.nxv32i16.i64(<vscale x 32 x i16> [[VALUE:%.*]], ptr [[BASE:%.*]], <vscale x 32 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
