...
void test_vsse32_v_f32mf2_ntl_P1(float *base, ptrdiff_t bstride, vfloat32mf2_t value, size_t vl, int domain) {
  return __riscv_vsse32_ntl(base, bstride, value, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
...
void test_vsse32_v_f32mf2_m_ntl_P1(vbool64_t mask, float *base, ptrdiff_t bstride, vfloat32mf2_t value, size_t vl, int domain) {
  return __riscv_vsse32_ntl(mask, base, bstride, value, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
