...
// CHECK-LABEL: @test_vle16_v_f16mf4_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_f16mf2_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_f16m1_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_f16m2_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_f16m4_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_f16m8_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_i16mf4_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_i16mf2_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_i16m1_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_i16m2_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_i16m4_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_i16m8_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_u16mf4_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x i16> @llvm.riscv.vle.nxv1i16.i64(<vscale x 1 x i16> poison, ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret <vscale x 1 x i16> [[TMP0]]
//
...
// CHECK-LABEL: @test_vle16_v_u16mf2_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x i16> @llvm.riscv.vle.nxv2i16.i64(<vscale x 2 x i16> poison, ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret <vscale x 2 x i16> [[TMP0]]
//
...
// CHECK-LABEL: @test_vle16_v_u16m1_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x i16> @llvm.riscv.vle.nxv4i16.i64(<vscale x 4 x i16> poison, ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret <vscale x 4 x i16> [[TMP0]]
//
...
// CHECK-LABEL: @test_vle16_v_u16m2_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x i16> @llvm.riscv.vle.nxv8i16.i64(<vscale x 8 x i16> poison, ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret <vscale x 8 x i16> [[TMP0]]
//
...
// CHECK-LABEL: @test_vle16_v_u16m4_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call <vscale x 16 x i16> @llvm.riscv.vle.nxv16i16.i64(<vscale x 16 x i16> poison, ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret <vscale x 16 x i16> [[TMP0]]
//
...
// CHECK-LABEL: @test_vle16_v_u16m8_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call <vscale x 32 x i16> @llvm.riscv.vle.nxv32i16.i64(<vscale x 32 x i16> poison, ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret <vscale x 32 x i16> [[TMP0]]
//
...
// CHECK-LABEL: @test_vle16_v_f16mf4_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_f16mf2_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_f16m1_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_f16m2_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_f16m4_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_f16m8_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_i16mf4_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_i16mf2_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_i16m1_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_i16m2_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_i16m4_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_i16m8_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle16_v_u16mf4_m_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x i16> @llvm.riscv.vle.mask.nxv1i16.i64(<vscale x 1 x i16> poison, ptr [[BASE:%.*]], <vscale x 1 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 3), !nontemporal [[META6]]
// CHECK-NEXT:    ret <vscale x 1 x i16> [[TMP0]]
//
...
// CHECK-LABEL: @test_vle16_v_u16mf2_m_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x i16> @llvm.riscv.vle.mask.nxv2i16.i64(<vscale x 2 x i16> poison, ptr [[BASE:%.*]], <vscale x 2 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 3), !nontemporal [[META6]]
// CHECK-NEXT:    ret <vscale x 2 x i16> [[TMP0]]
//
...
// CHECK-LABEL: @test_vle16_v_u16m1_m_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x i16> @llvm.riscv.vle.mask.nxv4i16.i64(<vscale x 4 x i16> poison, ptr [[BASE:%.*]], <vscale x 4 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 3), !nontemporal [[META6]]
// CHECK-NEXT:    ret <vscale x 4 x i16> [[TMP0]]
//
...
// CHECK-LABEL: @test_vle16_v_u16m2_m_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x i16> @llvm.riscv.vle.mask.nxv8i16.i64(<vscale x 8 x i16> poison, ptr [[BASE:%.*]], <vscale x 8 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 3), !nontemporal [[META6]]
// CHECK-NEXT:    ret <vscale x 8 x i16> [[TMP0]]
//
...
// CHECK-LABEL: @test_vle16_v_u16m4_m_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call <vscale x 16 x i16> @llvm.riscv.vle.mask.nxv16i16.i64(<vscale x 16 x i16> poison, ptr [[BASE:%.*]], <vscale x 16 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 3), !nontemporal [[META6]]
// CHECK-NEXT:    ret <vscale x 16 x i16> [[TMP0]]
//
...
// CHECK-LABEL: @test_vle16_v_u16m8_m_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call <vscale x 32 x i16> @llvm.riscv.vle.mask.nxv32i16.i64(<vscale x 32 x i16> poison, ptr [[BASE:%.*]], <vscale x 32 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 3), !nontemporal [[META6]]
// CHECK-NEXT:    ret <vscale x 32 x i16> [[TMP0]]
//
