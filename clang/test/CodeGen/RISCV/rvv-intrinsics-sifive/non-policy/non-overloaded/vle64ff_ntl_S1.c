...
// CHECK-LABEL: @test_vle64ff_v_f64m1_ntl_S1(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle64ff_v_f64m2_ntl_S1(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle64ff_v_f64m4_ntl_S1(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle64ff_v_f64m8_ntl_S1(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle64ff_v_i64m1_ntl_S1(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle64ff_v_i64m2_ntl_S1(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle64ff_v_i64m4_ntl_S1(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle64ff_v_i64m8_ntl_S1(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle64ff_v_u64m1_ntl_S1(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call { <vscale x 1 x i64>, i64 } @llvm.riscv.vleff.nxv1i64.i64.p0(<vscale x 1 x i64> poison, ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    [[TMP1:%.*]] = extractvalue { <vscale x 1 x i64>, i64 } [[TMP0]], 0
// CHECK-NEXT:    [[TMP2:%.*]] = extractvalue { <vscale x 1 x i64>, i64 } [[TMP0]], 1
...
// CHECK-LABEL: @test_vle64ff_v_u64m2_ntl_S1(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call { <vscale x 2 x i64>, i64 } @llvm.riscv.vleff.nxv2i64.i64.p0(<vscale x 2 x i64> poison, ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    [[TMP1:%.*]] = extractvalue { <vscale x 2 x i64>, i64 } [[TMP0]], 0
// CHECK-NEXT:    [[TMP2:%.*]] = extractvalue { <vscale x 2 x i64>, i64 } [[TMP0]], 1
...
// CHECK-LABEL: @test_vle64ff_v_u64m4_ntl_S1(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call { <vscale x 4 x i64>, i64 } @llvm.riscv.vleff.nxv4i64.i64.p0(<vscale x 4 x i64> poison, ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    [[TMP1:%.*]] = extractvalue { <vscale x 4 x i64>, i64 } [[TMP0]], 0
// CHECK-NEXT:    [[TMP2:%.*]] = extractvalue { <vscale x 4 x i64>, i64 } [[TMP0]], 1
...
// CHECK-LABEL: @test_vle64ff_v_u64m8_ntl_S1(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call { <vscale x 8 x i64>, i64 } @llvm.riscv.vleff.nxv8i64.i64.p0(<vscale x 8 x i64> poison, ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    [[TMP1:%.*]] = extractvalue { <vscale x 8 x i64>, i64 } [[TMP0]], 0
// CHECK-NEXT:    [[TMP2:%.*]] = extractvalue { <vscale x 8 x i64>, i64 } [[TMP0]], 1
...
// CHECK-LABEL: @test_vle64ff_v_f64m1_m_ntl_S1(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle64ff_v_f64m2_m_ntl_S1(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle64ff_v_f64m4_m_ntl_S1(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle64ff_v_f64m8_m_ntl_S1(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle64ff_v_i64m1_m_ntl_S1(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle64ff_v_i64m2_m_ntl_S1(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle64ff_v_i64m4_m_ntl_S1(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle64ff_v_i64m8_m_ntl_S1(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vle64ff_v_u64m1_m_ntl_S1(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call { <vscale x 1 x i64>, i64 } @llvm.riscv.vleff.mask.nxv1i64.i64.p0(<vscale x 1 x i64> poison, ptr [[BASE:%.*]], <vscale x 1 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 3), !nontemporal [[META6]]
// CHECK-NEXT:    [[TMP1:%.*]] = extractvalue { <vscale x 1 x i64>, i64 } [[TMP0]], 0
// CHECK-NEXT:    [[TMP2:%.*]] = extractvalue { <vscale x 1 x i64>, i64 } [[TMP0]], 1
...
// CHECK-LABEL: @test_vle64ff_v_u64m2_m_ntl_S1(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call { <vscale x 2 x i64>, i64 } @llvm.riscv.vleff.mask.nxv2i64.i64.p0(<vscale x 2 x i64> poison, ptr [[BASE:%.*]], <vscale x 2 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 3), !nontemporal [[META6]]
// CHECK-NEXT:    [[TMP1:%.*]] = extractvalue { <vscale x 2 x i64>, i64 } [[TMP0]], 0
// CHECK-NEXT:    [[TMP2:%.*]] = extractvalue { <vscale x 2 x i64>, i64 } [[TMP0]], 1
...
// CHECK-LABEL: @test_vle64ff_v_u64m4_m_ntl_S1(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call { <vscale x 4 x i64>, i64 } @llvm.riscv.vleff.mask.nxv4i64.i64.p0(<vscale x 4 x i64> poison, ptr [[BASE:%.*]], <vscale x 4 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 3), !nontemporal [[META6]]
// CHECK-NEXT:    [[TMP1:%.*]] = extractvalue { <vscale x 4 x i64>, i64 } [[TMP0]], 0
// CHECK-NEXT:    [[TMP2:%.*]] = extractvalue { <vscale x 4 x i64>, i64 } [[TMP0]], 1
...
// CHECK-LABEL: @test_vle64ff_v_u64m8_m_ntl_S1(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call { <vscale x 8 x i64>, i64 } @llvm.riscv.vleff.mask.nxv8i64.i64.p0(<vscale x 8 x i64> poison, ptr [[BASE:%.*]], <vscale x 8 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 3), !nontemporal [[META6]]
// CHECK-NEXT:    [[TMP1:%.*]] = extractvalue { <vscale x 8 x i64>, i64 } [[TMP0]], 0
// CHECK-NEXT:    [[TMP2:%.*]] = extractvalue { <vscale x 8 x i64>, i64 } [[TMP0]], 1
