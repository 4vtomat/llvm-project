...
// CHECK-LABEL: @test_vse32_v_f32mf2_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_f32m1_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_f32m2_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_f32m4_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_f32m8_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_i32mf2_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_i32m1_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_i32m2_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_i32m4_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_i32m8_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_u32mf2_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.nxv1i32.i64(<vscale x 1 x i32> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse32_v_u32m1_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.nxv2i32.i64(<vscale x 2 x i32> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse32_v_u32m2_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.nxv4i32.i64(<vscale x 4 x i32> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse32_v_u32m4_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.nxv8i32.i64(<vscale x 8 x i32> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse32_v_u32m8_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.nxv16i32.i64(<vscale x 16 x i32> [[VALUE:%.*]], ptr [[BASE:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse32_v_f32mf2_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_f32m1_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_f32m2_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_f32m4_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_f32m8_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_i32mf2_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_i32m1_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_i32m2_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_i32m4_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_i32m8_m_ntl_PALL(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_vse32_v_u32mf2_m_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.mask.nxv1i32.i64(<vscale x 1 x i32> [[VALUE:%.*]], ptr [[BASE:%.*]], <vscale x 1 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse32_v_u32m1_m_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.mask.nxv2i32.i64(<vscale x 2 x i32> [[VALUE:%.*]], ptr [[BASE:%.*]], <vscale x 2 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse32_v_u32m2_m_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.mask.nxv4i32.i64(<vscale x 4 x i32> [[VALUE:%.*]], ptr [[BASE:%.*]], <vscale x 4 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse32_v_u32m4_m_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.mask.nxv8i32.i64(<vscale x 8 x i32> [[VALUE:%.*]], ptr [[BASE:%.*]], <vscale x 8 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_vse32_v_u32m8_m_ntl_PALL(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.riscv.vse.mask.nxv16i32.i64(<vscale x 16 x i32> [[VALUE:%.*]], ptr [[BASE:%.*]], <vscale x 16 x i1> [[MASK:%.*]], i64 [[VL:%.*]]), !nontemporal [[META6]]
// CHECK-NEXT:    ret void
//
