...
// CHECK-RV64-LABEL: @test_vreinterpret_v_u16mf4_bf16mf4(
...
vbfloat16mf4_t test_vreinterpret_v_u16mf4_bf16mf4(vuint16mf4_t src) {
  return vreinterpret_v_u16mf4_bf16mf4(src);
}

// CHECK-RV64-LABEL: @test_vreinterpret_v_u16mf2_bf16mf2(
// CHECK-RV64-NEXT:  entry:
...
vbfloat16mf2_t test_vreinterpret_v_u16mf2_bf16mf2(vuint16mf2_t src) {
  return vreinterpret_v_u16mf2_bf16mf2(src);
}

// CHECK-RV64-LABEL: @test_vreinterpret_v_u16m1_bf16m1(
// CHECK-RV64-NEXT:  entry:
...
vbfloat16m1_t test_vreinterpret_v_u16m1_bf16m1(vuint16m1_t src) {
  return vreinterpret_v_u16m1_bf16m1(src);
}

// CHECK-RV64-LABEL: @test_vreinterpret_v_u16m2_bf16m2(
// CHECK-RV64-NEXT:  entry:
...
vbfloat16m2_t test_vreinterpret_v_u16m2_bf16m2(vuint16m2_t src) {
  return vreinterpret_v_u16m2_bf16m2(src);
}

// CHECK-RV64-LABEL: @test_vreinterpret_v_u16m4_bf16m4(
// CHECK-RV64-NEXT:  entry:
...
vbfloat16m4_t test_vreinterpret_v_u16m4_bf16m4(vuint16m4_t src) {
  return vreinterpret_v_u16m4_bf16m4(src);
}

// CHECK-RV64-LABEL: @test_vreinterpret_v_u16m8_bf16m8(
// CHECK-RV64-NEXT:  entry:
...
vbfloat16m8_t test_vreinterpret_v_u16m8_bf16m8(vuint16m8_t src) {
  return vreinterpret_v_u16m8_bf16m8(src);
}

// CHECK-RV64-LABEL: @test_vreinterpret_v_bf16mf4_u16mf4(
// CHECK-RV64-NEXT:  entry:
...
vuint16mf4_t test_vreinterpret_v_bf16mf4_u16mf4(vbfloat16mf4_t src) {
  return vreinterpret_v_bf16mf4_u16mf4(src);
}

// CHECK-RV64-LABEL: @test_vreinterpret_v_bf16mf2_u16mf2(
// CHECK-RV64-NEXT:  entry:
...
vuint16mf2_t test_vreinterpret_v_bf16mf2_u16mf2(vbfloat16mf2_t src) {
  return vreinterpret_v_bf16mf2_u16mf2(src);
}

// CHECK-RV64-LABEL: @test_vreinterpret_v_bf16m1_u16m1(
// CHECK-RV64-NEXT:  entry:
...
vuint16m1_t test_vreinterpret_v_bf16m1_u16m1(vbfloat16m1_t src) {
  return vreinterpret_v_bf16m1_u16m1(src);
}

// CHECK-RV64-LABEL: @test_vreinterpret_v_bf16m2_u16m2(
// CHECK-RV64-NEXT:  entry:
...
vuint16m2_t test_vreinterpret_v_bf16m2_u16m2(vbfloat16m2_t src) {
  return vreinterpret_v_bf16m2_u16m2(src);
}

// CHECK-RV64-LABEL: @test_vreinterpret_v_bf16m4_u16m4(
// CHECK-RV64-NEXT:  entry:
...
vuint16m4_t test_vreinterpret_v_bf16m4_u16m4(vbfloat16m4_t src) {
  return vreinterpret_v_bf16m4_u16m4(src);
}

// CHECK-RV64-LABEL: @test_vreinterpret_v_bf16m8_u16m8(
// CHECK-RV64-NEXT:  entry:
...
vuint16m8_t test_vreinterpret_v_bf16m8_u16m8(vbfloat16m8_t src) {
  return vreinterpret_v_bf16m8_u16m8(src);
}
