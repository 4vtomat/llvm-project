...
// RUN:     -mcf-branch-label-scheme=unlabeled \
...
// RUN:     -mcf-branch-label-scheme=unlabeled -c %s -o - | llvm-readelf -x .note.gnu.property - \
// RUN:     | FileCheck --check-prefix=ZICFILPSS-RV32 %s
// RUN: %clang --target=riscv32 -menable-experimental-extensions -march=rv32g_zicfilp_zicfiss -fcf-protection=full \
// RUN:     -mcf-branch-label-scheme=unlabeled -c %s -o - | llvm-readobj -n - | FileCheck --check-prefix=ZICFILPSS-NOTE %s
//
...
// RUN:     -mcf-branch-label-scheme=unlabeled -fcf-protection=branch -c %s -o - | llvm-readelf -x .note.gnu.property - \
// RUN:     | FileCheck --check-prefix=ZICFILP-RV32 %s
// RUN: %clang --target=riscv32 -menable-experimental-extensions -march=rv32g_zicfilp_zicfiss \
// RUN:     -mcf-branch-label-scheme=unlabeled -fcf-protection=branch -c %s -o - | llvm-readobj -n - | FileCheck --check-prefix=ZICFILP-NOTE %s
...
// ZICFILP-NOTE:      RISC-V feature: ZICFILP
...
// ZICFISS-NOTE:      RISC-V feature: ZICFISS
...
// ZICFILPSS-NOTE:      RISC-V feature: ZICFILP-unlabeled, ZICFISS
