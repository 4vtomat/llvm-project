...
// RUN: %clang_cc1 -triple riscv64-none-linux-gnu -target-feature +zve32f -target-feature +f -target-feature +d -emit-llvm -o - %s | FileCheck %s --check-prefix=CHECK-ZVE32
