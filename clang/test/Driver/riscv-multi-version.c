...
// RUN: %clang -target riscv32-unknown-elf -march=rv32ia2p0 -### %s -fsyntax-only 2>&1 | FileCheck %s
...
// CHECK-UNSUPPORTED-VERSION: extension 'a' (this compiler supports 2.1, 2.0)
