...
// RUN:     %S/Inputs/sifive-optimization-remark-with-profile-count.proftext \
// RUN:     -o %t.profdata
//
...
// RUN:     -fdiagnostics-show-profile-count -S -emit-llvm \
// RUN:     2>&1 %s \
...
// RUN:     -S -emit-llvm \
// RUN:     2>&1 %s \
// RUN:     | FileCheck -check-prefix=REQUIRE_PGO %s
...
// REQUIRE_PGO: argument '-fdiagnostics-show-profile-count' requires profile-guided optimization information
