...
enum class VectorTypeModifier : uint8_t {
  ...
  // modifier. We deal with them specially in parsePrototypeDescriptor.
...
enum RVVRequire : uint32_t {
  ...
  RVV_REQ_HasBfloat16 = 1 << 18,
  RVV_REQ_xsfvqdotq = 1 << 19,
  RVV_REQ_Xsfvfexpa = 1 << 20,
  RVV_REQ_Xsfvfexpa64e = 1 << 21,
