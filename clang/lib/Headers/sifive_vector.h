...
#define __riscv_sf_vtzero_t_e8w1(tile, atm, atn) __riscv_sf_vtzero_t(tile, atm, atn, 3, 1);
#define __riscv_sf_vtzero_t_e8w2(tile, atm, atn) __riscv_sf_vtzero_t(tile, atm, atn, 3, 2);
#define __riscv_sf_vtzero_t_e8w4(tile, atm, atn) __riscv_sf_vtzero_t(tile, atm, atn, 3, 4);
#define __riscv_sf_vtzero_t_e16w1(tile, atm, atn) __riscv_sf_vtzero_t(tile, atm, atn, 4, 1);
#define __riscv_sf_vtzero_t_e16w2(tile, atm, atn) __riscv_sf_vtzero_t(tile, atm, atn, 4, 2);
#define __riscv_sf_vtzero_t_e16w4(tile, atm, atn) __riscv_sf_vtzero_t(tile, atm, atn, 4, 4);
#define __riscv_sf_vtzero_t_e32w1(tile, atm, atn) __riscv_sf_vtzero_t(tile, atm, atn, 5, 1);
#define __riscv_sf_vtzero_t_e32w2(tile, atm, atn) __riscv_sf_vtzero_t(tile, atm, atn, 5, 2);
#if __riscv_v_elen >= 64
...
#define __riscv_sf_vtzero_t_e64w1(tile, atm, atn) __riscv_sf_vtzero_t(tile, atm, atn, 6, 1);
#endif
