...
static MCOperand lowerSymbolOperand(const MachineOperand &MO, MCSymbol *Sym,
  ...
  case RISCVII::MO_TLS_GOT_GPREL_LO:
    Kind = RISCV::S_TLS_GOT_GPREL_LO;
    break;
  case RISCVII::MO_TLS_GOT_GPREL_HI:
    Kind = RISCV::S_TLS_GOT_GPREL_HI;
    break;
  case RISCVII::MO_TLS_GOT_GPREL_ADD:
    Kind = RISCV::S_TLS_GOT_GPREL_ADD;
    break;
  case RISCVII::MO_TLS_GD_GPREL_LO:
    Kind = RISCV::S_TLS_GD_GPREL_LO;
    break;
  case RISCVII::MO_TLS_GD_GPREL_HI:
    Kind = RISCV::S_TLS_GD_GPREL_HI;
    break;
  case RISCVII::MO_TLS_GD_GPREL_ADD:
    Kind = RISCV::S_TLS_GD_GPREL_ADD;
    break;
  case RISCVII::MO_GOT_GPREL_ADD:
    Kind = RISCV::S_GOT_GPREL_ADD;
    break;
  case RISCVII::MO_GOT_GPREL_LO:
    Kind = RISCV::S_GOT_GPREL_LO;
    break;
  case RISCVII::MO_GOT_GPREL_HI:
    Kind = RISCV::S_GOT_GPREL_HI;
    break;
#endif // SIFIVE_CUSTOMIZATION
  }
