...
; CHECK-LOOP-INV-NEXT: Running analysis: LiveValuesAnalysis
...
; CHECK-SCEV-INV-NEXT: Running analysis: LiveValuesAnalysis
...
; CHECK-SCEV-INV-AFTER-DELETE-NEXT: Running analysis: LiveValuesAnalysis
