...
; CHECK-O-NEXT: Running pass: LoopReversePass
; CHECK-O-NEXT: Running pass: LoopFullUnrollPass
; CHECK-O-NEXT: Running pass: LoopConcatPass
...
; CHECK-O-NEXT: Running pass: LoopDeletionPass
; CHECK-O-NEXT: Running pass: LoopReversePass
; CHECK-O-NEXT: Running pass: LoopConcatPass on foo
...
; CHECK-O-NEXT: Running pass: LoopSimplifyPass
; CHECK-O-NEXT: Running pass: LCSSAPass
; CHECK-O-NEXT: Running pass: SiFiveLoopReassociatePass
; CHECK-O-NEXT: Running pass: LoopSimplifyPass
; CHECK-O-NEXT: Running pass: LCSSAPass
...
; CHECK-O-NEXT: Running pass: LoopDataLayoutPass
