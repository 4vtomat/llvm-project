...
; RUN: opt -passes=loop-vectorize,dce,instcombine -scalable-vectorization=on -hints-allow-reordering=true -force-target-instruction-cost=1 -force-target-supports-scalable-vectors < %s -S | FileCheck %s
