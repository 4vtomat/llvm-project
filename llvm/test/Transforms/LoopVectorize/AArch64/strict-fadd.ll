...
; CHECK-ORDERED-NEXT:    [[BC_MERGE_RDX:%.*]] = phi float [ [[A2]], [[ENTRY]] ], [ [[TMP7]], [[MIDDLE_BLOCK]] ]
; CHECK-ORDERED-NEXT:    [[BC_MERGE_RDX3:%.*]] = phi float [ [[A1]], [[ENTRY]] ], [ [[TMP8]], [[MIDDLE_BLOCK]] ]
; CHECK-ORDERED-NEXT:    br label [[FOR_BODY:%.*]]
; CHECK-ORDERED:       for.body:
...
; CHECK-UNORDERED-NEXT:    [[N_MOD_VF:%.*]] = urem i64 [[N]], 4
; CHECK-UNORDERED-NEXT:    [[N_VEC:%.*]] = sub i64 [[N]], [[N_MOD_VF]]
; CHECK-UNORDERED-NEXT:    [[CAST_VTC:%.*]] = sitofp i64 [[N_VEC]] to float
; CHECK-UNORDERED-NEXT:    [[TMP0:%.*]] = fmul fast float 2.000000e+00, [[CAST_VTC]]
...
; CHECK-ORDERED-NEXT:    [[N_MOD_VF:%.*]] = urem i64 [[N]], 4
; CHECK-ORDERED-NEXT:    [[N_VEC:%.*]] = sub i64 [[N]], [[N_MOD_VF]]
; CHECK-ORDERED-NEXT:    [[CAST_VTC:%.*]] = sitofp i64 [[N_VEC]] to float
; CHECK-ORDERED-NEXT:    [[TMP0:%.*]] = fmul fast float 2.000000e+00, [[CAST_VTC]]
...
; CHECK-ORDERED-NEXT:    [[TMP6:%.*]] = getelementptr inbounds float, float* [[A]], i64 [[TMP2]]
; CHECK-ORDERED-NEXT:    [[TMP7:%.*]] = getelementptr inbounds float, float* [[A]], i64 [[TMP3]]
; CHECK-ORDERED-NEXT:    [[TMP8:%.*]] = load float, float* [[TMP4]], align 4
; CHECK-ORDERED-NEXT:    [[TMP9:%.*]] = load float, float* [[TMP5]], align 4
; CHECK-ORDERED-NEXT:    [[TMP10:%.*]] = load float, float* [[TMP6]], align 4
; CHECK-ORDERED-NEXT:    [[TMP11:%.*]] = load float, float* [[TMP7]], align 4
...
; CHECK-ORDERED-NEXT:    [[TMP10:%.*]] = load float, float* [[TMP6]], align 4
; CHECK-ORDERED-NEXT:    [[TMP11:%.*]] = load float, float* [[TMP7]], align 4
; CHECK-ORDERED-NEXT:    [[TMP12:%.*]] = getelementptr inbounds float, float* [[B:%.*]], i64 [[TMP0]]
; CHECK-ORDERED-NEXT:    [[TMP13:%.*]] = getelementptr inbounds float, float* [[B]], i64 [[TMP1]]
; CHECK-ORDERED-NEXT:    [[TMP14:%.*]] = getelementptr inbounds float, float* [[B]], i64 [[TMP2]]
; CHECK-ORDERED-NEXT:    [[TMP15:%.*]] = getelementptr inbounds float, float* [[B]], i64 [[TMP3]]
; CHECK-ORDERED-NEXT:    [[TMP16:%.*]] = load float, float* [[TMP12]], align 4
; CHECK-ORDERED-NEXT:    [[TMP17:%.*]] = load float, float* [[TMP13]], align 4
; CHECK-ORDERED-NEXT:    [[TMP18:%.*]] = load float, float* [[TMP14]], align 4
; CHECK-ORDERED-NEXT:    [[TMP19:%.*]] = load float, float* [[TMP15]], align 4
...
; CHECK-ORDERED-NEXT:    [[SUM_07:%.*]] = phi float [ [[BC_MERGE_RDX]], [[SCALAR_PH]] ], [ [[MULADD:%.*]], [[FOR_BODY]] ]
; CHECK-ORDERED-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds float, float* [[A]], i64 [[IV]]
; CHECK-ORDERED-NEXT:    [[TMP29:%.*]] = load float, float* [[ARRAYIDX]], align 4
; CHECK-ORDERED-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds float, float* [[B]], i64 [[IV]]
; CHECK-ORDERED-NEXT:    [[TMP30:%.*]] = load float, float* [[ARRAYIDX2]], align 4
...
; CHECK-ORDERED-NEXT:  entry:
; CHECK-ORDERED-NEXT:    [[SRC4:%.*]] = bitcast float* [[SRC:%.*]] to i8*
; CHECK-ORDERED-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds float, float* [[DST:%.*]], i64 42
; CHECK-ORDERED-NEXT:    [[ARRAYIDX2:%.*]] = bitcast float* [[ARRAYIDX]] to i8*
...
; CHECK-ORDERED-NEXT:    [[SCEVGEP:%.*]] = getelementptr float, float* [[DST]], i64 43
; CHECK-ORDERED-NEXT:    [[SCEVGEP3:%.*]] = bitcast float* [[SCEVGEP]] to i8*
; CHECK-ORDERED-NEXT:    [[SCEVGEP5:%.*]] = getelementptr float, float* [[SRC]], i64 1000
; CHECK-ORDERED-NEXT:    [[SCEVGEP56:%.*]] = bitcast float* [[SCEVGEP5]] to i8*
; CHECK-ORDERED-NEXT:    [[BOUND0:%.*]] = icmp ult i8* [[ARRAYIDX2]], [[SCEVGEP56]]
; CHECK-ORDERED-NEXT:    [[BOUND1:%.*]] = icmp ult i8* [[SRC4]], [[SCEVGEP3]]
...
; CHECK-ORDERED-NEXT:    [[VEC_PHI:%.*]] = phi float [ 0.000000e+00, [[VECTOR_PH]] ], [ [[TMP4:%.*]], [[VECTOR_BODY]] ]
; CHECK-ORDERED-NEXT:    [[TMP0:%.*]] = add i64 [[INDEX]], 0
; CHECK-ORDERED-NEXT:    [[TMP1:%.*]] = getelementptr inbounds float, float* [[SRC]], i64 [[TMP0]]
; CHECK-ORDERED-NEXT:    [[TMP2:%.*]] = getelementptr inbounds float, float* [[TMP1]], i32 0
; CHECK-ORDERED-NEXT:    [[TMP3:%.*]] = bitcast float* [[TMP2]] to <8 x float>*
; CHECK-ORDERED-NEXT:    [[WIDE_LOAD:%.*]] = load <8 x float>, <8 x float>* [[TMP3]], align 4, !alias.scope !36
; CHECK-ORDERED-NEXT:    [[TMP4]] = call float @llvm.vector.reduce.fadd.v8f32(float [[VEC_PHI]], <8 x float> [[WIDE_LOAD]])
; CHECK-ORDERED-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 8
; CHECK-ORDERED-NEXT:    [[TMP5:%.*]] = icmp eq i64 [[INDEX_NEXT]], 1000
; CHECK-ORDERED-NEXT:    br i1 [[TMP5]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP39:![0-9]+]]
; CHECK-ORDERED:       middle.block:
; CHECK-ORDERED-NEXT:    store float [[TMP4]], float* [[ARRAYIDX]], align 4
...
; CHECK-ORDERED-NEXT:    [[BC_MERGE_RDX:%.*]] = phi float [ 0.000000e+00, [[VECTOR_MEMCHECK]] ], [ 0.000000e+00, [[ENTRY]] ], [ [[TMP4]], [[MIDDLE_BLOCK]] ]
; CHECK-ORDERED-NEXT:    br label [[FOR_BODY:%.*]]
; CHECK-ORDERED:       for.body:
; CHECK-ORDERED-NEXT:    [[TMP6:%.*]] = phi float [ [[BC_MERGE_RDX]], [[SCALAR_PH]] ], [ [[ADD:%.*]], [[FOR_BODY]] ]
...
; CHECK-ORDERED-NEXT:    [[TMP7:%.*]] = load float, float* [[ARRAYIDX1]], align 4
; CHECK-ORDERED-NEXT:    [[ADD]] = fadd float [[TMP6]], [[TMP7]]
