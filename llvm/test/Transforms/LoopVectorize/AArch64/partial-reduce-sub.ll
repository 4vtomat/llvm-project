...
; CHECK-INTERLEAVE1-NEXT:    [[TMP12:%.*]] = zext <16 x i8> [[WIDE_LOAD1]] to <16 x i32>
; CHECK-INTERLEAVE1-NEXT:    [[TMP13:%.*]] = mul <16 x i32> [[TMP12]], [[TMP3]]
; CHECK-INTERLEAVE1-NEXT:    [[TMP14:%.*]] = sub <16 x i32> zeroinitializer, [[TMP13]]
; CHECK-INTERLEAVE1-NEXT:    [[TMP9]] = add <16 x i32> [[VEC_PHI]], [[TMP14]]
...
; CHECK-INTERLEAVED-NEXT:    [[VEC_PHI:%.*]] = phi <16 x i32> [ zeroinitializer, [[VECTOR_PH]] ], [ [[TMP19:%.*]], [[VECTOR_BODY]] ]
...
; CHECK-INTERLEAVED-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[TMP7]], i32 16
...
; CHECK-INTERLEAVED-NEXT:    [[TMP21:%.*]] = sub <16 x i32> zeroinitializer, [[TMP12]]
; CHECK-INTERLEAVED-NEXT:    [[TMP19]] = add <16 x i32> [[VEC_PHI]], [[TMP13]]
; CHECK-INTERLEAVED-NEXT:    [[TMP16]] = add <16 x i32> [[VEC_PHI1]], [[TMP21]]
; CHECK-INTERLEAVED-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 32
; CHECK-INTERLEAVED-NEXT:    [[TMP17:%.*]] = icmp eq i64 [[INDEX_NEXT]], 1024
; CHECK-INTERLEAVED-NEXT:    br i1 [[TMP17]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
; CHECK-INTERLEAVED:       middle.block:
; CHECK-INTERLEAVED-NEXT:    [[BIN_RDX:%.*]] = add <16 x i32> [[TMP16]], [[TMP19]]
; CHECK-INTERLEAVED-NEXT:    [[TMP18:%.*]] = call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> [[BIN_RDX]])
...
; CHECK-INTERLEAVED-NEXT:    [[BC_MERGE_RDX:%.*]] = phi i32 [ [[TMP18]], [[MIDDLE_BLOCK]] ], [ 0, [[ENTRY]] ]
...
; CHECK-INTERLEAVED-NEXT:    [[ADD_LCSSA:%.*]] = phi i32 [ [[ADD]], [[FOR_BODY]] ], [ [[TMP18]], [[MIDDLE_BLOCK]] ]
