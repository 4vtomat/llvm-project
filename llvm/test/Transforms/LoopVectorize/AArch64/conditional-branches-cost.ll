...
; DEFAULT-NEXT:    [[TMP10:%.*]] = fcmp ogt <4 x double> [[TMP4]], splat (double 1.000000e+00)
; DEFAULT-NEXT:    [[TMP6:%.*]] = extractelement <4 x i1> [[TMP10]], i32 0
; DEFAULT-NEXT:    br i1 [[TMP6]], label %[[PRED_STORE_IF:.*]], label %[[PRED_STORE_CONTINUE:.*]]
; DEFAULT:       [[PRED_STORE_IF]]:
; DEFAULT-NEXT:    store i32 0, ptr [[DST]], align 4
; DEFAULT-NEXT:    br label %[[PRED_STORE_CONTINUE]]
; DEFAULT:       [[PRED_STORE_CONTINUE]]:
; DEFAULT-NEXT:    [[TMP7:%.*]] = extractelement <4 x i1> [[TMP10]], i32 1
...
; DEFAULT-NEXT:    [[TMP8:%.*]] = extractelement <4 x i1> [[TMP10]], i32 2
; DEFAULT-NEXT:    br i1 [[TMP8]], label %[[PRED_STORE_IF3:.*]], label %[[PRED_STORE_CONTINUE4:.*]]
; DEFAULT:       [[PRED_STORE_IF3]]:
; DEFAULT-NEXT:    store i32 0, ptr [[DST]], align 4
; DEFAULT-NEXT:    br label %[[PRED_STORE_CONTINUE4]]
; DEFAULT:       [[PRED_STORE_CONTINUE4]]:
; DEFAULT-NEXT:    [[TMP9:%.*]] = extractelement <4 x i1> [[TMP10]], i32 3
...
; DEFAULT-NEXT:  [[ENTRY:.*]]:
; DEFAULT-NEXT:    [[TMP0:%.*]] = add i64 [[N]], 1
; DEFAULT-NEXT:    [[MIN_ITERS_CHECK:%.*]] = icmp ult i64 [[TMP0]], 116
...
; DEFAULT-NEXT:    call void @llvm.masked.store.v4i32.p0(<4 x i32> zeroinitializer, ptr [[TMP17]], i32 4, <4 x i1> [[TMP8]])
; DEFAULT-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
...
; DEFAULT-NEXT:    br i1 [[C_1]], label %[[EXIT]], label %[[LOOP_HEADER]], !llvm.loop [[LOOP19:![0-9]+]]
; DEFAULT:       [[EXIT]]:
...
; DEFAULT-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 8
; DEFAULT-NEXT:    br i1 true, label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP22:![0-9]+]]
; DEFAULT:       [[MIDDLE_BLOCK]]:
