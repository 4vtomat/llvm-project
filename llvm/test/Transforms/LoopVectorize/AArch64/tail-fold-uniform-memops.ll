...
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i32, ptr [[DST]], i64 [[TMP4]]
...
; CHECK:       if.then:
; CHECK-NEXT:    [[TMP15:%.*]] = load i32, ptr [[SRC]], align 4
; CHECK-NEXT:    br label [[IF_END]]
; CHECK:       if.end:
; CHECK-NEXT:    [[VAL_0:%.*]] = phi i32 [ [[TMP15]], [[IF_THEN]] ], [ 0, [[FOR_BODY]] ]
