...
; RUN:   -prefer-predicate-over-epilogue=scalar-epilogue -hints-allow-reordering=true -S -o - | FileCheck %s
; RUN: opt < %s -passes=loop-vectorize -mtriple=aarch64--linux-gnu -mattr=+sve -force-vector-width=2 -force-vector-interleave=1 \
; RUN:   -prefer-predicate-over-epilogue=scalar-epilogue -scalable-vectorization=on -hints-allow-reordering=true -S -o - | FileCheck --check-prefix=SVE %s
