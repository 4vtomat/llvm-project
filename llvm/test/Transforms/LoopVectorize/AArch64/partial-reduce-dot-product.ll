...
; CHECK-INTERLEAVED-NEXT:    [[INDEX1:%.*]] = phi i64 [ 0, [[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], [[VECTOR_BODY]] ]
...
; CHECK-INTERLEAVED-NEXT:    [[TMP11:%.*]] = mul <16 x i32> [[TMP12]], [[TMP4]]
; CHECK-INTERLEAVED-NEXT:    [[TMP13]] = add <16 x i32> [[TMP10]], [[VEC_PHI]]
; CHECK-INTERLEAVED-NEXT:    [[TMP14]] = add <16 x i32> [[TMP11]], [[VEC_PHI1]]
; CHECK-INTERLEAVED-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX1]], 32
...
; CHECK-INTERLEAVE1-NEXT:    [[GEP_A:%.*]] = phi ptr [ [[A]], [[VECTOR_PH]] ], [ [[GEP_A_NEXT:%.*]], [[VECTOR_BODY]] ]
; CHECK-INTERLEAVE1-NEXT:    [[GEP_B:%.*]] = phi ptr [ [[B]], [[VECTOR_PH]] ], [ [[GEP_B_NEXT:%.*]], [[VECTOR_BODY]] ]
...
; CHECK-INTERLEAVE1-NEXT:    br i1 [[EXITCOND_NOT]], label [[FOR_EXIT:%.*]], label [[VECTOR_BODY]]
...
; CHECK-MAXBW-NEXT:    [[GEP_A:%.*]] = phi ptr [ [[A]], [[VECTOR_PH]] ], [ [[GEP_A_NEXT:%.*]], [[VECTOR_BODY]] ]
; CHECK-MAXBW-NEXT:    [[GEP_B:%.*]] = phi ptr [ [[B]], [[VECTOR_PH]] ], [ [[GEP_B_NEXT:%.*]], [[VECTOR_BODY]] ]
...
; CHECK-MAXBW-NEXT:    [[INDEX_NEXT]] = add i64 [[INDEX]], 1
; CHECK-MAXBW-NEXT:    [[EXITCOND_NOT:%.*]] = icmp eq i64 [[INDEX_NEXT]], 1024
; CHECK-MAXBW-NEXT:    br i1 [[EXITCOND_NOT]], label [[FOR_EXIT:%.*]], label [[VECTOR_BODY]]
...
; CHECK-INTERLEAVE1-NEXT:    [[N_MOD_VF1:%.*]] = urem i64 [[N_RND_UP]], [[TMP1]]
; CHECK-INTERLEAVE1-NEXT:    [[N_VEC1:%.*]] = sub i64 [[N_RND_UP]], [[N_MOD_VF1]]
...
; CHECK-INTERLEAVED-NEXT:    [[N_MOD_VF1:%.*]] = urem i64 [[N_RND_UP]], [[TMP1]]
; CHECK-INTERLEAVED-NEXT:    [[N_VEC1:%.*]] = sub i64 [[N_RND_UP]], [[N_MOD_VF1]]
...
; CHECK-INTERLEAVE1:       middle.block:
; CHECK-INTERLEAVE1-NEXT:    [[TMP12:%.*]] = call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> [[TMP8]])
; CHECK-INTERLEAVE1-NEXT:    [[TMP13:%.*]] = extractelement <16 x i32> [[TMP10]], i32 15
; CHECK-INTERLEAVE1-NEXT:    br i1 true, label [[FOR_EXIT:%.*]], label [[SCALAR_PH]]
; CHECK-INTERLEAVE1:       scalar.ph:
;
...
; CHECK-INTERLEAVED-NEXT:    [[TMP17:%.*]] = zext <16 x i8> [[WIDE_LOAD4]] to <16 x i32>
; CHECK-INTERLEAVED-NEXT:    [[TMP10:%.*]] = mul <16 x i32> [[TMP12]], [[TMP5]]
; CHECK-INTERLEAVED-NEXT:    [[TMP11:%.*]] = mul <16 x i32> [[TMP17]], [[TMP6]]
; CHECK-INTERLEAVED-NEXT:    [[TMP13]] = add <16 x i32> [[TMP10]], [[VEC_PHI]]
; CHECK-INTERLEAVED-NEXT:    [[TMP14]] = add <16 x i32> [[TMP11]], [[VEC_PHI1]]
; CHECK-INTERLEAVED-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 32
; CHECK-INTERLEAVED-NEXT:    [[TMP18:%.*]] = icmp eq i64 [[INDEX_NEXT]], 1024
; CHECK-INTERLEAVED-NEXT:    br i1 [[TMP18]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP19:![0-9]+]]
; CHECK-INTERLEAVED:       middle.block:
; CHECK-INTERLEAVED-NEXT:    [[BIN_RDX:%.*]] = add <16 x i32> [[TMP14]], [[TMP13]]
; CHECK-INTERLEAVED-NEXT:    [[TMP15:%.*]] = call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> [[BIN_RDX]])
; CHECK-INTERLEAVED-NEXT:    [[TMP16:%.*]] = extractelement <16 x i32> [[TMP17]], i32 15
; CHECK-INTERLEAVED-NEXT:    br i1 true, label [[FOR_EXIT:%.*]], label [[SCALAR_PH]]
; CHECK-INTERLEAVED:       scalar.ph:
;
...
; CHECK-INTERLEAVE1-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 16
; CHECK-INTERLEAVE1-NEXT:    br i1 true, label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP17:![0-9]+]]
; CHECK-INTERLEAVE1:       middle.block:
...
; CHECK-INTERLEAVED-NEXT:    [[TMP10:%.*]] = mul nuw nsw <16 x i64> [[TMP6]], [[TMP2]]
; CHECK-INTERLEAVED-NEXT:    [[TMP9]] = add <16 x i64> [[VEC_PHI]], [[TMP10]]
...
; CHECK-INTERLEAVE1-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 16
; CHECK-INTERLEAVE1-NEXT:    [[TMP19:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
; CHECK-INTERLEAVE1-NEXT:    br i1 [[TMP19]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP23:![0-9]+]]
; CHECK-INTERLEAVE1:       middle.block:
...
; CHECK-INTERLEAVED-NEXT:    [[TMP11:%.*]] = mul nuw nsw <16 x i64> [[TMP10]], [[TMP6]]
; CHECK-INTERLEAVED-NEXT:    [[TMP15]] = add <16 x i64> [[TMP11]], [[VEC_PHI]]
; CHECK-INTERLEAVED-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 16
...
; CHECK-INTERLEAVE1-NEXT:    br i1 [[TMP5]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP25:![0-9]+]]
; CHECK-INTERLEAVE1:       middle.block:
...
; CHECK-MAXBW-NEXT:    br i1 [[TMP10]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP25:![0-9]+]]
; CHECK-MAXBW:       middle.block:
...
; CHECK-MAXBW-NEXT:    br i1 [[TMP5]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP31:![0-9]+]]
; CHECK-MAXBW:       middle.block:
...
; CHECK-INTERLEAVE1-NEXT:    [[TMP10:%.*]] = sext <4 x i8> [[WIDE_LOAD]] to <4 x i32>
...
; CHECK-INTERLEAVED-NEXT:    [[TMP10:%.*]] = sext <4 x i8> [[WIDE_LOAD]] to <4 x i32>
...
; CHECK-INTERLEAVED-NEXT:    [[PARTIAL_REDUCE17]] = add <4 x i32> [[TMP23]], [[VEC_PHI4]]
...
; CHECK-INTERLEAVED-NEXT:    [[PARTIAL_REDUCE18]] = add <4 x i32> [[TMP26]], [[VEC_PHI3]]
; CHECK-INTERLEAVED-NEXT:    [[TMP28:%.*]] = sext <4 x i8> [[STRIDED_VEC12]] to <4 x i32>
; CHECK-INTERLEAVED-NEXT:    [[TMP38:%.*]] = mul nsw <4 x i32> [[TMP28]], [[TMP10]]
; CHECK-INTERLEAVED-NEXT:    [[PARTIAL_REDUCE19]] = add <4 x i32> [[TMP38]], [[VEC_PHI2]]
; CHECK-INTERLEAVED-NEXT:    [[TMP39:%.*]] = sext <4 x i8> [[STRIDED_VEC13]] to <4 x i32>
; CHECK-INTERLEAVED-NEXT:    [[TMP40:%.*]] = mul nsw <4 x i32> [[TMP39]], [[TMP10]]
; CHECK-INTERLEAVED-NEXT:    [[PARTIAL_REDUCE20]] = add <4 x i32> [[TMP40]], [[VEC_PHI1]]
; CHECK-INTERLEAVED-NEXT:    [[TMP41:%.*]] = sext <4 x i8> [[STRIDED_VEC14]] to <4 x i32>
; CHECK-INTERLEAVED-NEXT:    [[TMP42:%.*]] = mul nsw <4 x i32> [[TMP41]], [[TMP10]]
...
; CHECK-MAXBW-NEXT:    [[PARTIAL_REDUCE]] = add <4 x i32> [[TMP14]], [[VEC_PHI7]]
; CHECK-MAXBW-NEXT:    [[TMP16:%.*]] = sext <4 x i8> [[STRIDED_VEC8]] to <4 x i32>
; CHECK-MAXBW-NEXT:    [[TMP17:%.*]] = mul nsw <4 x i32> [[TMP16]], [[TMP10]]
; CHECK-MAXBW-NEXT:    [[PARTIAL_REDUCE15]] = add <4 x i32> [[TMP17]], [[VEC_PHI6]]
; CHECK-MAXBW-NEXT:    [[TMP19:%.*]] = sext <4 x i8> [[STRIDED_VEC9]] to <4 x i32>
; CHECK-MAXBW-NEXT:    [[TMP20:%.*]] = mul nsw <4 x i32> [[TMP19]], [[TMP10]]
; CHECK-MAXBW-NEXT:    [[PARTIAL_REDUCE16]] = add <4 x i32> [[TMP20]], [[VEC_PHI5]]
; CHECK-MAXBW-NEXT:    [[TMP22:%.*]] = sext <4 x i8> [[STRIDED_VEC10]] to <4 x i32>
; CHECK-MAXBW-NEXT:    [[TMP23:%.*]] = mul nsw <4 x i32> [[TMP22]], [[TMP10]]
; CHECK-MAXBW-NEXT:    [[PARTIAL_REDUCE17]] = add <4 x i32> [[TMP23]], [[VEC_PHI4]]
; CHECK-MAXBW-NEXT:    [[TMP25:%.*]] = sext <4 x i8> [[STRIDED_VEC11]] to <4 x i32>
; CHECK-MAXBW-NEXT:    [[TMP26:%.*]] = mul nsw <4 x i32> [[TMP25]], [[TMP10]]
; CHECK-MAXBW-NEXT:    [[PARTIAL_REDUCE18]] = add <4 x i32> [[TMP26]], [[VEC_PHI3]]
; CHECK-MAXBW-NEXT:    [[TMP28:%.*]] = sext <4 x i8> [[STRIDED_VEC12]] to <4 x i32>
; CHECK-MAXBW-NEXT:    [[TMP38:%.*]] = mul nsw <4 x i32> [[TMP28]], [[TMP10]]
; CHECK-MAXBW-NEXT:    [[PARTIAL_REDUCE19]] = add <4 x i32> [[TMP38]], [[VEC_PHI2]]
; CHECK-MAXBW-NEXT:    [[TMP39:%.*]] = sext <4 x i8> [[STRIDED_VEC13]] to <4 x i32>
; CHECK-MAXBW-NEXT:    [[TMP40:%.*]] = mul nsw <4 x i32> [[TMP39]], [[TMP10]]
; CHECK-MAXBW-NEXT:    [[PARTIAL_REDUCE20]] = add <4 x i32> [[TMP40]], [[VEC_PHI1]]
; CHECK-MAXBW-NEXT:    [[TMP41:%.*]] = sext <4 x i8> [[STRIDED_VEC14]] to <4 x i32>
; CHECK-MAXBW-NEXT:    [[TMP42:%.*]] = mul nsw <4 x i32> [[TMP41]], [[TMP10]]
; CHECK-MAXBW-NEXT:    [[PARTIAL_REDUCE21]] = add <4 x i32> [[TMP42]], [[VEC_PHI]]
; CHECK-MAXBW-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; CHECK-MAXBW-NEXT:    [[TMP29:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
; CHECK-MAXBW-NEXT:    br i1 [[TMP29]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP35:![0-9]+]]
; CHECK-MAXBW:       middle.block:
