...
; DEFAULT-NEXT:    [[TMP62:%.*]] = lshr <vscale x 8 x i16> [[TMP61]], trunc (<vscale x 8 x i32> splat (i32 1) to <vscale x 8 x i16>)
...
; PRED-NEXT:    [[TMP7:%.*]] = icmp ule <4 x i64> [[VEC_IV]], [[BROADCAST_SPLAT]]
