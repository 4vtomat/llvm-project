...
; DEFAULT-NEXT:    [[TMP8:%.*]] = mul nuw i64 [[TMP9]], 32
...
; DEFAULT-NEXT:    [[TMP24:%.*]] = mul nuw i64 [[TMP23]], 16
...
; DEFAULT-NEXT:    [[TMP27:%.*]] = lshr <vscale x 16 x i16> [[TMP35]], splat (i16 1)
; DEFAULT-NEXT:    [[TMP28:%.*]] = lshr <vscale x 16 x i16> [[TMP26]], splat (i16 1)
...
; DEFAULT-NEXT:    [[TMP42:%.*]] = mul nuw i64 [[TMP41]], 16
; DEFAULT-NEXT:    [[TMP43:%.*]] = getelementptr i8, ptr [[TMP38]], i64 [[TMP42]]
; DEFAULT-NEXT:    store <vscale x 16 x i8> [[TMP29]], ptr [[TMP40]], align 1
; DEFAULT-NEXT:    store <vscale x 16 x i8> [[TMP30]], ptr [[TMP43]], align 1
; DEFAULT-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], [[TMP12]]
; DEFAULT-NEXT:    [[TMP37:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
; DEFAULT-NEXT:    br i1 [[TMP37]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
...
; DEFAULT-NEXT:    [[TMP44:%.*]] = call i64 @llvm.vscale.i64()
; DEFAULT-NEXT:    [[TMP39:%.*]] = mul nuw i64 [[TMP44]], 8
...
; DEFAULT-NEXT:    [[TMP46:%.*]] = call i64 @llvm.vscale.i64()
; DEFAULT-NEXT:    [[TMP48:%.*]] = mul nuw i64 [[TMP46]], 8
...
; DEFAULT-NEXT:    [[TMP50:%.*]] = mul nuw i64 [[TMP49]], 8
...
; DEFAULT-NEXT:    [[TMP45:%.*]] = trunc <vscale x 8 x i32> [[BROADCAST_SPLAT8]] to <vscale x 8 x i16>
...
; DEFAULT-NEXT:    [[TMP47:%.*]] = getelementptr i8, ptr [[GEP_SRC]], i32 0
; DEFAULT-NEXT:    [[WIDE_LOAD10:%.*]] = load <vscale x 8 x i8>, ptr [[TMP47]], align 1
; DEFAULT-NEXT:    [[TMP58:%.*]] = zext <vscale x 8 x i8> [[WIDE_LOAD10]] to <vscale x 8 x i16>
; DEFAULT-NEXT:    [[TMP59:%.*]] = mul <vscale x 8 x i16> [[TMP58]], [[TMP45]]
; DEFAULT-NEXT:    [[TMP60:%.*]] = zext <vscale x 8 x i8> [[WIDE_LOAD10]] to <vscale x 8 x i16>
; DEFAULT-NEXT:    [[TMP61:%.*]] = or <vscale x 8 x i16> [[TMP59]], [[TMP60]]
; DEFAULT-NEXT:    [[TMP62:%.*]] = lshr <vscale x 8 x i16> [[TMP61]], splat (i16 1)
; DEFAULT-NEXT:    [[TMP63:%.*]] = trunc <vscale x 8 x i16> [[TMP62]] to <vscale x 8 x i8>
; DEFAULT-NEXT:    [[TMP64:%.*]] = getelementptr i8, ptr [[DST]], i64 [[IV]]
; DEFAULT-NEXT:    [[TMP65:%.*]] = getelementptr i8, ptr [[TMP64]], i32 0
; DEFAULT-NEXT:    store <vscale x 8 x i8> [[TMP63]], ptr [[TMP65]], align 1
...
; PRED-NEXT:    [[BROADCAST_SPLATINSERT3:%.*]] = insertelement <4 x i64> poison, i64 [[INDEX]], i64 0
; PRED-NEXT:    [[BROADCAST_SPLAT4:%.*]] = shufflevector <4 x i64> [[BROADCAST_SPLATINSERT3]], <4 x i64> poison, <4 x i32> zeroinitializer
; PRED-NEXT:    [[VEC_IV:%.*]] = add <4 x i64> [[BROADCAST_SPLAT4]], <i64 0, i64 1, i64 2, i64 3>
...
; PRED-NEXT:    [[TMP14:%.*]] = extractelement <4 x i1> [[TMP7]], i32 2
...
; PRED-NEXT:    br i1 [[TMP17]], label %[[PRED_STORE_IF8:.*]], label %[[PRED_STORE_CONTINUE9]]
; PRED:       [[PRED_STORE_IF8]]:
...
; PRED-NEXT:    br i1 [[TMP20]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP4:![0-9]+]]
; PRED:       [[MIDDLE_BLOCK]]:
; PRED-NEXT:    br label %[[EXIT:.*]]
; PRED:       [[SCALAR_PH]]:
