...
; RUN: opt < %s -passes=loop-vectorize -force-vector-interleave=1 -force-vector-width=4 -lv-strided-pointer-ivs=false -S | FileCheck --check-prefixes=CHECK,DEFAULT %s
