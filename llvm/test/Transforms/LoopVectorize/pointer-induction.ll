...
; STRIDED-NEXT:    [[TMP6:%.*]] = add i32 [[OFFSET_IDX]], 1
; STRIDED-NEXT:    [[TMP7:%.*]] = add i32 [[OFFSET_IDX]], 2
; STRIDED-NEXT:    [[TMP8:%.*]] = add i32 [[OFFSET_IDX]], 3
...
; STRIDED-NEXT:    [[TMP13:%.*]] = extractelement <4 x ptr> [[TMP4]], i32 0
; STRIDED-NEXT:    store ptr [[TMP13]], ptr [[TMP9]], align 4
; STRIDED-NEXT:    [[TMP14:%.*]] = extractelement <4 x ptr> [[TMP4]], i32 1
; STRIDED-NEXT:    store ptr [[TMP14]], ptr [[TMP10]], align 4
; STRIDED-NEXT:    [[TMP15:%.*]] = extractelement <4 x ptr> [[TMP4]], i32 2
; STRIDED-NEXT:    store ptr [[TMP15]], ptr [[TMP11]], align 4
; STRIDED-NEXT:    [[TMP16:%.*]] = extractelement <4 x ptr> [[TMP4]], i32 3
; STRIDED-NEXT:    store ptr [[TMP16]], ptr [[TMP12]], align 4
; STRIDED-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; STRIDED-NEXT:    [[PTR_IND]] = getelementptr i8, ptr [[POINTER_PHI]], i64 [[TMP3]]
; STRIDED-NEXT:    [[TMP17:%.*]] = icmp eq i64 [[INDEX_NEXT]], 4294967264
; STRIDED-NEXT:    br i1 [[TMP17]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP6:![0-9]+]]
...
; STRIDED:       for.cond:
; STRIDED-NEXT:    [[TMP18:%.*]] = phi i32 [ [[BC_RESUME_VAL]], [[SCALAR_PH]] ], [ [[INC:%.*]], [[FOR_COND]] ]
; STRIDED-NEXT:    [[P_0:%.*]] = phi ptr [ [[BC_RESUME_VAL1]], [[SCALAR_PH]] ], [ [[ADD_PTR:%.*]], [[FOR_COND]] ]
; STRIDED-NEXT:    [[ADD_PTR]] = getelementptr i8, ptr [[P_0]], i32 [[MUL]]
; STRIDED-NEXT:    [[ARRAYIDX:%.*]] = getelementptr ptr, ptr [[CALL]], i32 [[TMP18]]
; STRIDED-NEXT:    store ptr [[P_0]], ptr [[ARRAYIDX]], align 4
; STRIDED-NEXT:    [[INC]] = add i32 [[TMP18]], 1
; STRIDED-NEXT:    [[TOBOOL_NOT:%.*]] = icmp eq i32 [[TMP18]], 0
