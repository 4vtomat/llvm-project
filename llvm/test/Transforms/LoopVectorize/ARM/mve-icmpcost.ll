...
; CHECK: Cost of 1 for VF 2: EMIT vp<%index.next> = add nuw vp<%2>, vp<%0>
...
; CHECK: Cost of 1 for VF 4: EMIT vp<%index.next> = add nuw vp<%2>, vp<%0>
...
; CHECK: Cost of 1 for VF 8: EMIT vp<%index.next> = add nuw vp<%2>, vp<%0>
...
; CHECK: Cost of 1 for VF 2: EMIT vp<%index.next> = add nuw vp<[[CAN_IV]]>, vp<%0>
...
; CHECK: Cost of 1 for VF 4: EMIT vp<%index.next> = add nuw vp<[[CAN_IV]]>, vp<%0>
...
; CHECK: Cost of 1 for VF 8: EMIT vp<%index.next> = add nuw vp<[[CAN_IV]]>, vp<{{.+}}
; CHECK: Cost of 0 for VF 8: EMIT branch-on-count vp<%index.next>, vp<{{.+}}>
; CHECK: Cost for VF 8: 27 (Estimated cost per lane: 3.
...
; CHECK: Cost of 1 for VF 16: EMIT vp<%index.next> = add nuw vp<[[CAN_IV]]>, vp<{{.+}}>
