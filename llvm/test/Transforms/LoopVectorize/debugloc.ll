...
; CHECK-NEXT:    [[TMP2:%.*]] = icmp ne <2 x i32> [[WIDE_LOAD]], splat (i32 10), !dbg [[DBG27:![0-9]+]]
; CHECK-NEXT:    [[TMP3:%.*]] = extractelement <2 x i1> [[TMP2]], i32 0, !dbg [[DBG27]]
; CHECK-NEXT:    br i1 [[TMP3]], label [[PRED_STORE_IF:%.*]], label [[PRED_STORE_CONTINUE:%.*]], !dbg [[DBG27]]
; CHECK:       pred.store.if:
...
; CHECK-NEXT:    [[TMP6:%.*]] = extractelement <2 x i1> [[TMP2]], i32 1, !dbg [[DBG27]]
; CHECK-NEXT:    br i1 [[TMP6]], label [[PRED_STORE_IF1:%.*]], label [[PRED_STORE_CONTINUE2]], !dbg [[DBG27]]
...
; CHECK-NEXT:    [[CMP:%.*]] = icmp eq i32 [[L]], 10
; CHECK-NEXT:    br i1 [[CMP]], label [[LOOP_LATCH]], label [[IF_THEN:%.*]], !dbg [[DBG27]]
; CHECK:       if.then:
...
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr inbounds i32, ptr [[TMP0]], i32 0
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <2 x i32>, ptr [[TMP1]], align 4
; CHECK-NEXT:    [[TMP2:%.*]] = icmp ne <2 x i32> [[WIDE_LOAD]], splat (i32 10), !dbg [[DBG32:![0-9]+]]
; CHECK-NEXT:    [[TMP3:%.*]] = extractelement <2 x i1> [[TMP2]], i32 0, !dbg [[DBG32]]
; CHECK-NEXT:    br i1 [[TMP3]], label [[PRED_STORE_IF:%.*]], label [[PRED_STORE_CONTINUE:%.*]], !dbg [[DBG32]]
; CHECK:       pred.store.if:
; CHECK-NEXT:    [[TMP4:%.*]] = add i64 [[INDEX]], 0
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr inbounds i32, ptr [[DST]], i64 [[TMP4]], !dbg [[DBG35:![0-9]+]]
; CHECK-NEXT:    store i32 0, ptr [[TMP5]], align 4
; CHECK-NEXT:    br label [[PRED_STORE_CONTINUE]], !dbg [[DBG32]]
; CHECK:       pred.store.continue:
; CHECK-NEXT:    [[TMP6:%.*]] = extractelement <2 x i1> [[TMP2]], i32 1, !dbg [[DBG32]]
; CHECK-NEXT:    br i1 [[TMP6]], label [[PRED_STORE_IF1:%.*]], label [[PRED_STORE_CONTINUE2]], !dbg [[DBG32]]
; CHECK:       pred.store.if1:
; CHECK-NEXT:    [[TMP7:%.*]] = add i64 [[INDEX]], 1
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds i32, ptr [[DST]], i64 [[TMP7]], !dbg [[DBG35]]
; CHECK-NEXT:    store i32 0, ptr [[TMP8]], align 4
...
; CHECK-NEXT:    [[L:%.*]] = load i32, ptr [[GEP_SRC]], align 4
; CHECK-NEXT:    [[CMP:%.*]] = icmp eq i32 [[L]], 10
; CHECK-NEXT:    br i1 [[CMP]], label [[LOOP_LATCH]], label [[IF_THEN:%.*]], !dbg [[DBG32]]
; CHECK:       if.then:
