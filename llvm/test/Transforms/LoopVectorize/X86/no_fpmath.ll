...
; CHECK: remark: no_fpmath.c:6:11: loop not vectorized: cannot prove it is safe to reorder floating-point operations. Consider to use '#pragma clang fp reassociate(on)' to enable vectorization
; CHECK: remark: no_fpmath.c:6:14: loop not vectorized
; CHECK: remark: no_fpmath.c:17:11: loop not vectorized: cannot prove it is safe to reorder floating-point operations. Consider to use '#pragma clang fp reassociate(on)' to enable vectorization
; CHECK: remark: no_fpmath.c:17:14: loop not vectorized (Force=true)
