...
; CHECK-NEXT:    [[STRIDED_VEC3:%.*]] = shufflevector <32 x float> [[WIDE_VEC]], <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
; CHECK-NEXT:    [[STRIDED_VEC4:%.*]] = shufflevector <32 x float> [[WIDE_VEC]], <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
; CHECK-NEXT:    [[STRIDED_VEC5:%.*]] = shufflevector <32 x float> [[WIDE_VEC]], <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
; CHECK-NEXT:    [[STRIDED_VEC6:%.*]] = shufflevector <32 x float> [[WIDE_VEC]], <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
; CHECK-NEXT:    [[STRIDED_VEC7:%.*]] = shufflevector <32 x float> [[WIDE_VEC]], <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
; CHECK-NEXT:    [[STRIDED_VEC8:%.*]] = shufflevector <32 x float> [[WIDE_VEC]], <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
; CHECK-NEXT:    [[STRIDED_VEC9:%.*]] = shufflevector <32 x float> [[WIDE_VEC]], <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
; CHECK-NEXT:    [[TMP13:%.*]] = fadd <4 x float> [[STRIDED_VEC]], [[STRIDED_VEC6]]
; CHECK-NEXT:    [[TMP40:%.*]] = fmul <4 x float> [[TMP13]], zeroinitializer
; CHECK-NEXT:    [[TMP15:%.*]] = fadd <4 x float> [[STRIDED_VEC3]], [[STRIDED_VEC7]]
; CHECK-NEXT:    [[TMP41:%.*]] = fmul <4 x float> [[TMP15]], zeroinitializer
; CHECK-NEXT:    [[TMP17:%.*]] = fadd <4 x float> [[STRIDED_VEC4]], [[STRIDED_VEC8]]
; CHECK-NEXT:    [[TMP34:%.*]] = fmul <4 x float> [[TMP17]], zeroinitializer
; CHECK-NEXT:    [[TMP19:%.*]] = fadd <4 x float> [[STRIDED_VEC5]], [[STRIDED_VEC9]]
; CHECK-NEXT:    [[TMP36:%.*]] = fmul <4 x float> [[TMP19]], zeroinitializer
...
; CHECK-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <4 x i32> @llvm.masked.gather.v4i32.v4p0(<4 x ptr> [[TMP54]], i32 4, <4 x i1> splat (i1 true), <4 x i32> poison)
