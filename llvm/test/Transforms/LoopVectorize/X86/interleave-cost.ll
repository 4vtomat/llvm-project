...
; CHECK-NEXT:    [[TMP14:%.*]] = fadd <4 x float> [[STRIDED_VEC]], [[STRIDED_VEC6]]
; CHECK-NEXT:    [[TMP40:%.*]] = fmul <4 x float> [[TMP14]], zeroinitializer
; CHECK-NEXT:    [[TMP16:%.*]] = fadd <4 x float> [[STRIDED_VEC3]], [[STRIDED_VEC7]]
; CHECK-NEXT:    [[TMP41:%.*]] = fmul <4 x float> [[TMP16]], zeroinitializer
; CHECK-NEXT:    [[TMP18:%.*]] = fadd <4 x float> [[STRIDED_VEC4]], [[STRIDED_VEC8]]
; CHECK-NEXT:    [[TMP34:%.*]] = fmul <4 x float> [[TMP18]], zeroinitializer
; CHECK-NEXT:    [[TMP29:%.*]] = fadd <4 x float> [[STRIDED_VEC5]], [[STRIDED_VEC9]]
; CHECK-NEXT:    [[TMP36:%.*]] = fmul <4 x float> [[TMP29]], zeroinitializer
