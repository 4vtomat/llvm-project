...
; AUTO_VEC-NEXT:    [[MIN_ITERS_CHECK1:%.*]] = icmp samesign ult i32 [[N]], 8
; AUTO_VEC-NEXT:    br i1 [[MIN_ITERS_CHECK1]], label [[VEC_EPILOG_PH:%.*]], label [[VECTOR_PH:%.*]]
; AUTO_VEC:       vector.main.loop.iter.check:
; AUTO_VEC-NEXT:    [[MIN_ITERS_CHECK2:%.*]] = icmp samesign ult i32 [[N]], 32
; AUTO_VEC-NEXT:    br i1 [[MIN_ITERS_CHECK2]], label [[VEC_EPILOG_PH1:%.*]], label [[VECTOR_PH1:%.*]]
; AUTO_VEC:       vector.ph:
...
; AUTO_VEC-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, [[VECTOR_PH1]] ], [ [[INDEX_NEXT:%.*]], [[VECTOR_BODY]] ]
; AUTO_VEC-NEXT:    [[VEC_IND:%.*]] = phi <8 x float> [ <float 1.000000e+00, float 1.500000e+00, float 2.000000e+00, float 2.500000e+00, float 3.000000e+00, float 3.500000e+00, float 4.000000e+00, float 4.500000e+00>, [[VECTOR_PH1]] ], [ [[VEC_IND_NEXT:%.*]], [[VECTOR_BODY]] ]
...
; AUTO_VEC-NEXT:    br i1 [[MIN_EPILOG_ITERS_CHECK]], label [[VEC_EPILOG_PH]], label [[VEC_EPILOG_PH1]]
; AUTO_VEC:       vec.epilog.ph:
; AUTO_VEC-NEXT:    [[VEC_EPILOG_RESUME_VAL:%.*]] = phi i64 [ [[N_VEC]], [[VEC_EPILOG_ITER_CHECK]] ], [ 0, [[VECTOR_PH]] ]
; AUTO_VEC-NEXT:    [[BC_RESUME_VAL:%.*]] = phi float [ [[IND_END]], [[VEC_EPILOG_ITER_CHECK]] ], [ 1.000000e+00, [[VECTOR_PH]] ]
; AUTO_VEC-NEXT:    [[N_VEC4:%.*]] = and i64 [[ZEXT]], 2147483640
; AUTO_VEC-NEXT:    [[DOTCAST5:%.*]] = uitofp nneg i64 [[N_VEC4]] to float
; AUTO_VEC-NEXT:    [[TMP7:%.*]] = fmul fast float [[DOTCAST5]], 5.000000e-01
; AUTO_VEC-NEXT:    [[TMP8:%.*]] = fadd fast float [[TMP7]], 1.000000e+00
...
; AUTO_VEC-NEXT:    [[INDEX6:%.*]] = phi i64 [ [[VEC_EPILOG_RESUME_VAL]], [[VEC_EPILOG_PH1]] ], [ [[INDEX_NEXT9:%.*]], [[VEC_EPILOG_VECTOR_BODY]] ]
; AUTO_VEC-NEXT:    [[VEC_IND7:%.*]] = phi <8 x float> [ [[INDUCTION]], [[VEC_EPILOG_PH1]] ], [ [[VEC_IND_NEXT8:%.*]], [[VEC_EPILOG_VECTOR_BODY]] ]
; AUTO_VEC-NEXT:    [[TMP9:%.*]] = getelementptr inbounds nuw float, ptr [[A]], i64 [[INDEX6]]
; AUTO_VEC-NEXT:    store <8 x float> [[VEC_IND7]], ptr [[TMP9]], align 4
; AUTO_VEC-NEXT:    [[INDEX_NEXT9]] = add nuw i64 [[INDEX6]], 8
; AUTO_VEC-NEXT:    [[VEC_IND_NEXT8]] = fadd fast <8 x float> [[VEC_IND7]], splat (float 4.000000e+00)
; AUTO_VEC-NEXT:    [[TMP11:%.*]] = icmp eq i64 [[INDEX_NEXT9]], [[N_VEC4]]
; AUTO_VEC-NEXT:    br i1 [[TMP11]], label [[VEC_EPILOG_MIDDLE_BLOCK:%.*]], label [[VEC_EPILOG_VECTOR_BODY]], !llvm.loop [[LOOP3:![0-9]+]]
; AUTO_VEC:       vec.epilog.middle.block:
; AUTO_VEC-NEXT:    [[CMP_N10:%.*]] = icmp eq i64 [[N_VEC4]], [[ZEXT]]
; AUTO_VEC-NEXT:    br i1 [[CMP_N10]], label [[FOR_END]], label [[VEC_EPILOG_PH]]
; AUTO_VEC:       for.body:
; AUTO_VEC-NEXT:    [[INDVARS_IV:%.*]] = phi i64 [ [[INDVARS_IV_NEXT:%.*]], [[VEC_EPILOG_PH]] ], [ 0, [[ITER_CHECK]] ], [ [[N_VEC]], [[VEC_EPILOG_ITER_CHECK]] ], [ [[N_VEC4]], [[VEC_EPILOG_MIDDLE_BLOCK]] ]
; AUTO_VEC-NEXT:    [[X_06:%.*]] = phi float [ [[CONV1:%.*]], [[VEC_EPILOG_PH]] ], [ 1.000000e+00, [[ITER_CHECK]] ], [ [[IND_END]], [[VEC_EPILOG_ITER_CHECK]] ], [ [[TMP8]], [[VEC_EPILOG_MIDDLE_BLOCK]] ]
...
; AUTO_VEC-NEXT:    br i1 [[TMP10]], label [[FOR_END]], label [[VEC_EPILOG_PH]], !llvm.loop [[LOOP4:![0-9]+]]
; AUTO_VEC:       for.end:
...
; AUTO_VEC-NEXT:    [[N_VEC7:%.*]] = and i64 [[TMP0]], 4294967288
; AUTO_VEC-NEXT:    [[DOTCAST8:%.*]] = uitofp nneg i64 [[N_VEC7]] to float
; AUTO_VEC-NEXT:    [[TMP12:%.*]] = fmul reassoc float [[DOTCAST8]], 4.200000e+01
; AUTO_VEC-NEXT:    [[TMP13:%.*]] = fadd reassoc float [[TMP12]], 1.000000e+00
; AUTO_VEC-NEXT:    [[DOTSPLATINSERT:%.*]] = insertelement <8 x float> poison, float [[BC_RESUME_VAL]], i64 0
; AUTO_VEC-NEXT:    [[DOTSPLAT:%.*]] = shufflevector <8 x float> [[DOTSPLATINSERT]], <8 x float> poison, <8 x i32> zeroinitializer
...
; AUTO_VEC-NEXT:    br label [[VEC_EPILOG_VECTOR_BODY:%.*]]
; AUTO_VEC:       vec.epilog.vector.body:
; AUTO_VEC-NEXT:    [[INDEX9:%.*]] = phi i64 [ [[VEC_EPILOG_RESUME_VAL]], [[VEC_EPILOG_PH]] ], [ [[INDEX_NEXT13:%.*]], [[VEC_EPILOG_VECTOR_BODY]] ]
; AUTO_VEC-NEXT:    [[VEC_IND10:%.*]] = phi <8 x float> [ [[INDUCTION]], [[VEC_EPILOG_PH]] ], [ [[VEC_IND_NEXT11:%.*]], [[VEC_EPILOG_VECTOR_BODY]] ]
; AUTO_VEC-NEXT:    [[TMP14:%.*]] = getelementptr inbounds nuw float, ptr [[P]], i64 [[INDEX9]]
; AUTO_VEC-NEXT:    [[WIDE_LOAD12:%.*]] = load <8 x float>, ptr [[TMP14]], align 4
; AUTO_VEC-NEXT:    [[TMP15:%.*]] = fadd reassoc <8 x float> [[VEC_IND10]], [[WIDE_LOAD12]]
; AUTO_VEC-NEXT:    store <8 x float> [[TMP15]], ptr [[TMP14]], align 4
; AUTO_VEC-NEXT:    [[INDEX_NEXT13]] = add nuw i64 [[INDEX9]], 8
; AUTO_VEC-NEXT:    [[VEC_IND_NEXT11]] = fadd reassoc <8 x float> [[VEC_IND10]], splat (float 3.360000e+02)
; AUTO_VEC-NEXT:    [[TMP17:%.*]] = icmp eq i64 [[INDEX_NEXT13]], [[N_VEC7]]
; AUTO_VEC-NEXT:    br i1 [[TMP17]], label [[VEC_EPILOG_MIDDLE_BLOCK:%.*]], label [[VEC_EPILOG_VECTOR_BODY]], !llvm.loop [[LOOP11:![0-9]+]]
; AUTO_VEC:       vec.epilog.middle.block:
; AUTO_VEC-NEXT:    [[CMP_N14:%.*]] = icmp eq i64 [[N_VEC7]], [[TMP0]]
; AUTO_VEC-NEXT:    br i1 [[CMP_N14]], label [[FOR_COND_CLEANUP]], label [[FOR_BODY]]
; AUTO_VEC:       for.cond.cleanup:
; AUTO_VEC-NEXT:    ret void
; AUTO_VEC:       for.body:
; AUTO_VEC-NEXT:    [[INDVARS_IV:%.*]] = phi i64 [ [[INDVARS_IV_NEXT:%.*]], [[FOR_BODY]] ], [ 0, [[ITER_CHECK]] ], [ [[N_VEC]], [[VEC_EPILOG_ITER_CHECK]] ], [ [[N_VEC7]], [[VEC_EPILOG_MIDDLE_BLOCK]] ]
; AUTO_VEC-NEXT:    [[X_012:%.*]] = phi float [ [[ADD3:%.*]], [[FOR_BODY]] ], [ 1.000000e+00, [[ITER_CHECK]] ], [ [[IND_END]], [[VEC_EPILOG_ITER_CHECK]] ], [ [[TMP13]], [[VEC_EPILOG_MIDDLE_BLOCK]] ]
