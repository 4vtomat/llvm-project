...
<<<<<<< HEAD
; CHECK: [[META9]] = !{[[META10]], [[META11]], [[META14]], [[META17]]}
=======
...
<<<<<<< HEAD
; CHECK: [[DBG20]] = !DILocation(line: 0, scope: [[DBG4]])
; CHECK: [[DBG21]] = !DILocation(line: 0, scope: [[META12]])
; CHECK: [[DBG22]] = !DILocation(line: 10, column: 3, scope: [[META12]])
...
; CHECK: [[DBG25]] = !DILocation(line: 11, column: 32, scope: [[META19]])
; CHECK: [[DBG26]] = !DILocation(line: 11, column: 26, scope: [[META19]])
; CHECK: [[DBG27]] = !DILocation(line: 10, column: 30, scope: [[META16]])
; CHECK: [[DBG28]] = !DILocation(line: 10, column: 24, scope: [[META16]])
; CHECK: [[LOOP29]] = distinct !{[[LOOP29]], [[DBG22]], [[META30:![0-9]+]], [[META31:![0-9]+]], [[META32:![0-9]+]]}
...
; CHECK: [[DBG33]] = !DILocation(line: 0, scope: [[META15]])
; CHECK: [[DBG34]] = !DILocation(line: 11, column: 5, scope: [[META15]])
; CHECK: [[DBG35]] = !DILocation(line: 0, scope: [[META18]])
; CHECK: [[DBG36]] = !DILocation(line: 13, column: 2, scope: [[META24]])
; CHECK: [[LOOP37]] = distinct !{[[LOOP37]], [[DBG34]], [[META38:![0-9]+]]}
; CHECK: [[META38]] = !DILocation(line: 13, column: 13, scope: [[META15]])
; CHECK: [[LOOP39]] = distinct !{[[LOOP39]], [[DBG22]], [[META30]], [[META31]]}
; CHECK: [[DBG40]] = !DILocation(line: 14, column: 1, scope: [[DBG4]])
=======
