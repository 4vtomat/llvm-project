...
; CHECK-P470: VPlanCM: cost 16 for RVL (mf2, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%13>)
...
; CHECK-P470: VPlanCM: cost 18 for RVL (m1, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%13>)
...
; CHECK-P470: VPlanCM: cost 22 for RVL (m2, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%13>)
...
; CHECK-P470: VPlanCM: cost 30 for RVL (m4, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%13>)
...
; CHECK-P470: VPlanCM: cost 46 for RVL (m8, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%13>)
...
; CHECK-P670: VPlanCM: cost 16 for RVL (mf2, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%13>)
...
; CHECK-P670: VPlanCM: cost 18 for RVL (m1, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%13>)
...
; CHECK-P670: VPlanCM: cost 22 for RVL (m2, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%13>)
...
; CHECK-P670: VPlanCM: cost 30 for RVL (m4, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%13>)
...
; CHECK-P670: VPlanCM: cost 46 for RVL (m8, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%13>)
