...
; CHECK-P670: VPlanCM: cost 6 for RVL (mf2, float) for VPInstruction: EMIT vp<%13> = fmul ir<%sub>, ir<%sub>
...
; CHECK-P670: VPlanCM: cost 6 for RVL (m1, float) for VPInstruction: EMIT vp<%13> = fmul ir<%sub>, ir<%sub>
...
; CHECK-P670: VPlanCM: cost 12 for RVL (m2, float) for VPInstruction: EMIT vp<%13> = fmul ir<%sub>, ir<%sub>
...
; CHECK-P670: VPlanCM: cost 24 for RVL (m4, float) for VPInstruction: EMIT vp<%13> = fmul ir<%sub>, ir<%sub>
...
; CHECK-P670: VPlanCM: cost 48 for RVL (m8, float) for VPInstruction: EMIT vp<%13> = fmul ir<%sub>, ir<%sub>
