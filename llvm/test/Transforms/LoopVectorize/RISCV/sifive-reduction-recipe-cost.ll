...
; CHECK-X280: VPlanCM: cost 47 for RVL (mf2, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%11>)
...
; CHECK-X280: VPlanCM: cost 12 for RVL (m1, float) for VPInstruction: EMIT vp<%11> = fmul ir<%sub>, ir<%sub>
; CHECK-X280: VPlanCM: cost 48 for RVL (m1, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%11>)
...
; CHECK-X280: VPlanCM: cost 24 for RVL (m2, float) for VPInstruction: EMIT vp<%11> = fmul ir<%sub>, ir<%sub>
; CHECK-X280: VPlanCM: cost 50 for RVL (m2, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%11>)
...
; CHECK-X280: VPlanCM: cost 48 for RVL (m4, float) for VPInstruction: EMIT vp<%11> = fmul ir<%sub>, ir<%sub>
; CHECK-X280: VPlanCM: cost 54 for RVL (m4, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%11>)
...
; CHECK-X280: VPlanCM: cost 96 for RVL (m8, float) for VPInstruction: EMIT vp<%11> = fmul ir<%sub>, ir<%sub>
; CHECK-X280: VPlanCM: cost 62 for RVL (m8, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%11>)
...
; CHECK-P470: VPlanCM: cost 16 for RVL (mf2, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%11>)
...
; CHECK-P470: VPlanCM: cost 18 for RVL (m1, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%11>)
...
; CHECK-P470: VPlanCM: cost 22 for RVL (m2, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%11>)
...
; CHECK-P470: VPlanCM: cost 30 for RVL (m4, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%11>)
...
; CHECK-P470: VPlanCM: cost 46 for RVL (m8, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%11>)
...
; CHECK-P670: VPlanCM: cost 6 for RVL (mf2, float) for VPInstruction: EMIT vp<%11> = fmul ir<%sub>, ir<%sub>
; CHECK-P670: VPlanCM: cost 16 for RVL (mf2, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%11>)
...
; CHECK-P670: VPlanCM: cost 6 for RVL (m1, float) for VPInstruction: EMIT vp<%11> = fmul ir<%sub>, ir<%sub>
; CHECK-P670: VPlanCM: cost 18 for RVL (m1, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%11>)
...
; CHECK-P670: VPlanCM: cost 12 for RVL (m2, float) for VPInstruction: EMIT vp<%11> = fmul ir<%sub>, ir<%sub>
; CHECK-P670: VPlanCM: cost 22 for RVL (m2, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%11>)
...
; CHECK-P670: VPlanCM: cost 24 for RVL (m4, float) for VPInstruction: EMIT vp<%11> = fmul ir<%sub>, ir<%sub>
; CHECK-P670: VPlanCM: cost 30 for RVL (m4, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%11>)
...
; CHECK-P670: VPlanCM: cost 48 for RVL (m8, float) for VPInstruction: EMIT vp<%11> = fmul ir<%sub>, ir<%sub>
; CHECK-P670: VPlanCM: cost 46 for RVL (m8, float) for VPInstruction: REDUCE ir<%2> = ir<%weighted_MSE.07> + reduce.fadd (vp<%11>)
