...
; CHECK-NEXT:    [[TMP11]] = tail call reassoc double @llvm.fmuladd.f64(double 0.000000e+00, double 0.000000e+00, double [[YE_0849]])
...
; CHECK-NO-POSTSV-NEXT:    [[TMP10]] = tail call reassoc double @llvm.fmuladd.f64(double 0.000000e+00, double 0.000000e+00, double [[YE_0849]])
