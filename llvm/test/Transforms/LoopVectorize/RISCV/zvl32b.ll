...
; CHECK-NEXT:    [[TMP1:%.*]] = add <2 x i16> [[WIDE_MASKED_GATHER]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    call void @llvm.masked.scatter.v2i16.v2p0(<2 x i16> [[TMP1]], <2 x ptr> [[TMP0]], i32 2, <2 x i1> <i1 true, i1 true>)
