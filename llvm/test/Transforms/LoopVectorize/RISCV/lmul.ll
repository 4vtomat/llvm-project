...
; RUN: opt < %s -passes=loop-vectorize -mtriple riscv64 -mattr=+v -riscv-use-vla-vectorizer=false -S --riscv-v-register-bit-width-lmul=1 | FileCheck %s -check-prefix=LMUL1
; RUN: opt < %s -passes=loop-vectorize -mtriple riscv64 -mattr=+v -riscv-use-vla-vectorizer=false -S --riscv-v-register-bit-width-lmul=2 | FileCheck %s -check-prefix=LMUL2
; RUN: opt < %s -passes=loop-vectorize -mtriple riscv64 -mattr=+v -riscv-use-vla-vectorizer=false -S --riscv-v-register-bit-width-lmul=4 | FileCheck %s -check-prefix=LMUL4
; RUN: opt < %s -passes=loop-vectorize -mtriple riscv64 -mattr=+v -riscv-use-vla-vectorizer=false -S --riscv-v-register-bit-width-lmul=8 | FileCheck %s -check-prefix=LMUL8
; RUN: opt < %s -passes=loop-vectorize -mtriple riscv64 -mattr=+v -riscv-use-vla-vectorizer=false -S | FileCheck %s -check-prefix=LMUL2
