...
; CHECK-NEXT:    [[TMP24:%.*]] = zext <vscale x 8 x i8> [[VP_OP_LOAD]] to <vscale x 8 x i32>
; CHECK-NEXT:    [[TMP15:%.*]] = mul <vscale x 8 x i32> [[TMP24]], zeroinitializer
; CHECK-NEXT:    [[TMP16:%.*]] = ashr <vscale x 8 x i32> [[TMP24]], zeroinitializer
; CHECK-NEXT:    [[TMP17:%.*]] = or <vscale x 8 x i32> [[TMP16]], zeroinitializer
; CHECK-NEXT:    [[TMP18:%.*]] = icmp ult <vscale x 8 x i32> [[TMP24]], zeroinitializer
; CHECK-NEXT:    [[TMP19:%.*]] = select <vscale x 8 x i1> [[TMP18]], <vscale x 8 x i32> [[TMP17]], <vscale x 8 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP25:%.*]] = trunc <vscale x 8 x i32> [[TMP19]] to <vscale x 8 x i8>
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv8i8.nxv8p0(<vscale x 8 x i8> [[TMP25]], <vscale x 8 x ptr> align 1 [[BROADCAST_SPLAT]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP11]]), !alias.scope [[META3:![0-9]+]], !noalias [[META0]]
; CHECK-NEXT:    [[TMP21:%.*]] = trunc <vscale x 8 x i32> [[TMP15]] to <vscale x 8 x i16>
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv8i16.nxv8p0(<vscale x 8 x i16> [[TMP21]], <vscale x 8 x ptr> align 2 zeroinitializer, <vscale x 8 x i1> splat (i1 true), i32 [[TMP11]])
