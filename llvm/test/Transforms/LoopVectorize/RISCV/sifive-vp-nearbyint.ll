...
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds double, ptr [[TMP3]], i32 4
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <4 x double>, ptr [[TMP4]], align 8
; CHECK-NEXT:    [[WIDE_LOAD1:%.*]] = load <4 x double>, ptr [[TMP2]], align 8
; CHECK-NEXT:    [[TMP11:%.*]] = call <4 x double> @llvm.nearbyint.v4f64(<4 x double> [[WIDE_LOAD]])
; CHECK-NEXT:    [[TMP12:%.*]] = call <4 x double> @llvm.nearbyint.v4f64(<4 x double> [[WIDE_LOAD1]])
...
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr inbounds double, ptr [[TMP5]], i32 4
; CHECK-NEXT:    store <4 x double> [[TMP11]], ptr [[TMP6]], align 8
; CHECK-NEXT:    store <4 x double> [[TMP12]], ptr [[TMP7]], align 8
