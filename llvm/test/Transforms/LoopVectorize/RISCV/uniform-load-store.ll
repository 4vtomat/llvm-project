...
; SCALABLE:       [[VECTOR_PH]]:
; SCALABLE-NEXT:    [[TMP1:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 1025, i32 2, i1 true)
...
; TF-SCALABLE-NEXT:    [[TMP1:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 1025, i32 2, i1 true)
...
; TF-FIXEDLEN-NEXT:    [[TMP6:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 1025, i32 4, i1 true)
...
; TF-FIXEDLEN-NEXT:    br i1 [[TMP5]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
...
; TF-SCALABLE-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <vscale x 2 x i64> [[BROADCAST_SPLATINSERT]], <vscale x 2 x i64> poison, <vscale x 2 x i32> zeroinitializer
; TF-SCALABLE-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[EVL_BASED_IV]]
...
; TF-FIXEDLEN-NEXT:    br i1 false, label %[[SCALAR_PH:.*]], label %[[VECTOR_PH:.*]]
; TF-FIXEDLEN:       [[VECTOR_PH]]:
; TF-FIXEDLEN-NEXT:    [[TMP1:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 1025, i32 4, i1 true)
; TF-FIXEDLEN-NEXT:    br label %[[VECTOR_BODY:.*]]
; TF-FIXEDLEN:       [[VECTOR_BODY]]:
; TF-FIXEDLEN-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_EVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; TF-FIXEDLEN-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <4 x i64> [[BROADCAST_SPLATINSERT]], <4 x i64> poison, <4 x i32> zeroinitializer
; TF-FIXEDLEN-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[EVL_BASED_IV]]
...
; SCALABLE-NEXT:    [[TMP6:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 1025, i32 2, i1 true)
...
; SCALABLE-NEXT:    [[AVL:%.*]] = sub i64 1025, [[INDEX]]
; SCALABLE-NEXT:    [[TMP4:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 2, i1 true)
...
; FIXEDLEN-NEXT:    br i1 false, label %[[SCALAR_PH:.*]], label %[[VECTOR_PH:.*]]
; FIXEDLEN:       [[VECTOR_PH]]:
; FIXEDLEN-NEXT:    [[TMP1:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 1025, i32 4, i1 true)
...
; FIXEDLEN-NEXT:    call void @llvm.vp.store.v4i64.p0(<4 x i64> [[PREDPHI]], ptr align 8 [[TMP4]], <4 x i1> splat (i1 true), i32 [[TMP0]])
; FIXEDLEN-NEXT:    [[TMP7:%.*]] = zext i32 [[TMP0]] to i64
; FIXEDLEN-NEXT:    [[INDEX_EVL_NEXT]] = add nuw i64 [[TMP7]], [[INDEX]]
; FIXEDLEN-NEXT:    [[TMP8:%.*]] = sext i32 [[TMP0]] to i64
; FIXEDLEN-NEXT:    [[TMP5:%.*]] = mul i64 1, [[TMP8]]
; FIXEDLEN-NEXT:    [[DOTSPLATINSERT:%.*]] = insertelement <4 x i64> poison, i64 [[TMP5]], i64 0
...
; TF-SCALABLE-NEXT:    [[TMP6:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 1025, i32 2, i1 true)
...
; TF-FIXEDLEN-NEXT:    call void @llvm.vp.store.v4i64.p0(<4 x i64> [[PREDPHI]], ptr align 8 [[TMP4]], <4 x i1> splat (i1 true), i32 [[TMP0]])
; TF-FIXEDLEN-NEXT:    [[TMP7:%.*]] = zext i32 [[TMP0]] to i64
; TF-FIXEDLEN-NEXT:    [[INDEX_EVL_NEXT]] = add nuw i64 [[TMP7]], [[INDEX]]
; TF-FIXEDLEN-NEXT:    [[TMP8:%.*]] = sext i32 [[TMP0]] to i64
; TF-FIXEDLEN-NEXT:    [[TMP5:%.*]] = mul i64 1, [[TMP8]]
; TF-FIXEDLEN-NEXT:    [[DOTSPLATINSERT:%.*]] = insertelement <4 x i64> poison, i64 [[TMP5]], i64 0
...
; TF-FIXEDLEN-NEXT:    [[TMP6:%.*]] = icmp eq i64 [[INDEX_EVL_NEXT]], 1025
; TF-FIXEDLEN-NEXT:    br i1 [[TMP6]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP6:![0-9]+]]
; TF-FIXEDLEN:       [[MIDDLE_BLOCK]]:
; TF-FIXEDLEN-NEXT:    br label %[[FOR_END:.*]]
; TF-FIXEDLEN:       [[SCALAR_PH]]:
; TF-FIXEDLEN-NEXT:    br label %[[FOR_BODY:.*]]
...
; TF-FIXEDLEN-NEXT:    [[INDEX_EVL_NEXT]] = add nuw i64 [[TMP4]], [[INDEX]]
; TF-FIXEDLEN-NEXT:    [[TMP5:%.*]] = icmp eq i64 [[INDEX_EVL_NEXT]], 1025
; TF-FIXEDLEN-NEXT:    br i1 [[TMP5]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP8:![0-9]+]]
; TF-FIXEDLEN:       [[MIDDLE_BLOCK]]:
; TF-FIXEDLEN-NEXT:    br label %[[FOR_END:.*]]
; TF-FIXEDLEN:       [[SCALAR_PH]]:
; TF-FIXEDLEN-NEXT:    br label %[[FOR_BODY:.*]]
