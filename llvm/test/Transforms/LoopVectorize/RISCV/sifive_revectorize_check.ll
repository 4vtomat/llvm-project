...
; CHECK-NEXT:    [[MUL3:%.*]] = call { i32, i1 } @llvm.umul.with.overflow.i32(i32 [[TMP9]], i32 1023)
...
; CHECK-NEXT:    [[OFFSET_IDX:%.*]] = add i32 [[BC_RESUME_VAL1]], [[EVL_BASED_IV9]]
; CHECK-NEXT:    [[TMP17:%.*]] = mul i32 [[OFFSET_IDX]], [[LOAD]]
