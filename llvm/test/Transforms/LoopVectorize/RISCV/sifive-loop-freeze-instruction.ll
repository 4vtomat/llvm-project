...
; RUN: opt -loop-vectorize -S -mtriple=riscv64-unknown-linux-gnu -prefer-predicate-over-epilogue=predicate-dont-vectorize -scalable-vectorization=only -riscv-use-vla-vectorizer -mattr=+v -vectorizer-use-vp-strided-load-store < %s | FileCheck %s
