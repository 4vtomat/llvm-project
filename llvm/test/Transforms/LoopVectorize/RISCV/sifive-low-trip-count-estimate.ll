...
; CHECK-NEXT:    [[TMP9:%.*]] = insertelement <vscale x 2 x i32> zeroinitializer, i32 [[R:%.*]], i32 0
...
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <vscale x 2 x i32> [ [[TMP9]], [[VECTOR_PH]] ], [ [[VP_OP_MERGE:%.*]], [[VECTOR_BODY]] ]
