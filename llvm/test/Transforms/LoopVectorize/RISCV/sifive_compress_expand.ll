...
; CHECK-NEXT:    [[PRED_NOT:%.*]] = call <vscale x 8 x i1> @llvm.vp.xor.nxv8i1(<vscale x 8 x i1> [[VP_OP_ICMP]], <vscale x 8 x i1> splat (i1 true), <vscale x 8 x i1> splat (i1 true), i32 [[TMP2]])
; CHECK-NEXT:    [[TMP16:%.*]] = call i32 @llvm.vp.first.nxv8i1(<vscale x 8 x i1> [[PRED_NOT]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP2]])
...
; CHECK-NEXT:    [[TMP12:%.*]] = call i32 @llvm.experimental.vp.popcount.nxv8i1(<vscale x 8 x i1> [[PRED_NOT]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP2]])
; CHECK-NEXT:    call void @llvm.vp.store.nxv8i32.p0(<vscale x 8 x i32> [[TMP8]], ptr align 4 [[TMP7]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP12]])
; CHECK-NEXT:    br label [[VECTOR_BODY_SPLIT]]
; CHECK:       vector.body.split:
; CHECK-NEXT:    [[TMP10:%.*]] = call i32 @llvm.experimental.vp.popcount.nxv8i1(<vscale x 8 x i1> [[PRED_NOT]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP2]])
...
; CHECK-NEXT:    [[PRED_NOT:%.*]] = call <vscale x 8 x i1> @llvm.vp.xor.nxv8i1(<vscale x 8 x i1> [[VP_OP_ICMP]], <vscale x 8 x i1> splat (i1 true), <vscale x 8 x i1> splat (i1 true), i32 [[TMP19]])
; CHECK-NEXT:    [[TMP20:%.*]] = call i32 @llvm.vp.first.nxv8i1(<vscale x 8 x i1> [[PRED_NOT]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP19]])
...
; CHECK-NEXT:    br label [[VECTOR_BODY_SPLIT]]
; CHECK:       vector.body.split:
; CHECK-NEXT:    [[TMP13:%.*]] = call i32 @llvm.experimental.vp.popcount.nxv8i1(<vscale x 8 x i1> [[PRED_NOT]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP19]])
...
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[TMP16]], [[EVL_BASED_IV]]
