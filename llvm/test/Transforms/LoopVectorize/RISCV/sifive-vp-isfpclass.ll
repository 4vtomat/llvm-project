...
; CHECK-NEXT:    [[TMP9:%.*]] = icmp ult i64 [[TMP1]], 1
; CHECK-NEXT:    [[SAFE_AVL:%.*]] = select i1 [[TMP9]], i64 [[TMP1]], i64 1
...
; CHECK-NEXT:    [[TMP6:%.*]] = call <vscale x 1 x i1> @llvm.is.fpclass.nxv1f64(<vscale x 1 x double> [[VP_OP_LOAD]], i32 264)
