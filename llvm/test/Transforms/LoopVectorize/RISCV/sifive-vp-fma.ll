...
; CHECK-NEXT:    [[TMP26:%.*]] = call <vscale x 2 x double> @llvm.fma.nxv2f64(<vscale x 2 x double> [[WIDE_LOAD]], <vscale x 2 x double> [[WIDE_LOAD8]], <vscale x 2 x double> [[WIDE_LOAD9]])
