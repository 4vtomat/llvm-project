...
; CHECK-NEXT:    [[TMP9:%.*]] = mul i32 1, [[TMP10]]
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT5:%.*]] = insertelement <vscale x 8 x i32> poison, i32 [[TMP9]], i64 0
...
; CHECK-NEXT:    [[INDEX_EVL_NEXT]] = add nuw i32 [[TMP10]], [[EVL_BASED_IV]]
