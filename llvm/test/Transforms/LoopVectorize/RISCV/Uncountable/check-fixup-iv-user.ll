...
; CHECK-NEXT:    [[TMP18:%.*]] = call i32 @llvm.vp.first.nxv16i1(<vscale x 16 x i1> [[VP_OP_ICMP]], <vscale x 16 x i1> splat (i1 true), i32 [[TMP15]])
; CHECK-NEXT:    [[TMP19:%.*]] = icmp sge i32 [[TMP18]], 0
; CHECK-NEXT:    br i1 [[TMP19]], label %[[VECTOR_EARLY_EXIT:.*]], label %[[LOOP_NEXT2]]
; CHECK:       [[LOOP_NEXT2]]:
...
; CHECK-NEXT:    [[DOTLCSSA:%.*]] = phi i32 [ [[TMP18]], %[[VECTOR_BODY]] ]
