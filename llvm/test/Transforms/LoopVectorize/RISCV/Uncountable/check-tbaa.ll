...
; CHECK-NEXT:    [[TMP9:%.*]] = call { <vscale x 8 x i8>, i64 } @llvm.riscv.vleff.nxv8i8.i64(<vscale x 8 x i8> poison, ptr [[TMP7]], i64 [[TMP8]]), !tbaa [[TBAA0:![0-9]+]]
; CHECK-NEXT:    [[TMP10:%.*]] = extractvalue { <vscale x 8 x i8>, i64 } [[TMP9]], 0
; CHECK-NEXT:    [[TMP11:%.*]] = extractvalue { <vscale x 8 x i8>, i64 } [[TMP9]], 1
