...
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <8 x i32> [ [[TMP1]], [[VECTOR_PH]] ], [ [[TMP15:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI1:%.*]] = phi <8 x i32> [ zeroinitializer, [[VECTOR_PH]] ], [ [[TMP16:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP2:%.*]] = add i64 [[INDEX]], 0, !dbg [[DBG10]]
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr inbounds i16, ptr [[PTR:%.*]], i64 [[TMP2]], !dbg [[DBG12:![0-9]+]]
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds i16, ptr [[TMP3]], i32 0, !dbg [[DBG12]]
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr inbounds i16, ptr [[TMP3]], i32 8, !dbg [[DBG12]]
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <8 x i16>, ptr [[TMP4]], align 2, !dbg [[DBG12]], !tbaa [[TBAA13:![0-9]+]]
; CHECK-NEXT:    [[WIDE_LOAD2:%.*]] = load <8 x i16>, ptr [[TMP5]], align 2, !dbg [[DBG12]], !tbaa [[TBAA13]]
; CHECK-NEXT:    [[TMP6:%.*]] = and <8 x i32> [[VEC_PHI]], splat (i32 65535), !dbg [[DBG17:![0-9]+]]
; CHECK-NEXT:    [[TMP7:%.*]] = and <8 x i32> [[VEC_PHI1]], splat (i32 65535), !dbg [[DBG17]]
; CHECK-NEXT:    [[TMP8:%.*]] = zext <8 x i16> [[WIDE_LOAD]] to <8 x i32>, !dbg [[DBG18:![0-9]+]]
; CHECK-NEXT:    [[TMP9:%.*]] = zext <8 x i16> [[WIDE_LOAD2]] to <8 x i32>, !dbg [[DBG18]]
; CHECK-NEXT:    [[TMP11:%.*]] = add <8 x i32> [[TMP6]], [[TMP8]], !dbg [[DBG19:![0-9]+]]
; CHECK-NEXT:    [[TMP12:%.*]] = add <8 x i32> [[TMP7]], [[TMP9]], !dbg [[DBG19]]
...
; CHECK-NEXT:    br i1 [[TMP20]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !dbg [[DBG11]], !llvm.loop [[LOOP20:![0-9]+]]
; CHECK:       middle.block:
; CHECK-NEXT:    [[TMP17:%.*]] = trunc <8 x i32> [[TMP15]] to <8 x i16>, !dbg [[DBG10]]
; CHECK-NEXT:    [[TMP18:%.*]] = trunc <8 x i32> [[TMP16]] to <8 x i16>, !dbg [[DBG10]]
; CHECK-NEXT:    [[BIN_RDX:%.*]] = add <8 x i16> [[TMP18]], [[TMP17]], !dbg [[DBG10]]
; CHECK-NEXT:    [[TMP19:%.*]] = call i16 @llvm.vector.reduce.add.v8i16(<8 x i16> [[BIN_RDX]]), !dbg [[DBG10]]
...
; CHECK-NEXT:    [[TMP21:%.*]] = load i16, ptr [[ARRAYIDX]], align 2, !dbg [[DBG12]], !tbaa [[TBAA13]]
; CHECK-NEXT:    [[AND:%.*]] = and i32 [[SUM_010]], 65535, !dbg [[DBG17]]
; CHECK-NEXT:    [[CONV:%.*]] = zext i16 [[TMP21]] to i32, !dbg [[DBG18]]
...
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[EXTRACT_T:%.*]] = trunc i32 [[BC_MERGE_RDX:%.*]] to i16, !dbg [[DBG10:![0-9]+]]
...
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[TMP16:%.*]] = insertelement <vscale x 4 x i32> zeroinitializer, i32 [[BC_MERGE_RDX]], i32 0, !dbg [[DBG10]]
...
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[VEC_PHI:%.*]] = phi <vscale x 4 x i32> [ [[TMP16]], [[VECTOR_PH]] ], [ [[TMP9:%.*]], [[VECTOR_BODY]] ]
...
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 4 x i16> @llvm.vp.load.nxv4i16.p0(ptr align 2 [[TMP7]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP4]]), !dbg [[DBG12]], !tbaa [[TBAA13:![0-9]+]]
...
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[TMP10:%.*]] = zext i32 [[TMP4]] to i64, !dbg [[DBG11]]
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[INDEX_EVL_NEXT]] = add nuw i64 [[TMP10]], [[EVL_BASED_IV]], !dbg [[DBG11]]
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[TMP11:%.*]] = icmp eq i64 [[INDEX_EVL_NEXT]], [[TMP0]], !dbg [[DBG11]]
...
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[TMP12:%.*]] = trunc <vscale x 4 x i32> [[TMP9]] to <vscale x 4 x i16>, !dbg [[DBG10]]
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[TMP13:%.*]] = call i16 @llvm.vp.reduce.add.nxv4i16(i16 0, <vscale x 4 x i16> [[TMP12]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP2]]), !dbg [[DBG10]]
...
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[INDVARS_IV:%.*]] = phi i64 [ 0, [[SCALAR_PH]] ], [ [[INDVARS_IV_NEXT:%.*]], [[WHILE_BODY]] ]
