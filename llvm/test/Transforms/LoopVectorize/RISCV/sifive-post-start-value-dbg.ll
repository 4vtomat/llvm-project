...
; CHECK-NEXT:    [[TMP4:%.*]] = and <8 x i32> [[VEC_PHI1]], splat (i32 65535), !dbg [[DBG17:![0-9]+]]
; CHECK-NEXT:    [[TMP5:%.*]] = and <8 x i32> [[VEC_PHI2]], splat (i32 65535), !dbg [[DBG17]]
...
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[TMP12:%.*]] = trunc i32 [[BC_MERGE_RDX]] to i16, !dbg [[DBG10]]
