...
; CHECK-NEXT:    [[TMP1:%.*]] = add i64 [[INDEX]], 0, !dbg [[DBG11]]
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds i16, ptr [[PTR:%.*]], i64 [[TMP1]], !dbg [[DBG12:![0-9]+]]
...
; CHECK-NEXT:    [[TMP5:%.*]] = and <8 x i32> [[VEC_PHI1]], splat (i32 65535), !dbg [[DBG17:![0-9]+]]
; CHECK-NEXT:    [[TMP6:%.*]] = and <8 x i32> [[VEC_PHI2]], splat (i32 65535), !dbg [[DBG17]]
...
; CHECK:       middle.block:
; CHECK-NEXT:    [[TMP24:%.*]] = trunc <8 x i32> [[TMP16]] to <8 x i16>, !dbg [[DBG10]]
; CHECK-NEXT:    [[TMP17:%.*]] = trunc <8 x i32> [[TMP21]] to <8 x i16>, !dbg [[DBG10]]
; CHECK-NEXT:    [[BIN_RDX:%.*]] = add <8 x i16> [[TMP17]], [[TMP24]], !dbg [[DBG10]]
; CHECK-NEXT:    [[TMP18:%.*]] = call i16 @llvm.vector.reduce.add.v8i16(<8 x i16> [[BIN_RDX]]), !dbg [[DBG10]]
; CHECK-NEXT:    [[TMP19:%.*]] = trunc i32 [[START]] to i16, !dbg [[DBG10]]
; CHECK-NEXT:    [[TMP20:%.*]] = add i16 [[TMP19]], [[TMP18]], !dbg [[DBG10]]
; CHECK-NEXT:    [[TMP23:%.*]] = zext i16 [[TMP20]] to i32, !dbg [[DBG10]]
...
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 4 x i16> @llvm.vp.load.nxv4i16.p0(ptr align 2 [[TMP6]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP4]]), !dbg [[DBG12]], !tbaa [[TBAA13:![0-9]+]]
...
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[TMP17:%.*]] = zext i32 [[TMP4]] to i64, !dbg [[DBG11]]
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[INDEX_EVL_NEXT]] = add nuw i64 [[TMP17]], [[EVL_BASED_IV]], !dbg [[DBG11]]
...
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[TMP13:%.*]] = trunc i32 [[BC_MERGE_RDX]] to i16, !dbg [[DBG10]]
