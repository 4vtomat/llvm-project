...
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[TMP7:%.*]] = trunc i64 [[TMP6]] to i32, !dbg [[DBG10]]
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[TMP8:%.*]] = add i64 [[INDEX]], 0, !dbg [[DBG10]]
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[TMP9:%.*]] = getelementptr inbounds i16, ptr [[PTR:%.*]], i64 [[TMP8]], !dbg [[DBG12:![0-9]+]]
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i16, ptr [[TMP9]], i32 0, !dbg [[DBG12]]
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 4 x i16> @llvm.vp.load.nxv4i16.p0(ptr align 2 [[TMP10]], <vscale x 4 x i1> shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i64 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer), i32 [[TMP7]]), !dbg [[DBG12]], !tbaa [[TBAA13:![0-9]+]]
...
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[VP_CAST:%.*]] = call <vscale x 4 x i32> @llvm.vp.zext.nxv4i32.nxv4i16(<vscale x 4 x i16> [[VP_OP_LOAD]], <vscale x 4 x i1> shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i64 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer), i32 [[TMP7]]), !dbg [[DBG18:![0-9]+]]
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[VP_OP1:%.*]] = call <vscale x 4 x i32> @llvm.vp.add.nxv4i32(<vscale x 4 x i32> [[VP_OP]], <vscale x 4 x i32> [[VP_CAST]], <vscale x 4 x i1> shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i64 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer), i32 [[TMP7]]), !dbg [[DBG19:![0-9]+]]
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[VP_OP_MERGE:%.*]] = call <vscale x 4 x i32> @llvm.vp.merge.nxv4i32(<vscale x 4 x i1> shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i64 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer), <vscale x 4 x i32> [[VP_OP1]], <vscale x 4 x i32> [[VEC_PHI]], i32 [[TMP7]]), !dbg [[DBG19]]
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[TMP11:%.*]] = trunc <vscale x 4 x i32> [[VP_OP_MERGE]] to <vscale x 4 x i16>
...
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    br i1 [[TMP14]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !dbg [[DBG11]], !llvm.loop [[LOOP20:![0-9]+]]
...
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[TMP21:%.*]] = load i16, ptr [[ARRAYIDX]], align 2, !dbg [[DBG12]], !tbaa [[TBAA13]]
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[AND:%.*]] = and i32 [[SUM_010]], 65535, !dbg [[DBG17]]
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[CONV:%.*]] = zext i16 [[TMP21]] to i32, !dbg [[DBG18]]
...
; IGNORE-INTERLEAVE-FOR-VLA-NEXT:    [[ADD_LCSSA:%.*]] = phi i32 [ [[ADD]], [[WHILE_BODY]] ], [ [[TMP20]], [[MIDDLE_BLOCK]] ], !dbg [[DBG19]]
