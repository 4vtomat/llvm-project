...
; VEC-M1-NEXT:    [[TMP62:%.*]] = add i64 [[EVL_BASED_IV]], 0
; VEC-M1-NEXT:    [[TMP63:%.*]] = getelementptr [[STRUCT_SU3_VECTOR:%.*]], ptr [[A]], i64 [[TMP62]]
; VEC-M1-NEXT:    [[TMP64:%.*]] = getelementptr [[STRUCT_SU3_VECTOR]], ptr [[B]], i64 [[TMP62]]
; VEC-M1-NEXT:    [[TMP65:%.*]] = mul nuw nsw i32 [[TMP61]], 6
...
; VEC-M1-NEXT:    [[TMP72:%.*]] = mul nuw nsw i32 [[TMP61]], 6
...
; VEC-M1-NEXT:    [[VP_OP:%.*]] = call <vscale x 1 x double> @llvm.vp.fmul.nxv1f64(<vscale x 1 x double> [[TMP73]], <vscale x 1 x double> [[BROADCAST_SPLAT]], <vscale x 1 x i1> splat (i1 true), i32 [[TMP61]])
; VEC-M1-NEXT:    [[VP_OP47:%.*]] = call <vscale x 1 x double> @llvm.vp.fadd.nxv1f64(<vscale x 1 x double> [[VP_OP]], <vscale x 1 x double> [[TMP66]], <vscale x 1 x i1> splat (i1 true), i32 [[TMP61]])
; VEC-M1-NEXT:    [[VP_OP48:%.*]] = call <vscale x 1 x double> @llvm.vp.fmul.nxv1f64(<vscale x 1 x double> [[TMP74]], <vscale x 1 x double> [[BROADCAST_SPLAT]], <vscale x 1 x i1> splat (i1 true), i32 [[TMP61]])
; VEC-M1-NEXT:    [[VP_OP49:%.*]] = call <vscale x 1 x double> @llvm.vp.fadd.nxv1f64(<vscale x 1 x double> [[VP_OP48]], <vscale x 1 x double> [[TMP67]], <vscale x 1 x i1> splat (i1 true), i32 [[TMP61]])
; VEC-M1-NEXT:    [[VP_OP50:%.*]] = call <vscale x 1 x double> @llvm.vp.fmul.nxv1f64(<vscale x 1 x double> [[TMP75]], <vscale x 1 x double> [[BROADCAST_SPLAT]], <vscale x 1 x i1> splat (i1 true), i32 [[TMP61]])
; VEC-M1-NEXT:    [[VP_OP51:%.*]] = call <vscale x 1 x double> @llvm.vp.fadd.nxv1f64(<vscale x 1 x double> [[VP_OP50]], <vscale x 1 x double> [[TMP68]], <vscale x 1 x i1> splat (i1 true), i32 [[TMP61]])
; VEC-M1-NEXT:    [[VP_OP52:%.*]] = call <vscale x 1 x double> @llvm.vp.fmul.nxv1f64(<vscale x 1 x double> [[TMP76]], <vscale x 1 x double> [[BROADCAST_SPLAT]], <vscale x 1 x i1> splat (i1 true), i32 [[TMP61]])
; VEC-M1-NEXT:    [[VP_OP53:%.*]] = call <vscale x 1 x double> @llvm.vp.fadd.nxv1f64(<vscale x 1 x double> [[VP_OP52]], <vscale x 1 x double> [[TMP69]], <vscale x 1 x i1> splat (i1 true), i32 [[TMP61]])
; VEC-M1-NEXT:    [[VP_OP54:%.*]] = call <vscale x 1 x double> @llvm.vp.fmul.nxv1f64(<vscale x 1 x double> [[TMP77]], <vscale x 1 x double> [[BROADCAST_SPLAT]], <vscale x 1 x i1> splat (i1 true), i32 [[TMP61]])
; VEC-M1-NEXT:    [[VP_OP55:%.*]] = call <vscale x 1 x double> @llvm.vp.fadd.nxv1f64(<vscale x 1 x double> [[VP_OP54]], <vscale x 1 x double> [[TMP70]], <vscale x 1 x i1> splat (i1 true), i32 [[TMP61]])
; VEC-M1-NEXT:    [[VP_OP56:%.*]] = call <vscale x 1 x double> @llvm.vp.fmul.nxv1f64(<vscale x 1 x double> [[TMP78]], <vscale x 1 x double> [[BROADCAST_SPLAT]], <vscale x 1 x i1> splat (i1 true), i32 [[TMP61]])
; VEC-M1-NEXT:    [[VP_OP57:%.*]] = call <vscale x 1 x double> @llvm.vp.fadd.nxv1f64(<vscale x 1 x double> [[VP_OP56]], <vscale x 1 x double> [[TMP71]], <vscale x 1 x i1> splat (i1 true), i32 [[TMP61]])
...
; VEC-M1-NEXT:    [[TMP79:%.*]] = mul nuw nsw i32 [[TMP61]], 6
...
; VEC-M1-NEXT:    [[TMP80:%.*]] = zext i32 [[TMP61]] to i64
...
; VEC-M4-NEXT:    [[TMP62:%.*]] = add i64 [[EVL_BASED_IV]], 0
; VEC-M4-NEXT:    [[TMP63:%.*]] = getelementptr [[STRUCT_SU3_VECTOR:%.*]], ptr [[A]], i64 [[TMP62]]
; VEC-M4-NEXT:    [[TMP64:%.*]] = getelementptr [[STRUCT_SU3_VECTOR]], ptr [[B]], i64 [[TMP62]]
; VEC-M4-NEXT:    [[VP_STRIDED_LOAD:%.*]] = call <vscale x 4 x double> @llvm.experimental.vp.strided.load.nxv4f64.p0.i64(ptr align 8 [[TMP63]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META0:![0-9]+]], !noalias [[META3:![0-9]+]]
; VEC-M4-NEXT:    [[VP_STRIDED_LOAD45:%.*]] = call <vscale x 4 x double> @llvm.experimental.vp.strided.load.nxv4f64.p0.i64(ptr align 8 [[TMP64]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META3]]
...
; VEC-M4-NEXT:    call void @llvm.experimental.vp.strided.store.nxv4f64.p0.i64(<vscale x 4 x double> [[VP_OP46]], ptr align 8 [[TMP63]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META0]], !noalias [[META3]]
; VEC-M4-NEXT:    [[TMP65:%.*]] = getelementptr [3 x %struct.complex], ptr [[TMP63]], i64 0, i64 0, i32 1
; VEC-M4-NEXT:    [[VP_STRIDED_LOAD47:%.*]] = call <vscale x 4 x double> @llvm.experimental.vp.strided.load.nxv4f64.p0.i64(ptr align 8 [[TMP65]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META0]], !noalias [[META3]]
; VEC-M4-NEXT:    [[TMP66:%.*]] = getelementptr [3 x %struct.complex], ptr [[TMP64]], i64 0, i64 0, i32 1
; VEC-M4-NEXT:    [[VP_STRIDED_LOAD48:%.*]] = call <vscale x 4 x double> @llvm.experimental.vp.strided.load.nxv4f64.p0.i64(ptr align 8 [[TMP66]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META3]]
...
; VEC-M4-NEXT:    call void @llvm.experimental.vp.strided.store.nxv4f64.p0.i64(<vscale x 4 x double> [[VP_OP50]], ptr align 8 [[TMP65]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META0]], !noalias [[META3]]
; VEC-M4-NEXT:    [[TMP67:%.*]] = getelementptr [3 x %struct.complex], ptr [[TMP63]], i64 0, i64 1
; VEC-M4-NEXT:    [[VP_STRIDED_LOAD51:%.*]] = call <vscale x 4 x double> @llvm.experimental.vp.strided.load.nxv4f64.p0.i64(ptr align 8 [[TMP67]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META0]], !noalias [[META3]]
; VEC-M4-NEXT:    [[TMP68:%.*]] = getelementptr [3 x %struct.complex], ptr [[TMP64]], i64 0, i64 1
; VEC-M4-NEXT:    [[VP_STRIDED_LOAD52:%.*]] = call <vscale x 4 x double> @llvm.experimental.vp.strided.load.nxv4f64.p0.i64(ptr align 8 [[TMP68]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META3]]
...
; VEC-M4-NEXT:    call void @llvm.experimental.vp.strided.store.nxv4f64.p0.i64(<vscale x 4 x double> [[VP_OP54]], ptr align 8 [[TMP67]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META0]], !noalias [[META3]]
; VEC-M4-NEXT:    [[TMP69:%.*]] = getelementptr [3 x %struct.complex], ptr [[TMP63]], i64 0, i64 1, i32 1
; VEC-M4-NEXT:    [[VP_STRIDED_LOAD55:%.*]] = call <vscale x 4 x double> @llvm.experimental.vp.strided.load.nxv4f64.p0.i64(ptr align 8 [[TMP69]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META0]], !noalias [[META3]]
; VEC-M4-NEXT:    [[TMP70:%.*]] = getelementptr [3 x %struct.complex], ptr [[TMP64]], i64 0, i64 1, i32 1
; VEC-M4-NEXT:    [[VP_STRIDED_LOAD56:%.*]] = call <vscale x 4 x double> @llvm.experimental.vp.strided.load.nxv4f64.p0.i64(ptr align 8 [[TMP70]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META3]]
...
; VEC-M4-NEXT:    call void @llvm.experimental.vp.strided.store.nxv4f64.p0.i64(<vscale x 4 x double> [[VP_OP58]], ptr align 8 [[TMP69]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META0]], !noalias [[META3]]
; VEC-M4-NEXT:    [[TMP71:%.*]] = getelementptr [3 x %struct.complex], ptr [[TMP63]], i64 0, i64 2
; VEC-M4-NEXT:    [[VP_STRIDED_LOAD59:%.*]] = call <vscale x 4 x double> @llvm.experimental.vp.strided.load.nxv4f64.p0.i64(ptr align 8 [[TMP71]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META0]], !noalias [[META3]]
; VEC-M4-NEXT:    [[TMP72:%.*]] = getelementptr [3 x %struct.complex], ptr [[TMP64]], i64 0, i64 2
; VEC-M4-NEXT:    [[VP_STRIDED_LOAD60:%.*]] = call <vscale x 4 x double> @llvm.experimental.vp.strided.load.nxv4f64.p0.i64(ptr align 8 [[TMP72]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META3]]
...
; VEC-M4-NEXT:    call void @llvm.experimental.vp.strided.store.nxv4f64.p0.i64(<vscale x 4 x double> [[VP_OP62]], ptr align 8 [[TMP71]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META0]], !noalias [[META3]]
; VEC-M4-NEXT:    [[TMP73:%.*]] = getelementptr [3 x %struct.complex], ptr [[TMP63]], i64 0, i64 2, i32 1
; VEC-M4-NEXT:    [[VP_STRIDED_LOAD63:%.*]] = call <vscale x 4 x double> @llvm.experimental.vp.strided.load.nxv4f64.p0.i64(ptr align 8 [[TMP73]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META0]], !noalias [[META3]]
; VEC-M4-NEXT:    [[TMP74:%.*]] = getelementptr [3 x %struct.complex], ptr [[TMP64]], i64 0, i64 2, i32 1
; VEC-M4-NEXT:    [[VP_STRIDED_LOAD64:%.*]] = call <vscale x 4 x double> @llvm.experimental.vp.strided.load.nxv4f64.p0.i64(ptr align 8 [[TMP74]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META3]]
...
; VEC-M4-NEXT:    call void @llvm.experimental.vp.strided.store.nxv4f64.p0.i64(<vscale x 4 x double> [[VP_OP66]], ptr align 8 [[TMP73]], i64 48, <vscale x 4 x i1> splat (i1 true), i32 [[TMP61]]), !alias.scope [[META0]], !noalias [[META3]]
; VEC-M4-NEXT:    [[TMP75:%.*]] = zext i32 [[TMP61]] to i64
