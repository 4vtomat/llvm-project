...
; CHECK:       [[VECTOR_PH]]:
; CHECK-NEXT:    [[TMP0:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[CONV47]], i32 8, i1 true)
...
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 8 x float> @llvm.vp.load.nxv8f32.p0(ptr align 4 [[TMP2]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP3]])
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv8f32.nxv8p0(<vscale x 8 x float> [[VP_OP_LOAD]], <vscale x 8 x ptr> align 4 zeroinitializer, <vscale x 8 x i1> splat (i1 true), i32 [[TMP3]])
; CHECK-NEXT:    [[TMP4:%.*]] = zext i32 [[TMP3]] to i64
; CHECK-NEXT:    [[INDEX_EVL_NEXT]] = add nuw i64 [[TMP4]], [[EVL_BASED_IV]]
; CHECK-NEXT:    [[TMP5:%.*]] = icmp eq i64 [[INDEX_EVL_NEXT]], [[CONV47]]
...
; CHECK:       [[VECTOR_PH2]]:
; CHECK-NEXT:    [[TMP7:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[CONV47]], i32 8, i1 true)
...
; CHECK-NEXT:    [[TMP8:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL6]], i32 8, i1 true)
; CHECK-NEXT:    [[OFFSET_IDX:%.*]] = add i64 [[BC_RESUME_VAL]], [[EVL_BASED_IV5]]
; CHECK-NEXT:    [[TMP9:%.*]] = mul i64 [[OFFSET_IDX]], [[CONV49]]
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr float, ptr [[DATA]], i64 [[TMP9]]
; CHECK-NEXT:    [[VP_STRIDED_LOAD:%.*]] = call <vscale x 8 x float> @llvm.experimental.vp.strided.load.nxv8f32.p0.i64(ptr align 4 [[TMP11]], i64 [[TMP6]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP8]])
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv8f32.nxv8p0(<vscale x 8 x float> [[VP_STRIDED_LOAD]], <vscale x 8 x ptr> align 4 zeroinitializer, <vscale x 8 x i1> splat (i1 true), i32 [[TMP8]])
