...
; CHECK-NEXT:    EMIT branch-on-cond ir<%8>
...
; CHECK-NEXT:    EMIT-SCALAR vp<%3> = EXPLICIT-VECTOR-LENGTH vp<%avl>
; CHECK-NEXT:    vp<%4> = DERIVED-IV ir<%n> + vp<%evl.based.iv> * ir<-1>
; CHECK-NEXT:    CLONE ir<%i.0> = add nsw vp<%4>, ir<-1>
; CHECK-NEXT:    CLONE ir<%idxprom> = zext ir<%i.0>
; CHECK-NEXT:    CLONE ir<%arrayidx> = getelementptr inbounds ir<%B>, ir<%idxprom>
; CHECK-NEXT:    vp<%5> = vector-end-pointer ir<%arrayidx>, vp<%3>
; CHECK-NEXT:    WIDEN ir<%14> = vp.load vp<%5>, vp<%3> unit-strided
; CHECK-NEXT:    WIDEN ir<%add9> = add ir<%14>, ir<1>
; CHECK-NEXT:    CLONE ir<%arrayidx3> = getelementptr inbounds ir<%A>, ir<%idxprom>
; CHECK-NEXT:    vp<%6> = vector-end-pointer ir<%arrayidx3>, vp<%3>
; CHECK-NEXT:    WIDEN vp.store vp<%6>, ir<%add9>, vp<%3> unit-strided
; CHECK-NEXT:    EMIT-SCALAR vp<%7> = zext vp<%3> to i64
; CHECK-NEXT:    EMIT vp<%index.evl.next> = add nuw vp<%7>, vp<%evl.based.iv>
...
; CHECK-NEXT:    br i1 %8, <null operand!>, <null operand!>
...
; CHECK-NEXT:    %20 = sub i64 %18, 1
; CHECK-NEXT:    %21 = mul i64 -1, %20
; CHECK-NEXT:    %22 = getelementptr i32, ptr %17, i64 %19
; CHECK-NEXT:    %23 = getelementptr i32, ptr %22, i64 %21
; CHECK-NEXT:    %vp.op.load = call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr align 4 %23, <vscale x 4 x i1> splat (i1 true), i32 %14)
...
; CHECK-NEXT:    %24 = getelementptr inbounds i32, ptr %A, i64 %16
; CHECK-NEXT:    %25 = zext i32 %14 to i64
; CHECK-NEXT:    %26 = mul i64 0, %25
; CHECK-NEXT:    %27 = sub i64 %25, 1
; CHECK-NEXT:    %28 = mul i64 -1, %27
; CHECK-NEXT:    %29 = getelementptr i32, ptr %24, i64 %26
; CHECK-NEXT:    %30 = getelementptr i32, ptr %29, i64 %28
; CHECK-NEXT:    call void @llvm.vp.store.nxv4i32.p0(<vscale x 4 x i32> %vp.op, ptr align 4 %30, <vscale x 4 x i1> splat (i1 true), i32 %14)
; CHECK-NEXT:    %31 = zext i32 %14 to i64
; CHECK-NEXT:    %index.evl.next = add nuw i64 %31, %evl.based.iv
; CHECK-NEXT:    %32 = icmp eq i64 %index.evl.next, %0
...
; CHECK-NEXT:  LV: filled BB:
; CHECK-NEXT:  scalar.ph: ; No predecessors!
...
; CHECK-NEXT:    CLONE ir<%arrayidx3> = getelementptr inbounds ir<%A>, ir<%idxprom>
; CHECK-NEXT:    vp<%6> = vector-end-pointer ir<%arrayidx3>, vp<%3>
; CHECK-NEXT:    WIDEN vp.store vp<%6>, ir<%conv1>, vp<%3> unit-strided
; CHECK-NEXT:    EMIT-SCALAR vp<%7> = zext vp<%3> to i64
; CHECK-NEXT:    EMIT vp<%index.evl.next> = add nuw vp<%7>, vp<%evl.based.iv>
; CHECK-NEXT:    EMIT branch-on-count vp<%index.evl.next>, ir<%0>
; CHECK-NEXT:  Successor(s): middle.block, vector.body
...
; CHECK-NEXT:    %20 = sub i64 %18, 1
; CHECK-NEXT:    %21 = mul i64 -1, %20
; CHECK-NEXT:    %22 = getelementptr float, ptr %17, i64 %19
; CHECK-NEXT:    %23 = getelementptr float, ptr %22, i64 %21
; CHECK-NEXT:    %vp.op.load = call <vscale x 4 x float> @llvm.vp.load.nxv4f32.p0(ptr align 4 %23, <vscale x 4 x i1> splat (i1 true), i32 %14)
...
; CHECK-NEXT:    %24 = getelementptr inbounds float, ptr %A, i64 %16
; CHECK-NEXT:    %25 = zext i32 %14 to i64
; CHECK-NEXT:    %26 = mul i64 0, %25
; CHECK-NEXT:    %27 = sub i64 %25, 1
; CHECK-NEXT:    %28 = mul i64 -1, %27
; CHECK-NEXT:    %29 = getelementptr float, ptr %24, i64 %26
; CHECK-NEXT:    %30 = getelementptr float, ptr %29, i64 %28
; CHECK-NEXT:    call void @llvm.vp.store.nxv4f32.p0(<vscale x 4 x float> %vp.op, ptr align 4 %30, <vscale x 4 x i1> splat (i1 true), i32 %14)
; CHECK-NEXT:    %31 = zext i32 %14 to i64
; CHECK-NEXT:    %index.evl.next = add nuw i64 %31, %evl.based.iv
; CHECK-NEXT:    %32 = icmp eq i64 %index.evl.next, %0
; CHECK-NEXT:    br i1 %32, <null operand!>, label %vector.body
