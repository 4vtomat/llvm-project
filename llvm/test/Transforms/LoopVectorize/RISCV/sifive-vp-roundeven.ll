...
; CHECK-NEXT:    [[TMP8:%.*]] = call <vscale x 2 x double> @llvm.roundeven.nxv2f64(<vscale x 2 x double> [[WIDE_LOAD]])
...
; CHECK-NEXT:    store <vscale x 2 x double> [[TMP8]], ptr [[TMP6]], align 8
; CHECK-NEXT:    [[INDEX_EVL_NEXT]] = add nuw i64 [[EVL_BASED_IV]], [[TMP13]]
