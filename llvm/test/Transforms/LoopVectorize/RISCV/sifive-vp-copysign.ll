...
; CHECK-NEXT:    [[WIDE_LOAD1:%.*]] = load <vscale x 2 x double>, ptr [[TMP6]], align 8
; CHECK-NEXT:    [[TMP10:%.*]] = call <vscale x 2 x double> @llvm.copysign.nxv2f64(<vscale x 2 x double> [[WIDE_LOAD]], <vscale x 2 x double> [[WIDE_LOAD1]])
...
; CHECK-NEXT:    store <vscale x 2 x double> [[TMP10]], ptr [[TMP8]], align 8
