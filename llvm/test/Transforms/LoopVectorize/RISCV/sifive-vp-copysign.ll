...
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr inbounds double, ptr [[A:%.*]], i64 [[EVL_BASED_IV1]]
...
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr inbounds double, ptr [[B:%.*]], i64 [[EVL_BASED_IV1]]
...
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr inbounds double, ptr [[C:%.*]], i64 [[EVL_BASED_IV1]]
