...
<<<<<<< HEAD
; RUN: opt -mtriple riscv64-linux-gnu -mattr=+v,+d -riscv-use-vla-vectorizer=false -loop-vectorize < %s -S -o - | FileCheck %s -check-prefix=OUTLOOP
; RUN: opt -mtriple riscv64-linux-gnu -mattr=+v,+d -riscv-use-vla-vectorizer=false -loop-vectorize -prefer-inloop-reductions < %s -S -o - | FileCheck %s -check-prefix=INLOOP
=======
