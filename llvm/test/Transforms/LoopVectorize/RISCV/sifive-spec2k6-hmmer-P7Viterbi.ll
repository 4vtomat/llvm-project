...
; X280-NEXT:    [[TMP30:%.*]] = zext i32 [[TMP9]] to i64
; X280-NEXT:    [[INDEX_EVL_NEXT]] = add i64 [[TMP30]], [[EVL_BASED_IV]]
; X280-NEXT:    [[TMP31:%.*]] = zext i32 [[TMP9]] to i64
; X280-NEXT:    [[INDEX_NEXT:%.*]] = add i64 [[EVL_BASED_IV]], [[TMP31]]
...
; X390-NEXT:    [[TMP30:%.*]] = zext i32 [[TMP9]] to i64
; X390-NEXT:    [[INDEX_EVL_NEXT]] = add i64 [[TMP30]], [[EVL_BASED_IV]]
; X390-NEXT:    [[TMP31:%.*]] = zext i32 [[TMP9]] to i64
; X390-NEXT:    [[INDEX_NEXT:%.*]] = add i64 [[EVL_BASED_IV]], [[TMP31]]
