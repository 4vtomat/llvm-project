...
; IF-EVL-NEXT:    [[TMP4:%.*]] = add i64 [[TMP3]], -1
; IF-EVL-NEXT:    [[TMP5:%.*]] = getelementptr inbounds i32, ptr [[PTR:%.*]], i64 [[TMP4]]
; IF-EVL-NEXT:    [[TMP18:%.*]] = zext i32 [[TMP1]] to i64
; IF-EVL-NEXT:    [[TMP6:%.*]] = mul i64 0, [[TMP18]]
; IF-EVL-NEXT:    [[TMP7:%.*]] = sub i64 1, [[TMP18]]
; IF-EVL-NEXT:    [[TMP8:%.*]] = getelementptr inbounds i32, ptr [[TMP5]], i64 [[TMP6]]
; IF-EVL-NEXT:    [[TMP9:%.*]] = getelementptr inbounds i32, ptr [[TMP8]], i64 [[TMP7]]
; IF-EVL-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 2 x i32> @llvm.vp.load.nxv2i32.p0(ptr align 4 [[TMP9]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP1]])
...
; IF-EVL-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i32, ptr [[PTR2:%.*]], i64 [[TMP4]]
; IF-EVL-NEXT:    [[TMP19:%.*]] = zext i32 [[TMP1]] to i64
; IF-EVL-NEXT:    [[TMP11:%.*]] = mul i64 0, [[TMP19]]
; IF-EVL-NEXT:    [[TMP12:%.*]] = sub i64 1, [[TMP19]]
; IF-EVL-NEXT:    [[TMP13:%.*]] = getelementptr inbounds i32, ptr [[TMP10]], i64 [[TMP11]]
; IF-EVL-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i32, ptr [[TMP13]], i64 [[TMP12]]
; IF-EVL-NEXT:    [[VP_REVERSE2:%.*]] = call <vscale x 2 x i32> @llvm.experimental.vp.reverse.nxv2i32(<vscale x 2 x i32> [[VP_REVERSE]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP1]])
; IF-EVL-NEXT:    call void @llvm.vp.store.nxv2i32.p0(<vscale x 2 x i32> [[VP_REVERSE2]], ptr align 4 [[TMP14]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP1]])
; IF-EVL-NEXT:    [[TMP15:%.*]] = zext i32 [[TMP1]] to i64
; IF-EVL-NEXT:    [[INDEX_EVL_NEXT]] = add nuw i64 [[TMP15]], [[EVL_BASED_IV]]
; IF-EVL-NEXT:    [[TMP16:%.*]] = icmp eq i64 [[INDEX_EVL_NEXT]], 1024
...
>>>>>>> refs/rewritten/ef391dbc29db097952e71d81cd88e9bd7e81a3fa-2
; IF-EVL:       middle.block:
