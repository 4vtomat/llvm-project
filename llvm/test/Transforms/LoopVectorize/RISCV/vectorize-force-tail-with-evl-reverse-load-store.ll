...
; IF-EVL-NEXT:    [[TMP6:%.*]] = mul i64 0, [[TMP17]]
; IF-EVL-NEXT:    [[TMP7:%.*]] = sub i64 1, [[TMP17]]
...
; IF-EVL-NEXT:    [[TMP11:%.*]] = mul i64 0, [[TMP17]]
; IF-EVL-NEXT:    [[TMP12:%.*]] = sub i64 1, [[TMP17]]
...
; IF-EVL-NEXT:    [[TMP9:%.*]] = mul i64 0, [[TMP20]]
; IF-EVL-NEXT:    [[TMP10:%.*]] = sub i64 1, [[TMP20]]
...
; IF-EVL-NEXT:    [[TMP14:%.*]] = mul i64 0, [[TMP20]]
; IF-EVL-NEXT:    [[TMP15:%.*]] = sub i64 1, [[TMP20]]
