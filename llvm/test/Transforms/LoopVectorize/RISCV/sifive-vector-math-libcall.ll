...
; RUN: opt -inject-tli-mappings -loop-vectorize -vector-library=SiFive_NF -riscv-use-vla-vectorizer -S -mtriple=riscv64-unknown-linux-gnu -mattr=+v < %s | FileCheck %s
