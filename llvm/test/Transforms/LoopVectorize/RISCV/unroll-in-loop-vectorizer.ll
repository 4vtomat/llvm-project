...
; RUN: opt -S -mtriple=riscv64 -mattr=+v -riscv-use-vla-vectorizer=false -passes=loop-vectorize -scalable-vectorization=off -riscv-v-vector-bits-min=0 < %s | FileCheck %s
