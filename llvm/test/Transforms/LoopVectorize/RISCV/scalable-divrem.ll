...
; RUN: opt < %s -riscv-use-vla-vectorizer=false -loop-vectorize -scalable-vectorization=on -mtriple riscv64-linux-gnu -mattr=+v,+f -riscv-v-vector-bits-min=0 -S 2>%t | FileCheck %s
