...
; CHECK-NEXT:    [[VP_STRIDED_LOAD6:%.*]] = call <vscale x 1 x double> @llvm.experimental.vp.strided.load.nxv1f64.p0.i64(ptr [[TMP14]], i64 -48, <vscale x 1 x i1> shufflevector (<vscale x 1 x i1> insertelement (<vscale x 1 x i1> poison, i1 true, i64 0), <vscale x 1 x i1> poison, <vscale x 1 x i32> zeroinitializer), i32 [[TMP7]])
; CHECK-NEXT:    [[TMP15:%.*]] = getelementptr [[STRUCT_WOMBAT_20]], ptr [[NEXT_GEP]], i64 -2, i32 2
; CHECK-NEXT:    call void @llvm.experimental.vp.strided.store.nxv1f64.p0.i64(<vscale x 1 x double> [[VP_STRIDED_LOAD6]], ptr [[TMP15]], i64 -48, <vscale x 1 x i1> shufflevector (<vscale x 1 x i1> insertelement (<vscale x 1 x i1> poison, i1 true, i64 0), <vscale x 1 x i1> poison, <vscale x 1 x i32> zeroinitializer), i32 [[TMP7]])
