...
; CHECK-NEXT:    [[TMP24:%.*]] = icmp ult i64 [[TMP7]], 1
; CHECK-NEXT:    [[SAFE_AVL:%.*]] = select i1 [[TMP24]], i64 [[TMP7]], i64 1
; CHECK-NEXT:    [[TMP8:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[SAFE_AVL]], i32 1, i1 true)
...
; CHECK-NEXT:    [[VP_OP:%.*]] = call <vscale x 1 x double> @llvm.fmuladd.nxv1f64(<vscale x 1 x double> [[VP_OP_LOAD]], <vscale x 1 x double> [[VP_OP_LOAD8]], <vscale x 1 x double> [[VP_OP_LOAD9]])
