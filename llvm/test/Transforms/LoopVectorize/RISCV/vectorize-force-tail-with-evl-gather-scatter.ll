...
; IF-EVL:       vector.ph:
<<<<<<< HEAD
; IF-EVL-NEXT:    [[TMP0:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[N:%.*]], i32 1, i1 true)
...
; IF-EVL-NEXT:    [[TMP1:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 1, i1 true)
; IF-EVL-NEXT:    [[TMP2:%.*]] = getelementptr inbounds i32, ptr [[INDEX:%.*]], i64 [[EVL_BASED_IV]]
; IF-EVL-NEXT:    [[VP_STRIDED_LOAD:%.*]] = call <vscale x 1 x i64> @llvm.experimental.vp.strided.load.nxv1i64.p0.i64(ptr align 8 [[TMP2]], i64 4, <vscale x 1 x i1> splat (i1 true), i32 [[TMP1]])
; IF-EVL-NEXT:    [[TMP3:%.*]] = getelementptr inbounds float, ptr [[IN:%.*]], <vscale x 1 x i64> [[VP_STRIDED_LOAD]]
; IF-EVL-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <vscale x 1 x float> @llvm.vp.gather.nxv1f32.nxv1p0(<vscale x 1 x ptr> align 4 [[TMP3]], <vscale x 1 x i1> splat (i1 true), i32 [[TMP1]])
; IF-EVL-NEXT:    [[TMP4:%.*]] = getelementptr inbounds float, ptr [[OUT:%.*]], <vscale x 1 x i64> [[VP_STRIDED_LOAD]]
; IF-EVL-NEXT:    call void @llvm.vp.scatter.nxv1f32.nxv1p0(<vscale x 1 x float> [[WIDE_MASKED_GATHER]], <vscale x 1 x ptr> align 4 [[TMP4]], <vscale x 1 x i1> splat (i1 true), i32 [[TMP1]])
; IF-EVL-NEXT:    [[TMP5:%.*]] = zext i32 [[TMP1]] to i64
; IF-EVL-NEXT:    [[INDVARS_IV_NEXT]] = add nuw i64 [[TMP5]], [[EVL_BASED_IV]]
