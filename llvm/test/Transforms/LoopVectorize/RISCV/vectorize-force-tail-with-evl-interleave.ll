...
; IF-EVL-NEXT:    [[TMP2:%.*]] = getelementptr inbounds [2 x i32], ptr [[B:%.*]], i64 [[TMP13]], i32 0
; IF-EVL-NEXT:    [[TMP3:%.*]] = mul nuw nsw i32 [[TMP0]], 2
...
; IF-EVL-NEXT:    [[VP_OP:%.*]] = call <vscale x 2 x i32> @llvm.vp.add.nxv2i32(<vscale x 2 x i32> [[TMP5]], <vscale x 2 x i32> [[TMP4]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP0]])
