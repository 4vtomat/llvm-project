...
; CHECK-NEXT:    [[CSA_DATA_PHI:%.*]] = phi <vscale x 16 x i32> [ shufflevector (<vscale x 16 x i32> insertelement (<vscale x 16 x i32> poison, i32 poison, i64 0), <vscale x 16 x i32> poison, <vscale x 16 x i32> zeroinitializer), %[[VECTOR_PH]] ], [ [[TMP15:%.*]], %[[VECTOR_BODY]] ]
