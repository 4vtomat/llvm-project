...
; CHECK: VPlanCM: cost 2 for RVL (mf2, i32) for VPInstruction: EMIT vp<%6> = not ir<%cmp1>
; CHECK: VPlanCM: cost 2 for RVL (mf2, i32) for VPInstruction: EMIT vp<%8> = logical-and vp<%6>, ir<%cmp8>
; P670: VPlanCM: cost 1 for RVL (m1, i32) for VPInstruction: EMIT vp<{{.*}}> = not ir<%cmp1>
; P670: VPlanCM: cost 1 for RVL (m1, i32) for VPInstruction: EMIT vp<{{.*}}> = logical-and vp<{{.*}}>, ir<%cmp8>
