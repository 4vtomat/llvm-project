...
; CHECK-NEXT:    [[VP_STRIDED_LOAD:%.*]] = call <vscale x 8 x i64> @llvm.experimental.vp.strided.load.nxv8i64.p0.i64(ptr align 8 [[NEXT_GEP]], i64 64, <vscale x 8 x i1> splat (i1 true), i32 [[TMP3]]), !alias.scope [[META3]]
