...
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[TMP0]], i64 274877906880
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[TMP1]], i64 274877906880
...
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i64, ptr [[NEXT_GEP18]], i64 6
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr inbounds i64, ptr [[NEXT_GEP18]], i64 7
; CHECK-NEXT:    [[TMP8:%.*]] = load i64, ptr [[ELMS_I159]], align 8, !alias.scope [[META0:![0-9]+]]
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT15:%.*]] = insertelement <vscale x 8 x i64> poison, i64 [[TMP8]], i64 0
; CHECK-NEXT:    [[BROADCAST_SPLAT16:%.*]] = shufflevector <vscale x 8 x i64> [[BROADCAST_SPLATINSERT15]], <vscale x 8 x i64> poison, <vscale x 8 x i32> zeroinitializer
...
; CHECK:       scalar.ph:
; CHECK-NEXT:    [[BC_RESUME_VAL:%.*]] = phi ptr [ [[TMP3]], [[MIDDLE_BLOCK]] ], [ [[TMP0]], [[VECTOR_MEMCHECK]] ]
; CHECK-NEXT:    [[BC_RESUME_VAL11:%.*]] = phi ptr [ getelementptr (i8, ptr null, i64 274877906880), [[MIDDLE_BLOCK]] ], [ null, [[VECTOR_MEMCHECK]] ]
; CHECK-NEXT:    [[BC_RESUME_VAL13:%.*]] = phi ptr [ [[TMP4]], [[MIDDLE_BLOCK]] ], [ [[TMP1]], [[VECTOR_MEMCHECK]] ]
