...
<<<<<<< HEAD
; RUN: opt -riscv-use-vla-vectorizer=false -loop-vectorize -riscv-v-vector-bits-min=128 -scalable-vectorization=on -force-target-instruction-cost=1 -S < %s | FileCheck %s
=======
