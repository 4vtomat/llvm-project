...
; CHECK-LABEL: add
; CHECK-SCALAR: {{.*}}
; COM: SIFIVE SKIP CHECK-SCALAR:      LV(REG): VF = 1
; COM: SIFIVE SKIP CHECK-SCALAR-NEXT: LV(REG): Found max usage: 2 item
; COM: SIFIVE SKIP CHECK-SCALAR-NEXT: LV(REG): RegisterClass: RISCV::GPRRC, 3 registers
; COM: SIFIVE SKIP CHECK-SCALAR-NEXT: LV(REG): RegisterClass: RISCV::FPRRC, 2 registers
; COM: SIFIVE SKIP CHECK-SCALAR-NEXT: LV(REG): Found invariant usage: 1 item
; COM: SIFIVE SKIP CHECK-SCALAR-NEXT: LV(REG): RegisterClass: RISCV::GPRRC, 1 registers
...
; CHECK-LMUL4-NEXT:  LV(REG): RegisterClass: RISCV::VRRC, 2 registers
...
; CHECK-LMUL8-NEXT:  LV(REG): RegisterClass: RISCV::VRRC, 2 registers
...
; CHECK-SCALAR: {{.*}}
; COM: SIFIVE SKIP CHECK-SCALAR:      LV(REG): VF = 1
; COM: SIFIVE SKIP CHECK-SCALAR-NEXT: LV(REG): Found max usage: 1 item
; COM: SIFIVE SKIP CHECK-SCALAR-NEXT: LV(REG): RegisterClass: RISCV::GPRRC, 3 registers
; CHECK-LMUL1:       LV(REG): Found max usage: 2 item
; CHECK-LMUL1-NEXT:  LV(REG): RegisterClass: RISCV::GPRRC, 2 registers
; CHECK-LMUL1-NEXT:  LV(REG): RegisterClass: RISCV::VRRC, 2 registers
