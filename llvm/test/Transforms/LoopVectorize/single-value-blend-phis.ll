...
; CHECK-NEXT:    [[TMP18:%.*]] = xor <2 x i1> [[TMP16]], <i1 true, i1 true>
; CHECK-NEXT:    [[TMP19:%.*]] = select <2 x i1> [[TMP2]], <2 x i1> [[TMP18]], <2 x i1> zeroinitializer
; CHECK-NEXT:    [[PREDPHI:%.*]] = select <2 x i1> [[TMP19]], <2 x i16> [[TMP15]], <2 x i16> zeroinitializer
