...
; INTERLEAVE-NEXT:    [[TMP5:%.*]] = add nuw nsw i16 [[TMP1]], 1
; INTERLEAVE-NEXT:    [[TMP4:%.*]] = zext nneg i16 [[TMP5]] to i32
; INTERLEAVE-NEXT:    [[INDEX_NEXT]] = add nuw i32 [[INDEX]], 2
...
; INTERLEAVE:       [[EXIT]]:
; INTERLEAVE-NEXT:    [[IV_1_EXT_LCSSA:%.*]] = phi i32 [ [[IV_1_EXT]], %[[LOOP]] ], [ [[TMP4]], %[[MIDDLE_BLOCK]] ]
