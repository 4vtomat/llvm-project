...
; INTERLEAVE-NEXT:    br label %[[LOOP:.*]]
; INTERLEAVE:       [[LOOP]]:
; INTERLEAVE-NEXT:    [[IV:%.*]] = phi i32 [ 0, %[[ENTRY]] ], [ [[IV_NEXT:%.*]], %[[LOOP]] ]
...
; INTERLEAVE:       [[E_EXIT]]:
; INTERLEAVE-NEXT:    [[RES:%.*]] = phi i32 [ [[IV_NEXT]], %[[LOOP]] ]
...
; VEC-NEXT:    [[TMP3:%.*]] = add nuw nsw <2 x i16> [[VEC_IND]], splat (i16 1)
; VEC-NEXT:    [[TMP4:%.*]] = extractelement <2 x i16> [[TMP3]], i32 0
; VEC-NEXT:    [[TMP5:%.*]] = zext nneg i16 [[TMP4]] to i32
; VEC-NEXT:    [[TMP8:%.*]] = extractelement <2 x i16> [[TMP3]], i32 1
...
; INTERLEAVE-NEXT:    br label %[[LOOP:.*]]
; INTERLEAVE:       [[LOOP]]:
; INTERLEAVE-NEXT:    [[IV_1:%.*]] = phi i64 [ 3, %[[ENTRY]] ], [ [[IV_1_NEXT:%.*]], %[[LOOP]] ]
; INTERLEAVE-NEXT:    [[IV_2:%.*]] = phi i64 [ 2, %[[ENTRY]] ], [ [[IV_2_NEXT:%.*]], %[[LOOP]] ]
...
; INTERLEAVE:       [[EXIT]]:
; INTERLEAVE-NEXT:    [[IV_1_NEXT_LCSSA:%.*]] = phi i64 [ [[IV_1_NEXT]], %[[LOOP]] ]
