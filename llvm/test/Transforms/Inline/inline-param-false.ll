; Test that -inline-param-size works for false value
; RUN: opt < %s -O2 -inline-param-size=false -S  | FileCheck %s
; RUN: opt < %s -O3 -inline-param-size=false -S  | FileCheck %s
; RUN: opt < %s -Os -inline-param-size=false -S  | FileCheck %s
; RUN: opt < %s -Oz -inline-param-size=false -S  | FileCheck %s
