...
; RUN: opt < %s -S -passes='default<O1>,function(loop-versioning-licm,loop-mssa(licm))' -enable-loop-distribute=false -debug-only=loop-versioning-licm 2>&1 | FileCheck %s
; REQUIRES: asserts
;
