...
; CHECK:       [[EXIT]]:
; CHECK-NEXT:      #dbg_value(float poison, [[META4:![0-9]+]], !DIExpression(), [[META9:![0-9]+]])
; CHECK-NEXT:    ret void
;
entry:
  br label %loop
...
; CHECK: [[META2]] = !{}
; CHECK: [[META4]] = !DILocalVariable(name: "m_2", scope: [[META5:![0-9]+]], file: [[META1]], line: 4, type: [[META8:![0-9]+]])
; CHECK: [[META5]] = distinct !DISubprogram(name: "test_dbg_value_in_exit_block", scope: [[META1]], file: [[META1]], line: 3, type: [[META6:![0-9]+]], scopeLine: 3, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: [[META0]], retainedNodes: [[META2]])
; CHECK: [[META6]] = !DISubroutineType(types: [[META7:![0-9]+]])
; CHECK: [[META7]] = !{null}
; CHECK: [[META8]] = !DIBasicType(name: "float", size: 32, encoding: DW_ATE_float)
; CHECK: [[META9]] = !DILocation(line: 0, scope: [[META5]])
;.
