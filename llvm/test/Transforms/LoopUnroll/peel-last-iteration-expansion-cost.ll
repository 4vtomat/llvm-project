...
<<<<<<< HEAD
; BUDGET2-NEXT:    [[PEELCOUNTXSTEP_EXIT:%.*]] = sub i32 [[END]], 1
; BUDGET2-NEXT:    [[EC:%.*]] = icmp eq i32 [[IV_NEXT]], [[PEELCOUNTXSTEP_EXIT]]
...
; BUDGET2-NEXT:    [[TMP2:%.*]] = phi i32 [ [[START]], %[[ENTRY]] ], [ [[DOTPH]], %[[EXIT_PEEL_BEGIN_LOOPEXIT]] ]
