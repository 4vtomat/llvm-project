...
; RUN: opt -p loop-unroll -unroll-full-max-count=0 -allow-peeling-switches -mtriple=riscv64 -allow-epilog-peeling -S %s | FileCheck %s
...
; CHECK-NEXT:    call void @foo(i32 20)
; CHECK-NEXT:    [[IV_NEXT1]] = add nuw nsw i64 [[IV1]], 1
; CHECK-NEXT:    [[EC1:%.*]] = icmp ult i64 [[IV_NEXT1]], 63
