...
; CHECK-NEXT:    [[PEELCOUNTXSTEP_EXIT:%.*]] = sub i64 [[WIDE_TRIP_COUNT]], 1
; CHECK-NEXT:    [[EC1:%.*]] = icmp eq i64 [[IV_NEXT1]], [[PEELCOUNTXSTEP_EXIT]]
...
; CHECK-NEXT:    [[EC:%.*]] = icmp eq i32 [[IV_NEXT]], [[PEELCOUNTXSTEP_EXIT]]
