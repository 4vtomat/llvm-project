...
; O23-NEXT:    store <2 x double> splat (double 2.000000e+00), ptr [[TMP1]], align 8
; O23-NEXT:    store <2 x double> splat (double 2.000000e+00), ptr [[TMP2]], align 8
; O23-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; O23-NEXT:    [[TMP3:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
; O23-NEXT:    br i1 [[TMP3]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP8:![0-9]+]]
; O23:       middle.block:
...
; O23-NEXT:    store double 2.000000e+00, ptr [[ADD_PTR_I]], align 8, !tbaa [[TBAA11:![0-9]+]]
