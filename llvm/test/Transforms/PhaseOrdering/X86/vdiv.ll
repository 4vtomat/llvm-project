...
; CHECK-NEXT:    [[TMP22:%.*]] = fmul fast <4 x double> [[WIDE_LOAD9]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr inbounds nuw double, ptr [[X]], i64 [[INDEX]]
...
; CHECK-NEXT:    [[TMP19:%.*]] = sub nsw i64 [[INDVARS_IV_PH]], [[WIDE_TRIP_COUNT]]
; CHECK-NEXT:    [[TMP20:%.*]] = icmp ugt i64 [[TMP19]], -8
; CHECK-NEXT:    br i1 [[TMP20]], label [[FOR_END]], label [[FOR_BODY:%.*]]
; CHECK:       for.body:
