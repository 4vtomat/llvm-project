...
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <2 x i64> [ zeroinitializer, [[VECTOR_PH]] ], [ [[DOTLCSSA:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI13:%.*]] = phi <2 x i64> [ zeroinitializer, [[VECTOR_PH]] ], [ [[TMP20:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr i64, ptr [[START_I]], i64 [[INDEX]]
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr [[TMP10]], i64 16
...
; CHECK-NEXT:    [[WIDE_LOAD17:%.*]] = load <2 x i64>, ptr [[TMP12]], align 8
; CHECK-NEXT:    [[TMP13:%.*]] = add <2 x i64> [[WIDE_LOAD15]], [[VEC_PHI]]
; CHECK-NEXT:    [[TMP14:%.*]] = add <2 x i64> [[WIDE_LOAD14]], [[VEC_PHI13]]
; CHECK-NEXT:    [[DOTLCSSA]] = add <2 x i64> [[TMP13]], [[WIDE_LOAD16]]
; CHECK-NEXT:    [[TMP20]] = add <2 x i64> [[TMP14]], [[WIDE_LOAD17]]
...
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, [[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <2 x i64> [ zeroinitializer, [[VECTOR_PH]] ], [ [[DOTLCSSA:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI25:%.*]] = phi <2 x i64> [ zeroinitializer, [[VECTOR_PH]] ], [ [[TMP29:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP14:%.*]] = getelementptr i64, ptr [[START_I]], i64 [[INDEX]]
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr i8, ptr [[TMP14]], i64 16
; CHECK-NEXT:    [[WIDE_LOAD28:%.*]] = load <2 x i64>, ptr [[TMP14]], align 8
; CHECK-NEXT:    [[WIDE_LOAD27:%.*]] = load <2 x i64>, ptr [[TMP12]], align 8
; CHECK-NEXT:    [[TMP15:%.*]] = getelementptr i64, ptr [[START_I1]], i64 [[INDEX]]
; CHECK-NEXT:    [[TMP17:%.*]] = getelementptr i8, ptr [[TMP15]], i64 16
; CHECK-NEXT:    [[WIDE_LOAD29:%.*]] = load <2 x i64>, ptr [[TMP15]], align 8
; CHECK-NEXT:    [[VEC_PHI25_LCSSA:%.*]] = load <2 x i64>, ptr [[TMP17]], align 8
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr i64, ptr [[START_I12]], i64 [[INDEX]]
; CHECK-NEXT:    [[TMP18:%.*]] = getelementptr i8, ptr [[TMP16]], i64 16
; CHECK-NEXT:    [[WIDE_LOAD30:%.*]] = load <2 x i64>, ptr [[TMP16]], align 8
; CHECK-NEXT:    [[WIDE_LOAD31:%.*]] = load <2 x i64>, ptr [[TMP18]], align 8
; CHECK-NEXT:    [[TMP19:%.*]] = add <2 x i64> [[WIDE_LOAD28]], [[VEC_PHI]]
; CHECK-NEXT:    [[WIDE_LOAD26:%.*]] = add <2 x i64> [[WIDE_LOAD27]], [[VEC_PHI25]]
; CHECK-NEXT:    [[TMP21:%.*]] = add <2 x i64> [[TMP19]], [[WIDE_LOAD29]]
; CHECK-NEXT:    [[TMP25:%.*]] = add <2 x i64> [[WIDE_LOAD26]], [[VEC_PHI25_LCSSA]]
; CHECK-NEXT:    [[DOTLCSSA]] = add <2 x i64> [[TMP21]], [[WIDE_LOAD30]]
; CHECK-NEXT:    [[TMP29]] = add <2 x i64> [[TMP25]], [[WIDE_LOAD31]]
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
