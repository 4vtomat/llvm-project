...
; CHECK-NEXT:    [[TMP29:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B:%.*]], i64 0, i64 [[CONV6]]
; CHECK-NEXT:    [[MATRIXEXT_US_US:%.*]] = load double, ptr [[A:%.*]], align 8
; CHECK-NEXT:    [[MATRIXEXT8_US_US:%.*]] = load double, ptr [[TMP29]], align 8
...
; CHECK-NEXT:    [[TMP188:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 8
; CHECK-NEXT:    [[MATRIXEXT_US_US_1:%.*]] = load double, ptr [[TMP188]], align 8
; CHECK-NEXT:    [[MATRIXEXT8_US_US_1:%.*]] = load double, ptr [[TMP29]], align 8
; CHECK-NEXT:    [[MUL_US_US_1:%.*]] = fmul double [[MATRIXEXT_US_US_1]], [[MATRIXEXT8_US_US_1]]
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds nuw i8, ptr [[B]], i64 8
...
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 16
; CHECK-NEXT:    [[MATRIXEXT_US_US_2:%.*]] = load double, ptr [[TMP3]], align 8
; CHECK-NEXT:    [[MATRIXEXT8_US_US_2:%.*]] = load double, ptr [[TMP29]], align 8
; CHECK-NEXT:    [[MUL_US_US_2:%.*]] = fmul double [[MATRIXEXT_US_US_2]], [[MATRIXEXT8_US_US_2]]
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds nuw i8, ptr [[B]], i64 16
...
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP5]]
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 120
; CHECK-NEXT:    [[MATRIXEXT_US_US_151:%.*]] = load double, ptr [[TMP7]], align 8
; CHECK-NEXT:    [[MATRIXEXT8_US_US_152:%.*]] = load double, ptr [[TMP6]], align 8
; CHECK-NEXT:    [[MUL_US_US_153:%.*]] = fmul double [[MATRIXEXT_US_US_151]], [[MATRIXEXT8_US_US_152]]
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw i8, ptr [[B]], i64 120
; CHECK-NEXT:    [[MATRIXEXT11_US_US_154:%.*]] = load double, ptr [[TMP8]], align 8
; CHECK-NEXT:    [[SUB_US_US_155:%.*]] = fsub double [[MATRIXEXT11_US_US_154]], [[MUL_US_US_153]]
; CHECK-NEXT:    store double [[SUB_US_US_155]], ptr [[TMP8]], align 8
...
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 128
...
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr inbounds nuw i8, ptr [[B]], i64 128
...
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 136
...
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr inbounds nuw i8, ptr [[B]], i64 136
...
; CHECK-NEXT:    [[TMP14:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP13]]
; CHECK-NEXT:    [[TMP15:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 240
; CHECK-NEXT:    [[MATRIXEXT_US_US_258:%.*]] = load double, ptr [[TMP15]], align 8
; CHECK-NEXT:    [[MATRIXEXT8_US_US_259:%.*]] = load double, ptr [[TMP14]], align 8
; CHECK-NEXT:    [[MUL_US_US_260:%.*]] = fmul double [[MATRIXEXT_US_US_258]], [[MATRIXEXT8_US_US_259]]
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr inbounds nuw i8, ptr [[B]], i64 240
; CHECK-NEXT:    [[MATRIXEXT11_US_US_261:%.*]] = load double, ptr [[TMP16]], align 8
; CHECK-NEXT:    [[SUB_US_US_262:%.*]] = fsub double [[MATRIXEXT11_US_US_261]], [[MUL_US_US_260]]
; CHECK-NEXT:    store double [[SUB_US_US_262]], ptr [[TMP16]], align 8
...
; CHECK-NEXT:    [[TMP17:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 248
...
; CHECK-NEXT:    [[TMP18:%.*]] = getelementptr inbounds nuw i8, ptr [[B]], i64 248
...
; CHECK-NEXT:    [[TMP19:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 256
...
; CHECK-NEXT:    [[TMP20:%.*]] = getelementptr inbounds nuw i8, ptr [[B]], i64 256
...
; CHECK-NEXT:    [[TMP22:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP21]]
; CHECK-NEXT:    [[TMP23:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 360
...
; CHECK-NEXT:    [[TMP24:%.*]] = getelementptr inbounds nuw i8, ptr [[B]], i64 360
...
; CHECK-NEXT:    [[TMP25:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 368
...
; CHECK-NEXT:    [[TMP26:%.*]] = getelementptr inbounds nuw i8, ptr [[B]], i64 368
...
; CHECK-NEXT:    [[TMP189:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 376
; CHECK-NEXT:    [[MATRIXEXT_US_US_2_3:%.*]] = load double, ptr [[TMP189]], align 8
...
; CHECK-NEXT:    [[TMP191:%.*]] = getelementptr inbounds nuw i8, ptr [[B]], i64 376
; CHECK-NEXT:    [[MATRIXEXT11_US_US_2_3:%.*]] = load double, ptr [[TMP191]], align 8
; CHECK-NEXT:    [[SUB_US_US_2_3:%.*]] = fsub double [[MATRIXEXT11_US_US_2_3]], [[MUL_US_US_2_3]]
; CHECK-NEXT:    store double [[SUB_US_US_2_3]], ptr [[TMP191]], align 8
...
; CHECK-NEXT:    [[TMP100:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[CONV6]]
...
; CHECK-NEXT:    [[TMP33:%.*]] = icmp samesign ult i64 [[INDVARS_IV_US29]], 225
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP33]])
; CHECK-NEXT:    [[TMP102:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[A]], i64 0, i64 [[INDVARS_IV_US29]]
; CHECK-NEXT:    [[MATRIXEXT_US_US30:%.*]] = load double, ptr [[TMP102]], align 8
; CHECK-NEXT:    [[MATRIXEXT8_US_US31:%.*]] = load double, ptr [[TMP100]], align 8
; CHECK-NEXT:    [[MUL_US_US32:%.*]] = fmul double [[MATRIXEXT_US_US30]], [[MATRIXEXT8_US_US31]]
; CHECK-NEXT:    [[TMP35:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[INDVARS_IV_US29]]
...
; CHECK-NEXT:    [[TMP37:%.*]] = icmp samesign ult i32 [[I]], 210
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP37]])
; CHECK-NEXT:    [[TMP165:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP36]]
...
; CHECK-NEXT:    [[TMP40:%.*]] = icmp samesign ult i64 [[INDVARS_IV_US29_1]], 210
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP40]])
; CHECK-NEXT:    [[TMP41:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[A]], i64 0, i64 [[TMP39]]
; CHECK-NEXT:    [[MATRIXEXT_US_US30_1:%.*]] = load double, ptr [[TMP41]], align 8
; CHECK-NEXT:    [[MATRIXEXT8_US_US31_1:%.*]] = load double, ptr [[TMP165]], align 8
; CHECK-NEXT:    [[MUL_US_US32_1:%.*]] = fmul double [[MATRIXEXT_US_US30_1]], [[MATRIXEXT8_US_US31_1]]
; CHECK-NEXT:    [[TMP42:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP39]]
...
; CHECK-NEXT:    [[TMP44:%.*]] = icmp samesign ult i32 [[I]], 195
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP44]])
; CHECK-NEXT:    [[TMP45:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP43]]
...
; CHECK-NEXT:    [[TMP47:%.*]] = icmp samesign ult i64 [[INDVARS_IV_US29_2]], 195
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP47]])
; CHECK-NEXT:    [[TMP48:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[A]], i64 0, i64 [[TMP46]]
...
; CHECK-NEXT:    [[TMP49:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP46]]
...
; CHECK-NEXT:    [[TMP51:%.*]] = icmp samesign ult i32 [[I]], 180
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP51]])
; CHECK-NEXT:    [[TMP52:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP50]]
...
; CHECK-NEXT:    [[TMP54:%.*]] = icmp samesign ult i64 [[INDVARS_IV_US29_3]], 180
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP54]])
; CHECK-NEXT:    [[TMP55:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[A]], i64 0, i64 [[TMP53]]
...
; CHECK-NEXT:    [[TMP56:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP53]]
...
; CHECK-NEXT:    [[TMP58:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[CONV6]]
...
; CHECK-NEXT:    [[TMP166:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP59]]
...
; CHECK-NEXT:    [[TMP70:%.*]] = icmp ult <2 x i64> [[TMP65]], splat (i64 225)
; CHECK-NEXT:    [[TMP71:%.*]] = icmp ult <2 x i64> [[TMP69]], splat (i64 225)
...
; CHECK-NEXT:    [[WIDE_LOAD_US_1:%.*]] = load <2 x double>, ptr [[TMP167]], align 8, !alias.scope [[META2:![0-9]+]]
; CHECK-NEXT:    [[WIDE_LOAD21_US_1:%.*]] = load <2 x double>, ptr [[TMP168]], align 8, !alias.scope [[META2]]
; CHECK-NEXT:    [[TMP78:%.*]] = load double, ptr [[TMP166]], align 8, !alias.scope [[META5:![0-9]+]]
...
; CHECK-NEXT:    [[TMP88:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP86]]
...
; CHECK-NEXT:    [[TMP97:%.*]] = icmp ult <2 x i64> [[TMP92]], splat (i64 225)
; CHECK-NEXT:    [[TMP98:%.*]] = icmp ult <2 x i64> [[TMP96]], splat (i64 225)
; CHECK-NEXT:    [[TMP99:%.*]] = extractelement <2 x i1> [[TMP97]], i64 0
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP99]])
; CHECK-NEXT:    [[TMP261:%.*]] = extractelement <2 x i1> [[TMP97]], i64 1
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP261]])
; CHECK-NEXT:    [[TMP101:%.*]] = extractelement <2 x i1> [[TMP98]], i64 0
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP101]])
; CHECK-NEXT:    [[TMP263:%.*]] = extractelement <2 x i1> [[TMP98]], i64 1
...
; CHECK-NEXT:    [[TMP115:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP113]]
...
; CHECK-NEXT:    [[TMP124:%.*]] = icmp ult <2 x i64> [[TMP119]], splat (i64 225)
; CHECK-NEXT:    [[TMP125:%.*]] = icmp ult <2 x i64> [[TMP123]], splat (i64 225)
...
; CHECK-NEXT:    [[TMP130:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[A]], i64 0, i64 [[TMP116]]
; CHECK-NEXT:    [[TMP131:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP130]], i64 16
...
; CHECK-NEXT:    [[TMP135:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP116]]
; CHECK-NEXT:    [[TMP136:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP135]], i64 16
...
; CHECK-NEXT:    [[TMP147:%.*]] = icmp ult <2 x i64> [[TMP144]], splat (i64 225)
; CHECK-NEXT:    [[TMP148:%.*]] = icmp ult <2 x i64> [[TMP146]], splat (i64 225)
...
; CHECK-NEXT:    [[TMP153:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[A]], i64 0, i64 [[INDEX_US]]
...
; CHECK-NEXT:    [[TMP158:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[INDEX_US]]
...
; CHECK-NEXT:    [[TMP164:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[CONV6]]
; CHECK-NEXT:    br label [[VECTOR_BODY:%.*]]
; CHECK:       vector.body:
<<<<<<< HEAD
; CHECK-NEXT:    [[TMP194:%.*]] = phi i64 [ 0, [[FOR_COND1_PREHEADER_US]] ], [ [[INDEX_NEXT_1:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP195:%.*]] = or disjoint i64 [[TMP194]], 1
; CHECK-NEXT:    [[TMP198:%.*]] = or disjoint i64 [[TMP194]], 2
; CHECK-NEXT:    [[TMP199:%.*]] = or disjoint i64 [[TMP194]], 3
...
; CHECK-NEXT:    [[TMP202:%.*]] = icmp ult <2 x i64> [[TMP197]], splat (i64 225)
; CHECK-NEXT:    [[TMP203:%.*]] = icmp ult <2 x i64> [[TMP201]], splat (i64 225)
...
; CHECK-NEXT:    [[TMP178:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[A]], i64 0, i64 [[TMP194]]
; CHECK-NEXT:    [[TMP179:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP178]], i64 16
; CHECK-NEXT:    [[WIDE_LOAD_1:%.*]] = load <2 x double>, ptr [[TMP178]], align 8, !alias.scope [[META2]]
; CHECK-NEXT:    [[WIDE_LOAD21_1:%.*]] = load <2 x double>, ptr [[TMP179]], align 8, !alias.scope [[META2]]
; CHECK-NEXT:    [[TMP210:%.*]] = load double, ptr [[TMP164]], align 8, !alias.scope [[META5]]
...
; CHECK-NEXT:    [[TMP183:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP194]]
; CHECK-NEXT:    [[TMP184:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP183]], i64 16
; CHECK-NEXT:    [[WIDE_LOAD24_1:%.*]] = load <2 x double>, ptr [[TMP183]], align 8, !alias.scope [[META7]], !noalias [[META2]]
; CHECK-NEXT:    [[WIDE_LOAD25_1:%.*]] = load <2 x double>, ptr [[TMP184]], align 8, !alias.scope [[META7]], !noalias [[META2]]
; CHECK-NEXT:    [[TMP215:%.*]] = fsub <2 x double> [[WIDE_LOAD24_1]], [[TMP211]]
; CHECK-NEXT:    [[TMP216:%.*]] = fsub <2 x double> [[WIDE_LOAD25_1]], [[TMP212]]
; CHECK-NEXT:    store <2 x double> [[TMP215]], ptr [[TMP183]], align 8, !alias.scope [[META7]], !noalias [[META2]]
; CHECK-NEXT:    store <2 x double> [[TMP216]], ptr [[TMP184]], align 8, !alias.scope [[META7]], !noalias [[META2]]
; CHECK-NEXT:    [[INDEX_NEXT_1]] = add nuw i64 [[TMP194]], 4
; CHECK-NEXT:    [[TMP217:%.*]] = icmp eq i64 [[INDEX_NEXT_1]], [[N_VEC]]
; CHECK-NEXT:    br i1 [[TMP217]], label [[FOR_BODY4_US:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP9]]
=======
...
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP193]])
; CHECK-NEXT:    [[TMP222:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[A]], i64 0, i64 [[INDVARS_IV]]
; CHECK-NEXT:    [[MATRIXEXT_US:%.*]] = load double, ptr [[TMP222]], align 8
; CHECK-NEXT:    [[MATRIXEXT8_US:%.*]] = load double, ptr [[TMP164]], align 8
; CHECK-NEXT:    [[MUL_US:%.*]] = fmul double [[MATRIXEXT_US]], [[MATRIXEXT8_US]]
; CHECK-NEXT:    [[TMP190:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[INDVARS_IV]]
...
; CHECK-NEXT:    [[TMP192:%.*]] = icmp samesign ult i32 [[I]], 210
...
; CHECK:       vector.body.1:
; CHECK-NEXT:    [[INDEX_1:%.*]] = phi i64 [ 0, [[FOR_COND1_FOR_COND_CLEANUP3_CRIT_EDGE_US]] ], [ [[INDEX_NEXT_4:%.*]], [[VECTOR_BODY_1]] ]
; CHECK-NEXT:    [[TMP252:%.*]] = add nuw nsw i64 [[INDEX_1]], 15
; CHECK-NEXT:    [[TMP34:%.*]] = add nuw nsw i64 [[INDEX_1]], 16
; CHECK-NEXT:    [[TMP284:%.*]] = insertelement <2 x i64> poison, i64 [[TMP252]], i64 0
; CHECK-NEXT:    [[TMP228:%.*]] = insertelement <2 x i64> [[TMP284]], i64 [[TMP34]], i64 1
; CHECK-NEXT:    [[TMP285:%.*]] = add nuw nsw i64 [[INDEX_1]], 17
; CHECK-NEXT:    [[TMP38:%.*]] = add nuw nsw i64 [[INDEX_1]], 18
<<<<<<< HEAD
; CHECK-NEXT:    [[TMP286:%.*]] = insertelement <2 x i64> poison, i64 [[TMP285]], i64 0
; CHECK-NEXT:    [[TMP232:%.*]] = insertelement <2 x i64> [[TMP286]], i64 [[TMP38]], i64 1
; CHECK-NEXT:    [[TMP233:%.*]] = icmp ult <2 x i64> [[TMP228]], splat (i64 225)
; CHECK-NEXT:    [[TMP234:%.*]] = icmp ult <2 x i64> [[TMP232]], splat (i64 225)
...
; CHECK-NEXT:    [[WIDE_LOAD_2:%.*]] = load <2 x double>, ptr [[TMP208]], align 8, !alias.scope [[META2]]
; CHECK-NEXT:    [[WIDE_LOAD21_2:%.*]] = load <2 x double>, ptr [[TMP209]], align 8, !alias.scope [[META2]]
; CHECK-NEXT:    [[TMP241:%.*]] = load double, ptr [[TMP32]], align 8, !alias.scope [[META5]]
...
; CHECK-NEXT:    [[WIDE_LOAD24_2:%.*]] = load <2 x double>, ptr [[TMP213]], align 8, !alias.scope [[META7]], !noalias [[META2]]
; CHECK-NEXT:    [[WIDE_LOAD25_2:%.*]] = load <2 x double>, ptr [[TMP214]], align 8, !alias.scope [[META7]], !noalias [[META2]]
; CHECK-NEXT:    [[TMP246:%.*]] = fsub <2 x double> [[WIDE_LOAD24_2]], [[TMP242]]
; CHECK-NEXT:    [[TMP247:%.*]] = fsub <2 x double> [[WIDE_LOAD25_2]], [[TMP243]]
; CHECK-NEXT:    store <2 x double> [[TMP246]], ptr [[TMP213]], align 8, !alias.scope [[META7]], !noalias [[META2]]
; CHECK-NEXT:    store <2 x double> [[TMP247]], ptr [[TMP214]], align 8, !alias.scope [[META7]], !noalias [[META2]]
; CHECK-NEXT:    [[INDEX_NEXT_4]] = add nuw i64 [[INDEX_1]], 4
; CHECK-NEXT:    [[TMP287:%.*]] = icmp eq i64 [[INDEX_NEXT_4]], [[N_VEC]]
; CHECK-NEXT:    br i1 [[TMP287]], label [[FOR_BODY4_US_1:%.*]], label [[VECTOR_BODY_1]], !llvm.loop [[LOOP9]]
=======
...
; CHECK-NEXT:    [[TMP219:%.*]] = icmp samesign ult i64 [[INDVARS_IV_1]], 210
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP219]])
; CHECK-NEXT:    [[TMP220:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[A]], i64 0, i64 [[TMP218]]
...
; CHECK-NEXT:    [[TMP221:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP218]]
...
; CHECK-NEXT:    br i1 [[EXITCOND_NOT_1]], label [[VECTOR_PH_2:%.*]], label [[FOR_BODY4_US_1]], !llvm.loop [[LOOP0]]
; CHECK:       for.cond1.for.cond.cleanup3_crit_edge.us.1:
; CHECK-NEXT:    [[TMP61:%.*]] = add nuw nsw i64 [[CONV6]], 30
; CHECK-NEXT:    [[TMP223:%.*]] = icmp samesign ult i32 [[I]], 195
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP223]])
; CHECK-NEXT:    [[TMP224:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP61]]
...
; CHECK-NEXT:    [[TMP288:%.*]] = insertelement <2 x i64> [[TMP227]], i64 [[TMP226]], i64 1
...
; CHECK-NEXT:    [[TMP289:%.*]] = insertelement <2 x i64> [[TMP231]], i64 [[TMP230]], i64 1
; CHECK-NEXT:    [[TMP290:%.*]] = icmp ult <2 x i64> [[TMP288]], splat (i64 225)
; CHECK-NEXT:    [[TMP291:%.*]] = icmp ult <2 x i64> [[TMP289]], splat (i64 225)
; CHECK-NEXT:    [[TMP76:%.*]] = extractelement <2 x i1> [[TMP290]], i64 0
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP76]])
; CHECK-NEXT:    [[TMP77:%.*]] = extractelement <2 x i1> [[TMP290]], i64 1
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP77]])
; CHECK-NEXT:    [[TMP292:%.*]] = extractelement <2 x i1> [[TMP291]], i64 0
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP292]])
; CHECK-NEXT:    [[TMP293:%.*]] = extractelement <2 x i1> [[TMP291]], i64 1
...
; CHECK-NEXT:    [[INDVARS_IV_3:%.*]] = phi i64 [ [[INDVARS_IV_NEXT_3:%.*]], [[FOR_BODY4_US_2]] ], [ [[N_VEC]], [[VECTOR_BODY_2]] ]
; CHECK-NEXT:    [[TMP249:%.*]] = add nuw nsw i64 [[INDVARS_IV_3]], 30
; CHECK-NEXT:    [[TMP250:%.*]] = icmp samesign ult i64 [[INDVARS_IV_3]], 195
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP250]])
; CHECK-NEXT:    [[TMP251:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[A]], i64 0, i64 [[TMP249]]
; CHECK-NEXT:    [[MATRIXEXT_US_3:%.*]] = load double, ptr [[TMP251]], align 8
; CHECK-NEXT:    [[MATRIXEXT8_US_3:%.*]] = load double, ptr [[TMP224]], align 8
=======
...
; CHECK-NEXT:    [[TMP283:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP249]]
; CHECK-NEXT:    [[MATRIXEXT11_US_2:%.*]] = load double, ptr [[TMP283]], align 8
; CHECK-NEXT:    [[SUB_US_3:%.*]] = fsub double [[MATRIXEXT11_US_2]], [[MUL_US_3]]
...
; CHECK-NEXT:    br i1 [[EXITCOND_NOT_3]], label [[FOR_COND1_FOR_COND_CLEANUP3_CRIT_EDGE_US_2:%.*]], label [[FOR_BODY4_US_2]], !llvm.loop [[LOOP0]]
; CHECK:       for.cond1.for.cond.cleanup3_crit_edge.us.2:
; CHECK-NEXT:    [[TMP253:%.*]] = add nuw nsw i64 [[CONV6]], 45
; CHECK-NEXT:    [[TMP254:%.*]] = icmp samesign ult i32 [[I]], 180
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP254]])
; CHECK-NEXT:    [[TMP255:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP253]]
; CHECK-NEXT:    br label [[VECTOR_BODY_3:%.*]]
; CHECK:       vector.body.3:
...
; CHECK-NEXT:    [[TMP299:%.*]] = add nuw nsw i64 [[INDEX_3]], 48
; CHECK-NEXT:    [[TMP262:%.*]] = insertelement <2 x i64> poison, i64 [[TMP260]], i64 0
; CHECK-NEXT:    [[TMP300:%.*]] = insertelement <2 x i64> [[TMP262]], i64 [[TMP299]], i64 1
; CHECK-NEXT:    [[TMP264:%.*]] = icmp ult <2 x i64> [[TMP259]], splat (i64 225)
; CHECK-NEXT:    [[TMP265:%.*]] = icmp ult <2 x i64> [[TMP300]], splat (i64 225)
...
; CHECK-NEXT:    [[TMP281:%.*]] = icmp samesign ult i64 [[INDVARS_IV_4]], 180
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[TMP281]])
; CHECK-NEXT:    [[TMP282:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[A]], i64 0, i64 [[TMP280]]
; CHECK-NEXT:    [[MATRIXEXT_US_4:%.*]] = load double, ptr [[TMP282]], align 8
; CHECK-NEXT:    [[MATRIXEXT8_US_4:%.*]] = load double, ptr [[TMP255]], align 8
; CHECK-NEXT:    [[MUL_US_4:%.*]] = fmul double [[MATRIXEXT_US_4]], [[MATRIXEXT8_US_4]]
; CHECK-NEXT:    [[TMP301:%.*]] = getelementptr inbounds nuw <225 x double>, ptr [[B]], i64 0, i64 [[TMP280]]
; CHECK-NEXT:    [[MATRIXEXT11_US_3:%.*]] = load double, ptr [[TMP301]], align 8
; CHECK-NEXT:    [[SUB_US_4:%.*]] = fsub double [[MATRIXEXT11_US_3]], [[MUL_US_4]]
; CHECK-NEXT:    store double [[SUB_US_4]], ptr [[TMP301]], align 8
; CHECK-NEXT:    [[INDVARS_IV_NEXT_4]] = add nuw nsw i64 [[INDVARS_IV_4]], 1
; CHECK-NEXT:    [[EXITCOND_NOT_4:%.*]] = icmp eq i64 [[INDVARS_IV_NEXT_4]], [[CONV6]]
; CHECK-NEXT:    br i1 [[EXITCOND_NOT_4]], label [[FOR_COND_CLEANUP]], label [[FOR_BODY4_US_3]], !llvm.loop [[LOOP0]]
