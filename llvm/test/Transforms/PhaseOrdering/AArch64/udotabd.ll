...
; CHECK-O3-NEXT:    [[VEC_PHI16:%.*]] = phi i32 [ [[OP_RDX34:%.*]], %[[VECTOR_BODY]] ], [ 0, %[[ENTRY]] ]
; CHECK-O3-NEXT:    [[COMBINED_REDUCE43:%.*]] = phi <16 x i32> [ [[TMP6:%.*]], %[[VECTOR_BODY]] ], [ zeroinitializer, %[[ENTRY]] ]
...
; CHECK-O3-NEXT:    [[TMP215:%.*]] = load <16 x i8>, ptr [[NEXT_GEP_7]], align 1, !tbaa [[TBAA0:![0-9]+]]
; CHECK-O3-NEXT:    [[TMP216:%.*]] = zext <16 x i8> [[TMP215]] to <16 x i16>
; CHECK-O3-NEXT:    [[TMP217:%.*]] = load <16 x i8>, ptr [[NEXT_GEP19_7]], align 1, !tbaa [[TBAA0]]
...
; CHECK-O3-NEXT:    [[TMP39:%.*]] = shufflevector <16 x i16> [[TMP220]], <16 x i16> poison, <8 x i32> <i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8>
; CHECK-O3-NEXT:    [[TMP47:%.*]] = zext <8 x i16> [[TMP39]] to <8 x i32>
; CHECK-O3-NEXT:    [[TMP55:%.*]] = shufflevector <16 x i16> [[TMP220]], <16 x i16> poison, <4 x i32> <i32 9, i32 10, i32 11, i32 12>
...
; CHECK-O3-NEXT:    [[TMP131:%.*]] = getelementptr i8, ptr [[NEXT_GEP19_7]], i64 16
; CHECK-O3-NEXT:    [[TMP132:%.*]] = load i8, ptr [[TMP131]], align 1, !tbaa [[TBAA0]]
...
; CHECK-O3-NEXT:    [[COMBINED_REDUCE42:%.*]] = zext <16 x i16> [[TMP220]] to <16 x i32>
...
; CHECK-O3-NEXT:    [[BIN_RDX:%.*]] = add i32 [[TMP139]], [[TMP7]]
...
; CHECK-LTO-NEXT:    [[VEC_PHI16:%.*]] = phi i32 [ [[OP_RDX34:%.*]], %[[VECTOR_BODY]] ], [ 0, %[[ENTRY]] ]
; CHECK-LTO-NEXT:    [[VECTOR_ACCUMULATOR:%.*]] = phi <16 x i32> [ [[VECTOR_ACCUMULATOR_UPDATE:%.*]], %[[VECTOR_BODY]] ], [ zeroinitializer, %[[ENTRY]] ]
...
; CHECK-LTO-NEXT:    [[TMP195:%.*]] = load <16 x i8>, ptr [[NEXT_GEP_7]], align 1, !tbaa [[TBAA0:![0-9]+]]
; CHECK-LTO-NEXT:    [[TMP196:%.*]] = zext <16 x i8> [[TMP195]] to <16 x i16>
; CHECK-LTO-NEXT:    [[TMP197:%.*]] = load <16 x i8>, ptr [[NEXT_GEP19_7]], align 1, !tbaa [[TBAA0]]
...
; CHECK-LTO-NEXT:    [[TMP36:%.*]] = shufflevector <16 x i16> [[TMP200]], <16 x i16> poison, <8 x i32> <i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8>
; CHECK-LTO-NEXT:    [[TMP44:%.*]] = zext nneg <8 x i16> [[TMP36]] to <8 x i32>
; CHECK-LTO-NEXT:    [[TMP52:%.*]] = shufflevector <16 x i16> [[TMP200]], <16 x i16> poison, <4 x i32> <i32 9, i32 10, i32 11, i32 12>
; CHECK-LTO-NEXT:    [[TMP60:%.*]] = zext nneg <4 x i16> [[TMP52]] to <4 x i32>
; CHECK-LTO-NEXT:    [[TMP68:%.*]] = getelementptr i8, ptr [[NEXT_GEP_7]], i64 16
; CHECK-LTO-NEXT:    [[TMP76:%.*]] = load i8, ptr [[TMP68]], align 1, !tbaa [[TBAA0]]
; CHECK-LTO-NEXT:    [[TMP84:%.*]] = zext i8 [[TMP76]] to i32
; CHECK-LTO-NEXT:    [[TMP92:%.*]] = getelementptr i8, ptr [[NEXT_GEP19_7]], i64 16
; CHECK-LTO-NEXT:    [[TMP116:%.*]] = load i8, ptr [[TMP92]], align 1, !tbaa [[TBAA0]]
...
; CHECK-LTO-NEXT:    [[VECTOR_ACCUMULATOR_UPDATE]] = add <16 x i32> [[VECTOR_ACCUMULATOR]], [[TMP100]]
; CHECK-LTO-NEXT:    [[TMP120:%.*]] = shufflevector <8 x i32> [[TMP44]], <8 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-LTO-NEXT:    [[RDX_OP:%.*]] = add nuw nsw <4 x i32> [[TMP120]], [[TMP60]]
; CHECK-LTO-NEXT:    [[TMP121:%.*]] = shufflevector <4 x i32> [[RDX_OP]], <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-LTO-NEXT:    [[TMP122:%.*]] = shufflevector <8 x i32> [[TMP121]], <8 x i32> [[TMP44]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15>
; CHECK-LTO-NEXT:    [[VECTOR_ACCUMULATOR_UPDATE50]] = add <8 x i32> [[TMP122]], [[VECTOR_ACCUMULATOR49]]
; CHECK-LTO-NEXT:    [[SHIFT:%.*]] = shufflevector <16 x i16> [[TMP200]], <16 x i16> poison, <16 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 15, i32 poison>
; CHECK-LTO-NEXT:    [[TMP123:%.*]] = add nuw nsw <16 x i16> [[TMP200]], [[SHIFT]]
; CHECK-LTO-NEXT:    [[OP_RDX32:%.*]] = add i32 [[TMP119]], [[VEC_PHI16]]
; CHECK-LTO-NEXT:    [[SHIFT59:%.*]] = shufflevector <16 x i16> [[TMP123]], <16 x i16> poison, <16 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 14, i32 poison, i32 poison>
; CHECK-LTO-NEXT:    [[TMP124:%.*]] = add nuw nsw <16 x i16> [[SHIFT59]], [[TMP200]]
; CHECK-LTO-NEXT:    [[NARROW52:%.*]] = extractelement <16 x i16> [[TMP124]], i64 13
; CHECK-LTO-NEXT:    [[OP_RDX33:%.*]] = zext nneg i16 [[NARROW52]] to i32
...
; CHECK-LTO-NEXT:    [[TMP126:%.*]] = tail call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> [[VECTOR_ACCUMULATOR_UPDATE]])
; CHECK-LTO-NEXT:    [[TMP127:%.*]] = tail call i32 @llvm.vector.reduce.add.v8i32(<8 x i32> [[VECTOR_ACCUMULATOR_UPDATE50]])
; CHECK-LTO-NEXT:    [[TMP128:%.*]] = add i32 [[OP_RDX34]], [[TMP126]]
...
; CHECK-LTO-NEXT:    [[OP_RDX_15:%.*]] = phi i32 [ [[BIN_RDX]], %[[MIDDLE_BLOCK]] ], [ [[TMP134]], %[[FOR_COND1_PREHEADER]] ]
