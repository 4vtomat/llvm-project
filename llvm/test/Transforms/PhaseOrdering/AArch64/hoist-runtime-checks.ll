...
; CHECK-NEXT:    [[RET_06_PH:%.*]] = phi i32 [ 0, [[FOR_BODY_PREHEADER8]] ], [ [[ADD]], [[MIDDLE_BLOCK]] ]
; CHECK-NEXT:    br label [[FOR_BODY:%.*]]
; CHECK:       for.cond.cleanup:
; CHECK-NEXT:    [[RET_0_LCSSA:%.*]] = phi i32 [ 0, [[ENTRY:%.*]] ], [ [[ADD]], [[MIDDLE_BLOCK]] ], [ [[ADD1:%.*]], [[FOR_BODY]] ]
; CHECK-NEXT:    ret i32 [[RET_0_LCSSA]]
; CHECK:       for.body:
; CHECK-NEXT:    [[I_07:%.*]] = phi i64 [ [[INC:%.*]], [[FOR_BODY]] ], [ [[I_07_PH]], [[FOR_BODY_PREHEADER13]] ]
; CHECK-NEXT:    [[RET_06:%.*]] = phi i32 [ [[ADD1]], [[FOR_BODY]] ], [ [[RET_06_PH]], [[FOR_BODY_PREHEADER13]] ]
