...
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x double>, ptr [[IDXB1]], align 8
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <2 x double> [[TMP1]], double [[B0]], i32 0
...
; CHECK-NEXT:    [[TMP6:%.*]] = shufflevector <2 x double> [[TMP1]], <2 x double> poison, <2 x i32> <i32 poison, i32 0>
; CHECK-NEXT:    [[TMP7:%.*]] = insertelement <2 x double> [[TMP6]], double [[D0]], i32 0
...
; CHECK-NEXT:    [[TMP10:%.*]] = extractelement <2 x double> [[TMP1]], i32 0
