...
; CHECK-NEXT:    [[TMP14:%.*]] = fadd fast <2 x double> [[TMP10]], <double 3.000000e+00, double 3.100000e+00>
; CHECK-NEXT:    [[TMP12:%.*]] = shufflevector <2 x double> [[TMP14]], <2 x double> poison, <2 x i32> <i32 1, i32 0>
...
; CHECK-NEXT:    br label [[BB6]]
; CHECK:       bb6:
; CHECK-NEXT:    [[TMP15]] = phi <2 x double> [ [[TMP13]], [[BB2]] ], [ [[TMP11]], [[BB4]] ], [ [[TMP11]], [[BB5]] ]
; CHECK-NEXT:    br label [[BB2]]
;
entry:
