...
; CHECK-NEXT:    [[TMP10:%.*]] = shufflevector <2 x float> [[TMP8]], <2 x float> [[TMP4]], <4 x i32> <i32 3, i32 poison, i32 0, i32 1>
; CHECK-NEXT:    [[TMP13:%.*]] = insertelement <4 x float> [[TMP10]], float [[TMP9]], i32 1
