...
; AVX-NEXT:    [[TMP30:%.*]] = load <2 x float>, ptr [[TMP4]], align 4, !tbaa [[TBAA0]]
; AVX-NEXT:    [[TMP27:%.*]] = load <2 x float>, ptr [[TMP5]], align 4, !tbaa [[TBAA0]]
; AVX-NEXT:    [[TMP25:%.*]] = load <3 x float>, ptr [[TMP6]], align 4, !tbaa [[TBAA0]]
; AVX-NEXT:    [[TMP26:%.*]] = shufflevector <2 x float> [[TMP30]], <2 x float> poison, <3 x i32> <i32 0, i32 poison, i32 poison>
; AVX-NEXT:    [[TMP31:%.*]] = shufflevector <3 x float> [[TMP26]], <3 x float> [[TMP25]], <8 x i32> <i32 poison, i32 0, i32 3, i32 poison, i32 poison, i32 poison, i32 5, i32 poison>
; AVX-NEXT:    [[TMP28:%.*]] = insertelement <8 x float> [[TMP31]], float [[TMP3]], i64 0
...
; AVX-NEXT:    [[TMP34:%.*]] = shufflevector <8 x float> [[TMP28]], <8 x float> [[TMP33]], <8 x i32> <i32 0, i32 1, i32 2, i32 9, i32 poison, i32 poison, i32 6, i32 poison>
...
; AVX-NEXT:    [[TMP38:%.*]] = insertelement <8 x float> [[TMP36]], float [[TMP22]], i64 7
; AVX-NEXT:    [[TMP37:%.*]] = shufflevector <2 x float> [[TMP27]], <2 x float> poison, <3 x i32> <i32 0, i32 poison, i32 poison>
; AVX-NEXT:    [[TMP39:%.*]] = shufflevector <3 x float> [[TMP25]], <3 x float> [[TMP37]], <8 x i32> <i32 1, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; AVX-NEXT:    [[TMP29:%.*]] = shufflevector <2 x float> [[TMP30]], <2 x float> poison, <8 x i32> <i32 poison, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
...
; AVX2-NEXT:    [[TMP30:%.*]] = load <2 x float>, ptr [[TMP4]], align 4, !tbaa [[TBAA0]]
; AVX2-NEXT:    [[TMP27:%.*]] = load <2 x float>, ptr [[TMP5]], align 4, !tbaa [[TBAA0]]
; AVX2-NEXT:    [[TMP25:%.*]] = load <3 x float>, ptr [[TMP6]], align 4, !tbaa [[TBAA0]]
; AVX2-NEXT:    [[TMP26:%.*]] = shufflevector <2 x float> [[TMP30]], <2 x float> poison, <3 x i32> <i32 0, i32 poison, i32 poison>
; AVX2-NEXT:    [[TMP31:%.*]] = shufflevector <3 x float> [[TMP26]], <3 x float> [[TMP25]], <8 x i32> <i32 poison, i32 0, i32 3, i32 poison, i32 poison, i32 poison, i32 5, i32 poison>
; AVX2-NEXT:    [[TMP28:%.*]] = insertelement <8 x float> [[TMP31]], float [[TMP3]], i64 0
...
; AVX2-NEXT:    [[TMP34:%.*]] = shufflevector <8 x float> [[TMP28]], <8 x float> [[TMP33]], <8 x i32> <i32 0, i32 1, i32 2, i32 9, i32 poison, i32 poison, i32 6, i32 poison>
...
; AVX2-NEXT:    [[TMP38:%.*]] = insertelement <8 x float> [[TMP36]], float [[TMP22]], i64 7
; AVX2-NEXT:    [[TMP37:%.*]] = shufflevector <2 x float> [[TMP27]], <2 x float> poison, <3 x i32> <i32 0, i32 poison, i32 poison>
; AVX2-NEXT:    [[TMP39:%.*]] = shufflevector <3 x float> [[TMP25]], <3 x float> [[TMP37]], <8 x i32> <i32 1, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; AVX2-NEXT:    [[TMP29:%.*]] = shufflevector <2 x float> [[TMP30]], <2 x float> poison, <8 x i32> <i32 poison, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
