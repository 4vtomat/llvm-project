...
; CHECK-NEXT:    [[CONV_I147_I1756_3:%.*]] = uitofp i32 [[V3]] to float
; CHECK-NEXT:    [[DIV_I_I_I1749_3:%.*]] = fdiv float 0.000000e+00, [[CONV_I147_I1756_3]]
; CHECK-NEXT:    [[TMP17:%.*]] = select i1 [[V4]], float 0.000000e+00, float [[DIV_I_I_I1749_3]]
...
; CHECK-NEXT:    [[TMP5:%.*]] = and <2 x i32> [[TMP3]], <i32 1, i32 255>
; CHECK-NEXT:    [[TMP6:%.*]] = icmp eq <2 x i32> [[TMP5]], zeroinitializer
; CHECK-NEXT:    [[TMP7:%.*]] = bitcast float [[TMP17]] to i32
; CHECK-NEXT:    [[TMP21:%.*]] = icmp ult i32 [[TMP7]], 1333788672
...
; CHECK-NEXT:    [[TMP9:%.*]] = insertelement <3 x i32> poison, i32 [[V3]], i32 0
; CHECK-NEXT:    [[TMP10:%.*]] = shufflevector <2 x i32> [[TMP5]], <2 x i32> poison, <3 x i32> <i32 0, i32 1, i32 poison>
; CHECK-NEXT:    [[TMP11:%.*]] = shufflevector <3 x i32> [[TMP9]], <3 x i32> [[TMP10]], <3 x i32> <i32 0, i32 4, i32 3>
; CHECK-NEXT:    [[TMP12:%.*]] = uitofp <3 x i32> [[TMP11]] to <3 x float>
; CHECK-NEXT:    [[TMP13:%.*]] = fdiv <3 x float> zeroinitializer, [[TMP12]]
; CHECK-NEXT:    [[TMP14:%.*]] = insertelement <3 x i1> poison, i1 [[V4]], i32 0
; CHECK-NEXT:    [[TMP15:%.*]] = shufflevector <2 x i1> [[TMP6]], <2 x i1> poison, <3 x i32> <i32 0, i32 1, i32 poison>
; CHECK-NEXT:    [[TMP16:%.*]] = shufflevector <3 x i1> [[TMP14]], <3 x i1> [[TMP15]], <3 x i32> <i32 0, i32 4, i32 3>
; CHECK-NEXT:    [[TMP23:%.*]] = select <3 x i1> [[TMP16]], <3 x float> zeroinitializer, <3 x float> [[TMP13]]
; CHECK-NEXT:    [[TMP25:%.*]] = bitcast <3 x float> [[TMP23]] to <3 x i32>
; CHECK-NEXT:    [[TMP19:%.*]] = icmp ult <3 x i32> [[TMP25]], <i32 1333788672, i32 1333788672, i32 1333788672>
; CHECK-NEXT:    [[TMP20:%.*]] = fptoui <3 x float> [[TMP23]] to <3 x i32>
; CHECK-NEXT:    [[TMP26:%.*]] = select <3 x i1> [[TMP19]], <3 x i32> [[TMP20]], <3 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP22:%.*]] = call i32 @llvm.vector.reduce.or.v3i32(<3 x i32> [[TMP26]])
; CHECK-NEXT:    [[RT5:%.*]] = or i32 [[TMP22]], [[TMP24]]
