...
; CHECK-NEXT:    [[TMP5:%.*]] = or <2 x i32> zeroinitializer, [[TMP4]]
; CHECK-NEXT:    [[TMP7:%.*]] = or <2 x i32> [[TMP2]], [[TMP3]]
...
; CHECK-NEXT:    [[OP_RDX3:%.*]] = or <2 x i32> zeroinitializer, [[TMP12]]
; CHECK-NEXT:    [[OP_RDX4:%.*]] = or <2 x i32> [[TMP2]], [[TMP8]]
; CHECK-NEXT:    [[TMP16]] = or <2 x i32> [[OP_RDX3]], [[OP_RDX4]]
; CHECK-NEXT:    br label [[BCI_252]]
; CHECK:       not_zero70:
; CHECK-NEXT:    [[TMP9:%.*]] = phi <2 x i32> [ [[TMP8]], [[BCI_252]] ]
; CHECK-NEXT:    ret void
;
bci_0:
