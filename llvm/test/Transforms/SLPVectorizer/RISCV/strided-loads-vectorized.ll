...
; CHECK-NEXT:    [[TMP1:%.*]] = call <8 x float> @llvm.riscv.masked.strided.load.v8f32.p0.i64(<8 x float> poison, ptr align 4 [[ARRAYIDX]], i64 [[TMP0]], <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>)
; CHECK-NEXT:    [[TMP2:%.*]] = call <8 x float> @llvm.riscv.masked.strided.load.v8f32.p0.i64(<8 x float> poison, ptr align 4 [[ARRAYIDX1]], i64 -16, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>)
