...
; CHECK-NEXT:    [[TMP174:%.*]] = extractelement <2 x i32> [[TMP167]], i32 1
; CHECK-NEXT:    [[TMP175:%.*]] = extractelement <2 x i32> [[TMP146]], i32 1
; CHECK-NEXT:    [[ADD78_1:%.*]] = add i32 [[TMP175]], [[TMP174]]
; CHECK-NEXT:    [[TMP176:%.*]] = sub <2 x i32> [[TMP167]], [[TMP146]]
; CHECK-NEXT:    [[TMP177:%.*]] = extractelement <2 x i32> [[TMP176]], i32 1
; CHECK-NEXT:    [[ADD105_1:%.*]] = add i32 [[SUB102_1]], [[TMP177]]
...
; CHECK-NEXT:    [[TMP191:%.*]] = extractelement <2 x i32> [[TMP190]], i32 0
; CHECK-NEXT:    [[ADD110_1:%.*]] = add i32 [[ADD108_1]], [[TMP191]]
; CHECK-NEXT:    [[TMP192:%.*]] = extractelement <2 x i32> [[TMP190]], i32 1
; CHECK-NEXT:    [[ADD112_1:%.*]] = add i32 [[ADD110_1]], [[TMP192]]
...
; CHECK-NEXT:    [[TMP200:%.*]] = extractelement <2 x i32> [[TMP199]], i32 1
; CHECK-NEXT:    [[ADD113_1:%.*]] = add i32 [[ADD112_1]], [[TMP200]]
...
; CHECK-NEXT:    [[TMP212:%.*]] = extractelement <2 x i32> [[TMP211]], i32 0
; CHECK-NEXT:    [[TMP213:%.*]] = extractelement <2 x i32> [[TMP211]], i32 1
; CHECK-NEXT:    [[ADD_I62_2:%.*]] = add i32 [[TMP212]], [[TMP213]]
; CHECK-NEXT:    [[XOR_I63_2:%.*]] = xor i32 [[ADD_I62_2]], [[ADD44]]
; CHECK-NEXT:    [[TMP214:%.*]] = extractelement <2 x i32> [[TMP199]], i32 0
; CHECK-NEXT:    [[ADD108_2:%.*]] = add i32 [[TMP214]], [[ADD113_1]]
; CHECK-NEXT:    [[TMP215:%.*]] = extractelement <2 x i32> [[TMP207]], i32 0
; CHECK-NEXT:    [[ADD110_2:%.*]] = add i32 [[ADD108_2]], [[TMP215]]
; CHECK-NEXT:    [[TMP216:%.*]] = extractelement <2 x i32> [[TMP207]], i32 1
; CHECK-NEXT:    [[ADD112_2:%.*]] = add i32 [[ADD110_2]], [[TMP216]]
...
; CHECK-NEXT:    [[TMP226:%.*]] = extractelement <2 x i32> [[TMP225]], i32 1
; CHECK-NEXT:    [[ADD78_3:%.*]] = add i32 [[SUB59_1]], [[TMP226]]
...
; CHECK-NEXT:    [[ADD94_3:%.*]] = add i32 [[SUB59_3]], [[TMP239]]
...
; CHECK-NEXT:    [[TMP253:%.*]] = extractelement <2 x i32> [[TMP252]], i32 0
; CHECK-NEXT:    [[TMP254:%.*]] = extractelement <2 x i32> [[TMP252]], i32 1
; CHECK-NEXT:    [[ADD_I52_3:%.*]] = add i32 [[TMP253]], [[TMP254]]
...
; CHECK-NEXT:    [[TMP261:%.*]] = extractelement <2 x i32> [[TMP260]], i32 0
; CHECK-NEXT:    [[TMP262:%.*]] = extractelement <2 x i32> [[TMP260]], i32 1
; CHECK-NEXT:    [[ADD_I62_3:%.*]] = add i32 [[TMP261]], [[TMP262]]
; CHECK-NEXT:    [[XOR_I63_3:%.*]] = xor i32 [[ADD_I62_3]], [[CONV33]]
; CHECK-NEXT:    [[ADD108_3:%.*]] = add i32 [[XOR_I53_3]], [[ADD113_2]]
; CHECK-NEXT:    [[TMP263:%.*]] = extractelement <2 x i32> [[TMP256]], i32 0
; CHECK-NEXT:    [[ADD110_3:%.*]] = add i32 [[ADD108_3]], [[TMP263]]
; CHECK-NEXT:    [[TMP264:%.*]] = extractelement <2 x i32> [[TMP256]], i32 1
; CHECK-NEXT:    [[ADD112_3:%.*]] = add i32 [[ADD110_3]], [[TMP264]]
