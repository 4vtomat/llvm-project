...
; CHECK-NEXT:    [[TMP58:%.*]] = add <2 x i32> [[TMP57]], [[TMP50]]
; CHECK-NEXT:    [[TMP59:%.*]] = add <2 x i32> [[TMP58]], [[TMP45]]
; CHECK-NEXT:    [[TMP60:%.*]] = sub <2 x i32> [[TMP45]], [[TMP58]]
; CHECK-NEXT:    [[TMP61:%.*]] = extractelement <2 x i32> [[TMP59]], i32 0
; CHECK-NEXT:    [[TMP62:%.*]] = extractelement <2 x i32> [[TMP59]], i32 1
; CHECK-NEXT:    [[ADD48_3:%.*]] = add i32 [[TMP62]], [[TMP61]]
; CHECK-NEXT:    [[TMP63:%.*]] = extractelement <2 x i32> [[TMP60]], i32 0
; CHECK-NEXT:    [[TMP64:%.*]] = extractelement <2 x i32> [[TMP60]], i32 1
; CHECK-NEXT:    [[TMP65:%.*]] = insertelement <2 x i32> [[TMP60]], i32 [[SUB47_2]], i32 0
; CHECK-NEXT:    [[TMP66:%.*]] = shufflevector <2 x i32> [[TMP60]], <2 x i32> poison, <2 x i32> <i32 poison, i32 0>
; CHECK-NEXT:    [[TMP67:%.*]] = insertelement <2 x i32> [[TMP66]], i32 [[SUB45_2]], i32 0
; CHECK-NEXT:    [[TMP68:%.*]] = add <2 x i32> [[TMP65]], [[TMP67]]
; CHECK-NEXT:    [[SUB59_3:%.*]] = sub i32 [[TMP63]], [[TMP64]]
; CHECK-NEXT:    [[TMP69:%.*]] = extractelement <2 x i32> [[TMP35]], i32 0
...
; CHECK-NEXT:    [[TMP71:%.*]] = extractelement <2 x i32> [[TMP68]], i32 1
; CHECK-NEXT:    [[ADD94_1:%.*]] = add i32 [[TMP71]], [[TMP70]]
; CHECK-NEXT:    [[SUB102_1:%.*]] = sub i32 [[TMP70]], [[TMP71]]
; CHECK-NEXT:    [[TMP72:%.*]] = extractelement <2 x i32> [[TMP5]], i32 0
...
; CHECK-NEXT:    [[TMP73:%.*]] = load <2 x i8>, ptr [[ARRAYIDX8]], align 1
; CHECK-NEXT:    [[TMP74:%.*]] = zext <2 x i8> [[TMP73]] to <2 x i32>
; CHECK-NEXT:    [[TMP75:%.*]] = load <2 x i8>, ptr [[PIX2]], align 1
; CHECK-NEXT:    [[TMP76:%.*]] = zext <2 x i8> [[TMP75]] to <2 x i32>
; CHECK-NEXT:    [[TMP77:%.*]] = load <2 x i8>, ptr [[ARRAYIDX3]], align 1
; CHECK-NEXT:    [[TMP78:%.*]] = zext <2 x i8> [[TMP77]] to <2 x i32>
; CHECK-NEXT:    [[TMP79:%.*]] = load <2 x i8>, ptr [[ARRAYIDX5]], align 1
; CHECK-NEXT:    [[TMP80:%.*]] = zext <2 x i8> [[TMP79]] to <2 x i32>
; CHECK-NEXT:    [[TMP81:%.*]] = sub <2 x i32> [[TMP78]], [[TMP80]]
; CHECK-NEXT:    [[TMP82:%.*]] = shl <2 x i32> [[TMP81]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP83:%.*]] = shufflevector <2 x i32> [[TMP74]], <2 x i32> poison, <2 x i32> <i32 1, i32 0>
; CHECK-NEXT:    [[TMP84:%.*]] = insertelement <2 x i32> [[TMP83]], i32 [[CONV]], i32 0
; CHECK-NEXT:    [[TMP85:%.*]] = sub <2 x i32> [[TMP84]], [[TMP76]]
; CHECK-NEXT:    [[TMP86:%.*]] = add <2 x i32> [[TMP82]], [[TMP85]]
; CHECK-NEXT:    [[TMP87:%.*]] = load <2 x i8>, ptr [[ARRAYIDX22]], align 1
; CHECK-NEXT:    [[TMP88:%.*]] = zext <2 x i8> [[TMP87]] to <2 x i32>
; CHECK-NEXT:    [[TMP89:%.*]] = load <2 x i8>, ptr [[ARRAYIDX25]], align 1
; CHECK-NEXT:    [[TMP90:%.*]] = zext <2 x i8> [[TMP89]] to <2 x i32>
; CHECK-NEXT:    [[TMP91:%.*]] = load <2 x i8>, ptr [[ARRAYIDX27]], align 1
; CHECK-NEXT:    [[TMP92:%.*]] = zext <2 x i8> [[TMP91]] to <2 x i32>
; CHECK-NEXT:    [[TMP93:%.*]] = sub <2 x i32> [[TMP90]], [[TMP92]]
; CHECK-NEXT:    [[TMP94:%.*]] = shl <2 x i32> [[TMP93]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP95:%.*]] = insertelement <2 x i32> [[TMP83]], i32 [[CONV33]], i32 1
; CHECK-NEXT:    [[TMP96:%.*]] = sub <2 x i32> [[TMP95]], [[TMP88]]
; CHECK-NEXT:    [[TMP97:%.*]] = add <2 x i32> [[TMP94]], [[TMP96]]
; CHECK-NEXT:    [[TMP98:%.*]] = extractelement <2 x i32> [[TMP86]], i32 0
; CHECK-NEXT:    [[TMP99:%.*]] = extractelement <2 x i32> [[TMP86]], i32 1
; CHECK-NEXT:    [[ADD44:%.*]] = add i32 [[TMP99]], [[TMP98]]
; CHECK-NEXT:    [[TMP100:%.*]] = shufflevector <2 x i32> [[TMP27]], <2 x i32> [[TMP86]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP101:%.*]] = shufflevector <2 x i32> [[TMP27]], <2 x i32> [[TMP86]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP102:%.*]] = add <2 x i32> [[TMP100]], [[TMP101]]
; CHECK-NEXT:    [[TMP103:%.*]] = sub <2 x i32> [[TMP100]], [[TMP101]]
; CHECK-NEXT:    [[TMP104:%.*]] = shufflevector <2 x i32> [[TMP102]], <2 x i32> [[TMP103]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP105:%.*]] = extractelement <2 x i32> [[TMP104]], i32 0
; CHECK-NEXT:    [[SHR_I49:%.*]] = lshr i32 [[TMP105]], 15
; CHECK-NEXT:    [[AND_I50:%.*]] = and i32 [[SHR_I49]], 65537
; CHECK-NEXT:    [[MUL_I51:%.*]] = mul i32 [[AND_I50]], 65535
; CHECK-NEXT:    [[TMP106:%.*]] = extractelement <2 x i32> [[TMP97]], i32 0
; CHECK-NEXT:    [[TMP107:%.*]] = extractelement <2 x i32> [[TMP97]], i32 1
; CHECK-NEXT:    [[ADD46:%.*]] = add i32 [[TMP107]], [[TMP106]]
; CHECK-NEXT:    [[TMP108:%.*]] = shufflevector <2 x i32> [[TMP15]], <2 x i32> [[TMP97]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP109:%.*]] = shufflevector <2 x i32> [[TMP15]], <2 x i32> [[TMP97]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP110:%.*]] = add <2 x i32> [[TMP108]], [[TMP109]]
; CHECK-NEXT:    [[TMP111:%.*]] = sub <2 x i32> [[TMP108]], [[TMP109]]
; CHECK-NEXT:    [[TMP112:%.*]] = shufflevector <2 x i32> [[TMP110]], <2 x i32> [[TMP111]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP113:%.*]] = extractelement <2 x i32> [[TMP112]], i32 0
; CHECK-NEXT:    [[ADD48_2:%.*]] = add i32 [[TMP105]], [[TMP113]]
...
; CHECK-NEXT:    [[TMP133:%.*]] = sub <2 x i32> [[TMP132]], [[TMP125]]
; CHECK-NEXT:    [[TMP134:%.*]] = add <2 x i32> [[TMP131]], [[TMP133]]
; CHECK-NEXT:    [[TMP135:%.*]] = insertelement <2 x i32> [[TMP115]], i32 [[CONV_1]], i32 0
; CHECK-NEXT:    [[TMP136:%.*]] = sub <2 x i32> [[TMP135]], [[TMP117]]
; CHECK-NEXT:    [[TMP137:%.*]] = add <2 x i32> [[TMP123]], [[TMP136]]
; CHECK-NEXT:    [[TMP138:%.*]] = add <2 x i32> [[TMP134]], [[TMP137]]
; CHECK-NEXT:    [[TMP139:%.*]] = sub <2 x i32> [[TMP137]], [[TMP134]]
; CHECK-NEXT:    [[TMP140:%.*]] = extractelement <2 x i32> [[TMP138]], i32 0
; CHECK-NEXT:    [[TMP141:%.*]] = extractelement <2 x i32> [[TMP138]], i32 1
; CHECK-NEXT:    [[ADD48_1:%.*]] = add i32 [[TMP141]], [[TMP140]]
; CHECK-NEXT:    [[SUB51_1:%.*]] = sub i32 [[TMP140]], [[TMP141]]
; CHECK-NEXT:    [[TMP142:%.*]] = shufflevector <2 x i32> [[TMP59]], <2 x i32> [[TMP139]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP143:%.*]] = shufflevector <2 x i32> [[TMP59]], <2 x i32> [[TMP139]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP144:%.*]] = sub <2 x i32> [[TMP142]], [[TMP143]]
; CHECK-NEXT:    [[TMP145:%.*]] = add <2 x i32> [[TMP142]], [[TMP143]]
; CHECK-NEXT:    [[TMP146:%.*]] = shufflevector <2 x i32> [[TMP144]], <2 x i32> [[TMP145]], <2 x i32> <i32 0, i32 3>
...
; CHECK-NEXT:    [[XOR_I53:%.*]] = xor i32 [[ADD_I52]], [[TMP105]]
...
; CHECK-NEXT:    [[TMP152:%.*]] = insertelement <2 x i32> poison, i32 [[ADD44]], i32 0
; CHECK-NEXT:    [[TMP153:%.*]] = shufflevector <2 x i32> [[TMP152]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP154:%.*]] = insertelement <2 x i32> <i32 15, i32 poison>, i32 [[ADD46]], i32 1
...
; CHECK-NEXT:    [[TMP158:%.*]] = extractelement <2 x i32> [[TMP157]], i32 1
; CHECK-NEXT:    [[ADD78_2:%.*]] = add i32 [[SUB51_1]], [[TMP158]]
; CHECK-NEXT:    [[TMP159:%.*]] = insertelement <2 x i32> poison, i32 [[ADD78_2]], i32 0
; CHECK-NEXT:    [[TMP160:%.*]] = shufflevector <2 x i32> [[TMP159]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP161:%.*]] = insertelement <2 x i32> <i32 65537, i32 poison>, i32 [[SUB51_1]], i32 1
...
; CHECK-NEXT:    [[TMP165:%.*]] = sub <2 x i32> [[TMP112]], [[TMP104]]
; CHECK-NEXT:    [[TMP166:%.*]] = add <2 x i32> [[TMP112]], [[TMP104]]
; CHECK-NEXT:    [[TMP167:%.*]] = shufflevector <2 x i32> [[TMP165]], <2 x i32> [[TMP166]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP168:%.*]] = extractelement <2 x i32> [[TMP167]], i32 0
; CHECK-NEXT:    [[TMP169:%.*]] = extractelement <2 x i32> [[TMP146]], i32 0
; CHECK-NEXT:    [[TMP174:%.*]] = shufflevector <2 x i32> [[TMP146]], <2 x i32> [[TMP167]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[ADD94_2:%.*]] = add i32 [[TMP169]], [[TMP168]]
; CHECK-NEXT:    [[TMP170:%.*]] = insertelement <2 x i32> [[TMP112]], i32 [[CONV_1]], i32 0
...
; CHECK-NEXT:    [[TMP175:%.*]] = extractelement <2 x i32> [[TMP167]], i32 1
; CHECK-NEXT:    [[TMP191:%.*]] = extractelement <2 x i32> [[TMP146]], i32 1
; CHECK-NEXT:    [[TMP177:%.*]] = shufflevector <2 x i32> [[TMP146]], <2 x i32> [[TMP167]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[ADD78_1:%.*]] = add i32 [[TMP191]], [[TMP175]]
; CHECK-NEXT:    [[TMP176:%.*]] = sub <2 x i32> [[TMP167]], [[TMP146]]
; CHECK-NEXT:    [[TMP192:%.*]] = extractelement <2 x i32> [[TMP176]], i32 1
; CHECK-NEXT:    [[ADD105_1:%.*]] = add i32 [[SUB102_1]], [[TMP192]]
; CHECK-NEXT:    [[ADD_I52_1:%.*]] = add i32 [[MUL_I51_1]], [[ADD105_1]]
; CHECK-NEXT:    [[XOR_I53_1:%.*]] = xor i32 [[ADD_I52_1]], [[TMP72]]
...
; CHECK-NEXT:    [[TMP200:%.*]] = extractelement <2 x i32> [[TMP190]], i32 0
; CHECK-NEXT:    [[ADD110_1:%.*]] = add i32 [[ADD108_1]], [[TMP200]]
; CHECK-NEXT:    [[TMP212:%.*]] = extractelement <2 x i32> [[TMP190]], i32 1
; CHECK-NEXT:    [[ADD112_1:%.*]] = add i32 [[ADD110_1]], [[TMP212]]
; CHECK-NEXT:    [[TMP193:%.*]] = shufflevector <2 x i32> [[TMP164]], <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
; CHECK-NEXT:    [[TMP194:%.*]] = insertelement <2 x i32> [[TMP193]], i32 [[SUB102_1]], i32 1
; CHECK-NEXT:    [[TMP195:%.*]] = add <2 x i32> [[TMP176]], [[TMP194]]
; CHECK-NEXT:    [[TMP196:%.*]] = sub <2 x i32> [[TMP176]], [[TMP194]]
...
; CHECK-NEXT:    [[TMP213:%.*]] = extractelement <2 x i32> [[TMP199]], i32 1
...
; CHECK-NEXT:    [[TMP203:%.*]] = add <2 x i32> [[TMP160]], [[TMP202]]
; CHECK-NEXT:    [[TMP204:%.*]] = sub <2 x i32> [[TMP160]], [[TMP202]]
; CHECK-NEXT:    [[TMP205:%.*]] = shufflevector <2 x i32> [[TMP203]], <2 x i32> [[TMP204]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP206:%.*]] = add <2 x i32> [[TMP151]], [[TMP205]]
; CHECK-NEXT:    [[TMP207:%.*]] = xor <2 x i32> [[TMP206]], [[TMP115]]
...
; CHECK-NEXT:    [[TMP214:%.*]] = extractelement <2 x i32> [[TMP211]], i32 0
; CHECK-NEXT:    [[TMP215:%.*]] = extractelement <2 x i32> [[TMP211]], i32 1
; CHECK-NEXT:    [[ADD_I62_2:%.*]] = add i32 [[TMP214]], [[TMP215]]
; CHECK-NEXT:    [[XOR_I63_2:%.*]] = xor i32 [[ADD_I62_2]], [[ADD44]]
; CHECK-NEXT:    [[TMP216:%.*]] = extractelement <2 x i32> [[TMP199]], i32 0
; CHECK-NEXT:    [[ADD108_2:%.*]] = add i32 [[TMP216]], [[ADD113_1]]
; CHECK-NEXT:    [[TMP226:%.*]] = extractelement <2 x i32> [[TMP207]], i32 0
; CHECK-NEXT:    [[ADD110_2:%.*]] = add i32 [[ADD108_2]], [[TMP226]]
; CHECK-NEXT:    [[TMP239:%.*]] = extractelement <2 x i32> [[TMP207]], i32 1
; CHECK-NEXT:    [[ADD112_2:%.*]] = add i32 [[ADD110_2]], [[TMP239]]
; CHECK-NEXT:    [[ADD113_2:%.*]] = add i32 [[ADD112_2]], [[XOR_I63_2]]
; CHECK-NEXT:    [[TMP217:%.*]] = lshr <2 x i32> [[TMP74]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP218:%.*]] = and <2 x i32> [[TMP217]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP219:%.*]] = mul <2 x i32> [[TMP218]], <i32 65535, i32 65535>
; CHECK-NEXT:    [[TMP220:%.*]] = insertelement <2 x i32> poison, i32 [[CONV33]], i32 0
; CHECK-NEXT:    [[TMP221:%.*]] = shufflevector <2 x i32> [[TMP220]], <2 x i32> [[TMP104]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP222:%.*]] = shufflevector <2 x i32> <i32 15, i32 poison>, <2 x i32> [[TMP112]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP223:%.*]] = lshr <2 x i32> [[TMP221]], [[TMP222]]
; CHECK-NEXT:    [[TMP224:%.*]] = sub <2 x i32> [[TMP221]], [[TMP222]]
; CHECK-NEXT:    [[TMP225:%.*]] = shufflevector <2 x i32> [[TMP223]], <2 x i32> [[TMP224]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP253:%.*]] = extractelement <2 x i32> [[TMP225]], i32 1
; CHECK-NEXT:    [[ADD78_3:%.*]] = add i32 [[SUB59_1]], [[TMP253]]
; CHECK-NEXT:    [[TMP227:%.*]] = insertelement <2 x i32> poison, i32 [[ADD78_3]], i32 0
; CHECK-NEXT:    [[TMP228:%.*]] = shufflevector <2 x i32> [[TMP227]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP229:%.*]] = insertelement <2 x i32> <i32 65537, i32 poison>, i32 [[SUB59_1]], i32 1
; CHECK-NEXT:    [[TMP230:%.*]] = and <2 x i32> [[TMP225]], [[TMP229]]
; CHECK-NEXT:    [[TMP231:%.*]] = sub <2 x i32> [[TMP225]], [[TMP229]]
; CHECK-NEXT:    [[TMP232:%.*]] = shufflevector <2 x i32> [[TMP230]], <2 x i32> [[TMP231]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP233:%.*]] = insertelement <2 x i32> poison, i32 [[CONV]], i32 0
; CHECK-NEXT:    [[TMP234:%.*]] = insertelement <2 x i32> [[TMP233]], i32 [[SUB45_2]], i32 1
; CHECK-NEXT:    [[TMP235:%.*]] = insertelement <2 x i32> <i32 15, i32 poison>, i32 [[SUB47_2]], i32 1
...
; CHECK-NEXT:    [[TMP254:%.*]] = extractelement <2 x i32> [[TMP238]], i32 1
; CHECK-NEXT:    [[ADD94_3:%.*]] = add i32 [[SUB59_3]], [[TMP254]]
; CHECK-NEXT:    [[TMP240:%.*]] = insertelement <2 x i32> <i32 65537, i32 poison>, i32 [[SUB59_3]], i32 1
; CHECK-NEXT:    [[TMP241:%.*]] = and <2 x i32> [[TMP238]], [[TMP240]]
; CHECK-NEXT:    [[TMP242:%.*]] = sub <2 x i32> [[TMP238]], [[TMP240]]
; CHECK-NEXT:    [[TMP243:%.*]] = shufflevector <2 x i32> [[TMP241]], <2 x i32> [[TMP242]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP244:%.*]] = insertelement <2 x i32> poison, i32 [[ADD94_3]], i32 0
; CHECK-NEXT:    [[TMP245:%.*]] = shufflevector <2 x i32> [[TMP244]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP246:%.*]] = add <2 x i32> [[TMP228]], [[TMP245]]
; CHECK-NEXT:    [[TMP247:%.*]] = sub <2 x i32> [[TMP228]], [[TMP245]]
; CHECK-NEXT:    [[TMP248:%.*]] = shufflevector <2 x i32> [[TMP246]], <2 x i32> [[TMP247]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP249:%.*]] = shufflevector <2 x i32> [[TMP232]], <2 x i32> <i32 65535, i32 poison>, <2 x i32> <i32 2, i32 1>
; CHECK-NEXT:    [[TMP250:%.*]] = mul <2 x i32> [[TMP243]], [[TMP249]]
; CHECK-NEXT:    [[TMP251:%.*]] = add <2 x i32> [[TMP243]], [[TMP249]]
...
; CHECK-NEXT:    [[TMP262:%.*]] = extractelement <2 x i32> [[TMP252]], i32 1
; CHECK-NEXT:    [[ADD_I52_3:%.*]] = add i32 [[TMP261]], [[TMP262]]
; CHECK-NEXT:    [[XOR_I53_3:%.*]] = xor i32 [[ADD_I52_3]], [[CONV]]
; CHECK-NEXT:    [[TMP255:%.*]] = add <2 x i32> [[TMP219]], [[TMP248]]
; CHECK-NEXT:    [[TMP256:%.*]] = xor <2 x i32> [[TMP255]], [[TMP74]]
; CHECK-NEXT:    [[TMP257:%.*]] = shufflevector <2 x i32> <i32 65535, i32 poison>, <2 x i32> [[TMP243]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP258:%.*]] = mul <2 x i32> [[TMP232]], [[TMP257]]
; CHECK-NEXT:    [[TMP259:%.*]] = sub <2 x i32> [[TMP232]], [[TMP257]]
; CHECK-NEXT:    [[TMP260:%.*]] = shufflevector <2 x i32> [[TMP258]], <2 x i32> [[TMP259]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP263:%.*]] = extractelement <2 x i32> [[TMP260]], i32 0
; CHECK-NEXT:    [[TMP264:%.*]] = extractelement <2 x i32> [[TMP260]], i32 1
; CHECK-NEXT:    [[ADD_I62_3:%.*]] = add i32 [[TMP263]], [[TMP264]]
; CHECK-NEXT:    [[XOR_I63_3:%.*]] = xor i32 [[ADD_I62_3]], [[CONV33]]
; CHECK-NEXT:    [[ADD108_3:%.*]] = add i32 [[XOR_I53_3]], [[ADD113_2]]
; CHECK-NEXT:    [[TMP265:%.*]] = extractelement <2 x i32> [[TMP256]], i32 0
; CHECK-NEXT:    [[ADD110_3:%.*]] = add i32 [[ADD108_3]], [[TMP265]]
; CHECK-NEXT:    [[TMP266:%.*]] = extractelement <2 x i32> [[TMP256]], i32 1
; CHECK-NEXT:    [[ADD112_3:%.*]] = add i32 [[ADD110_3]], [[TMP266]]
