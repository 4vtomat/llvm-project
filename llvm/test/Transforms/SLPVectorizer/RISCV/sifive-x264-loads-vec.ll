...
; CHECK-NEXT:    [[TMP35:%.*]] = add <2 x i32> [[TMP26]], [[TMP24]]
; CHECK-NEXT:    [[TMP37:%.*]] = extractelement <2 x i32> [[TMP19]], i32 0
; CHECK-NEXT:    [[TMP27:%.*]] = extractelement <2 x i32> [[TMP19]], i32 1
; CHECK-NEXT:    [[TMP28:%.*]] = extractelement <2 x i32> [[TMP35]], i32 0
; CHECK-NEXT:    [[TMP29:%.*]] = extractelement <2 x i32> [[TMP35]], i32 1
; CHECK-NEXT:    [[TMP42:%.*]] = shufflevector <2 x i32> [[TMP19]], <2 x i32> [[TMP35]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP47:%.*]] = shufflevector <2 x i32> [[TMP19]], <2 x i32> [[TMP35]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP167:%.*]] = sub <2 x i32> [[TMP42]], [[TMP47]]
; CHECK-NEXT:    [[TMP30:%.*]] = extractelement <2 x i32> [[TMP167]], i32 0
; CHECK-NEXT:    [[TMP31:%.*]] = extractelement <2 x i32> [[TMP167]], i32 1
...
; CHECK-NEXT:    [[TMP38:%.*]] = zext <2 x i8> [[TMP34]] to <2 x i32>
...
; CHECK-NEXT:    [[TMP49:%.*]] = sub <2 x i32> [[TMP38]], [[TMP40]]
...
; CHECK-NEXT:    [[TMP55:%.*]] = zext <2 x i8> [[TMP39]] to <2 x i32>
...
; CHECK-NEXT:    [[TMP45:%.*]] = zext <2 x i8> [[TMP41]] to <2 x i32>
; CHECK-NEXT:    [[TMP43:%.*]] = sub <2 x i32> [[TMP55]], [[TMP45]]
; CHECK-NEXT:    [[TMP44:%.*]] = shl <2 x i32> [[TMP43]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP59:%.*]] = add <2 x i32> [[TMP44]], [[TMP49]]
...
; CHECK-NEXT:    [[TMP50:%.*]] = zext <2 x i8> [[TMP46]] to <2 x i32>
...
; CHECK-NEXT:    [[TMP60:%.*]] = zext <2 x i8> [[TMP48]] to <2 x i32>
; CHECK-NEXT:    [[TMP53:%.*]] = sub <2 x i32> [[TMP50]], [[TMP60]]
; CHECK-NEXT:    [[TMP51:%.*]] = insertelement <2 x i8> poison, i8 [[TMP32]], i32 0
; CHECK-NEXT:    [[TMP52:%.*]] = insertelement <2 x i8> [[TMP51]], i8 [[TMP33]], i32 1
; CHECK-NEXT:    [[TMP73:%.*]] = zext <2 x i8> [[TMP52]] to <2 x i32>
...
; CHECK-NEXT:    [[TMP58:%.*]] = zext <2 x i8> [[TMP54]] to <2 x i32>
; CHECK-NEXT:    [[TMP56:%.*]] = sub <2 x i32> [[TMP73]], [[TMP58]]
; CHECK-NEXT:    [[TMP57:%.*]] = shl <2 x i32> [[TMP56]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP61:%.*]] = add <2 x i32> [[TMP57]], [[TMP53]]
; CHECK-NEXT:    [[TMP62:%.*]] = sub <2 x i32> [[TMP59]], [[TMP61]]
; CHECK-NEXT:    [[ADD44_2:%.*]] = add i32 [[TMP27]], [[TMP37]]
; CHECK-NEXT:    [[TMP75:%.*]] = shufflevector <2 x i32> [[TMP61]], <2 x i32> [[TMP19]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP84:%.*]] = shufflevector <2 x i32> [[TMP59]], <2 x i32> [[TMP19]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP65:%.*]] = add <2 x i32> [[TMP75]], [[TMP84]]
; CHECK-NEXT:    [[TMP72:%.*]] = add i32 [[TMP29]], [[TMP28]]
; CHECK-NEXT:    [[TMP66:%.*]] = shufflevector <2 x i32> [[TMP61]], <2 x i32> [[TMP35]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP67:%.*]] = shufflevector <2 x i32> [[TMP59]], <2 x i32> [[TMP35]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP68:%.*]] = add <2 x i32> [[TMP66]], [[TMP67]]
; CHECK-NEXT:    [[ADD48_4:%.*]] = add i32 [[TMP72]], [[ADD44_2]]
; CHECK-NEXT:    [[TMP85:%.*]] = extractelement <2 x i32> [[TMP65]], i32 0
; CHECK-NEXT:    [[TMP70:%.*]] = extractelement <2 x i32> [[TMP68]], i32 0
; CHECK-NEXT:    [[ADD48_5:%.*]] = add i32 [[TMP70]], [[TMP85]]
; CHECK-NEXT:    [[TMP71:%.*]] = sub <2 x i32> [[TMP65]], [[TMP68]]
; CHECK-NEXT:    [[TMP63:%.*]] = extractelement <2 x i32> [[TMP62]], i32 0
; CHECK-NEXT:    [[TMP64:%.*]] = extractelement <2 x i32> [[TMP62]], i32 1
; CHECK-NEXT:    [[SUB59_3:%.*]] = sub i32 [[TMP63]], [[TMP64]]
; CHECK-NEXT:    [[ADD94:%.*]] = add i32 [[ADD48_5]], [[ADD48_4]]
; CHECK-NEXT:    [[SUB103:%.*]] = sub i32 [[ADD48_4]], [[ADD48_5]]
; CHECK-NEXT:    [[TMP69:%.*]] = extractelement <2 x i32> [[TMP38]], i32 0
; CHECK-NEXT:    [[SHR_I:%.*]] = lshr i32 [[TMP69]], 15
; CHECK-NEXT:    [[AND_I:%.*]] = and i32 [[SHR_I]], 65537
; CHECK-NEXT:    [[MUL_I:%.*]] = mul i32 [[AND_I]], 65535
; CHECK-NEXT:    [[SHR_I49_1:%.*]] = lshr i32 [[TMP72]], 15
; CHECK-NEXT:    [[AND_I50_1:%.*]] = and i32 [[SHR_I49_1]], 65537
; CHECK-NEXT:    [[MUL_I51_1:%.*]] = mul i32 [[AND_I50_1]], 65535
; CHECK-NEXT:    [[TMP105:%.*]] = extractelement <2 x i32> [[TMP5]], i32 0
; CHECK-NEXT:    [[SHR_I49:%.*]] = lshr i32 [[TMP105]], 15
...
; CHECK-NEXT:    [[TMP77:%.*]] = extractelement <2 x i32> [[TMP71]], i32 1
; CHECK-NEXT:    [[ADD94_3:%.*]] = add i32 [[TMP76]], [[TMP77]]
; CHECK-NEXT:    [[TMP78:%.*]] = load <2 x i8>, ptr [[ARRAYIDX20]], align 1
; CHECK-NEXT:    [[TMP79:%.*]] = zext <2 x i8> [[TMP78]] to <2 x i32>
; CHECK-NEXT:    [[TMP80:%.*]] = insertelement <2 x i32> poison, i32 [[SUB47_2]], i32 0
; CHECK-NEXT:    [[TMP81:%.*]] = shufflevector <2 x i32> [[TMP80]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP82:%.*]] = insertelement <2 x i32> poison, i32 [[SUB59_3]], i32 0
; CHECK-NEXT:    [[TMP83:%.*]] = shufflevector <2 x i32> [[TMP82]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP110:%.*]] = add <2 x i32> [[TMP81]], [[TMP83]]
; CHECK-NEXT:    [[TMP111:%.*]] = sub <2 x i32> [[TMP81]], [[TMP83]]
; CHECK-NEXT:    [[TMP112:%.*]] = shufflevector <2 x i32> [[TMP110]], <2 x i32> [[TMP111]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP87:%.*]] = load <2 x i8>, ptr [[PIX1]], align 1
; CHECK-NEXT:    [[TMP74:%.*]] = zext <2 x i8> [[TMP87]] to <2 x i32>
; CHECK-NEXT:    [[TMP89:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[PIX2]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP90:%.*]] = zext <2 x i8> [[TMP89]] to <2 x i32>
; CHECK-NEXT:    [[TMP91:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX3]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP92:%.*]] = zext <2 x i8> [[TMP91]] to <2 x i32>
; CHECK-NEXT:    [[TMP93:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX5]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
...
; CHECK-NEXT:    [[TMP97:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX10]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP98:%.*]] = zext <2 x i8> [[TMP97]] to <2 x i32>
; CHECK-NEXT:    [[TMP99:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX13]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP100:%.*]] = zext <2 x i8> [[TMP99]] to <2 x i32>
; CHECK-NEXT:    [[TMP101:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX15]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP102:%.*]] = zext <2 x i8> [[TMP101]] to <2 x i32>
; CHECK-NEXT:    [[TMP103:%.*]] = sub <2 x i32> [[TMP100]], [[TMP102]]
; CHECK-NEXT:    [[TMP104:%.*]] = shl <2 x i32> [[TMP103]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP117:%.*]] = shufflevector <2 x i32> [[TMP74]], <2 x i32> [[TMP79]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP106:%.*]] = sub <2 x i32> [[TMP117]], [[TMP90]]
; CHECK-NEXT:    [[TMP107:%.*]] = add <2 x i32> [[TMP96]], [[TMP106]]
; CHECK-NEXT:    [[TMP108:%.*]] = shufflevector <2 x i32> [[TMP74]], <2 x i32> [[TMP79]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP109:%.*]] = sub <2 x i32> [[TMP108]], [[TMP98]]
; CHECK-NEXT:    [[TMP119:%.*]] = add <2 x i32> [[TMP104]], [[TMP109]]
; CHECK-NEXT:    [[TMP127:%.*]] = sub <2 x i32> [[TMP107]], [[TMP119]]
; CHECK-NEXT:    [[TMP134:%.*]] = shufflevector <2 x i32> [[TMP119]], <2 x i32> [[TMP107]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP113:%.*]] = lshr <2 x i32> [[TMP74]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP136:%.*]] = and <2 x i32> [[TMP113]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP142:%.*]] = mul <2 x i32> [[TMP136]], <i32 65535, i32 65535>
; CHECK-NEXT:    [[ADD48_2:%.*]] = extractelement <2 x i32> [[TMP127]], i32 0
; CHECK-NEXT:    [[ADD48_3:%.*]] = extractelement <2 x i32> [[TMP127]], i32 1
...
; CHECK-NEXT:    [[TMP121:%.*]] = zext <2 x i8> [[TMP116]] to <2 x i32>
...
; CHECK-NEXT:    [[TMP169:%.*]] = zext <2 x i8> [[TMP118]] to <2 x i32>
...
; CHECK-NEXT:    [[TMP125:%.*]] = zext <2 x i8> [[TMP120]] to <2 x i32>
; CHECK-NEXT:    [[TMP122:%.*]] = sub <2 x i32> [[TMP169]], [[TMP125]]
...
; CHECK-NEXT:    [[TMP129:%.*]] = zext <2 x i8> [[TMP124]] to <2 x i32>
...
; CHECK-NEXT:    [[TMP175:%.*]] = zext <2 x i8> [[TMP126]] to <2 x i32>
...
; CHECK-NEXT:    [[TMP133:%.*]] = zext <2 x i8> [[TMP128]] to <2 x i32>
; CHECK-NEXT:    [[TMP130:%.*]] = sub <2 x i32> [[TMP175]], [[TMP133]]
; CHECK-NEXT:    [[TMP131:%.*]] = shl <2 x i32> [[TMP130]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP132:%.*]] = insertelement <2 x i32> [[TMP115]], i32 [[CONV33_1]], i32 1
; CHECK-NEXT:    [[TMP137:%.*]] = sub <2 x i32> [[TMP132]], [[TMP129]]
; CHECK-NEXT:    [[TMP138:%.*]] = add <2 x i32> [[TMP131]], [[TMP137]]
; CHECK-NEXT:    [[TMP135:%.*]] = insertelement <2 x i32> [[TMP115]], i32 [[CONV_1]], i32 0
; CHECK-NEXT:    [[TMP140:%.*]] = sub <2 x i32> [[TMP135]], [[TMP121]]
; CHECK-NEXT:    [[TMP177:%.*]] = add <2 x i32> [[TMP123]], [[TMP140]]
; CHECK-NEXT:    [[TMP139:%.*]] = sub <2 x i32> [[TMP177]], [[TMP138]]
; CHECK-NEXT:    [[TMP143:%.*]] = shufflevector <2 x i32> [[TMP139]], <2 x i32> [[TMP127]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP144:%.*]] = shufflevector <2 x i32> [[TMP139]], <2 x i32> [[TMP127]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP145:%.*]] = add <2 x i32> [[TMP143]], [[TMP144]]
; CHECK-NEXT:    [[TMP147:%.*]] = extractelement <2 x i32> [[TMP139]], i32 0
; CHECK-NEXT:    [[TMP148:%.*]] = extractelement <2 x i32> [[TMP139]], i32 1
; CHECK-NEXT:    [[SUB59_1:%.*]] = sub i32 [[TMP147]], [[TMP148]]
; CHECK-NEXT:    [[TMP149:%.*]] = lshr <2 x i32> [[TMP115]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP150:%.*]] = and <2 x i32> [[TMP149]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP151:%.*]] = mul <2 x i32> [[TMP150]], <i32 65535, i32 65535>
; CHECK-NEXT:    [[TMP191:%.*]] = insertelement <2 x i32> poison, i32 [[SUB59_1]], i32 0
; CHECK-NEXT:    [[TMP192:%.*]] = shufflevector <2 x i32> [[TMP191]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP200:%.*]] = extractelement <2 x i32> [[TMP145]], i32 0
; CHECK-NEXT:    [[TMP206:%.*]] = extractelement <2 x i32> [[TMP145]], i32 1
; CHECK-NEXT:    [[ADD78_1:%.*]] = add i32 [[TMP200]], [[TMP206]]
; CHECK-NEXT:    [[TMP207:%.*]] = insertelement <2 x i32> poison, i32 [[ADD94_3]], i32 0
; CHECK-NEXT:    [[TMP214:%.*]] = shufflevector <2 x i32> [[TMP207]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP215:%.*]] = shufflevector <2 x i32> [[TMP62]], <2 x i32> [[TMP167]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP158:%.*]] = shufflevector <2 x i32> [[TMP62]], <2 x i32> [[TMP167]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP159:%.*]] = add <2 x i32> [[TMP215]], [[TMP158]]
; CHECK-NEXT:    [[TMP160:%.*]] = shufflevector <2 x i32> [[TMP138]], <2 x i32> [[TMP119]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP216:%.*]] = shufflevector <2 x i32> [[TMP177]], <2 x i32> [[TMP107]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP217:%.*]] = add <2 x i32> [[TMP160]], [[TMP216]]
; CHECK-NEXT:    [[ADD46:%.*]] = extractelement <2 x i32> [[TMP217]], i32 1
; CHECK-NEXT:    [[SHR_I59:%.*]] = lshr i32 [[ADD46]], 15
; CHECK-NEXT:    [[AND_I60:%.*]] = and i32 [[SHR_I59]], 65537
; CHECK-NEXT:    [[MUL_I61:%.*]] = mul i32 [[AND_I60]], 65535
; CHECK-NEXT:    [[TMP218:%.*]] = shufflevector <2 x i32> [[TMP138]], <2 x i32> [[TMP119]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP165:%.*]] = shufflevector <2 x i32> [[TMP177]], <2 x i32> [[TMP107]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP166:%.*]] = add <2 x i32> [[TMP218]], [[TMP165]]
; CHECK-NEXT:    [[ADD44:%.*]] = extractelement <2 x i32> [[TMP166]], i32 1
; CHECK-NEXT:    [[ADD48:%.*]] = add i32 [[ADD46]], [[ADD44]]
; CHECK-NEXT:    [[TMP168:%.*]] = extractelement <2 x i32> [[TMP166]], i32 0
; CHECK-NEXT:    [[TMP141:%.*]] = extractelement <2 x i32> [[TMP217]], i32 0
; CHECK-NEXT:    [[ADD48_1:%.*]] = add i32 [[TMP141]], [[TMP168]]
; CHECK-NEXT:    [[SHR_I54:%.*]] = lshr i32 [[TMP141]], 15
...
; CHECK-NEXT:    [[XOR_I:%.*]] = xor i32 [[ADD_I]], [[TMP69]]
; CHECK-NEXT:    [[ADD_I52:%.*]] = add i32 [[MUL_I51_1]], [[ADD105]]
; CHECK-NEXT:    [[XOR_I53:%.*]] = xor i32 [[ADD_I52]], [[TMP72]]
; CHECK-NEXT:    [[ADD_I57:%.*]] = add i32 [[MUL_I56]], [[SUB104]]
; CHECK-NEXT:    [[XOR_I58:%.*]] = xor i32 [[ADD_I57]], [[TMP141]]
...
; CHECK-NEXT:    [[TMP152:%.*]] = shufflevector <2 x i32> [[TMP166]], <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
; CHECK-NEXT:    [[TMP153:%.*]] = shufflevector <2 x i32> [[TMP152]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP154:%.*]] = shufflevector <2 x i32> <i32 15, i32 poison>, <2 x i32> [[TMP217]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP155:%.*]] = lshr <2 x i32> [[TMP153]], [[TMP154]]
; CHECK-NEXT:    [[TMP156:%.*]] = sub <2 x i32> [[TMP153]], [[TMP154]]
; CHECK-NEXT:    [[TMP157:%.*]] = shufflevector <2 x i32> [[TMP155]], <2 x i32> [[TMP156]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP222:%.*]] = sub <2 x i32> [[TMP166]], [[TMP217]]
; CHECK-NEXT:    [[TMP161:%.*]] = shufflevector <2 x i32> <i32 65537, i32 poison>, <2 x i32> [[TMP222]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP162:%.*]] = and <2 x i32> [[TMP157]], [[TMP161]]
; CHECK-NEXT:    [[TMP163:%.*]] = sub <2 x i32> [[TMP157]], [[TMP161]]
; CHECK-NEXT:    [[TMP164:%.*]] = shufflevector <2 x i32> [[TMP162]], <2 x i32> [[TMP163]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP223:%.*]] = shufflevector <2 x i32> [[TMP152]], <2 x i32> [[TMP167]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP146:%.*]] = shufflevector <2 x i32> [[TMP217]], <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
; CHECK-NEXT:    [[TMP174:%.*]] = shufflevector <2 x i32> [[TMP146]], <2 x i32> [[TMP167]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP224:%.*]] = sub <2 x i32> [[TMP223]], [[TMP174]]
; CHECK-NEXT:    [[TMP225:%.*]] = add <2 x i32> [[TMP223]], [[TMP174]]
; CHECK-NEXT:    [[TMP226:%.*]] = shufflevector <2 x i32> [[TMP224]], <2 x i32> [[TMP225]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP229:%.*]] = extractelement <2 x i32> [[TMP159]], i32 0
; CHECK-NEXT:    [[TMP230:%.*]] = extractelement <2 x i32> [[TMP159]], i32 1
; CHECK-NEXT:    [[ADD94_1:%.*]] = add i32 [[TMP229]], [[TMP230]]
; CHECK-NEXT:    [[TMP170:%.*]] = insertelement <2 x i32> [[TMP127]], i32 [[CONV_1]], i32 0
; CHECK-NEXT:    [[TMP171:%.*]] = lshr <2 x i32> [[TMP170]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP172:%.*]] = and <2 x i32> [[TMP171]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP173:%.*]] = mul <2 x i32> [[TMP172]], <i32 65535, i32 65535>
; CHECK-NEXT:    [[SUB86_1:%.*]] = sub i32 [[TMP206]], [[TMP200]]
; CHECK-NEXT:    [[TMP193:%.*]] = shufflevector <2 x i32> [[TMP71]], <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
; CHECK-NEXT:    [[TMP194:%.*]] = shufflevector <2 x i32> [[TMP193]], <2 x i32> [[TMP145]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP238:%.*]] = shufflevector <2 x i32> [[TMP71]], <2 x i32> [[TMP145]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP176:%.*]] = sub <2 x i32> [[TMP194]], [[TMP238]]
; CHECK-NEXT:    [[SUB102_1:%.*]] = sub i32 [[TMP230]], [[TMP229]]
; CHECK-NEXT:    [[TMP239:%.*]] = shufflevector <2 x i32> [[TMP222]], <2 x i32> [[TMP159]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP240:%.*]] = sub <2 x i32> [[TMP226]], [[TMP239]]
; CHECK-NEXT:    [[ADD105_1:%.*]] = add i32 [[SUB102_1]], [[SUB86_1]]
; CHECK-NEXT:    [[ADD_I52_1:%.*]] = add i32 [[MUL_I51]], [[ADD105_1]]
; CHECK-NEXT:    [[XOR_I53_1:%.*]] = xor i32 [[ADD_I52_1]], [[TMP105]]
; CHECK-NEXT:    [[TMP178:%.*]] = shufflevector <2 x i32> [[TMP5]], <2 x i32> [[TMP139]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP179:%.*]] = lshr <2 x i32> [[TMP178]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP180:%.*]] = and <2 x i32> [[TMP179]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP181:%.*]] = mul <2 x i32> [[TMP180]], <i32 65535, i32 65535>
; CHECK-NEXT:    [[TMP182:%.*]] = insertelement <2 x i32> poison, i32 [[ADD78_1]], i32 0
; CHECK-NEXT:    [[TMP183:%.*]] = shufflevector <2 x i32> [[TMP182]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP184:%.*]] = insertelement <2 x i32> poison, i32 [[ADD94_1]], i32 0
; CHECK-NEXT:    [[TMP185:%.*]] = shufflevector <2 x i32> [[TMP184]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP186:%.*]] = add <2 x i32> [[TMP183]], [[TMP185]]
...
; CHECK-NEXT:    [[TMP189:%.*]] = add <2 x i32> [[TMP181]], [[TMP188]]
; CHECK-NEXT:    [[TMP190:%.*]] = xor <2 x i32> [[TMP189]], [[TMP178]]
; CHECK-NEXT:    [[ADD108_1:%.*]] = add i32 [[XOR_I53_1]], [[ADD113]]
; CHECK-NEXT:    [[TMP212:%.*]] = extractelement <2 x i32> [[TMP190]], i32 0
; CHECK-NEXT:    [[ADD110_1:%.*]] = add i32 [[ADD108_1]], [[TMP212]]
; CHECK-NEXT:    [[TMP213:%.*]] = extractelement <2 x i32> [[TMP190]], i32 1
; CHECK-NEXT:    [[ADD112_1:%.*]] = add i32 [[ADD110_1]], [[TMP213]]
; CHECK-NEXT:    [[TMP195:%.*]] = add <2 x i32> [[TMP176]], [[TMP240]]
; CHECK-NEXT:    [[TMP196:%.*]] = sub <2 x i32> [[TMP176]], [[TMP240]]
; CHECK-NEXT:    [[TMP197:%.*]] = shufflevector <2 x i32> [[TMP195]], <2 x i32> [[TMP196]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP198:%.*]] = add <2 x i32> [[TMP173]], [[TMP197]]
; CHECK-NEXT:    [[TMP199:%.*]] = xor <2 x i32> [[TMP198]], [[TMP170]]
; CHECK-NEXT:    [[TMP219:%.*]] = extractelement <2 x i32> [[TMP199]], i32 1
; CHECK-NEXT:    [[ADD113_1:%.*]] = add i32 [[ADD112_1]], [[TMP219]]
; CHECK-NEXT:    [[TMP220:%.*]] = extractelement <2 x i32> [[TMP222]], i32 0
; CHECK-NEXT:    [[TMP221:%.*]] = extractelement <2 x i32> [[TMP222]], i32 1
; CHECK-NEXT:    [[ADD94_2:%.*]] = add i32 [[TMP220]], [[TMP221]]
; CHECK-NEXT:    [[TMP201:%.*]] = insertelement <2 x i32> poison, i32 [[ADD94_2]], i32 0
; CHECK-NEXT:    [[TMP202:%.*]] = shufflevector <2 x i32> [[TMP201]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP203:%.*]] = add <2 x i32> [[TMP202]], [[TMP214]]
; CHECK-NEXT:    [[TMP204:%.*]] = sub <2 x i32> [[TMP202]], [[TMP214]]
; CHECK-NEXT:    [[TMP205:%.*]] = shufflevector <2 x i32> [[TMP203]], <2 x i32> [[TMP204]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP208:%.*]] = shufflevector <2 x i32> <i32 65535, i32 poison>, <2 x i32> [[TMP176]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP209:%.*]] = mul <2 x i32> [[TMP164]], [[TMP208]]
; CHECK-NEXT:    [[TMP210:%.*]] = sub <2 x i32> [[TMP164]], [[TMP208]]
; CHECK-NEXT:    [[TMP211:%.*]] = shufflevector <2 x i32> [[TMP209]], <2 x i32> [[TMP210]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP231:%.*]] = add <2 x i32> [[TMP151]], [[TMP205]]
; CHECK-NEXT:    [[TMP232:%.*]] = xor <2 x i32> [[TMP231]], [[TMP115]]
; CHECK-NEXT:    [[TMP233:%.*]] = extractelement <2 x i32> [[TMP211]], i32 0
; CHECK-NEXT:    [[TMP234:%.*]] = extractelement <2 x i32> [[TMP211]], i32 1
; CHECK-NEXT:    [[ADD_I62_2:%.*]] = add i32 [[TMP233]], [[TMP234]]
; CHECK-NEXT:    [[XOR_I63_2:%.*]] = xor i32 [[ADD_I62_2]], [[ADD44]]
; CHECK-NEXT:    [[TMP235:%.*]] = extractelement <2 x i32> [[TMP199]], i32 0
; CHECK-NEXT:    [[ADD108_2:%.*]] = add i32 [[TMP235]], [[ADD113_1]]
; CHECK-NEXT:    [[TMP236:%.*]] = extractelement <2 x i32> [[TMP232]], i32 0
; CHECK-NEXT:    [[ADD110_2:%.*]] = add i32 [[ADD108_2]], [[TMP236]]
; CHECK-NEXT:    [[TMP237:%.*]] = extractelement <2 x i32> [[TMP232]], i32 1
; CHECK-NEXT:    [[ADD112_2:%.*]] = add i32 [[ADD110_2]], [[TMP237]]
; CHECK-NEXT:    [[ADD113_2:%.*]] = add i32 [[ADD112_2]], [[XOR_I63_2]]
; CHECK-NEXT:    [[TMP227:%.*]] = insertelement <2 x i32> poison, i32 [[SUB102]], i32 0
; CHECK-NEXT:    [[TMP228:%.*]] = shufflevector <2 x i32> [[TMP227]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP241:%.*]] = add <2 x i32> [[TMP228]], [[TMP192]]
; CHECK-NEXT:    [[TMP242:%.*]] = sub <2 x i32> [[TMP228]], [[TMP192]]
; CHECK-NEXT:    [[TMP243:%.*]] = shufflevector <2 x i32> [[TMP241]], <2 x i32> [[TMP242]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP247:%.*]] = shufflevector <2 x i32> [[TMP242]], <2 x i32> [[TMP241]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP244:%.*]] = shufflevector <2 x i32> [[TMP111]], <2 x i32> [[TMP110]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP245:%.*]] = add <2 x i32> [[TMP244]], [[TMP247]]
; CHECK-NEXT:    [[TMP246:%.*]] = sub <2 x i32> [[TMP243]], [[TMP112]]
; CHECK-NEXT:    [[TMP255:%.*]] = add <2 x i32> [[TMP142]], [[TMP245]]
; CHECK-NEXT:    [[TMP256:%.*]] = xor <2 x i32> [[TMP255]], [[TMP74]]
; CHECK-NEXT:    [[TMP249:%.*]] = lshr <2 x i32> [[TMP79]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP250:%.*]] = and <2 x i32> [[TMP249]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP251:%.*]] = mul <2 x i32> [[TMP250]], <i32 65535, i32 65535>
; CHECK-NEXT:    [[TMP252:%.*]] = add <2 x i32> [[TMP251]], [[TMP246]]
; CHECK-NEXT:    [[TMP253:%.*]] = xor <2 x i32> [[TMP252]], [[TMP79]]
; CHECK-NEXT:    [[TMP254:%.*]] = extractelement <2 x i32> [[TMP256]], i32 0
; CHECK-NEXT:    [[ADD108_3:%.*]] = add i32 [[TMP254]], [[ADD113_2]]
; CHECK-NEXT:    [[TMP258:%.*]] = extractelement <2 x i32> [[TMP256]], i32 1
; CHECK-NEXT:    [[ADD110_3:%.*]] = add i32 [[ADD108_3]], [[TMP258]]
; CHECK-NEXT:    [[TMP259:%.*]] = extractelement <2 x i32> [[TMP253]], i32 0
; CHECK-NEXT:    [[ADD112_3:%.*]] = add i32 [[ADD110_3]], [[TMP259]]
; CHECK-NEXT:    [[TMP257:%.*]] = extractelement <2 x i32> [[TMP253]], i32 1
; CHECK-NEXT:    [[ADD113_3:%.*]] = add i32 [[ADD112_3]], [[TMP257]]
