...
; CHECK-NEXT:    [[TMP16:%.*]] = load <2 x i8>, ptr [[ARRAYIDX20_2]], align 1
...
; CHECK-NEXT:    [[TMP25:%.*]] = sub <2 x i32> [[TMP22]], [[TMP24]]
; CHECK-NEXT:    [[TMP26:%.*]] = shl <2 x i32> [[TMP25]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP27:%.*]] = add <2 x i32> [[TMP26]], [[TMP20]]
; CHECK-NEXT:    [[TMP28:%.*]] = load i8, ptr null, align 1
; CHECK-NEXT:    [[ARRAYIDX20_3:%.*]] = getelementptr i8, ptr null, i64 2
; CHECK-NEXT:    [[ARRAYIDX22_3:%.*]] = getelementptr i8, ptr null, i64 2
; CHECK-NEXT:    [[TMP29:%.*]] = load i8, ptr null, align 1
; CHECK-NEXT:    [[TMP30:%.*]] = insertelement <2 x ptr> <ptr poison, ptr null>, ptr [[ARRAYIDX20_3]], i32 0
; CHECK-NEXT:    [[TMP31:%.*]] = call <2 x i8> @llvm.masked.gather.v2i8.v2p0(<2 x ptr> [[TMP30]], i32 1, <2 x i1> <i1 true, i1 true>, <2 x i8> poison)
; CHECK-NEXT:    [[TMP32:%.*]] = zext <2 x i8> [[TMP31]] to <2 x i32>
; CHECK-NEXT:    [[TMP33:%.*]] = insertelement <2 x ptr> <ptr poison, ptr null>, ptr [[ARRAYIDX22_3]], i32 0
; CHECK-NEXT:    [[TMP34:%.*]] = call <2 x i8> @llvm.masked.gather.v2i8.v2p0(<2 x ptr> [[TMP33]], i32 1, <2 x i1> <i1 true, i1 true>, <2 x i8> poison)
; CHECK-NEXT:    [[TMP35:%.*]] = zext <2 x i8> [[TMP34]] to <2 x i32>
; CHECK-NEXT:    [[TMP36:%.*]] = sub <2 x i32> [[TMP32]], [[TMP35]]
; CHECK-NEXT:    [[TMP37:%.*]] = call <2 x i8> @llvm.riscv.masked.strided.load.v2i8.p0.i64(<2 x i8> poison, ptr align 1 null, i64 4, <2 x i1> <i1 true, i1 true>)
; CHECK-NEXT:    [[TMP38:%.*]] = zext <2 x i8> [[TMP37]] to <2 x i32>
; CHECK-NEXT:    [[TMP39:%.*]] = call <2 x i8> @llvm.masked.gather.v2i8.v2p0(<2 x ptr> getelementptr (i8, <2 x ptr> zeroinitializer, <2 x i64> <i64 6, i64 4>), i32 1, <2 x i1> <i1 true, i1 true>, <2 x i8> poison)
; CHECK-NEXT:    [[TMP40:%.*]] = zext <2 x i8> [[TMP39]] to <2 x i32>
; CHECK-NEXT:    [[TMP41:%.*]] = sub <2 x i32> [[TMP38]], [[TMP40]]
; CHECK-NEXT:    [[TMP42:%.*]] = shl <2 x i32> [[TMP41]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP43:%.*]] = add <2 x i32> [[TMP42]], [[TMP36]]
; CHECK-NEXT:    [[TMP44:%.*]] = call <2 x i8> @llvm.masked.gather.v2i8.v2p0(<2 x ptr> getelementptr (i8, <2 x ptr> zeroinitializer, <2 x i64> <i64 3, i64 1>), i32 1, <2 x i1> <i1 true, i1 true>, <2 x i8> poison)
; CHECK-NEXT:    [[TMP45:%.*]] = zext <2 x i8> [[TMP44]] to <2 x i32>
; CHECK-NEXT:    [[TMP46:%.*]] = call <2 x i8> @llvm.masked.gather.v2i8.v2p0(<2 x ptr> getelementptr (i8, <2 x ptr> zeroinitializer, <2 x i64> <i64 3, i64 1>), i32 1, <2 x i1> <i1 true, i1 true>, <2 x i8> poison)
; CHECK-NEXT:    [[TMP47:%.*]] = zext <2 x i8> [[TMP46]] to <2 x i32>
; CHECK-NEXT:    [[TMP48:%.*]] = sub <2 x i32> [[TMP45]], [[TMP47]]
; CHECK-NEXT:    [[TMP49:%.*]] = insertelement <2 x i8> poison, i8 [[TMP29]], i32 0
; CHECK-NEXT:    [[TMP50:%.*]] = insertelement <2 x i8> [[TMP49]], i8 [[TMP28]], i32 1
; CHECK-NEXT:    [[TMP51:%.*]] = zext <2 x i8> [[TMP50]] to <2 x i32>
; CHECK-NEXT:    [[TMP52:%.*]] = call <2 x i8> @llvm.masked.gather.v2i8.v2p0(<2 x ptr> getelementptr (i8, <2 x ptr> zeroinitializer, <2 x i64> <i64 7, i64 5>), i32 1, <2 x i1> <i1 true, i1 true>, <2 x i8> poison)
...
; CHECK-NEXT:    [[TMP56:%.*]] = add <2 x i32> [[TMP55]], [[TMP48]]
; CHECK-NEXT:    [[TMP57:%.*]] = add <2 x i32> [[TMP56]], [[TMP43]]
; CHECK-NEXT:    [[TMP58:%.*]] = sub <2 x i32> [[TMP43]], [[TMP56]]
; CHECK-NEXT:    [[TMP59:%.*]] = extractelement <2 x i32> [[TMP58]], i32 0
; CHECK-NEXT:    [[TMP60:%.*]] = extractelement <2 x i32> [[TMP58]], i32 1
; CHECK-NEXT:    [[SUB59_3:%.*]] = sub i32 [[TMP60]], [[TMP59]]
; CHECK-NEXT:    [[TMP61:%.*]] = extractelement <2 x i32> [[TMP32]], i32 1
; CHECK-NEXT:    [[SHR_I:%.*]] = lshr i32 [[TMP61]], 15
; CHECK-NEXT:    [[AND_I:%.*]] = and i32 [[SHR_I]], 65537
; CHECK-NEXT:    [[MUL_I:%.*]] = mul i32 [[AND_I]], 65535
; CHECK-NEXT:    [[TMP62:%.*]] = load <2 x i8>, ptr [[ARRAYIDX8]], align 1
; CHECK-NEXT:    [[TMP63:%.*]] = zext <2 x i8> [[TMP62]] to <2 x i32>
; CHECK-NEXT:    [[TMP64:%.*]] = load <2 x i8>, ptr [[PIX2]], align 1
; CHECK-NEXT:    [[TMP65:%.*]] = zext <2 x i8> [[TMP64]] to <2 x i32>
; CHECK-NEXT:    [[TMP66:%.*]] = load <2 x i8>, ptr [[ARRAYIDX3]], align 1
; CHECK-NEXT:    [[TMP67:%.*]] = zext <2 x i8> [[TMP66]] to <2 x i32>
; CHECK-NEXT:    [[TMP68:%.*]] = load <2 x i8>, ptr [[ARRAYIDX5]], align 1
; CHECK-NEXT:    [[TMP69:%.*]] = zext <2 x i8> [[TMP68]] to <2 x i32>
; CHECK-NEXT:    [[TMP70:%.*]] = sub <2 x i32> [[TMP67]], [[TMP69]]
; CHECK-NEXT:    [[TMP71:%.*]] = shl <2 x i32> [[TMP70]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP72:%.*]] = shufflevector <2 x i32> [[TMP63]], <2 x i32> poison, <2 x i32> <i32 1, i32 0>
; CHECK-NEXT:    [[TMP73:%.*]] = insertelement <2 x i32> [[TMP72]], i32 [[CONV]], i32 0
; CHECK-NEXT:    [[TMP74:%.*]] = sub <2 x i32> [[TMP73]], [[TMP65]]
; CHECK-NEXT:    [[TMP75:%.*]] = add <2 x i32> [[TMP71]], [[TMP74]]
; CHECK-NEXT:    [[TMP76:%.*]] = load <2 x i8>, ptr [[ARRAYIDX22]], align 1
; CHECK-NEXT:    [[TMP77:%.*]] = zext <2 x i8> [[TMP76]] to <2 x i32>
; CHECK-NEXT:    [[TMP78:%.*]] = load <2 x i8>, ptr [[ARRAYIDX25]], align 1
; CHECK-NEXT:    [[TMP79:%.*]] = zext <2 x i8> [[TMP78]] to <2 x i32>
; CHECK-NEXT:    [[TMP80:%.*]] = load <2 x i8>, ptr [[ARRAYIDX27]], align 1
...
; CHECK-NEXT:    [[TMP84:%.*]] = insertelement <2 x i32> [[TMP72]], i32 [[CONV33]], i32 1
; CHECK-NEXT:    [[TMP85:%.*]] = sub <2 x i32> [[TMP84]], [[TMP77]]
; CHECK-NEXT:    [[TMP86:%.*]] = add <2 x i32> [[TMP83]], [[TMP85]]
; CHECK-NEXT:    [[TMP87:%.*]] = shufflevector <2 x i32> [[TMP15]], <2 x i32> [[TMP75]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP88:%.*]] = shufflevector <2 x i32> [[TMP15]], <2 x i32> [[TMP75]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP89:%.*]] = sub <2 x i32> [[TMP87]], [[TMP88]]
; CHECK-NEXT:    [[TMP90:%.*]] = add <2 x i32> [[TMP87]], [[TMP88]]
; CHECK-NEXT:    [[TMP91:%.*]] = shufflevector <2 x i32> [[TMP89]], <2 x i32> [[TMP90]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP92:%.*]] = shufflevector <2 x i32> [[TMP27]], <2 x i32> [[TMP75]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP93:%.*]] = shufflevector <2 x i32> [[TMP27]], <2 x i32> [[TMP75]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP94:%.*]] = add <2 x i32> [[TMP92]], [[TMP93]]
; CHECK-NEXT:    [[TMP95:%.*]] = sub <2 x i32> [[TMP92]], [[TMP93]]
; CHECK-NEXT:    [[TMP96:%.*]] = shufflevector <2 x i32> [[TMP94]], <2 x i32> [[TMP95]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP97:%.*]] = extractelement <2 x i32> [[TMP96]], i32 0
; CHECK-NEXT:    [[SHR_I49:%.*]] = lshr i32 [[TMP97]], 15
; CHECK-NEXT:    [[AND_I50:%.*]] = and i32 [[SHR_I49]], 65537
; CHECK-NEXT:    [[MUL_I51:%.*]] = mul i32 [[AND_I50]], 65535
; CHECK-NEXT:    [[TMP98:%.*]] = shufflevector <2 x i32> [[TMP27]], <2 x i32> [[TMP86]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP99:%.*]] = shufflevector <2 x i32> [[TMP27]], <2 x i32> [[TMP86]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP100:%.*]] = sub <2 x i32> [[TMP98]], [[TMP99]]
; CHECK-NEXT:    [[TMP101:%.*]] = add <2 x i32> [[TMP98]], [[TMP99]]
; CHECK-NEXT:    [[TMP102:%.*]] = shufflevector <2 x i32> [[TMP100]], <2 x i32> [[TMP101]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP103:%.*]] = shufflevector <2 x i32> [[TMP15]], <2 x i32> [[TMP86]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP104:%.*]] = shufflevector <2 x i32> [[TMP15]], <2 x i32> [[TMP86]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP105:%.*]] = add <2 x i32> [[TMP103]], [[TMP104]]
; CHECK-NEXT:    [[TMP106:%.*]] = sub <2 x i32> [[TMP103]], [[TMP104]]
; CHECK-NEXT:    [[TMP107:%.*]] = shufflevector <2 x i32> [[TMP105]], <2 x i32> [[TMP106]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP108:%.*]] = shufflevector <2 x i32> [[TMP96]], <2 x i32> [[TMP57]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP109:%.*]] = shufflevector <2 x i32> [[TMP107]], <2 x i32> [[TMP57]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP110:%.*]] = add <2 x i32> [[TMP108]], [[TMP109]]
; CHECK-NEXT:    [[TMP111:%.*]] = extractelement <2 x i32> [[TMP110]], i32 0
; CHECK-NEXT:    [[TMP112:%.*]] = extractelement <2 x i32> [[TMP110]], i32 1
; CHECK-NEXT:    [[ADD94:%.*]] = add i32 [[TMP112]], [[TMP111]]
; CHECK-NEXT:    [[SUB102:%.*]] = sub i32 [[TMP111]], [[TMP112]]
; CHECK-NEXT:    [[TMP113:%.*]] = load <2 x i8>, ptr [[ARRAYIDX8_1]], align 1
...
; CHECK-NEXT:    [[TMP115:%.*]] = insertelement <2 x ptr> poison, ptr [[ADD_PTR644]], i32 0
; CHECK-NEXT:    [[TMP116:%.*]] = insertelement <2 x ptr> [[TMP115]], ptr [[ARRAYIDX22_1]], i32 1
...
; CHECK-NEXT:    [[TMP119:%.*]] = insertelement <2 x ptr> poison, ptr [[ADD_PTR3]], i32 0
...
; CHECK-NEXT:    [[TMP124:%.*]] = shufflevector <2 x ptr> [[TMP116]], <2 x ptr> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP125:%.*]] = getelementptr i8, <2 x ptr> [[TMP124]], <2 x i64> <i64 4, i64 6>
; CHECK-NEXT:    [[TMP126:%.*]] = call <2 x i8> @llvm.masked.gather.v2i8.v2p0(<2 x ptr> [[TMP125]], i32 1, <2 x i1> <i1 true, i1 true>, <2 x i8> poison)
; CHECK-NEXT:    [[TMP127:%.*]] = zext <2 x i8> [[TMP126]] to <2 x i32>
; CHECK-NEXT:    [[TMP128:%.*]] = sub <2 x i32> [[TMP123]], [[TMP127]]
; CHECK-NEXT:    [[TMP129:%.*]] = shl <2 x i32> [[TMP128]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP130:%.*]] = getelementptr i8, <2 x ptr> [[TMP124]], <2 x i64> <i64 1, i64 3>
; CHECK-NEXT:    [[TMP131:%.*]] = call <2 x i8> @llvm.masked.gather.v2i8.v2p0(<2 x ptr> [[TMP130]], i32 1, <2 x i1> <i1 true, i1 true>, <2 x i8> poison)
; CHECK-NEXT:    [[TMP132:%.*]] = zext <2 x i8> [[TMP131]] to <2 x i32>
; CHECK-NEXT:    [[TMP133:%.*]] = getelementptr i8, <2 x ptr> [[TMP120]], <2 x i64> <i64 5, i64 7>
; CHECK-NEXT:    [[TMP134:%.*]] = call <2 x i8> @llvm.masked.gather.v2i8.v2p0(<2 x ptr> [[TMP133]], i32 1, <2 x i1> <i1 true, i1 true>, <2 x i8> poison)
; CHECK-NEXT:    [[TMP135:%.*]] = zext <2 x i8> [[TMP134]] to <2 x i32>
; CHECK-NEXT:    [[TMP136:%.*]] = getelementptr i8, <2 x ptr> [[TMP124]], <2 x i64> <i64 5, i64 7>
; CHECK-NEXT:    [[TMP137:%.*]] = call <2 x i8> @llvm.masked.gather.v2i8.v2p0(<2 x ptr> [[TMP136]], i32 1, <2 x i1> <i1 true, i1 true>, <2 x i8> poison)
; CHECK-NEXT:    [[TMP138:%.*]] = zext <2 x i8> [[TMP137]] to <2 x i32>
; CHECK-NEXT:    [[TMP139:%.*]] = sub <2 x i32> [[TMP135]], [[TMP138]]
; CHECK-NEXT:    [[TMP140:%.*]] = shl <2 x i32> [[TMP139]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP141:%.*]] = insertelement <2 x i32> [[TMP114]], i32 [[CONV33_1]], i32 1
; CHECK-NEXT:    [[TMP142:%.*]] = sub <2 x i32> [[TMP141]], [[TMP132]]
; CHECK-NEXT:    [[TMP143:%.*]] = add <2 x i32> [[TMP140]], [[TMP142]]
; CHECK-NEXT:    [[TMP144:%.*]] = insertelement <2 x i32> [[TMP114]], i32 [[CONV_1]], i32 0
; CHECK-NEXT:    [[TMP145:%.*]] = sub <2 x i32> [[TMP144]], [[TMP118]]
; CHECK-NEXT:    [[TMP146:%.*]] = add <2 x i32> [[TMP129]], [[TMP145]]
; CHECK-NEXT:    [[TMP147:%.*]] = add <2 x i32> [[TMP143]], [[TMP146]]
; CHECK-NEXT:    [[TMP148:%.*]] = sub <2 x i32> [[TMP146]], [[TMP143]]
; CHECK-NEXT:    [[TMP149:%.*]] = extractelement <2 x i32> [[TMP147]], i32 0
; CHECK-NEXT:    [[TMP150:%.*]] = extractelement <2 x i32> [[TMP147]], i32 1
; CHECK-NEXT:    [[SUB51_1:%.*]] = sub i32 [[TMP149]], [[TMP150]]
; CHECK-NEXT:    [[TMP151:%.*]] = shufflevector <2 x i32> [[TMP57]], <2 x i32> [[TMP148]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP152:%.*]] = shufflevector <2 x i32> [[TMP57]], <2 x i32> [[TMP148]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP153:%.*]] = sub <2 x i32> [[TMP151]], [[TMP152]]
; CHECK-NEXT:    [[TMP154:%.*]] = add <2 x i32> [[TMP151]], [[TMP152]]
; CHECK-NEXT:    [[TMP155:%.*]] = shufflevector <2 x i32> [[TMP153]], <2 x i32> [[TMP154]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP156:%.*]] = extractelement <2 x i32> [[TMP148]], i32 0
; CHECK-NEXT:    [[TMP157:%.*]] = extractelement <2 x i32> [[TMP148]], i32 1
; CHECK-NEXT:    [[SUB59_1:%.*]] = sub i32 [[TMP156]], [[TMP157]]
; CHECK-NEXT:    [[SHR_I54:%.*]] = lshr i32 [[TMP150]], 15
; CHECK-NEXT:    [[AND_I55:%.*]] = and i32 [[SHR_I54]], 65537
; CHECK-NEXT:    [[MUL_I56:%.*]] = mul i32 [[AND_I55]], 65535
; CHECK-NEXT:    [[TMP158:%.*]] = lshr <2 x i32> [[TMP114]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP159:%.*]] = and <2 x i32> [[TMP158]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP160:%.*]] = mul <2 x i32> [[TMP159]], <i32 65535, i32 65535>
; CHECK-NEXT:    [[TMP161:%.*]] = shufflevector <2 x i32> [[TMP91]], <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
; CHECK-NEXT:    [[TMP162:%.*]] = shufflevector <2 x i32> [[TMP161]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP163:%.*]] = shufflevector <2 x i32> <i32 15, i32 poison>, <2 x i32> [[TMP102]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP164:%.*]] = lshr <2 x i32> [[TMP162]], [[TMP163]]
; CHECK-NEXT:    [[TMP165:%.*]] = sub <2 x i32> [[TMP162]], [[TMP163]]
; CHECK-NEXT:    [[TMP166:%.*]] = shufflevector <2 x i32> [[TMP164]], <2 x i32> [[TMP165]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP167:%.*]] = extractelement <2 x i32> [[TMP166]], i32 1
; CHECK-NEXT:    [[ADD78_2:%.*]] = add i32 [[SUB51_1]], [[TMP167]]
; CHECK-NEXT:    [[TMP168:%.*]] = insertelement <2 x i32> poison, i32 [[ADD78_2]], i32 0
; CHECK-NEXT:    [[TMP169:%.*]] = shufflevector <2 x i32> [[TMP168]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP170:%.*]] = insertelement <2 x i32> <i32 65537, i32 poison>, i32 [[SUB51_1]], i32 1
; CHECK-NEXT:    [[TMP171:%.*]] = and <2 x i32> [[TMP166]], [[TMP170]]
; CHECK-NEXT:    [[TMP172:%.*]] = sub <2 x i32> [[TMP166]], [[TMP170]]
; CHECK-NEXT:    [[TMP173:%.*]] = shufflevector <2 x i32> [[TMP171]], <2 x i32> [[TMP172]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP174:%.*]] = sub <2 x i32> [[TMP107]], [[TMP96]]
; CHECK-NEXT:    [[TMP175:%.*]] = add <2 x i32> [[TMP107]], [[TMP96]]
; CHECK-NEXT:    [[TMP176:%.*]] = shufflevector <2 x i32> [[TMP174]], <2 x i32> [[TMP175]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP177:%.*]] = extractelement <2 x i32> [[TMP176]], i32 0
; CHECK-NEXT:    [[TMP178:%.*]] = extractelement <2 x i32> [[TMP155]], i32 0
; CHECK-NEXT:    [[ADD94_2:%.*]] = add i32 [[TMP178]], [[TMP177]]
; CHECK-NEXT:    [[TMP179:%.*]] = insertelement <2 x i32> [[TMP107]], i32 [[CONV_1]], i32 0
...
; CHECK-NEXT:    [[TMP184:%.*]] = extractelement <2 x i32> [[TMP155]], i32 1
; CHECK-NEXT:    [[ADD78_1:%.*]] = add i32 [[TMP184]], [[TMP183]]
; CHECK-NEXT:    [[TMP185:%.*]] = sub <2 x i32> [[TMP176]], [[TMP155]]
; CHECK-NEXT:    [[TMP186:%.*]] = add <2 x i32> [[TMP102]], [[TMP91]]
; CHECK-NEXT:    [[TMP187:%.*]] = shufflevector <2 x i32> [[TMP58]], <2 x i32> [[TMP147]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP188:%.*]] = shufflevector <2 x i32> [[TMP58]], <2 x i32> [[TMP147]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP189:%.*]] = add <2 x i32> [[TMP187]], [[TMP188]]
; CHECK-NEXT:    [[TMP190:%.*]] = extractelement <2 x i32> [[TMP186]], i32 0
; CHECK-NEXT:    [[TMP191:%.*]] = extractelement <2 x i32> [[TMP189]], i32 0
; CHECK-NEXT:    [[ADD94_1:%.*]] = add i32 [[TMP191]], [[TMP190]]
; CHECK-NEXT:    [[TMP192:%.*]] = shufflevector <2 x i32> [[TMP5]], <2 x i32> [[TMP102]], <2 x i32> <i32 0, i32 3>
...
; CHECK-NEXT:    [[TMP196:%.*]] = extractelement <2 x i32> [[TMP186]], i32 1
; CHECK-NEXT:    [[TMP197:%.*]] = extractelement <2 x i32> [[TMP189]], i32 1
; CHECK-NEXT:    [[ADD78:%.*]] = add i32 [[TMP197]], [[TMP196]]
; CHECK-NEXT:    [[TMP198:%.*]] = sub <2 x i32> [[TMP186]], [[TMP189]]
; CHECK-NEXT:    [[ADD103:%.*]] = add i32 [[ADD94]], [[ADD78]]
; CHECK-NEXT:    [[SUB104:%.*]] = sub i32 [[ADD78]], [[ADD94]]
; CHECK-NEXT:    [[TMP199:%.*]] = extractelement <2 x i32> [[TMP198]], i32 1
; CHECK-NEXT:    [[ADD105:%.*]] = add i32 [[SUB102]], [[TMP199]]
; CHECK-NEXT:    [[ADD_I:%.*]] = add i32 [[MUL_I]], [[ADD103]]
; CHECK-NEXT:    [[XOR_I:%.*]] = xor i32 [[ADD_I]], [[TMP61]]
; CHECK-NEXT:    [[ADD_I52:%.*]] = add i32 [[MUL_I51]], [[ADD105]]
; CHECK-NEXT:    [[XOR_I53:%.*]] = xor i32 [[ADD_I52]], [[TMP97]]
; CHECK-NEXT:    [[ADD_I57:%.*]] = add i32 [[MUL_I56]], [[SUB104]]
; CHECK-NEXT:    [[XOR_I58:%.*]] = xor i32 [[ADD_I57]], [[TMP150]]
; CHECK-NEXT:    [[ADD110:%.*]] = add i32 [[XOR_I53]], [[XOR_I]]
; CHECK-NEXT:    [[ADD112:%.*]] = add i32 [[ADD110]], [[XOR_I58]]
; CHECK-NEXT:    [[TMP200:%.*]] = shufflevector <2 x i32> [[TMP185]], <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
; CHECK-NEXT:    [[TMP201:%.*]] = insertelement <2 x i32> [[TMP200]], i32 [[SUB102]], i32 1
; CHECK-NEXT:    [[TMP202:%.*]] = add <2 x i32> [[TMP198]], [[TMP201]]
; CHECK-NEXT:    [[TMP203:%.*]] = sub <2 x i32> [[TMP198]], [[TMP201]]
; CHECK-NEXT:    [[TMP204:%.*]] = shufflevector <2 x i32> [[TMP202]], <2 x i32> [[TMP203]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP205:%.*]] = add <2 x i32> [[TMP195]], [[TMP204]]
; CHECK-NEXT:    [[TMP206:%.*]] = xor <2 x i32> [[TMP205]], [[TMP192]]
; CHECK-NEXT:    [[TMP207:%.*]] = extractelement <2 x i32> [[TMP206]], i32 1
; CHECK-NEXT:    [[ADD113:%.*]] = add i32 [[ADD112]], [[TMP207]]
; CHECK-NEXT:    [[TMP208:%.*]] = shufflevector <2 x i32> [[TMP5]], <2 x i32> [[TMP148]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP209:%.*]] = lshr <2 x i32> [[TMP208]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP210:%.*]] = and <2 x i32> [[TMP209]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP211:%.*]] = mul <2 x i32> [[TMP210]], <i32 65535, i32 65535>
; CHECK-NEXT:    [[TMP212:%.*]] = insertelement <2 x i32> poison, i32 [[ADD78_1]], i32 0
; CHECK-NEXT:    [[TMP213:%.*]] = shufflevector <2 x i32> [[TMP212]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP214:%.*]] = insertelement <2 x i32> poison, i32 [[ADD94_1]], i32 0
; CHECK-NEXT:    [[TMP215:%.*]] = shufflevector <2 x i32> [[TMP214]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP216:%.*]] = add <2 x i32> [[TMP213]], [[TMP215]]
; CHECK-NEXT:    [[TMP217:%.*]] = sub <2 x i32> [[TMP213]], [[TMP215]]
; CHECK-NEXT:    [[TMP218:%.*]] = shufflevector <2 x i32> [[TMP216]], <2 x i32> [[TMP217]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP219:%.*]] = add <2 x i32> [[TMP211]], [[TMP218]]
; CHECK-NEXT:    [[TMP220:%.*]] = xor <2 x i32> [[TMP219]], [[TMP208]]
; CHECK-NEXT:    [[TMP221:%.*]] = extractelement <2 x i32> [[TMP206]], i32 0
; CHECK-NEXT:    [[ADD108_1:%.*]] = add i32 [[TMP221]], [[ADD113]]
; CHECK-NEXT:    [[TMP222:%.*]] = extractelement <2 x i32> [[TMP220]], i32 0
; CHECK-NEXT:    [[ADD110_1:%.*]] = add i32 [[ADD108_1]], [[TMP222]]
; CHECK-NEXT:    [[TMP223:%.*]] = extractelement <2 x i32> [[TMP220]], i32 1
; CHECK-NEXT:    [[ADD112_1:%.*]] = add i32 [[ADD110_1]], [[TMP223]]
; CHECK-NEXT:    [[TMP224:%.*]] = shufflevector <2 x i32> [[TMP173]], <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
; CHECK-NEXT:    [[TMP225:%.*]] = shufflevector <2 x i32> [[TMP224]], <2 x i32> [[TMP198]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP226:%.*]] = add <2 x i32> [[TMP185]], [[TMP225]]
; CHECK-NEXT:    [[TMP227:%.*]] = sub <2 x i32> [[TMP185]], [[TMP225]]
; CHECK-NEXT:    [[TMP228:%.*]] = shufflevector <2 x i32> [[TMP226]], <2 x i32> [[TMP227]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP229:%.*]] = add <2 x i32> [[TMP182]], [[TMP228]]
; CHECK-NEXT:    [[TMP230:%.*]] = xor <2 x i32> [[TMP229]], [[TMP179]]
; CHECK-NEXT:    [[TMP231:%.*]] = extractelement <2 x i32> [[TMP230]], i32 1
; CHECK-NEXT:    [[ADD113_1:%.*]] = add i32 [[ADD112_1]], [[TMP231]]
; CHECK-NEXT:    [[TMP232:%.*]] = insertelement <2 x i32> poison, i32 [[ADD94_2]], i32 0
; CHECK-NEXT:    [[TMP233:%.*]] = shufflevector <2 x i32> [[TMP232]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP234:%.*]] = add <2 x i32> [[TMP169]], [[TMP233]]
; CHECK-NEXT:    [[TMP235:%.*]] = sub <2 x i32> [[TMP169]], [[TMP233]]
; CHECK-NEXT:    [[TMP236:%.*]] = shufflevector <2 x i32> [[TMP234]], <2 x i32> [[TMP235]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP237:%.*]] = add <2 x i32> [[TMP160]], [[TMP236]]
; CHECK-NEXT:    [[TMP238:%.*]] = xor <2 x i32> [[TMP237]], [[TMP114]]
; CHECK-NEXT:    [[TMP239:%.*]] = shufflevector <2 x i32> <i32 65535, i32 poison>, <2 x i32> [[TMP185]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP240:%.*]] = mul <2 x i32> [[TMP173]], [[TMP239]]
; CHECK-NEXT:    [[TMP241:%.*]] = sub <2 x i32> [[TMP173]], [[TMP239]]
; CHECK-NEXT:    [[TMP242:%.*]] = shufflevector <2 x i32> [[TMP240]], <2 x i32> [[TMP241]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP243:%.*]] = extractelement <2 x i32> [[TMP242]], i32 0
; CHECK-NEXT:    [[TMP244:%.*]] = extractelement <2 x i32> [[TMP242]], i32 1
; CHECK-NEXT:    [[ADD_I62_2:%.*]] = add i32 [[TMP243]], [[TMP244]]
; CHECK-NEXT:    [[TMP245:%.*]] = extractelement <2 x i32> [[TMP91]], i32 1
; CHECK-NEXT:    [[XOR_I63_2:%.*]] = xor i32 [[ADD_I62_2]], [[TMP245]]
; CHECK-NEXT:    [[TMP246:%.*]] = extractelement <2 x i32> [[TMP230]], i32 0
; CHECK-NEXT:    [[ADD108_2:%.*]] = add i32 [[TMP246]], [[ADD113_1]]
; CHECK-NEXT:    [[TMP247:%.*]] = extractelement <2 x i32> [[TMP238]], i32 0
; CHECK-NEXT:    [[ADD110_2:%.*]] = add i32 [[ADD108_2]], [[TMP247]]
; CHECK-NEXT:    [[TMP248:%.*]] = extractelement <2 x i32> [[TMP238]], i32 1
; CHECK-NEXT:    [[ADD112_2:%.*]] = add i32 [[ADD110_2]], [[TMP248]]
; CHECK-NEXT:    [[ADD113_2:%.*]] = add i32 [[ADD112_2]], [[XOR_I63_2]]
; CHECK-NEXT:    [[TMP249:%.*]] = lshr <2 x i32> [[TMP63]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP250:%.*]] = and <2 x i32> [[TMP249]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP251:%.*]] = mul <2 x i32> [[TMP250]], <i32 65535, i32 65535>
; CHECK-NEXT:    [[TMP252:%.*]] = insertelement <2 x i32> poison, i32 [[CONV33]], i32 0
; CHECK-NEXT:    [[TMP253:%.*]] = shufflevector <2 x i32> [[TMP252]], <2 x i32> [[TMP96]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP254:%.*]] = shufflevector <2 x i32> <i32 15, i32 poison>, <2 x i32> [[TMP107]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP255:%.*]] = lshr <2 x i32> [[TMP253]], [[TMP254]]
; CHECK-NEXT:    [[TMP256:%.*]] = sub <2 x i32> [[TMP253]], [[TMP254]]
; CHECK-NEXT:    [[TMP257:%.*]] = shufflevector <2 x i32> [[TMP255]], <2 x i32> [[TMP256]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP258:%.*]] = extractelement <2 x i32> [[TMP257]], i32 1
; CHECK-NEXT:    [[ADD78_3:%.*]] = add i32 [[SUB59_1]], [[TMP258]]
; CHECK-NEXT:    [[TMP259:%.*]] = insertelement <2 x i32> poison, i32 [[ADD78_3]], i32 0
; CHECK-NEXT:    [[TMP260:%.*]] = shufflevector <2 x i32> [[TMP259]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP261:%.*]] = insertelement <2 x i32> <i32 65537, i32 poison>, i32 [[SUB59_1]], i32 1
; CHECK-NEXT:    [[TMP262:%.*]] = and <2 x i32> [[TMP257]], [[TMP261]]
; CHECK-NEXT:    [[TMP263:%.*]] = sub <2 x i32> [[TMP257]], [[TMP261]]
; CHECK-NEXT:    [[TMP264:%.*]] = shufflevector <2 x i32> [[TMP262]], <2 x i32> [[TMP263]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP265:%.*]] = insertelement <2 x i32> poison, i32 [[CONV]], i32 0
; CHECK-NEXT:    [[TMP266:%.*]] = shufflevector <2 x i32> [[TMP265]], <2 x i32> [[TMP91]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP267:%.*]] = shufflevector <2 x i32> <i32 15, i32 poison>, <2 x i32> [[TMP102]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP268:%.*]] = lshr <2 x i32> [[TMP266]], [[TMP267]]
; CHECK-NEXT:    [[TMP269:%.*]] = sub <2 x i32> [[TMP266]], [[TMP267]]
...
; CHECK-NEXT:    [[ADD94_3:%.*]] = add i32 [[SUB59_3]], [[TMP271]]
; CHECK-NEXT:    [[TMP272:%.*]] = insertelement <2 x i32> <i32 65537, i32 poison>, i32 [[SUB59_3]], i32 1
; CHECK-NEXT:    [[TMP273:%.*]] = and <2 x i32> [[TMP270]], [[TMP272]]
; CHECK-NEXT:    [[TMP274:%.*]] = sub <2 x i32> [[TMP270]], [[TMP272]]
; CHECK-NEXT:    [[TMP275:%.*]] = shufflevector <2 x i32> [[TMP273]], <2 x i32> [[TMP274]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP276:%.*]] = insertelement <2 x i32> poison, i32 [[ADD94_3]], i32 0
; CHECK-NEXT:    [[TMP277:%.*]] = shufflevector <2 x i32> [[TMP276]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP278:%.*]] = add <2 x i32> [[TMP260]], [[TMP277]]
; CHECK-NEXT:    [[TMP279:%.*]] = sub <2 x i32> [[TMP260]], [[TMP277]]
; CHECK-NEXT:    [[TMP280:%.*]] = shufflevector <2 x i32> [[TMP278]], <2 x i32> [[TMP279]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP281:%.*]] = shufflevector <2 x i32> [[TMP264]], <2 x i32> <i32 65535, i32 poison>, <2 x i32> <i32 2, i32 1>
; CHECK-NEXT:    [[TMP282:%.*]] = mul <2 x i32> [[TMP275]], [[TMP281]]
; CHECK-NEXT:    [[TMP283:%.*]] = add <2 x i32> [[TMP275]], [[TMP281]]
; CHECK-NEXT:    [[TMP284:%.*]] = shufflevector <2 x i32> [[TMP282]], <2 x i32> [[TMP283]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP285:%.*]] = extractelement <2 x i32> [[TMP284]], i32 0
; CHECK-NEXT:    [[TMP286:%.*]] = extractelement <2 x i32> [[TMP284]], i32 1
; CHECK-NEXT:    [[ADD_I52_3:%.*]] = add i32 [[TMP285]], [[TMP286]]
; CHECK-NEXT:    [[XOR_I53_3:%.*]] = xor i32 [[ADD_I52_3]], [[CONV]]
; CHECK-NEXT:    [[TMP287:%.*]] = add <2 x i32> [[TMP251]], [[TMP280]]
; CHECK-NEXT:    [[TMP288:%.*]] = xor <2 x i32> [[TMP287]], [[TMP63]]
; CHECK-NEXT:    [[TMP289:%.*]] = shufflevector <2 x i32> <i32 65535, i32 poison>, <2 x i32> [[TMP275]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP290:%.*]] = mul <2 x i32> [[TMP264]], [[TMP289]]
; CHECK-NEXT:    [[TMP291:%.*]] = sub <2 x i32> [[TMP264]], [[TMP289]]
; CHECK-NEXT:    [[TMP292:%.*]] = shufflevector <2 x i32> [[TMP290]], <2 x i32> [[TMP291]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP293:%.*]] = extractelement <2 x i32> [[TMP292]], i32 0
; CHECK-NEXT:    [[TMP294:%.*]] = extractelement <2 x i32> [[TMP292]], i32 1
; CHECK-NEXT:    [[ADD_I62_3:%.*]] = add i32 [[TMP293]], [[TMP294]]
; CHECK-NEXT:    [[XOR_I63_3:%.*]] = xor i32 [[ADD_I62_3]], [[CONV33]]
; CHECK-NEXT:    [[ADD108_3:%.*]] = add i32 [[XOR_I53_3]], [[ADD113_2]]
; CHECK-NEXT:    [[TMP295:%.*]] = extractelement <2 x i32> [[TMP288]], i32 0
; CHECK-NEXT:    [[ADD110_3:%.*]] = add i32 [[ADD108_3]], [[TMP295]]
; CHECK-NEXT:    [[TMP296:%.*]] = extractelement <2 x i32> [[TMP288]], i32 1
; CHECK-NEXT:    [[ADD112_3:%.*]] = add i32 [[ADD110_3]], [[TMP296]]
