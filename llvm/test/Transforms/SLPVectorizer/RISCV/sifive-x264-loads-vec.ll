...
; CHECK-NEXT:    [[TMP39:%.*]] = call <2 x i8> @llvm.riscv.masked.strided.load.v2i8.p0.i64(<2 x i8> poison, ptr align 1 null, i64 4, <2 x i1> <i1 true, i1 true>)
; CHECK-NEXT:    [[TMP40:%.*]] = zext <2 x i8> [[TMP39]] to <2 x i32>
; CHECK-NEXT:    [[TMP41:%.*]] = shufflevector <2 x i32> [[TMP40]], <2 x i32> poison, <2 x i32> <i32 1, i32 0>
; CHECK-NEXT:    [[TMP42:%.*]] = call <2 x i8> @llvm.riscv.masked.strided.load.v2i8.p0.i64(<2 x i8> poison, ptr align 1 [[ARRAYIDX5_3]], i64 2, <2 x i1> <i1 true, i1 true>)
; CHECK-NEXT:    [[TMP43:%.*]] = zext <2 x i8> [[TMP42]] to <2 x i32>
; CHECK-NEXT:    [[TMP44:%.*]] = sub <2 x i32> [[TMP41]], [[TMP43]]
; CHECK-NEXT:    [[TMP45:%.*]] = shl <2 x i32> [[TMP44]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP46:%.*]] = add <2 x i32> [[TMP45]], [[TMP38]]
; CHECK-NEXT:    [[TMP47:%.*]] = call <2 x i8> @llvm.riscv.masked.strided.load.v2i8.p0.i64(<2 x i8> poison, ptr align 1 [[ARRAYIDX8_3]], i64 2, <2 x i1> <i1 true, i1 true>)
; CHECK-NEXT:    [[TMP48:%.*]] = zext <2 x i8> [[TMP47]] to <2 x i32>
; CHECK-NEXT:    [[TMP49:%.*]] = call <2 x i8> @llvm.riscv.masked.strided.load.v2i8.p0.i64(<2 x i8> poison, ptr align 1 [[ARRAYIDX10_3]], i64 2, <2 x i1> <i1 true, i1 true>)
; CHECK-NEXT:    [[TMP50:%.*]] = zext <2 x i8> [[TMP49]] to <2 x i32>
; CHECK-NEXT:    [[TMP51:%.*]] = sub <2 x i32> [[TMP48]], [[TMP50]]
; CHECK-NEXT:    [[TMP52:%.*]] = insertelement <2 x i8> poison, i8 [[TMP32]], i32 0
; CHECK-NEXT:    [[TMP53:%.*]] = insertelement <2 x i8> [[TMP52]], i8 [[TMP33]], i32 1
; CHECK-NEXT:    [[TMP54:%.*]] = zext <2 x i8> [[TMP53]] to <2 x i32>
; CHECK-NEXT:    [[TMP55:%.*]] = call <2 x i8> @llvm.riscv.masked.strided.load.v2i8.p0.i64(<2 x i8> poison, ptr align 1 [[ARRAYIDX15_3]], i64 2, <2 x i1> <i1 true, i1 true>)
; CHECK-NEXT:    [[TMP56:%.*]] = zext <2 x i8> [[TMP55]] to <2 x i32>
; CHECK-NEXT:    [[TMP57:%.*]] = sub <2 x i32> [[TMP54]], [[TMP56]]
; CHECK-NEXT:    [[TMP58:%.*]] = shl <2 x i32> [[TMP57]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP59:%.*]] = add <2 x i32> [[TMP58]], [[TMP51]]
; CHECK-NEXT:    [[TMP60:%.*]] = add <2 x i32> [[TMP59]], [[TMP46]]
; CHECK-NEXT:    [[TMP61:%.*]] = sub <2 x i32> [[TMP46]], [[TMP59]]
; CHECK-NEXT:    [[TMP62:%.*]] = extractelement <2 x i32> [[TMP60]], i32 0
; CHECK-NEXT:    [[TMP63:%.*]] = extractelement <2 x i32> [[TMP60]], i32 1
; CHECK-NEXT:    [[ADD48_3:%.*]] = add i32 [[TMP63]], [[TMP62]]
; CHECK-NEXT:    [[TMP64:%.*]] = extractelement <2 x i32> [[TMP61]], i32 0
; CHECK-NEXT:    [[TMP65:%.*]] = extractelement <2 x i32> [[TMP61]], i32 1
; CHECK-NEXT:    [[TMP66:%.*]] = insertelement <2 x i32> [[TMP61]], i32 [[SUB47_2]], i32 0
; CHECK-NEXT:    [[TMP67:%.*]] = shufflevector <2 x i32> [[TMP61]], <2 x i32> poison, <2 x i32> <i32 poison, i32 0>
; CHECK-NEXT:    [[TMP68:%.*]] = insertelement <2 x i32> [[TMP67]], i32 [[SUB45_2]], i32 0
; CHECK-NEXT:    [[TMP69:%.*]] = add <2 x i32> [[TMP66]], [[TMP68]]
; CHECK-NEXT:    [[SUB59_3:%.*]] = sub i32 [[TMP64]], [[TMP65]]
; CHECK-NEXT:    [[TMP70:%.*]] = extractelement <2 x i32> [[TMP35]], i32 0
; CHECK-NEXT:    [[SHR_I:%.*]] = lshr i32 [[TMP70]], 15
; CHECK-NEXT:    [[AND_I:%.*]] = and i32 [[SHR_I]], 65537
; CHECK-NEXT:    [[MUL_I:%.*]] = mul i32 [[AND_I]], 65535
; CHECK-NEXT:    [[TMP71:%.*]] = extractelement <2 x i32> [[TMP69]], i32 0
; CHECK-NEXT:    [[TMP72:%.*]] = extractelement <2 x i32> [[TMP69]], i32 1
; CHECK-NEXT:    [[ADD94_1:%.*]] = add i32 [[TMP72]], [[TMP71]]
; CHECK-NEXT:    [[SUB102_1:%.*]] = sub i32 [[TMP71]], [[TMP72]]
; CHECK-NEXT:    [[TMP73:%.*]] = extractelement <2 x i32> [[TMP5]], i32 0
; CHECK-NEXT:    [[SHR_I49_1:%.*]] = lshr i32 [[TMP73]], 15
; CHECK-NEXT:    [[AND_I50_1:%.*]] = and i32 [[SHR_I49_1]], 65537
; CHECK-NEXT:    [[MUL_I51_1:%.*]] = mul i32 [[AND_I50_1]], 65535
; CHECK-NEXT:    [[TMP74:%.*]] = load <2 x i8>, ptr [[ARRAYIDX8]], align 1
; CHECK-NEXT:    [[TMP75:%.*]] = zext <2 x i8> [[TMP74]] to <2 x i32>
; CHECK-NEXT:    [[TMP76:%.*]] = load <2 x i8>, ptr [[PIX2]], align 1
; CHECK-NEXT:    [[TMP77:%.*]] = zext <2 x i8> [[TMP76]] to <2 x i32>
; CHECK-NEXT:    [[TMP78:%.*]] = load <2 x i8>, ptr [[ARRAYIDX3]], align 1
; CHECK-NEXT:    [[TMP79:%.*]] = zext <2 x i8> [[TMP78]] to <2 x i32>
; CHECK-NEXT:    [[TMP80:%.*]] = load <2 x i8>, ptr [[ARRAYIDX5]], align 1
...
; CHECK-NEXT:    [[TMP84:%.*]] = shufflevector <2 x i32> [[TMP75]], <2 x i32> poison, <2 x i32> <i32 1, i32 0>
; CHECK-NEXT:    [[TMP85:%.*]] = insertelement <2 x i32> [[TMP84]], i32 [[CONV]], i32 0
; CHECK-NEXT:    [[TMP86:%.*]] = sub <2 x i32> [[TMP85]], [[TMP77]]
; CHECK-NEXT:    [[TMP87:%.*]] = add <2 x i32> [[TMP83]], [[TMP86]]
; CHECK-NEXT:    [[TMP88:%.*]] = load <2 x i8>, ptr [[ARRAYIDX22]], align 1
; CHECK-NEXT:    [[TMP89:%.*]] = zext <2 x i8> [[TMP88]] to <2 x i32>
; CHECK-NEXT:    [[TMP90:%.*]] = load <2 x i8>, ptr [[ARRAYIDX25]], align 1
; CHECK-NEXT:    [[TMP91:%.*]] = zext <2 x i8> [[TMP90]] to <2 x i32>
; CHECK-NEXT:    [[TMP92:%.*]] = load <2 x i8>, ptr [[ARRAYIDX27]], align 1
; CHECK-NEXT:    [[TMP93:%.*]] = zext <2 x i8> [[TMP92]] to <2 x i32>
; CHECK-NEXT:    [[TMP94:%.*]] = sub <2 x i32> [[TMP91]], [[TMP93]]
; CHECK-NEXT:    [[TMP95:%.*]] = shl <2 x i32> [[TMP94]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP96:%.*]] = insertelement <2 x i32> [[TMP84]], i32 [[CONV33]], i32 1
; CHECK-NEXT:    [[TMP97:%.*]] = sub <2 x i32> [[TMP96]], [[TMP89]]
; CHECK-NEXT:    [[TMP98:%.*]] = add <2 x i32> [[TMP95]], [[TMP97]]
; CHECK-NEXT:    [[TMP99:%.*]] = extractelement <2 x i32> [[TMP87]], i32 0
; CHECK-NEXT:    [[TMP100:%.*]] = extractelement <2 x i32> [[TMP87]], i32 1
; CHECK-NEXT:    [[ADD44:%.*]] = add i32 [[TMP100]], [[TMP99]]
; CHECK-NEXT:    [[TMP101:%.*]] = shufflevector <2 x i32> [[TMP27]], <2 x i32> [[TMP87]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP102:%.*]] = shufflevector <2 x i32> [[TMP27]], <2 x i32> [[TMP87]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP103:%.*]] = add <2 x i32> [[TMP101]], [[TMP102]]
; CHECK-NEXT:    [[TMP104:%.*]] = sub <2 x i32> [[TMP101]], [[TMP102]]
; CHECK-NEXT:    [[TMP105:%.*]] = shufflevector <2 x i32> [[TMP103]], <2 x i32> [[TMP104]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP106:%.*]] = extractelement <2 x i32> [[TMP105]], i32 0
; CHECK-NEXT:    [[SHR_I49:%.*]] = lshr i32 [[TMP106]], 15
; CHECK-NEXT:    [[AND_I50:%.*]] = and i32 [[SHR_I49]], 65537
; CHECK-NEXT:    [[MUL_I51:%.*]] = mul i32 [[AND_I50]], 65535
; CHECK-NEXT:    [[TMP107:%.*]] = extractelement <2 x i32> [[TMP98]], i32 0
; CHECK-NEXT:    [[TMP108:%.*]] = extractelement <2 x i32> [[TMP98]], i32 1
; CHECK-NEXT:    [[ADD46:%.*]] = add i32 [[TMP108]], [[TMP107]]
; CHECK-NEXT:    [[TMP109:%.*]] = shufflevector <2 x i32> [[TMP15]], <2 x i32> [[TMP98]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP110:%.*]] = shufflevector <2 x i32> [[TMP15]], <2 x i32> [[TMP98]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP111:%.*]] = add <2 x i32> [[TMP109]], [[TMP110]]
; CHECK-NEXT:    [[TMP112:%.*]] = sub <2 x i32> [[TMP109]], [[TMP110]]
; CHECK-NEXT:    [[TMP113:%.*]] = shufflevector <2 x i32> [[TMP111]], <2 x i32> [[TMP112]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP114:%.*]] = extractelement <2 x i32> [[TMP113]], i32 0
; CHECK-NEXT:    [[ADD48_2:%.*]] = add i32 [[TMP106]], [[TMP114]]
...
; CHECK-NEXT:    [[TMP115:%.*]] = load <2 x i8>, ptr [[ARRAYIDX8_1]], align 1
; CHECK-NEXT:    [[TMP116:%.*]] = zext <2 x i8> [[TMP115]] to <2 x i32>
; CHECK-NEXT:    [[TMP117:%.*]] = call <2 x i8> @llvm.riscv.masked.strided.load.v2i8.p0.i64(<2 x i8> poison, ptr align 1 [[ADD_PTR644]], i64 2, <2 x i1> <i1 true, i1 true>)
; CHECK-NEXT:    [[TMP118:%.*]] = zext <2 x i8> [[TMP117]] to <2 x i32>
; CHECK-NEXT:    [[TMP119:%.*]] = call <2 x i8> @llvm.riscv.masked.strided.load.v2i8.p0.i64(<2 x i8> poison, ptr align 1 [[ARRAYIDX3_1]], i64 2, <2 x i1> <i1 true, i1 true>)
; CHECK-NEXT:    [[TMP120:%.*]] = zext <2 x i8> [[TMP119]] to <2 x i32>
; CHECK-NEXT:    [[TMP121:%.*]] = call <2 x i8> @llvm.riscv.masked.strided.load.v2i8.p0.i64(<2 x i8> poison, ptr align 1 [[ARRAYIDX5_1]], i64 2, <2 x i1> <i1 true, i1 true>)
...
; CHECK-NEXT:    [[TMP125:%.*]] = call <2 x i8> @llvm.riscv.masked.strided.load.v2i8.p0.i64(<2 x i8> poison, ptr align 1 [[ARRAYIDX10_1]], i64 2, <2 x i1> <i1 true, i1 true>)
; CHECK-NEXT:    [[TMP126:%.*]] = zext <2 x i8> [[TMP125]] to <2 x i32>
; CHECK-NEXT:    [[TMP127:%.*]] = call <2 x i8> @llvm.riscv.masked.strided.load.v2i8.p0.i64(<2 x i8> poison, ptr align 1 [[ARRAYIDX13_1]], i64 2, <2 x i1> <i1 true, i1 true>)
; CHECK-NEXT:    [[TMP128:%.*]] = zext <2 x i8> [[TMP127]] to <2 x i32>
; CHECK-NEXT:    [[TMP129:%.*]] = call <2 x i8> @llvm.riscv.masked.strided.load.v2i8.p0.i64(<2 x i8> poison, ptr align 1 [[ARRAYIDX15_1]], i64 2, <2 x i1> <i1 true, i1 true>)
...
; CHECK-NEXT:    [[TMP133:%.*]] = insertelement <2 x i32> [[TMP116]], i32 [[CONV33_1]], i32 1
; CHECK-NEXT:    [[TMP134:%.*]] = sub <2 x i32> [[TMP133]], [[TMP126]]
; CHECK-NEXT:    [[TMP135:%.*]] = add <2 x i32> [[TMP132]], [[TMP134]]
; CHECK-NEXT:    [[TMP136:%.*]] = insertelement <2 x i32> [[TMP116]], i32 [[CONV_1]], i32 0
; CHECK-NEXT:    [[TMP137:%.*]] = sub <2 x i32> [[TMP136]], [[TMP118]]
; CHECK-NEXT:    [[TMP138:%.*]] = add <2 x i32> [[TMP124]], [[TMP137]]
; CHECK-NEXT:    [[TMP139:%.*]] = add <2 x i32> [[TMP135]], [[TMP138]]
; CHECK-NEXT:    [[TMP140:%.*]] = sub <2 x i32> [[TMP138]], [[TMP135]]
; CHECK-NEXT:    [[TMP141:%.*]] = extractelement <2 x i32> [[TMP139]], i32 0
; CHECK-NEXT:    [[TMP142:%.*]] = extractelement <2 x i32> [[TMP139]], i32 1
; CHECK-NEXT:    [[ADD48_1:%.*]] = add i32 [[TMP142]], [[TMP141]]
; CHECK-NEXT:    [[SUB51_1:%.*]] = sub i32 [[TMP141]], [[TMP142]]
; CHECK-NEXT:    [[TMP143:%.*]] = shufflevector <2 x i32> [[TMP60]], <2 x i32> [[TMP140]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP144:%.*]] = shufflevector <2 x i32> [[TMP60]], <2 x i32> [[TMP140]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP145:%.*]] = sub <2 x i32> [[TMP143]], [[TMP144]]
; CHECK-NEXT:    [[TMP146:%.*]] = add <2 x i32> [[TMP143]], [[TMP144]]
; CHECK-NEXT:    [[TMP147:%.*]] = shufflevector <2 x i32> [[TMP145]], <2 x i32> [[TMP146]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP148:%.*]] = extractelement <2 x i32> [[TMP140]], i32 0
; CHECK-NEXT:    [[TMP149:%.*]] = extractelement <2 x i32> [[TMP140]], i32 1
; CHECK-NEXT:    [[SUB59_1:%.*]] = sub i32 [[TMP148]], [[TMP149]]
; CHECK-NEXT:    [[SHR_I54:%.*]] = lshr i32 [[TMP142]], 15
; CHECK-NEXT:    [[AND_I55:%.*]] = and i32 [[SHR_I54]], 65537
; CHECK-NEXT:    [[MUL_I56:%.*]] = mul i32 [[AND_I55]], 65535
; CHECK-NEXT:    [[TMP150:%.*]] = lshr <2 x i32> [[TMP116]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP151:%.*]] = and <2 x i32> [[TMP150]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP152:%.*]] = mul <2 x i32> [[TMP151]], <i32 65535, i32 65535>
...
; CHECK-NEXT:    [[XOR_I:%.*]] = xor i32 [[ADD_I]], [[TMP70]]
; CHECK-NEXT:    [[ADD_I52:%.*]] = add i32 [[MUL_I51]], [[ADD105]]
; CHECK-NEXT:    [[XOR_I53:%.*]] = xor i32 [[ADD_I52]], [[TMP106]]
...
; CHECK-NEXT:    [[TMP153:%.*]] = insertelement <2 x i32> poison, i32 [[ADD44]], i32 0
; CHECK-NEXT:    [[TMP154:%.*]] = shufflevector <2 x i32> [[TMP153]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP155:%.*]] = insertelement <2 x i32> <i32 15, i32 poison>, i32 [[ADD46]], i32 1
; CHECK-NEXT:    [[TMP156:%.*]] = lshr <2 x i32> [[TMP154]], [[TMP155]]
; CHECK-NEXT:    [[TMP157:%.*]] = sub <2 x i32> [[TMP154]], [[TMP155]]
; CHECK-NEXT:    [[TMP158:%.*]] = shufflevector <2 x i32> [[TMP156]], <2 x i32> [[TMP157]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP159:%.*]] = extractelement <2 x i32> [[TMP158]], i32 1
; CHECK-NEXT:    [[ADD78_2:%.*]] = add i32 [[SUB51_1]], [[TMP159]]
; CHECK-NEXT:    [[TMP160:%.*]] = insertelement <2 x i32> poison, i32 [[ADD78_2]], i32 0
; CHECK-NEXT:    [[TMP161:%.*]] = shufflevector <2 x i32> [[TMP160]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP162:%.*]] = insertelement <2 x i32> <i32 65537, i32 poison>, i32 [[SUB51_1]], i32 1
; CHECK-NEXT:    [[TMP163:%.*]] = and <2 x i32> [[TMP158]], [[TMP162]]
; CHECK-NEXT:    [[TMP164:%.*]] = sub <2 x i32> [[TMP158]], [[TMP162]]
; CHECK-NEXT:    [[TMP165:%.*]] = shufflevector <2 x i32> [[TMP163]], <2 x i32> [[TMP164]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP166:%.*]] = sub <2 x i32> [[TMP113]], [[TMP105]]
; CHECK-NEXT:    [[TMP167:%.*]] = add <2 x i32> [[TMP113]], [[TMP105]]
; CHECK-NEXT:    [[TMP168:%.*]] = shufflevector <2 x i32> [[TMP166]], <2 x i32> [[TMP167]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP169:%.*]] = extractelement <2 x i32> [[TMP168]], i32 0
; CHECK-NEXT:    [[TMP170:%.*]] = extractelement <2 x i32> [[TMP147]], i32 0
; CHECK-NEXT:    [[ADD94_2:%.*]] = add i32 [[TMP170]], [[TMP169]]
; CHECK-NEXT:    [[TMP171:%.*]] = insertelement <2 x i32> [[TMP113]], i32 [[CONV_1]], i32 0
; CHECK-NEXT:    [[TMP172:%.*]] = lshr <2 x i32> [[TMP171]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP173:%.*]] = and <2 x i32> [[TMP172]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP174:%.*]] = mul <2 x i32> [[TMP173]], <i32 65535, i32 65535>
; CHECK-NEXT:    [[TMP175:%.*]] = extractelement <2 x i32> [[TMP168]], i32 1
; CHECK-NEXT:    [[TMP176:%.*]] = extractelement <2 x i32> [[TMP147]], i32 1
; CHECK-NEXT:    [[ADD78_1:%.*]] = add i32 [[TMP176]], [[TMP175]]
; CHECK-NEXT:    [[TMP177:%.*]] = sub <2 x i32> [[TMP168]], [[TMP147]]
; CHECK-NEXT:    [[TMP178:%.*]] = extractelement <2 x i32> [[TMP177]], i32 1
; CHECK-NEXT:    [[ADD105_1:%.*]] = add i32 [[SUB102_1]], [[TMP178]]
; CHECK-NEXT:    [[ADD_I52_1:%.*]] = add i32 [[MUL_I51_1]], [[ADD105_1]]
; CHECK-NEXT:    [[XOR_I53_1:%.*]] = xor i32 [[ADD_I52_1]], [[TMP73]]
; CHECK-NEXT:    [[TMP179:%.*]] = shufflevector <2 x i32> [[TMP5]], <2 x i32> [[TMP140]], <2 x i32> <i32 1, i32 3>
...
; CHECK-NEXT:    [[TMP183:%.*]] = insertelement <2 x i32> poison, i32 [[ADD78_1]], i32 0
; CHECK-NEXT:    [[TMP184:%.*]] = shufflevector <2 x i32> [[TMP183]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP185:%.*]] = insertelement <2 x i32> poison, i32 [[ADD94_1]], i32 0
; CHECK-NEXT:    [[TMP186:%.*]] = shufflevector <2 x i32> [[TMP185]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP187:%.*]] = add <2 x i32> [[TMP184]], [[TMP186]]
; CHECK-NEXT:    [[TMP188:%.*]] = sub <2 x i32> [[TMP184]], [[TMP186]]
; CHECK-NEXT:    [[TMP189:%.*]] = shufflevector <2 x i32> [[TMP187]], <2 x i32> [[TMP188]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP190:%.*]] = add <2 x i32> [[TMP182]], [[TMP189]]
; CHECK-NEXT:    [[TMP191:%.*]] = xor <2 x i32> [[TMP190]], [[TMP179]]
; CHECK-NEXT:    [[ADD108_1:%.*]] = add i32 [[XOR_I53_1]], [[ADD113]]
; CHECK-NEXT:    [[TMP192:%.*]] = extractelement <2 x i32> [[TMP191]], i32 0
; CHECK-NEXT:    [[ADD110_1:%.*]] = add i32 [[ADD108_1]], [[TMP192]]
; CHECK-NEXT:    [[TMP193:%.*]] = extractelement <2 x i32> [[TMP191]], i32 1
; CHECK-NEXT:    [[ADD112_1:%.*]] = add i32 [[ADD110_1]], [[TMP193]]
; CHECK-NEXT:    [[TMP194:%.*]] = shufflevector <2 x i32> [[TMP165]], <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
; CHECK-NEXT:    [[TMP195:%.*]] = insertelement <2 x i32> [[TMP194]], i32 [[SUB102_1]], i32 1
; CHECK-NEXT:    [[TMP196:%.*]] = add <2 x i32> [[TMP177]], [[TMP195]]
; CHECK-NEXT:    [[TMP197:%.*]] = sub <2 x i32> [[TMP177]], [[TMP195]]
; CHECK-NEXT:    [[TMP198:%.*]] = shufflevector <2 x i32> [[TMP196]], <2 x i32> [[TMP197]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP199:%.*]] = add <2 x i32> [[TMP174]], [[TMP198]]
; CHECK-NEXT:    [[TMP200:%.*]] = xor <2 x i32> [[TMP199]], [[TMP171]]
; CHECK-NEXT:    [[TMP201:%.*]] = extractelement <2 x i32> [[TMP200]], i32 1
; CHECK-NEXT:    [[ADD113_1:%.*]] = add i32 [[ADD112_1]], [[TMP201]]
; CHECK-NEXT:    [[TMP202:%.*]] = insertelement <2 x i32> poison, i32 [[ADD94_2]], i32 0
; CHECK-NEXT:    [[TMP203:%.*]] = shufflevector <2 x i32> [[TMP202]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP204:%.*]] = add <2 x i32> [[TMP161]], [[TMP203]]
; CHECK-NEXT:    [[TMP205:%.*]] = sub <2 x i32> [[TMP161]], [[TMP203]]
; CHECK-NEXT:    [[TMP206:%.*]] = shufflevector <2 x i32> [[TMP204]], <2 x i32> [[TMP205]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP207:%.*]] = add <2 x i32> [[TMP152]], [[TMP206]]
; CHECK-NEXT:    [[TMP208:%.*]] = xor <2 x i32> [[TMP207]], [[TMP116]]
; CHECK-NEXT:    [[TMP209:%.*]] = shufflevector <2 x i32> <i32 65535, i32 poison>, <2 x i32> [[TMP177]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP210:%.*]] = mul <2 x i32> [[TMP165]], [[TMP209]]
; CHECK-NEXT:    [[TMP211:%.*]] = sub <2 x i32> [[TMP165]], [[TMP209]]
; CHECK-NEXT:    [[TMP212:%.*]] = shufflevector <2 x i32> [[TMP210]], <2 x i32> [[TMP211]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP213:%.*]] = extractelement <2 x i32> [[TMP212]], i32 0
; CHECK-NEXT:    [[TMP214:%.*]] = extractelement <2 x i32> [[TMP212]], i32 1
; CHECK-NEXT:    [[ADD_I62_2:%.*]] = add i32 [[TMP213]], [[TMP214]]
; CHECK-NEXT:    [[XOR_I63_2:%.*]] = xor i32 [[ADD_I62_2]], [[ADD44]]
; CHECK-NEXT:    [[TMP215:%.*]] = extractelement <2 x i32> [[TMP200]], i32 0
; CHECK-NEXT:    [[ADD108_2:%.*]] = add i32 [[TMP215]], [[ADD113_1]]
; CHECK-NEXT:    [[TMP216:%.*]] = extractelement <2 x i32> [[TMP208]], i32 0
; CHECK-NEXT:    [[ADD110_2:%.*]] = add i32 [[ADD108_2]], [[TMP216]]
; CHECK-NEXT:    [[TMP217:%.*]] = extractelement <2 x i32> [[TMP208]], i32 1
; CHECK-NEXT:    [[ADD112_2:%.*]] = add i32 [[ADD110_2]], [[TMP217]]
; CHECK-NEXT:    [[ADD113_2:%.*]] = add i32 [[ADD112_2]], [[XOR_I63_2]]
; CHECK-NEXT:    [[TMP218:%.*]] = lshr <2 x i32> [[TMP75]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP219:%.*]] = and <2 x i32> [[TMP218]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP220:%.*]] = mul <2 x i32> [[TMP219]], <i32 65535, i32 65535>
; CHECK-NEXT:    [[TMP221:%.*]] = insertelement <2 x i32> poison, i32 [[CONV33]], i32 0
; CHECK-NEXT:    [[TMP222:%.*]] = shufflevector <2 x i32> [[TMP221]], <2 x i32> [[TMP105]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP223:%.*]] = shufflevector <2 x i32> <i32 15, i32 poison>, <2 x i32> [[TMP113]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP224:%.*]] = lshr <2 x i32> [[TMP222]], [[TMP223]]
; CHECK-NEXT:    [[TMP225:%.*]] = sub <2 x i32> [[TMP222]], [[TMP223]]
; CHECK-NEXT:    [[TMP226:%.*]] = shufflevector <2 x i32> [[TMP224]], <2 x i32> [[TMP225]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP227:%.*]] = extractelement <2 x i32> [[TMP226]], i32 1
; CHECK-NEXT:    [[ADD78_3:%.*]] = add i32 [[SUB59_1]], [[TMP227]]
; CHECK-NEXT:    [[TMP228:%.*]] = insertelement <2 x i32> poison, i32 [[ADD78_3]], i32 0
; CHECK-NEXT:    [[TMP229:%.*]] = shufflevector <2 x i32> [[TMP228]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP230:%.*]] = insertelement <2 x i32> <i32 65537, i32 poison>, i32 [[SUB59_1]], i32 1
; CHECK-NEXT:    [[TMP231:%.*]] = and <2 x i32> [[TMP226]], [[TMP230]]
; CHECK-NEXT:    [[TMP232:%.*]] = sub <2 x i32> [[TMP226]], [[TMP230]]
; CHECK-NEXT:    [[TMP233:%.*]] = shufflevector <2 x i32> [[TMP231]], <2 x i32> [[TMP232]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP234:%.*]] = insertelement <2 x i32> poison, i32 [[CONV]], i32 0
; CHECK-NEXT:    [[TMP235:%.*]] = insertelement <2 x i32> [[TMP234]], i32 [[SUB45_2]], i32 1
; CHECK-NEXT:    [[TMP236:%.*]] = insertelement <2 x i32> <i32 15, i32 poison>, i32 [[SUB47_2]], i32 1
; CHECK-NEXT:    [[TMP237:%.*]] = lshr <2 x i32> [[TMP235]], [[TMP236]]
; CHECK-NEXT:    [[TMP238:%.*]] = sub <2 x i32> [[TMP235]], [[TMP236]]
; CHECK-NEXT:    [[TMP239:%.*]] = shufflevector <2 x i32> [[TMP237]], <2 x i32> [[TMP238]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP240:%.*]] = extractelement <2 x i32> [[TMP239]], i32 1
; CHECK-NEXT:    [[ADD94_3:%.*]] = add i32 [[SUB59_3]], [[TMP240]]
; CHECK-NEXT:    [[TMP241:%.*]] = insertelement <2 x i32> <i32 65537, i32 poison>, i32 [[SUB59_3]], i32 1
; CHECK-NEXT:    [[TMP242:%.*]] = and <2 x i32> [[TMP239]], [[TMP241]]
; CHECK-NEXT:    [[TMP243:%.*]] = sub <2 x i32> [[TMP239]], [[TMP241]]
; CHECK-NEXT:    [[TMP244:%.*]] = shufflevector <2 x i32> [[TMP242]], <2 x i32> [[TMP243]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP245:%.*]] = insertelement <2 x i32> poison, i32 [[ADD94_3]], i32 0
; CHECK-NEXT:    [[TMP246:%.*]] = shufflevector <2 x i32> [[TMP245]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP247:%.*]] = add <2 x i32> [[TMP229]], [[TMP246]]
; CHECK-NEXT:    [[TMP248:%.*]] = sub <2 x i32> [[TMP229]], [[TMP246]]
; CHECK-NEXT:    [[TMP249:%.*]] = shufflevector <2 x i32> [[TMP247]], <2 x i32> [[TMP248]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP250:%.*]] = shufflevector <2 x i32> [[TMP233]], <2 x i32> <i32 65535, i32 poison>, <2 x i32> <i32 2, i32 1>
; CHECK-NEXT:    [[TMP251:%.*]] = mul <2 x i32> [[TMP244]], [[TMP250]]
; CHECK-NEXT:    [[TMP252:%.*]] = add <2 x i32> [[TMP244]], [[TMP250]]
; CHECK-NEXT:    [[TMP253:%.*]] = shufflevector <2 x i32> [[TMP251]], <2 x i32> [[TMP252]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP254:%.*]] = extractelement <2 x i32> [[TMP253]], i32 0
; CHECK-NEXT:    [[TMP255:%.*]] = extractelement <2 x i32> [[TMP253]], i32 1
; CHECK-NEXT:    [[ADD_I52_3:%.*]] = add i32 [[TMP254]], [[TMP255]]
; CHECK-NEXT:    [[XOR_I53_3:%.*]] = xor i32 [[ADD_I52_3]], [[CONV]]
; CHECK-NEXT:    [[TMP256:%.*]] = add <2 x i32> [[TMP220]], [[TMP249]]
; CHECK-NEXT:    [[TMP257:%.*]] = xor <2 x i32> [[TMP256]], [[TMP75]]
; CHECK-NEXT:    [[TMP258:%.*]] = shufflevector <2 x i32> <i32 65535, i32 poison>, <2 x i32> [[TMP244]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP259:%.*]] = mul <2 x i32> [[TMP233]], [[TMP258]]
; CHECK-NEXT:    [[TMP260:%.*]] = sub <2 x i32> [[TMP233]], [[TMP258]]
; CHECK-NEXT:    [[TMP261:%.*]] = shufflevector <2 x i32> [[TMP259]], <2 x i32> [[TMP260]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP262:%.*]] = extractelement <2 x i32> [[TMP261]], i32 0
; CHECK-NEXT:    [[TMP263:%.*]] = extractelement <2 x i32> [[TMP261]], i32 1
; CHECK-NEXT:    [[ADD_I62_3:%.*]] = add i32 [[TMP262]], [[TMP263]]
; CHECK-NEXT:    [[XOR_I63_3:%.*]] = xor i32 [[ADD_I62_3]], [[CONV33]]
; CHECK-NEXT:    [[ADD108_3:%.*]] = add i32 [[XOR_I53_3]], [[ADD113_2]]
; CHECK-NEXT:    [[TMP264:%.*]] = extractelement <2 x i32> [[TMP257]], i32 0
; CHECK-NEXT:    [[ADD110_3:%.*]] = add i32 [[ADD108_3]], [[TMP264]]
; CHECK-NEXT:    [[TMP265:%.*]] = extractelement <2 x i32> [[TMP257]], i32 1
; CHECK-NEXT:    [[ADD112_3:%.*]] = add i32 [[ADD110_3]], [[TMP265]]
