...
; CHECK-NEXT:    [[TMP15:%.*]] = zext <2 x i8> [[TMP16]] to <2 x i32>
; CHECK-NEXT:    [[TMP18:%.*]] = load <2 x i8>, ptr [[ARRAYIDX22_2]], align 1
; CHECK-NEXT:    [[TMP17:%.*]] = zext <2 x i8> [[TMP18]] to <2 x i32>
; CHECK-NEXT:    [[TMP24:%.*]] = sub <2 x i32> [[TMP15]], [[TMP17]]
; CHECK-NEXT:    [[TMP21:%.*]] = load <2 x i8>, ptr [[ARRAYIDX25_2]], align 1
; CHECK-NEXT:    [[TMP20:%.*]] = zext <2 x i8> [[TMP21]] to <2 x i32>
; CHECK-NEXT:    [[TMP23:%.*]] = load <2 x i8>, ptr [[ARRAYIDX27_2]], align 1
; CHECK-NEXT:    [[TMP22:%.*]] = zext <2 x i8> [[TMP23]] to <2 x i32>
; CHECK-NEXT:    [[TMP25:%.*]] = sub <2 x i32> [[TMP20]], [[TMP22]]
; CHECK-NEXT:    [[TMP26:%.*]] = shl <2 x i32> [[TMP25]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP294:%.*]] = add <2 x i32> [[TMP26]], [[TMP24]]
...
; CHECK-NEXT:    [[TMP29:%.*]] = sub <2 x i32> [[TMP27]], [[TMP295]]
...
; CHECK-NEXT:    [[TMP33:%.*]] = extractelement <2 x i32> [[TMP29]], i32 1
...
; CHECK-NEXT:    [[TMP64:%.*]] = sub <2 x i32> [[TMP62]], [[TMP61]]
...
; CHECK-NEXT:    [[TMP70:%.*]] = shufflevector <2 x i32> [[TMP64]], <2 x i32> [[TMP29]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP71:%.*]] = shufflevector <2 x i32> [[TMP64]], <2 x i32> [[TMP29]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP72:%.*]] = add <2 x i32> [[TMP70]], [[TMP71]]
; CHECK-NEXT:    [[TMP73:%.*]] = extractelement <2 x i32> [[TMP64]], i32 0
; CHECK-NEXT:    [[TMP74:%.*]] = extractelement <2 x i32> [[TMP64]], i32 1
; CHECK-NEXT:    [[SUB59_3:%.*]] = sub i32 [[TMP73]], [[TMP74]]
; CHECK-NEXT:    [[TMP75:%.*]] = extractelement <2 x i32> [[TMP72]], i32 0
; CHECK-NEXT:    [[TMP76:%.*]] = extractelement <2 x i32> [[TMP72]], i32 1
; CHECK-NEXT:    [[ADD94_1:%.*]] = add i32 [[TMP75]], [[TMP76]]
; CHECK-NEXT:    [[TMP77:%.*]] = extractelement <2 x i32> [[TMP5]], i32 1
; CHECK-NEXT:    [[SHR_I_1:%.*]] = lshr i32 [[TMP77]], 15
; CHECK-NEXT:    [[AND_I_1:%.*]] = and i32 [[SHR_I_1]], 65537
; CHECK-NEXT:    [[MUL_I_1:%.*]] = mul i32 [[AND_I_1]], 65535
; CHECK-NEXT:    [[TMP78:%.*]] = extractelement <2 x i32> [[TMP5]], i32 0
...
; CHECK-NEXT:    [[TMP81:%.*]] = load <2 x i8>, ptr [[ARRAYIDX20]], align 1
...
; CHECK-NEXT:    [[TMP85:%.*]] = load <2 x i8>, ptr [[ARRAYIDX25]], align 1
; CHECK-NEXT:    [[TMP86:%.*]] = zext <2 x i8> [[TMP85]] to <2 x i32>
; CHECK-NEXT:    [[TMP87:%.*]] = load <2 x i8>, ptr [[ARRAYIDX27]], align 1
; CHECK-NEXT:    [[TMP88:%.*]] = zext <2 x i8> [[TMP87]] to <2 x i32>
; CHECK-NEXT:    [[TMP89:%.*]] = sub <2 x i32> [[TMP86]], [[TMP88]]
; CHECK-NEXT:    [[TMP90:%.*]] = shl <2 x i32> [[TMP89]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP91:%.*]] = sub <2 x i32> [[TMP82]], [[TMP84]]
...
; CHECK-NEXT:    [[TMP105:%.*]] = zext <2 x i8> [[TMP104]] to <2 x i32>
; CHECK-NEXT:    [[TMP106:%.*]] = load <2 x i8>, ptr [[ARRAYIDX5]], align 1
; CHECK-NEXT:    [[TMP107:%.*]] = zext <2 x i8> [[TMP106]] to <2 x i32>
; CHECK-NEXT:    [[TMP108:%.*]] = sub <2 x i32> [[TMP105]], [[TMP107]]
; CHECK-NEXT:    [[TMP109:%.*]] = shl <2 x i32> [[TMP108]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP110:%.*]] = sub <2 x i32> [[TMP101]], [[TMP103]]
; CHECK-NEXT:    [[TMP111:%.*]] = add <2 x i32> [[TMP109]], [[TMP110]]
...
; CHECK-NEXT:    [[TMP115:%.*]] = sub <2 x i32> [[TMP113]], [[TMP112]]
...
; CHECK-NEXT:    [[TMP120:%.*]] = extractelement <2 x i32> [[TMP114]], i32 1
; CHECK-NEXT:    [[ADD48:%.*]] = add i32 [[TMP120]], [[TMP119]]
...
; CHECK-NEXT:    [[TMP125:%.*]] = load <2 x i8>, ptr [[ADD_PTR644]], align 1
; CHECK-NEXT:    [[TMP126:%.*]] = zext <2 x i8> [[TMP125]] to <2 x i32>
; CHECK-NEXT:    [[TMP127:%.*]] = load <2 x i8>, ptr [[ARRAYIDX3_1]], align 1
; CHECK-NEXT:    [[TMP128:%.*]] = zext <2 x i8> [[TMP127]] to <2 x i32>
; CHECK-NEXT:    [[TMP129:%.*]] = load <2 x i8>, ptr [[ARRAYIDX5_1]], align 1
...
; CHECK-NEXT:    [[TMP135:%.*]] = sub <2 x i32> [[TMP134]], [[TMP126]]
; CHECK-NEXT:    [[TMP136:%.*]] = add <2 x i32> [[TMP132]], [[TMP135]]
; CHECK-NEXT:    [[TMP137:%.*]] = load <2 x i8>, ptr [[ARRAYIDX22_1]], align 1
...
; CHECK-NEXT:    [[TMP146:%.*]] = sub <2 x i32> [[TMP145]], [[TMP138]]
; CHECK-NEXT:    [[TMP147:%.*]] = add <2 x i32> [[TMP144]], [[TMP146]]
...
; CHECK-NEXT:    [[TMP151:%.*]] = sub <2 x i32> [[TMP149]], [[TMP148]]
; CHECK-NEXT:    [[TMP152:%.*]] = extractelement <2 x i32> [[TMP150]], i32 0
; CHECK-NEXT:    [[TMP153:%.*]] = extractelement <2 x i32> [[TMP150]], i32 1
; CHECK-NEXT:    [[ADD48_1:%.*]] = add i32 [[TMP153]], [[TMP152]]
; CHECK-NEXT:    [[TMP154:%.*]] = insertelement <2 x i32> poison, i32 [[AND_I50_1]], i32 0
; CHECK-NEXT:    [[TMP155:%.*]] = shufflevector <2 x i32> [[TMP154]], <2 x i32> [[TMP151]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP156:%.*]] = shufflevector <2 x i32> <i32 65535, i32 poison>, <2 x i32> [[TMP151]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP157:%.*]] = mul <2 x i32> [[TMP155]], [[TMP156]]
; CHECK-NEXT:    [[TMP158:%.*]] = add <2 x i32> [[TMP155]], [[TMP156]]
; CHECK-NEXT:    [[TMP159:%.*]] = shufflevector <2 x i32> [[TMP157]], <2 x i32> [[TMP158]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP160:%.*]] = extractelement <2 x i32> [[TMP151]], i32 0
; CHECK-NEXT:    [[TMP161:%.*]] = extractelement <2 x i32> [[TMP151]], i32 1
; CHECK-NEXT:    [[SUB59_1:%.*]] = sub i32 [[TMP160]], [[TMP161]]
; CHECK-NEXT:    [[SHR_I54_1:%.*]] = lshr i32 [[TMP161]], 15
...
; CHECK-NEXT:    [[TMP165:%.*]] = insertelement <2 x i32> poison, i32 [[SUB59_1]], i32 0
; CHECK-NEXT:    [[TMP166:%.*]] = shufflevector <2 x i32> [[TMP165]], <2 x i32> poison, <2 x i32> zeroinitializer
...
; CHECK-NEXT:    [[TMP185:%.*]] = sub <2 x i32> [[TMP184]], [[TMP173]]
...
; CHECK-NEXT:    [[TMP195:%.*]] = add <2 x i32> [[TMP177]], [[TMP185]]
; CHECK-NEXT:    [[TMP196:%.*]] = xor <2 x i32> [[TMP195]], [[TMP174]]
; CHECK-NEXT:    [[TMP197:%.*]] = extractelement <2 x i32> [[TMP194]], i32 0
; CHECK-NEXT:    [[TMP198:%.*]] = extractelement <2 x i32> [[TMP194]], i32 1
; CHECK-NEXT:    [[ADD110:%.*]] = add i32 [[TMP197]], [[TMP198]]
; CHECK-NEXT:    [[TMP199:%.*]] = extractelement <2 x i32> [[TMP196]], i32 0
; CHECK-NEXT:    [[ADD112:%.*]] = add i32 [[ADD110]], [[TMP199]]
; CHECK-NEXT:    [[TMP200:%.*]] = extractelement <2 x i32> [[TMP196]], i32 1
; CHECK-NEXT:    [[ADD113:%.*]] = add i32 [[ADD112]], [[TMP200]]
...
; CHECK-NEXT:    [[TMP203:%.*]] = add <2 x i32> [[TMP201]], [[TMP202]]
; CHECK-NEXT:    [[TMP204:%.*]] = shufflevector <2 x i32> [[TMP115]], <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
; CHECK-NEXT:    [[TMP205:%.*]] = shufflevector <2 x i32> [[TMP204]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP206:%.*]] = shufflevector <2 x i32> <i32 15, i32 poison>, <2 x i32> [[TMP115]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP207:%.*]] = lshr <2 x i32> [[TMP205]], [[TMP206]]
; CHECK-NEXT:    [[TMP208:%.*]] = add <2 x i32> [[TMP205]], [[TMP206]]
...
; CHECK-NEXT:    [[TMP211:%.*]] = extractelement <2 x i32> [[TMP203]], i32 1
; CHECK-NEXT:    [[TMP212:%.*]] = shufflevector <2 x i32> [[TMP72]], <2 x i32> [[TMP203]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP213:%.*]] = shufflevector <2 x i32> [[TMP72]], <2 x i32> [[TMP203]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP214:%.*]] = sub <2 x i32> [[TMP212]], [[TMP213]]
; CHECK-NEXT:    [[TMP215:%.*]] = shufflevector <2 x i32> <i32 65537, i32 poison>, <2 x i32> [[TMP159]], <2 x i32> <i32 0, i32 3>
...
; CHECK-NEXT:    [[TMP219:%.*]] = extractelement <2 x i32> [[TMP214]], i32 0
; CHECK-NEXT:    [[TMP220:%.*]] = extractelement <2 x i32> [[TMP214]], i32 1
; CHECK-NEXT:    [[ADD105_1:%.*]] = add i32 [[TMP219]], [[TMP220]]
; CHECK-NEXT:    [[ADD78_1:%.*]] = add i32 [[TMP210]], [[TMP211]]
; CHECK-NEXT:    [[TMP221:%.*]] = insertelement <2 x i32> poison, i32 [[ADD105_1]], i32 0
; CHECK-NEXT:    [[TMP222:%.*]] = shufflevector <2 x i32> [[TMP221]], <2 x i32> [[TMP203]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP223:%.*]] = add <2 x i32> [[TMP159]], [[TMP222]]
...
; CHECK-NEXT:    [[TMP228:%.*]] = insertelement <2 x i32> [[TMP5]], i32 [[ADD94_1]], i32 1
...
; CHECK-NEXT:    [[TMP232:%.*]] = extractelement <2 x i32> [[TMP227]], i32 0
; CHECK-NEXT:    [[TMP233:%.*]] = extractelement <2 x i32> [[TMP227]], i32 1
; CHECK-NEXT:    [[ADD_I62_1:%.*]] = add i32 [[TMP232]], [[TMP233]]
...
; CHECK-NEXT:    [[TMP238:%.*]] = shufflevector <2 x i32> [[TMP237]], <2 x i32> [[TMP151]], <2 x i32> <i32 0, i32 3>
...
; CHECK-NEXT:    [[TMP242:%.*]] = extractelement <2 x i32> [[TMP241]], i32 0
; CHECK-NEXT:    [[TMP243:%.*]] = extractelement <2 x i32> [[TMP241]], i32 1
; CHECK-NEXT:    [[ADD112_1:%.*]] = add i32 [[TMP242]], [[TMP243]]
...
; CHECK-NEXT:    [[TMP270:%.*]] = extractelement <2 x i32> [[TMP267]], i32 0
; CHECK-NEXT:    [[TMP271:%.*]] = extractelement <2 x i32> [[TMP267]], i32 1
; CHECK-NEXT:    [[ADD_I62_2:%.*]] = add i32 [[TMP270]], [[TMP271]]
...
; CHECK-NEXT:    [[ADD110_2:%.*]] = add i32 [[ADD108_2]], [[TMP272]]
; CHECK-NEXT:    [[TMP273:%.*]] = extractelement <2 x i32> [[TMP269]], i32 1
; CHECK-NEXT:    [[ADD112_2:%.*]] = add i32 [[ADD110_2]], [[TMP273]]
...
; CHECK-NEXT:    [[TMP276:%.*]] = add <2 x i32> [[TMP275]], [[TMP166]]
; CHECK-NEXT:    [[TMP277:%.*]] = sub <2 x i32> [[TMP275]], [[TMP166]]
...
; CHECK-NEXT:    [[TMP281:%.*]] = add <2 x i32> [[TMP280]], [[TMP279]]
; CHECK-NEXT:    [[TMP282:%.*]] = sub <2 x i32> [[TMP278]], [[TMP99]]
; CHECK-NEXT:    [[TMP283:%.*]] = add <2 x i32> [[TMP118]], [[TMP281]]
...
; CHECK-NEXT:    [[TMP288:%.*]] = add <2 x i32> [[TMP287]], [[TMP282]]
; CHECK-NEXT:    [[TMP289:%.*]] = xor <2 x i32> [[TMP288]], [[TMP82]]
; CHECK-NEXT:    [[TMP290:%.*]] = extractelement <2 x i32> [[TMP284]], i32 0
; CHECK-NEXT:    [[ADD108_3:%.*]] = add i32 [[TMP290]], [[ADD113_2]]
; CHECK-NEXT:    [[TMP291:%.*]] = extractelement <2 x i32> [[TMP284]], i32 1
; CHECK-NEXT:    [[ADD110_3:%.*]] = add i32 [[ADD108_3]], [[TMP291]]
; CHECK-NEXT:    [[TMP292:%.*]] = extractelement <2 x i32> [[TMP289]], i32 0
; CHECK-NEXT:    [[ADD112_3:%.*]] = add i32 [[ADD110_3]], [[TMP292]]
; CHECK-NEXT:    [[TMP293:%.*]] = extractelement <2 x i32> [[TMP289]], i32 1
; CHECK-NEXT:    [[ADD113_3:%.*]] = add i32 [[ADD112_3]], [[TMP293]]
