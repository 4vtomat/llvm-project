...
; CHECK-NEXT:    [[TMP11:%.*]] = load <2 x i8>, ptr [[ADD_PTR_1]], align 1
; CHECK-NEXT:    [[TMP12:%.*]] = zext <2 x i8> [[TMP11]] to <2 x i32>
; CHECK-NEXT:    [[TMP4:%.*]] = load <2 x i8>, ptr [[ADD_PTR64_1]], align 1
; CHECK-NEXT:    [[TMP5:%.*]] = zext <2 x i8> [[TMP4]] to <2 x i32>
; CHECK-NEXT:    [[TMP6:%.*]] = sub <2 x i32> [[TMP12]], [[TMP5]]
...
; CHECK-NEXT:    [[TMP41:%.*]] = load <2 x i8>, ptr [[ARRAYIDX5_3]], align 1
...
; CHECK-NEXT:    [[TMP48:%.*]] = load <2 x i8>, ptr [[ARRAYIDX20_3]], align 1
; CHECK-NEXT:    [[TMP49:%.*]] = zext <2 x i8> [[TMP48]] to <2 x i32>
; CHECK-NEXT:    [[TMP50:%.*]] = load <2 x i8>, ptr [[ARRAYIDX22_3]], align 1
...
; CHECK-NEXT:    [[TMP56:%.*]] = load <2 x i8>, ptr [[ARRAYIDX27_3]], align 1
...
; CHECK-NEXT:    [[TMP60:%.*]] = add <2 x i32> [[TMP59]], [[TMP52]]
...
; CHECK-NEXT:    [[TMP76:%.*]] = load <2 x i8>, ptr [[ARRAYIDX20]], align 1
; CHECK-NEXT:    [[TMP82:%.*]] = zext <2 x i8> [[TMP76]] to <2 x i32>
; CHECK-NEXT:    [[TMP84:%.*]] = load <2 x i8>, ptr [[ARRAYIDX22]], align 1
; CHECK-NEXT:    [[TMP85:%.*]] = zext <2 x i8> [[TMP84]] to <2 x i32>
; CHECK-NEXT:    [[TMP87:%.*]] = load <2 x i8>, ptr [[ARRAYIDX25]], align 1
; CHECK-NEXT:    [[TMP81:%.*]] = zext <2 x i8> [[TMP87]] to <2 x i32>
; CHECK-NEXT:    [[TMP88:%.*]] = load <2 x i8>, ptr [[ARRAYIDX27]], align 1
; CHECK-NEXT:    [[TMP83:%.*]] = zext <2 x i8> [[TMP88]] to <2 x i32>
; CHECK-NEXT:    [[TMP89:%.*]] = sub <2 x i32> [[TMP81]], [[TMP83]]
; CHECK-NEXT:    [[TMP90:%.*]] = shl <2 x i32> [[TMP89]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP86:%.*]] = sub <2 x i32> [[TMP82]], [[TMP85]]
; CHECK-NEXT:    [[TMP92:%.*]] = add <2 x i32> [[TMP90]], [[TMP86]]
...
; CHECK-NEXT:    [[TMP97:%.*]] = add <2 x i32> [[TMP94]], [[TMP96]]
; CHECK-NEXT:    [[TMP98:%.*]] = sub <2 x i32> [[TMP94]], [[TMP96]]
; CHECK-NEXT:    [[TMP99:%.*]] = shufflevector <2 x i32> [[TMP97]], <2 x i32> [[TMP98]], <2 x i32> <i32 0, i32 3>
...
; CHECK-NEXT:    [[TMP104:%.*]] = load <2 x i8>, ptr [[ARRAYIDX3]], align 1
; CHECK-NEXT:    [[TMP106:%.*]] = zext <2 x i8> [[TMP104]] to <2 x i32>
; CHECK-NEXT:    [[TMP107:%.*]] = load <2 x i8>, ptr [[ARRAYIDX5]], align 1
; CHECK-NEXT:    [[TMP110:%.*]] = zext <2 x i8> [[TMP107]] to <2 x i32>
; CHECK-NEXT:    [[TMP108:%.*]] = sub <2 x i32> [[TMP106]], [[TMP110]]
; CHECK-NEXT:    [[TMP109:%.*]] = shl <2 x i32> [[TMP108]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP105:%.*]] = sub <2 x i32> [[TMP101]], [[TMP103]]
; CHECK-NEXT:    [[TMP111:%.*]] = add <2 x i32> [[TMP109]], [[TMP105]]
...
; CHECK-NEXT:    [[TMP125:%.*]] = load <2 x i8>, ptr [[ARRAYIDX8_1]], align 1
; CHECK-NEXT:    [[TMP124:%.*]] = zext <2 x i8> [[TMP125]] to <2 x i32>
; CHECK-NEXT:    [[TMP126:%.*]] = load <2 x i8>, ptr [[ADD_PTR644]], align 1
; CHECK-NEXT:    [[TMP128:%.*]] = zext <2 x i8> [[TMP126]] to <2 x i32>
; CHECK-NEXT:    [[TMP135:%.*]] = load <2 x i8>, ptr [[ARRAYIDX3_1]], align 1
; CHECK-NEXT:    [[TMP120:%.*]] = zext <2 x i8> [[TMP135]] to <2 x i32>
; CHECK-NEXT:    [[TMP121:%.*]] = load <2 x i8>, ptr [[ARRAYIDX5_1]], align 1
; CHECK-NEXT:    [[TMP137:%.*]] = zext <2 x i8> [[TMP121]] to <2 x i32>
; CHECK-NEXT:    [[TMP131:%.*]] = sub <2 x i32> [[TMP120]], [[TMP137]]
; CHECK-NEXT:    [[TMP132:%.*]] = shl <2 x i32> [[TMP131]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP133:%.*]] = shufflevector <2 x i32> [[TMP124]], <2 x i32> poison, <2 x i32> <i32 1, i32 0>
; CHECK-NEXT:    [[TMP134:%.*]] = insertelement <2 x i32> [[TMP133]], i32 [[CONV_1]], i32 0
; CHECK-NEXT:    [[TMP127:%.*]] = sub <2 x i32> [[TMP134]], [[TMP128]]
; CHECK-NEXT:    [[TMP136:%.*]] = add <2 x i32> [[TMP132]], [[TMP127]]
; CHECK-NEXT:    [[TMP129:%.*]] = load <2 x i8>, ptr [[ARRAYIDX22_1]], align 1
; CHECK-NEXT:    [[TMP130:%.*]] = zext <2 x i8> [[TMP129]] to <2 x i32>
; CHECK-NEXT:    [[TMP139:%.*]] = load <2 x i8>, ptr [[ARRAYIDX25_1]], align 1
; CHECK-NEXT:    [[TMP140:%.*]] = zext <2 x i8> [[TMP139]] to <2 x i32>
; CHECK-NEXT:    [[TMP141:%.*]] = load <2 x i8>, ptr [[ARRAYIDX27_1]], align 1
; CHECK-NEXT:    [[TMP142:%.*]] = zext <2 x i8> [[TMP141]] to <2 x i32>
; CHECK-NEXT:    [[TMP143:%.*]] = sub <2 x i32> [[TMP140]], [[TMP142]]
; CHECK-NEXT:    [[TMP144:%.*]] = shl <2 x i32> [[TMP143]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP145:%.*]] = insertelement <2 x i32> [[TMP133]], i32 [[CONV33_1]], i32 1
; CHECK-NEXT:    [[TMP138:%.*]] = sub <2 x i32> [[TMP145]], [[TMP130]]
; CHECK-NEXT:    [[TMP147:%.*]] = add <2 x i32> [[TMP144]], [[TMP138]]
...
; CHECK-NEXT:    [[TMP172:%.*]] = sub <2 x i32> [[TMP168]], [[TMP170]]
; CHECK-NEXT:    [[TMP173:%.*]] = shufflevector <2 x i32> [[TMP171]], <2 x i32> [[TMP172]], <2 x i32> <i32 0, i32 3>
...
; CHECK-NEXT:    [[TMP182:%.*]] = add <2 x i32> [[TMP179]], [[TMP181]]
; CHECK-NEXT:    [[TMP183:%.*]] = sub <2 x i32> [[TMP179]], [[TMP181]]
; CHECK-NEXT:    [[TMP184:%.*]] = shufflevector <2 x i32> [[TMP182]], <2 x i32> [[TMP183]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP166:%.*]] = sub <2 x i32> [[TMP184]], [[TMP173]]
; CHECK-NEXT:    [[TMP186:%.*]] = shufflevector <2 x i32> [[TMP28]], <2 x i32> [[TMP35]], <2 x i32> <i32 1, i32 2>
...
; CHECK-NEXT:    [[TMP190:%.*]] = shufflevector <2 x i32> [[TMP172]], <2 x i32> [[TMP171]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP191:%.*]] = shufflevector <2 x i32> [[TMP183]], <2 x i32> [[TMP182]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP192:%.*]] = add <2 x i32> [[TMP190]], [[TMP191]]
; CHECK-NEXT:    [[TMP193:%.*]] = add <2 x i32> [[TMP189]], [[TMP192]]
; CHECK-NEXT:    [[TMP194:%.*]] = xor <2 x i32> [[TMP193]], [[TMP186]]
; CHECK-NEXT:    [[TMP195:%.*]] = add <2 x i32> [[TMP177]], [[TMP166]]
...
; CHECK-NEXT:    [[TMP208:%.*]] = add <2 x i32> [[TMP309]], [[TMP311]]
...
; CHECK-NEXT:    [[TMP217:%.*]] = sub <2 x i32> [[TMP209]], [[TMP215]]
; CHECK-NEXT:    [[TMP218:%.*]] = shufflevector <2 x i32> [[TMP216]], <2 x i32> [[TMP217]], <2 x i32> <i32 0, i32 3>
...
; CHECK-NEXT:    [[TMP226:%.*]] = sub <2 x i32> [[TMP218]], [[TMP224]]
...
; CHECK-NEXT:    [[TMP228:%.*]] = shufflevector <2 x i32> [[TMP12]], <2 x i32> [[TMP317]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP229:%.*]] = xor <2 x i32> [[TMP223]], [[TMP228]]
; CHECK-NEXT:    [[TMP230:%.*]] = sub <2 x i32> [[TMP223]], [[TMP228]]
; CHECK-NEXT:    [[TMP231:%.*]] = shufflevector <2 x i32> [[TMP229]], <2 x i32> [[TMP230]], <2 x i32> <i32 0, i32 3>
...
; CHECK-NEXT:    [[TMP236:%.*]] = add <2 x i32> [[TMP231]], [[TMP235]]
...
; CHECK-NEXT:    [[TMP239:%.*]] = add <2 x i32> [[TMP236]], [[TMP238]]
; CHECK-NEXT:    [[TMP240:%.*]] = xor <2 x i32> [[TMP236]], [[TMP238]]
; CHECK-NEXT:    [[TMP241:%.*]] = shufflevector <2 x i32> [[TMP239]], <2 x i32> [[TMP240]], <2 x i32> <i32 0, i32 3>
...
; CHECK-NEXT:    [[TMP251:%.*]] = sub <2 x i32> [[TMP248]], [[TMP249]]
...
; CHECK-NEXT:    [[TMP257:%.*]] = sub <2 x i32> [[TMP252]], [[TMP255]]
...
; CHECK-NEXT:    [[TMP261:%.*]] = add <2 x i32> [[TMP260]], [[TMP245]]
; CHECK-NEXT:    [[TMP262:%.*]] = sub <2 x i32> [[TMP260]], [[TMP245]]
...
; CHECK-NEXT:    [[TMP266:%.*]] = sub <2 x i32> [[TMP258]], [[TMP264]]
; CHECK-NEXT:    [[TMP267:%.*]] = shufflevector <2 x i32> [[TMP265]], <2 x i32> [[TMP266]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[ADD_I52_2:%.*]] = add i32 [[MUL_I51_2]], [[ADD105_2]]
; CHECK-NEXT:    [[XOR_I53_2:%.*]] = xor i32 [[ADD_I52_2]], [[CONV_1]]
; CHECK-NEXT:    [[TMP268:%.*]] = add <2 x i32> [[TMP164]], [[TMP263]]
...
; CHECK-NEXT:    [[TMP276:%.*]] = add <2 x i32> [[TMP275]], [[TMP205]]
; CHECK-NEXT:    [[TMP277:%.*]] = sub <2 x i32> [[TMP275]], [[TMP205]]
; CHECK-NEXT:    [[TMP278:%.*]] = shufflevector <2 x i32> [[TMP276]], <2 x i32> [[TMP277]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP279:%.*]] = shufflevector <2 x i32> [[TMP277]], <2 x i32> [[TMP276]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP280:%.*]] = shufflevector <2 x i32> [[TMP98]], <2 x i32> [[TMP97]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP296:%.*]] = add <2 x i32> [[TMP280]], [[TMP279]]
; CHECK-NEXT:    [[TMP297:%.*]] = sub <2 x i32> [[TMP278]], [[TMP99]]
; CHECK-NEXT:    [[TMP283:%.*]] = add <2 x i32> [[TMP118]], [[TMP296]]
...
; CHECK-NEXT:    [[TMP288:%.*]] = add <2 x i32> [[TMP287]], [[TMP297]]
