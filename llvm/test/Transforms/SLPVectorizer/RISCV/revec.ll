...
; CHECK-LABEL: @test5(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = call <8 x double> @llvm.vector.insert.v8f64.v4f64(<8 x double> poison, <4 x double> splat (double 0x7FF8000000000000), i64 0)
; CHECK-NEXT:    [[TMP1:%.*]] = shufflevector <8 x double> [[TMP0]], <8 x double> <double poison, double poison, double 0.000000e+00, double 0.000000e+00, double poison, double poison, double 0.000000e+00, double 0.000000e+00>, <8 x i32> <i32 0, i32 1, i32 10, i32 11, i32 2, i32 3, i32 14, i32 15>
; CHECK-NEXT:    [[TMP11:%.*]] = fadd <8 x double> zeroinitializer, [[TMP1]]
