...
; RUN: opt -S --passes=slp-vectorizer -mtriple=riscv64-unknown-linux-gnu -mcpu=sifive-x390 < %s | FileCheck %s
...
define fastcc i32 @Mode_Decision_for_new_8x8IntraBlocks(i32 %0, i32 %add111.i.i, <4 x i32> %PredPel.i.sroa.86.72.vec.extract, <4 x i32> %1) {
; CHECK-LABEL: define fastcc i32 @Mode_Decision_for_new_8x8IntraBlocks(
