...
; CHECK-NEXT:    [[SHR2158_I1:%.*]] = lshr i32 [[ADD2157_I]], 1
; CHECK-NEXT:    [[TMP12:%.*]] = trunc i32 [[SHR2158_I1]] to i16
...
; CHECK-NEXT:    store i16 [[TMP12]], ptr getelementptr inbounds nuw (i8, ptr @images, i64 8230), align 2
; CHECK-NEXT:    store i16 [[TMP12]], ptr getelementptr inbounds nuw (i8, ptr @images, i64 8210), align 2
; CHECK-NEXT:    store i16 [[TMP12]], ptr getelementptr inbounds nuw (i8, ptr @images, i64 8190), align 2
