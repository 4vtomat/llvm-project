...
; CHECK-NEXT:    [[ARRAYIDX10:%.*]] = getelementptr i8, ptr [[PIX2]], i64 1
; CHECK-NEXT:    [[ARRAYIDX13:%.*]] = getelementptr i8, ptr [[PIX1]], i64 5
...
; CHECK-NEXT:    [[TMP0:%.*]] = load i8, ptr [[ADD_PTR3]], align 1
; CHECK-NEXT:    [[CONV_1:%.*]] = zext i8 [[TMP0]] to i32
...
; CHECK-NEXT:    [[TMP1:%.*]] = load i8, ptr [[ARRAYIDX32_1]], align 1
; CHECK-NEXT:    [[CONV33_1:%.*]] = zext i8 [[TMP1]] to i32
...
; CHECK-NEXT:    [[TMP2:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ADD_PTR_1]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP3:%.*]] = zext <2 x i8> [[TMP2]] to <2 x i32>
; CHECK-NEXT:    [[TMP4:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ADD_PTR64_1]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP5:%.*]] = zext <2 x i8> [[TMP4]] to <2 x i32>
; CHECK-NEXT:    [[TMP6:%.*]] = sub <2 x i32> [[TMP3]], [[TMP5]]
; CHECK-NEXT:    [[TMP7:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX3_2]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP8:%.*]] = zext <2 x i8> [[TMP7]] to <2 x i32>
; CHECK-NEXT:    [[TMP9:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX5_2]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP10:%.*]] = zext <2 x i8> [[TMP9]] to <2 x i32>
; CHECK-NEXT:    [[TMP11:%.*]] = sub <2 x i32> [[TMP8]], [[TMP10]]
; CHECK-NEXT:    [[TMP12:%.*]] = shl <2 x i32> [[TMP11]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP13:%.*]] = add <2 x i32> [[TMP12]], [[TMP6]]
; CHECK-NEXT:    [[TMP14:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX8_2]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP15:%.*]] = zext <2 x i8> [[TMP14]] to <2 x i32>
; CHECK-NEXT:    [[TMP16:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX10_2]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP17:%.*]] = zext <2 x i8> [[TMP16]] to <2 x i32>
; CHECK-NEXT:    [[TMP18:%.*]] = sub <2 x i32> [[TMP15]], [[TMP17]]
; CHECK-NEXT:    [[TMP19:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX13_2]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP20:%.*]] = zext <2 x i8> [[TMP19]] to <2 x i32>
; CHECK-NEXT:    [[TMP21:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX15_2]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP22:%.*]] = zext <2 x i8> [[TMP21]] to <2 x i32>
; CHECK-NEXT:    [[TMP23:%.*]] = sub <2 x i32> [[TMP20]], [[TMP22]]
; CHECK-NEXT:    [[TMP24:%.*]] = shl <2 x i32> [[TMP23]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP25:%.*]] = add <2 x i32> [[TMP24]], [[TMP18]]
; CHECK-NEXT:    [[TMP26:%.*]] = sub <2 x i32> [[TMP13]], [[TMP25]]
; CHECK-NEXT:    [[TMP27:%.*]] = extractelement <2 x i32> [[TMP26]], i32 0
; CHECK-NEXT:    [[TMP28:%.*]] = extractelement <2 x i32> [[TMP26]], i32 1
; CHECK-NEXT:    [[SUB59_2:%.*]] = sub i32 [[TMP27]], [[TMP28]]
...
; CHECK-NEXT:    [[TMP30:%.*]] = load i8, ptr null, align 1
; CHECK-NEXT:    [[TMP31:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 null, i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP32:%.*]] = zext <2 x i8> [[TMP31]] to <2 x i32>
; CHECK-NEXT:    [[TMP33:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 null, i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP34:%.*]] = zext <2 x i8> [[TMP33]] to <2 x i32>
; CHECK-NEXT:    [[TMP35:%.*]] = sub <2 x i32> [[TMP32]], [[TMP34]]
; CHECK-NEXT:    [[TMP36:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX3_3]], i64 -4, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP37:%.*]] = zext <2 x i8> [[TMP36]] to <2 x i32>
; CHECK-NEXT:    [[TMP38:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX5_3]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP39:%.*]] = zext <2 x i8> [[TMP38]] to <2 x i32>
; CHECK-NEXT:    [[TMP40:%.*]] = sub <2 x i32> [[TMP37]], [[TMP39]]
; CHECK-NEXT:    [[TMP41:%.*]] = shl <2 x i32> [[TMP40]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP42:%.*]] = add <2 x i32> [[TMP41]], [[TMP35]]
; CHECK-NEXT:    [[TMP43:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX8_3]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP44:%.*]] = zext <2 x i8> [[TMP43]] to <2 x i32>
; CHECK-NEXT:    [[TMP45:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX10_3]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP46:%.*]] = zext <2 x i8> [[TMP45]] to <2 x i32>
; CHECK-NEXT:    [[TMP47:%.*]] = sub <2 x i32> [[TMP44]], [[TMP46]]
; CHECK-NEXT:    [[TMP48:%.*]] = insertelement <2 x i8> poison, i8 [[TMP29]], i32 0
; CHECK-NEXT:    [[TMP49:%.*]] = insertelement <2 x i8> [[TMP48]], i8 [[TMP30]], i32 1
; CHECK-NEXT:    [[TMP50:%.*]] = zext <2 x i8> [[TMP49]] to <2 x i32>
; CHECK-NEXT:    [[TMP51:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX15_3]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP52:%.*]] = zext <2 x i8> [[TMP51]] to <2 x i32>
; CHECK-NEXT:    [[TMP53:%.*]] = sub <2 x i32> [[TMP50]], [[TMP52]]
; CHECK-NEXT:    [[TMP54:%.*]] = shl <2 x i32> [[TMP53]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP55:%.*]] = add <2 x i32> [[TMP54]], [[TMP47]]
; CHECK-NEXT:    [[TMP56:%.*]] = sub <2 x i32> [[TMP42]], [[TMP55]]
; CHECK-NEXT:    [[TMP57:%.*]] = shufflevector <2 x i32> [[TMP55]], <2 x i32> [[TMP25]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP58:%.*]] = shufflevector <2 x i32> [[TMP42]], <2 x i32> [[TMP13]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP59:%.*]] = add <2 x i32> [[TMP57]], [[TMP58]]
; CHECK-NEXT:    [[TMP60:%.*]] = shufflevector <2 x i32> [[TMP55]], <2 x i32> [[TMP25]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP61:%.*]] = shufflevector <2 x i32> [[TMP42]], <2 x i32> [[TMP13]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP62:%.*]] = add <2 x i32> [[TMP60]], [[TMP61]]
; CHECK-NEXT:    [[TMP63:%.*]] = extractelement <2 x i32> [[TMP59]], i32 1
; CHECK-NEXT:    [[TMP64:%.*]] = extractelement <2 x i32> [[TMP62]], i32 1
; CHECK-NEXT:    [[ADD48_2:%.*]] = add i32 [[TMP64]], [[TMP63]]
; CHECK-NEXT:    [[TMP65:%.*]] = extractelement <2 x i32> [[TMP59]], i32 0
; CHECK-NEXT:    [[TMP66:%.*]] = extractelement <2 x i32> [[TMP62]], i32 0
; CHECK-NEXT:    [[ADD48_3:%.*]] = add i32 [[TMP66]], [[TMP65]]
; CHECK-NEXT:    [[TMP67:%.*]] = sub <2 x i32> [[TMP59]], [[TMP62]]
; CHECK-NEXT:    [[TMP68:%.*]] = shufflevector <2 x i32> [[TMP26]], <2 x i32> [[TMP56]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP69:%.*]] = shufflevector <2 x i32> [[TMP26]], <2 x i32> [[TMP56]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP70:%.*]] = add <2 x i32> [[TMP68]], [[TMP69]]
; CHECK-NEXT:    [[TMP71:%.*]] = extractelement <2 x i32> [[TMP56]], i32 0
; CHECK-NEXT:    [[TMP72:%.*]] = extractelement <2 x i32> [[TMP56]], i32 1
; CHECK-NEXT:    [[SUB59_3:%.*]] = sub i32 [[TMP71]], [[TMP72]]
; CHECK-NEXT:    [[ADD94:%.*]] = add i32 [[ADD48_3]], [[ADD48_2]]
; CHECK-NEXT:    [[SUB102:%.*]] = sub i32 [[ADD48_2]], [[ADD48_3]]
; CHECK-NEXT:    [[TMP73:%.*]] = extractelement <2 x i32> [[TMP32]], i32 0
; CHECK-NEXT:    [[SHR_I:%.*]] = lshr i32 [[TMP73]], 15
; CHECK-NEXT:    [[AND_I:%.*]] = and i32 [[SHR_I]], 65537
; CHECK-NEXT:    [[MUL_I:%.*]] = mul i32 [[AND_I]], 65535
; CHECK-NEXT:    [[SHR_I49:%.*]] = lshr i32 [[TMP64]], 15
; CHECK-NEXT:    [[AND_I50:%.*]] = and i32 [[SHR_I49]], 65537
; CHECK-NEXT:    [[MUL_I51:%.*]] = mul i32 [[AND_I50]], 65535
; CHECK-NEXT:    [[TMP74:%.*]] = extractelement <2 x i32> [[TMP70]], i32 0
; CHECK-NEXT:    [[TMP75:%.*]] = extractelement <2 x i32> [[TMP70]], i32 1
; CHECK-NEXT:    [[ADD94_1:%.*]] = add i32 [[TMP75]], [[TMP74]]
; CHECK-NEXT:    [[SUB102_1:%.*]] = sub i32 [[TMP74]], [[TMP75]]
; CHECK-NEXT:    [[TMP76:%.*]] = extractelement <2 x i32> [[TMP3]], i32 0
; CHECK-NEXT:    [[SHR_I49_1:%.*]] = lshr i32 [[TMP76]], 15
; CHECK-NEXT:    [[AND_I50_1:%.*]] = and i32 [[SHR_I49_1]], 65537
; CHECK-NEXT:    [[MUL_I51_1:%.*]] = mul i32 [[AND_I50_1]], 65535
; CHECK-NEXT:    [[TMP77:%.*]] = extractelement <2 x i32> [[TMP67]], i32 0
; CHECK-NEXT:    [[TMP78:%.*]] = extractelement <2 x i32> [[TMP67]], i32 1
; CHECK-NEXT:    [[ADD94_2:%.*]] = add i32 [[TMP77]], [[TMP78]]
; CHECK-NEXT:    [[TMP79:%.*]] = load <2 x i8>, ptr [[ARRAYIDX20]], align 1
; CHECK-NEXT:    [[TMP80:%.*]] = zext <2 x i8> [[TMP79]] to <2 x i32>
; CHECK-NEXT:    [[TMP81:%.*]] = insertelement <2 x i32> poison, i32 [[SUB59_2]], i32 0
; CHECK-NEXT:    [[TMP82:%.*]] = shufflevector <2 x i32> [[TMP81]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP83:%.*]] = insertelement <2 x i32> poison, i32 [[SUB59_3]], i32 0
; CHECK-NEXT:    [[TMP84:%.*]] = shufflevector <2 x i32> [[TMP83]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP85:%.*]] = add <2 x i32> [[TMP82]], [[TMP84]]
; CHECK-NEXT:    [[TMP86:%.*]] = sub <2 x i32> [[TMP82]], [[TMP84]]
; CHECK-NEXT:    [[TMP87:%.*]] = shufflevector <2 x i32> [[TMP85]], <2 x i32> [[TMP86]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP88:%.*]] = load <2 x i8>, ptr [[PIX1]], align 1
; CHECK-NEXT:    [[TMP89:%.*]] = zext <2 x i8> [[TMP88]] to <2 x i32>
; CHECK-NEXT:    [[TMP90:%.*]] = shufflevector <2 x i32> [[TMP89]], <2 x i32> poison, <2 x i32> <i32 1, i32 0>
; CHECK-NEXT:    [[TMP91:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[PIX2]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP92:%.*]] = zext <2 x i8> [[TMP91]] to <2 x i32>
; CHECK-NEXT:    [[TMP93:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX3]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP94:%.*]] = zext <2 x i8> [[TMP93]] to <2 x i32>
; CHECK-NEXT:    [[TMP95:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX5]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP96:%.*]] = zext <2 x i8> [[TMP95]] to <2 x i32>
; CHECK-NEXT:    [[TMP97:%.*]] = sub <2 x i32> [[TMP94]], [[TMP96]]
; CHECK-NEXT:    [[TMP98:%.*]] = shl <2 x i32> [[TMP97]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP99:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX10]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP100:%.*]] = zext <2 x i8> [[TMP99]] to <2 x i32>
; CHECK-NEXT:    [[TMP101:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX13]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP102:%.*]] = zext <2 x i8> [[TMP101]] to <2 x i32>
; CHECK-NEXT:    [[TMP103:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX15]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP104:%.*]] = zext <2 x i8> [[TMP103]] to <2 x i32>
; CHECK-NEXT:    [[TMP105:%.*]] = sub <2 x i32> [[TMP102]], [[TMP104]]
; CHECK-NEXT:    [[TMP106:%.*]] = shl <2 x i32> [[TMP105]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP107:%.*]] = shufflevector <2 x i32> [[TMP89]], <2 x i32> [[TMP80]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP108:%.*]] = sub <2 x i32> [[TMP107]], [[TMP92]]
; CHECK-NEXT:    [[TMP109:%.*]] = add <2 x i32> [[TMP98]], [[TMP108]]
; CHECK-NEXT:    [[TMP110:%.*]] = shufflevector <2 x i32> [[TMP90]], <2 x i32> [[TMP80]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP111:%.*]] = sub <2 x i32> [[TMP110]], [[TMP100]]
; CHECK-NEXT:    [[TMP112:%.*]] = add <2 x i32> [[TMP106]], [[TMP111]]
; CHECK-NEXT:    [[TMP113:%.*]] = extractelement <2 x i32> [[TMP109]], i32 1
; CHECK-NEXT:    [[TMP114:%.*]] = extractelement <2 x i32> [[TMP112]], i32 1
; CHECK-NEXT:    [[ADD46:%.*]] = add i32 [[TMP114]], [[TMP113]]
; CHECK-NEXT:    [[SHR_I59:%.*]] = lshr i32 [[ADD46]], 15
; CHECK-NEXT:    [[AND_I60:%.*]] = and i32 [[SHR_I59]], 65537
; CHECK-NEXT:    [[MUL_I61:%.*]] = mul i32 [[AND_I60]], 65535
; CHECK-NEXT:    [[TMP115:%.*]] = sub <2 x i32> [[TMP109]], [[TMP112]]
; CHECK-NEXT:    [[TMP116:%.*]] = extractelement <2 x i32> [[TMP109]], i32 0
; CHECK-NEXT:    [[TMP117:%.*]] = extractelement <2 x i32> [[TMP112]], i32 0
; CHECK-NEXT:    [[ADD44:%.*]] = add i32 [[TMP117]], [[TMP116]]
; CHECK-NEXT:    [[TMP118:%.*]] = lshr <2 x i32> [[TMP90]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP119:%.*]] = and <2 x i32> [[TMP118]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP120:%.*]] = mul <2 x i32> [[TMP119]], <i32 65535, i32 65535>
; CHECK-NEXT:    [[ADD48:%.*]] = add i32 [[ADD46]], [[ADD44]]
; CHECK-NEXT:    [[TMP121:%.*]] = extractelement <2 x i32> [[TMP115]], i32 0
; CHECK-NEXT:    [[TMP122:%.*]] = extractelement <2 x i32> [[TMP115]], i32 1
; CHECK-NEXT:    [[SUB59:%.*]] = sub i32 [[TMP121]], [[TMP122]]
; CHECK-NEXT:    [[TMP123:%.*]] = load <2 x i8>, ptr [[ARRAYIDX8_1]], align 1
; CHECK-NEXT:    [[TMP124:%.*]] = zext <2 x i8> [[TMP123]] to <2 x i32>
; CHECK-NEXT:    [[TMP125:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ADD_PTR644]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP126:%.*]] = zext <2 x i8> [[TMP125]] to <2 x i32>
; CHECK-NEXT:    [[TMP127:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX3_1]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP128:%.*]] = zext <2 x i8> [[TMP127]] to <2 x i32>
; CHECK-NEXT:    [[TMP129:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX5_1]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP130:%.*]] = zext <2 x i8> [[TMP129]] to <2 x i32>
; CHECK-NEXT:    [[TMP131:%.*]] = sub <2 x i32> [[TMP128]], [[TMP130]]
; CHECK-NEXT:    [[TMP132:%.*]] = shl <2 x i32> [[TMP131]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP133:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX10_1]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP134:%.*]] = zext <2 x i8> [[TMP133]] to <2 x i32>
; CHECK-NEXT:    [[TMP135:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX13_1]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP136:%.*]] = zext <2 x i8> [[TMP135]] to <2 x i32>
; CHECK-NEXT:    [[TMP137:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX15_1]], i64 2, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP138:%.*]] = zext <2 x i8> [[TMP137]] to <2 x i32>
; CHECK-NEXT:    [[TMP139:%.*]] = sub <2 x i32> [[TMP136]], [[TMP138]]
; CHECK-NEXT:    [[TMP140:%.*]] = shl <2 x i32> [[TMP139]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP141:%.*]] = insertelement <2 x i32> [[TMP124]], i32 [[CONV33_1]], i32 1
; CHECK-NEXT:    [[TMP142:%.*]] = sub <2 x i32> [[TMP141]], [[TMP134]]
; CHECK-NEXT:    [[TMP143:%.*]] = add <2 x i32> [[TMP140]], [[TMP142]]
; CHECK-NEXT:    [[TMP144:%.*]] = insertelement <2 x i32> [[TMP124]], i32 [[CONV_1]], i32 0
; CHECK-NEXT:    [[TMP145:%.*]] = sub <2 x i32> [[TMP144]], [[TMP126]]
; CHECK-NEXT:    [[TMP146:%.*]] = add <2 x i32> [[TMP132]], [[TMP145]]
...
; CHECK-NEXT:    [[ADD48_1:%.*]] = add i32 [[TMP150]], [[TMP149]]
; CHECK-NEXT:    [[SUB51_1:%.*]] = sub i32 [[TMP149]], [[TMP150]]
; CHECK-NEXT:    [[TMP151:%.*]] = shufflevector <2 x i32> [[TMP148]], <2 x i32> [[TMP115]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP152:%.*]] = shufflevector <2 x i32> [[TMP148]], <2 x i32> [[TMP115]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP153:%.*]] = add <2 x i32> [[TMP151]], [[TMP152]]
; CHECK-NEXT:    [[TMP154:%.*]] = extractelement <2 x i32> [[TMP148]], i32 0
; CHECK-NEXT:    [[TMP155:%.*]] = extractelement <2 x i32> [[TMP148]], i32 1
; CHECK-NEXT:    [[SUB59_1:%.*]] = sub i32 [[TMP154]], [[TMP155]]
; CHECK-NEXT:    [[SHR_I54:%.*]] = lshr i32 [[TMP150]], 15
; CHECK-NEXT:    [[AND_I55:%.*]] = and i32 [[SHR_I54]], 65537
; CHECK-NEXT:    [[MUL_I56:%.*]] = mul i32 [[AND_I55]], 65535
; CHECK-NEXT:    [[TMP156:%.*]] = lshr <2 x i32> [[TMP124]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP157:%.*]] = and <2 x i32> [[TMP156]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP158:%.*]] = mul <2 x i32> [[TMP157]], <i32 65535, i32 65535>
; CHECK-NEXT:    [[TMP159:%.*]] = insertelement <2 x i32> poison, i32 [[SUB59_1]], i32 0
; CHECK-NEXT:    [[TMP160:%.*]] = shufflevector <2 x i32> [[TMP159]], <2 x i32> poison, <2 x i32> zeroinitializer
...
; CHECK-NEXT:    [[XOR_I:%.*]] = xor i32 [[ADD_I]], [[TMP73]]
; CHECK-NEXT:    [[ADD_I52:%.*]] = add i32 [[MUL_I51]], [[ADD105]]
; CHECK-NEXT:    [[XOR_I53:%.*]] = xor i32 [[ADD_I52]], [[TMP64]]
...
; CHECK-NEXT:    [[XOR_I63:%.*]] = xor i32 [[ADD_I62]], [[ADD46]]
; CHECK-NEXT:    [[ADD110:%.*]] = add i32 [[XOR_I53]], [[XOR_I]]
; CHECK-NEXT:    [[ADD112:%.*]] = add i32 [[ADD110]], [[XOR_I58]]
; CHECK-NEXT:    [[ADD113:%.*]] = add i32 [[ADD112]], [[XOR_I63]]
; CHECK-NEXT:    [[TMP161:%.*]] = extractelement <2 x i32> [[TMP153]], i32 0
; CHECK-NEXT:    [[TMP162:%.*]] = extractelement <2 x i32> [[TMP153]], i32 1
; CHECK-NEXT:    [[ADD78_1:%.*]] = add i32 [[TMP161]], [[TMP162]]
; CHECK-NEXT:    [[TMP163:%.*]] = shufflevector <2 x i32> [[TMP15]], <2 x i32> [[TMP148]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP164:%.*]] = lshr <2 x i32> [[TMP163]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP165:%.*]] = and <2 x i32> [[TMP164]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP166:%.*]] = mul <2 x i32> [[TMP165]], <i32 65535, i32 65535>
; CHECK-NEXT:    [[TMP167:%.*]] = insertelement <2 x i32> poison, i32 [[ADD78_1]], i32 0
; CHECK-NEXT:    [[TMP168:%.*]] = shufflevector <2 x i32> [[TMP167]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP169:%.*]] = insertelement <2 x i32> poison, i32 [[ADD94_1]], i32 0
...
; CHECK-NEXT:    [[TMP174:%.*]] = add <2 x i32> [[TMP166]], [[TMP173]]
; CHECK-NEXT:    [[TMP175:%.*]] = xor <2 x i32> [[TMP174]], [[TMP163]]
; CHECK-NEXT:    [[TMP176:%.*]] = insertelement <2 x i32> poison, i32 [[ADD94_2]], i32 0
; CHECK-NEXT:    [[TMP177:%.*]] = shufflevector <2 x i32> [[TMP176]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP178:%.*]] = insertelement <2 x i32> poison, i32 [[ADD44]], i32 0
; CHECK-NEXT:    [[TMP179:%.*]] = shufflevector <2 x i32> [[TMP178]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP180:%.*]] = insertelement <2 x i32> <i32 15, i32 poison>, i32 [[ADD46]], i32 1
; CHECK-NEXT:    [[TMP181:%.*]] = lshr <2 x i32> [[TMP179]], [[TMP180]]
; CHECK-NEXT:    [[TMP182:%.*]] = sub <2 x i32> [[TMP179]], [[TMP180]]
; CHECK-NEXT:    [[TMP183:%.*]] = shufflevector <2 x i32> [[TMP181]], <2 x i32> [[TMP182]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP184:%.*]] = extractelement <2 x i32> [[TMP183]], i32 1
; CHECK-NEXT:    [[ADD78_2:%.*]] = add i32 [[SUB51_1]], [[TMP184]]
; CHECK-NEXT:    [[TMP185:%.*]] = insertelement <2 x i32> <i32 65537, i32 poison>, i32 [[SUB51_1]], i32 1
; CHECK-NEXT:    [[TMP186:%.*]] = and <2 x i32> [[TMP183]], [[TMP185]]
; CHECK-NEXT:    [[TMP187:%.*]] = sub <2 x i32> [[TMP183]], [[TMP185]]
; CHECK-NEXT:    [[TMP188:%.*]] = shufflevector <2 x i32> [[TMP186]], <2 x i32> [[TMP187]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP189:%.*]] = insertelement <2 x i32> poison, i32 [[ADD78_2]], i32 0
; CHECK-NEXT:    [[TMP190:%.*]] = shufflevector <2 x i32> [[TMP189]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP191:%.*]] = add <2 x i32> [[TMP190]], [[TMP177]]
; CHECK-NEXT:    [[TMP192:%.*]] = sub <2 x i32> [[TMP190]], [[TMP177]]
; CHECK-NEXT:    [[TMP193:%.*]] = shufflevector <2 x i32> [[TMP191]], <2 x i32> [[TMP192]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP194:%.*]] = insertelement <2 x i32> [[TMP115]], i32 [[CONV_1]], i32 0
; CHECK-NEXT:    [[TMP195:%.*]] = lshr <2 x i32> [[TMP194]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP196:%.*]] = and <2 x i32> [[TMP195]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP197:%.*]] = mul <2 x i32> [[TMP196]], <i32 65535, i32 65535>
; CHECK-NEXT:    [[TMP198:%.*]] = shufflevector <2 x i32> [[TMP67]], <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
; CHECK-NEXT:    [[TMP199:%.*]] = shufflevector <2 x i32> [[TMP198]], <2 x i32> [[TMP153]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP200:%.*]] = shufflevector <2 x i32> [[TMP67]], <2 x i32> [[TMP153]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP201:%.*]] = sub <2 x i32> [[TMP199]], [[TMP200]]
; CHECK-NEXT:    [[TMP202:%.*]] = extractelement <2 x i32> [[TMP201]], i32 1
; CHECK-NEXT:    [[ADD105_1:%.*]] = add i32 [[SUB102_1]], [[TMP202]]
; CHECK-NEXT:    [[ADD_I52_1:%.*]] = add i32 [[MUL_I51_1]], [[ADD105_1]]
; CHECK-NEXT:    [[XOR_I53_1:%.*]] = xor i32 [[ADD_I52_1]], [[TMP76]]
; CHECK-NEXT:    [[ADD108_1:%.*]] = add i32 [[XOR_I53_1]], [[ADD113]]
; CHECK-NEXT:    [[TMP203:%.*]] = extractelement <2 x i32> [[TMP175]], i32 0
; CHECK-NEXT:    [[ADD110_1:%.*]] = add i32 [[ADD108_1]], [[TMP203]]
; CHECK-NEXT:    [[TMP204:%.*]] = extractelement <2 x i32> [[TMP175]], i32 1
; CHECK-NEXT:    [[ADD112_1:%.*]] = add i32 [[ADD110_1]], [[TMP204]]
; CHECK-NEXT:    [[TMP205:%.*]] = shufflevector <2 x i32> [[TMP188]], <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
; CHECK-NEXT:    [[TMP206:%.*]] = insertelement <2 x i32> [[TMP205]], i32 [[SUB102_1]], i32 1
; CHECK-NEXT:    [[TMP207:%.*]] = add <2 x i32> [[TMP201]], [[TMP206]]
; CHECK-NEXT:    [[TMP208:%.*]] = sub <2 x i32> [[TMP201]], [[TMP206]]
; CHECK-NEXT:    [[TMP209:%.*]] = shufflevector <2 x i32> [[TMP207]], <2 x i32> [[TMP208]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP210:%.*]] = add <2 x i32> [[TMP197]], [[TMP209]]
; CHECK-NEXT:    [[TMP211:%.*]] = xor <2 x i32> [[TMP210]], [[TMP194]]
; CHECK-NEXT:    [[TMP212:%.*]] = extractelement <2 x i32> [[TMP211]], i32 1
; CHECK-NEXT:    [[ADD113_1:%.*]] = add i32 [[ADD112_1]], [[TMP212]]
; CHECK-NEXT:    [[TMP213:%.*]] = shufflevector <2 x i32> <i32 65535, i32 poison>, <2 x i32> [[TMP201]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP214:%.*]] = mul <2 x i32> [[TMP188]], [[TMP213]]
; CHECK-NEXT:    [[TMP215:%.*]] = sub <2 x i32> [[TMP188]], [[TMP213]]
; CHECK-NEXT:    [[TMP216:%.*]] = shufflevector <2 x i32> [[TMP214]], <2 x i32> [[TMP215]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP217:%.*]] = add <2 x i32> [[TMP158]], [[TMP193]]
; CHECK-NEXT:    [[TMP218:%.*]] = xor <2 x i32> [[TMP217]], [[TMP124]]
; CHECK-NEXT:    [[TMP219:%.*]] = extractelement <2 x i32> [[TMP216]], i32 0
; CHECK-NEXT:    [[TMP220:%.*]] = extractelement <2 x i32> [[TMP216]], i32 1
; CHECK-NEXT:    [[ADD_I62_2:%.*]] = add i32 [[TMP219]], [[TMP220]]
; CHECK-NEXT:    [[XOR_I63_2:%.*]] = xor i32 [[ADD_I62_2]], [[ADD44]]
; CHECK-NEXT:    [[TMP221:%.*]] = extractelement <2 x i32> [[TMP211]], i32 0
; CHECK-NEXT:    [[ADD108_2:%.*]] = add i32 [[TMP221]], [[ADD113_1]]
; CHECK-NEXT:    [[TMP222:%.*]] = extractelement <2 x i32> [[TMP218]], i32 0
; CHECK-NEXT:    [[ADD110_2:%.*]] = add i32 [[ADD108_2]], [[TMP222]]
; CHECK-NEXT:    [[TMP223:%.*]] = extractelement <2 x i32> [[TMP218]], i32 1
; CHECK-NEXT:    [[ADD112_2:%.*]] = add i32 [[ADD110_2]], [[TMP223]]
; CHECK-NEXT:    [[ADD113_2:%.*]] = add i32 [[ADD112_2]], [[XOR_I63_2]]
; CHECK-NEXT:    [[TMP224:%.*]] = insertelement <2 x i32> poison, i32 [[SUB59]], i32 0
; CHECK-NEXT:    [[TMP225:%.*]] = shufflevector <2 x i32> [[TMP224]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP226:%.*]] = add <2 x i32> [[TMP225]], [[TMP160]]
; CHECK-NEXT:    [[TMP227:%.*]] = sub <2 x i32> [[TMP225]], [[TMP160]]
; CHECK-NEXT:    [[TMP228:%.*]] = shufflevector <2 x i32> [[TMP226]], <2 x i32> [[TMP227]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP229:%.*]] = add <2 x i32> [[TMP87]], [[TMP228]]
; CHECK-NEXT:    [[TMP230:%.*]] = sub <2 x i32> [[TMP228]], [[TMP87]]
; CHECK-NEXT:    [[TMP231:%.*]] = add <2 x i32> [[TMP120]], [[TMP229]]
; CHECK-NEXT:    [[TMP232:%.*]] = xor <2 x i32> [[TMP231]], [[TMP90]]
; CHECK-NEXT:    [[TMP233:%.*]] = lshr <2 x i32> [[TMP80]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP234:%.*]] = and <2 x i32> [[TMP233]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP235:%.*]] = mul <2 x i32> [[TMP234]], <i32 65535, i32 65535>
; CHECK-NEXT:    [[TMP236:%.*]] = add <2 x i32> [[TMP235]], [[TMP230]]
; CHECK-NEXT:    [[TMP237:%.*]] = xor <2 x i32> [[TMP236]], [[TMP80]]
; CHECK-NEXT:    [[TMP238:%.*]] = extractelement <2 x i32> [[TMP232]], i32 1
; CHECK-NEXT:    [[ADD108_3:%.*]] = add i32 [[TMP238]], [[ADD113_2]]
; CHECK-NEXT:    [[TMP239:%.*]] = extractelement <2 x i32> [[TMP232]], i32 0
; CHECK-NEXT:    [[ADD110_3:%.*]] = add i32 [[ADD108_3]], [[TMP239]]
; CHECK-NEXT:    [[TMP240:%.*]] = extractelement <2 x i32> [[TMP237]], i32 0
; CHECK-NEXT:    [[ADD112_3:%.*]] = add i32 [[ADD110_3]], [[TMP240]]
; CHECK-NEXT:    [[TMP241:%.*]] = extractelement <2 x i32> [[TMP237]], i32 1
; CHECK-NEXT:    [[ADD113_3:%.*]] = add i32 [[ADD112_3]], [[TMP241]]
