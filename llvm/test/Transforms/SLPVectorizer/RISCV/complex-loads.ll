...
; CHECK-NEXT:    [[TMP43:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX5_3]], i64 -4, <2 x i1> splat (i1 true), i32 2)
; CHECK-NEXT:    [[TMP45:%.*]] = load <4 x i8>, ptr null, align 1
; CHECK-NEXT:    [[TMP52:%.*]] = load i8, ptr null, align 1
; CHECK-NEXT:    [[TMP46:%.*]] = shufflevector <4 x i8> [[TMP45]], <4 x i8> poison, <2 x i32> <i32 2, i32 poison>
; CHECK-NEXT:    [[TMP53:%.*]] = insertelement <2 x i8> [[TMP46]], i8 [[TMP52]], i32 1
...
; CHECK-NEXT:    [[TMP54:%.*]] = call <2 x i8> @llvm.masked.gather.v2i8.v2p0(<2 x ptr> [[TMP48]], i32 1, <2 x i1> splat (i1 true), <2 x i8> poison)
...
; CHECK-NEXT:    [[TMP47:%.*]] = insertelement <2 x i8> poison, i8 [[TMP33]], i32 0
; CHECK-NEXT:    [[TMP63:%.*]] = shufflevector <2 x i8> [[TMP47]], <2 x i8> [[TMP43]], <2 x i32> <i32 0, i32 2>
...
; CHECK-NEXT:    [[TMP60:%.*]] = add <2 x i32> [[TMP167]], [[TMP59]]
; CHECK-NEXT:    [[TMP64:%.*]] = shufflevector <4 x i8> [[TMP45]], <4 x i8> poison, <2 x i32> <i32 3, i32 1>
; CHECK-NEXT:    [[TMP79:%.*]] = zext <2 x i8> [[TMP64]] to <2 x i32>
; CHECK-NEXT:    [[TMP72:%.*]] = load <2 x i8>, ptr null, align 1
; CHECK-NEXT:    [[TMP82:%.*]] = insertelement <2 x i8> [[TMP72]], i8 [[TMP34]], i32 0
; CHECK-NEXT:    [[TMP91:%.*]] = zext <2 x i8> [[TMP82]] to <2 x i32>
; CHECK-NEXT:    [[TMP65:%.*]] = sub <2 x i32> [[TMP79]], [[TMP91]]
; CHECK-NEXT:    [[TMP170:%.*]] = shufflevector <2 x i8> [[TMP72]], <2 x i8> [[TMP43]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP171:%.*]] = zext <2 x i8> [[TMP170]] to <2 x i32>
; CHECK-NEXT:    [[TMP172:%.*]] = call <2 x i8> @llvm.masked.gather.v2i8.v2p0(<2 x ptr> getelementptr (i8, <2 x ptr> zeroinitializer, <2 x i64> <i64 7, i64 5>), i32 1, <2 x i1> splat (i1 true), <2 x i8> poison)
...
; CHECK-NEXT:    [[TMP73:%.*]] = add <2 x i32> [[TMP67]], [[TMP65]]
; CHECK-NEXT:    [[TMP74:%.*]] = sub <2 x i32> [[TMP60]], [[TMP73]]
; CHECK-NEXT:    [[TMP83:%.*]] = shufflevector <2 x i32> [[TMP73]], <2 x i32> [[TMP42]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP68:%.*]] = shufflevector <2 x i32> [[TMP60]], <2 x i32> [[TMP30]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP75:%.*]] = add <2 x i32> [[TMP83]], [[TMP68]]
; CHECK-NEXT:    [[TMP70:%.*]] = shufflevector <2 x i32> [[TMP73]], <2 x i32> [[TMP42]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP71:%.*]] = shufflevector <2 x i32> [[TMP60]], <2 x i32> [[TMP30]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP69:%.*]] = add <2 x i32> [[TMP70]], [[TMP71]]
; CHECK-NEXT:    [[TMP197:%.*]] = extractelement <2 x i32> [[TMP75]], i32 1
; CHECK-NEXT:    [[XOR_I63_2:%.*]] = extractelement <2 x i32> [[TMP69]], i32 1
; CHECK-NEXT:    [[ADD48_2:%.*]] = add i32 [[XOR_I63_2]], [[TMP197]]
; CHECK-NEXT:    [[SUB59:%.*]] = extractelement <2 x i32> [[TMP75]], i32 0
; CHECK-NEXT:    [[SUB59_1:%.*]] = extractelement <2 x i32> [[TMP69]], i32 0
; CHECK-NEXT:    [[ADD94:%.*]] = add i32 [[SUB59_1]], [[SUB59]]
; CHECK-NEXT:    [[TMP222:%.*]] = sub <2 x i32> [[TMP75]], [[TMP69]]
; CHECK-NEXT:    [[SUB47_3:%.*]] = extractelement <2 x i32> [[TMP74]], i32 0
; CHECK-NEXT:    [[SUB45_3:%.*]] = extractelement <2 x i32> [[TMP74]], i32 1
; CHECK-NEXT:    [[ADD55_3:%.*]] = add i32 [[SUB47_3]], [[SUB45_3]]
; CHECK-NEXT:    [[TMP78:%.*]] = shufflevector <2 x i32> [[TMP74]], <2 x i32> [[TMP44]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP80:%.*]] = shufflevector <2 x i32> [[TMP74]], <2 x i32> [[TMP44]], <2 x i32> <i32 0, i32 3>
...
; CHECK-NEXT:    [[SHR_I49_1:%.*]] = lshr i32 [[XOR_I63_2]], 15
...
; CHECK-NEXT:    [[TMP118:%.*]] = sub <2 x i32> [[TMP116]], [[TMP113]]
...
; CHECK-NEXT:    [[TMP123:%.*]] = shufflevector <2 x i32> [[TMP126]], <2 x i32> [[TMP44]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP124:%.*]] = shufflevector <2 x i32> [[TMP126]], <2 x i32> [[TMP44]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP121:%.*]] = sub <2 x i32> [[TMP123]], [[TMP124]]
; CHECK-NEXT:    [[TMP122:%.*]] = add <2 x i32> [[TMP123]], [[TMP124]]
; CHECK-NEXT:    [[TMP119:%.*]] = shufflevector <2 x i32> [[TMP121]], <2 x i32> [[TMP122]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP129:%.*]] = extractelement <2 x i32> [[TMP119]], i32 1
; CHECK-NEXT:    [[ADD94_1:%.*]] = add i32 [[ADD55_3]], [[TMP129]]
; CHECK-NEXT:    [[TMP125:%.*]] = extractelement <2 x i32> [[TMP118]], i32 0
; CHECK-NEXT:    [[TMP128:%.*]] = extractelement <2 x i32> [[TMP118]], i32 1
; CHECK-NEXT:    [[ADD55:%.*]] = add i32 [[TMP128]], [[TMP125]]
; CHECK-NEXT:    [[SUB60:%.*]] = sub i32 [[TMP125]], [[TMP128]]
; CHECK-NEXT:    [[SHR_I59_1:%.*]] = lshr i32 [[TMP127]], 15
...
; CHECK-NEXT:    [[XOR_I53:%.*]] = xor i32 [[ADD_I52]], [[XOR_I63_2]]
...
; CHECK-NEXT:    [[TMP177:%.*]] = extractelement <2 x i32> [[TMP119]], i32 0
; CHECK-NEXT:    [[ADD78_2:%.*]] = add i32 [[SUB51_1]], [[TMP177]]
; CHECK-NEXT:    [[TMP178:%.*]] = insertelement <2 x i32> poison, i32 [[ADD78_2]], i32 0
; CHECK-NEXT:    [[TMP179:%.*]] = shufflevector <2 x i32> [[TMP178]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP166:%.*]] = insertelement <2 x i32> poison, i32 [[ADD94_3]], i32 0
; CHECK-NEXT:    [[TMP180:%.*]] = shufflevector <2 x i32> [[TMP166]], <2 x i32> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP168:%.*]] = add <2 x i32> [[TMP179]], [[TMP180]]
; CHECK-NEXT:    [[TMP169:%.*]] = sub <2 x i32> [[TMP179]], [[TMP180]]
; CHECK-NEXT:    [[TMP201:%.*]] = shufflevector <2 x i32> [[TMP168]], <2 x i32> [[TMP169]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP195:%.*]] = insertelement <2 x i32> [[TMP118]], i32 [[CONV_1]], i32 0
; CHECK-NEXT:    [[TMP205:%.*]] = lshr <2 x i32> [[TMP195]], splat (i32 15)
; CHECK-NEXT:    [[TMP206:%.*]] = and <2 x i32> [[TMP205]], splat (i32 65537)
; CHECK-NEXT:    [[TMP174:%.*]] = mul <2 x i32> [[TMP206]], splat (i32 65535)
; CHECK-NEXT:    [[TMP175:%.*]] = shufflevector <2 x i32> [[TMP222]], <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
; CHECK-NEXT:    [[TMP176:%.*]] = insertelement <2 x i32> [[TMP175]], i32 [[ADD55]], i32 1
; CHECK-NEXT:    [[TMP207:%.*]] = insertelement <2 x i32> [[TMP222]], i32 [[ADD55_1]], i32 1
; CHECK-NEXT:    [[TMP210:%.*]] = sub <2 x i32> [[TMP176]], [[TMP207]]
; CHECK-NEXT:    [[TMP220:%.*]] = insertelement <2 x i32> poison, i32 [[SUB51_1]], i32 0
; CHECK-NEXT:    [[TMP221:%.*]] = insertelement <2 x i32> [[TMP220]], i32 [[ADD55_3]], i32 1
; CHECK-NEXT:    [[TMP181:%.*]] = sub <2 x i32> [[TMP119]], [[TMP221]]
; CHECK-NEXT:    [[TMP182:%.*]] = load <2 x i8>, ptr [[ADD_PTR_1]], align 1
; CHECK-NEXT:    [[TMP183:%.*]] = zext <2 x i8> [[TMP182]] to <2 x i32>
; CHECK-NEXT:    [[TMP184:%.*]] = lshr <2 x i32> [[TMP183]], splat (i32 15)
; CHECK-NEXT:    [[TMP223:%.*]] = and <2 x i32> [[TMP184]], splat (i32 65537)
; CHECK-NEXT:    [[TMP226:%.*]] = mul <2 x i32> [[TMP223]], splat (i32 65535)
; CHECK-NEXT:    [[TMP227:%.*]] = shufflevector <2 x i32> [[TMP181]], <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
; CHECK-NEXT:    [[TMP228:%.*]] = insertelement <2 x i32> [[TMP227]], i32 [[ADD94_1]], i32 1
; CHECK-NEXT:    [[TMP229:%.*]] = shufflevector <2 x i32> [[TMP210]], <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
; CHECK-NEXT:    [[TMP230:%.*]] = insertelement <2 x i32> [[TMP229]], i32 [[ADD78_1]], i32 1
; CHECK-NEXT:    [[TMP191:%.*]] = add <2 x i32> [[TMP228]], [[TMP230]]
; CHECK-NEXT:    [[TMP192:%.*]] = add <2 x i32> [[TMP226]], [[TMP191]]
; CHECK-NEXT:    [[TMP231:%.*]] = xor <2 x i32> [[TMP192]], [[TMP183]]
; CHECK-NEXT:    [[TMP194:%.*]] = extractelement <2 x i32> [[TMP231]], i32 0
; CHECK-NEXT:    [[ADD112_1:%.*]] = add i32 [[TMP194]], [[ADD105_3]]
; CHECK-NEXT:    [[TMP204:%.*]] = extractelement <2 x i32> [[TMP231]], i32 1
; CHECK-NEXT:    [[ADD113_1:%.*]] = add i32 [[ADD112_1]], [[TMP204]]
; CHECK-NEXT:    [[ADD112_2:%.*]] = add i32 [[ADD113_1]], [[XOR_I58_1]]
; CHECK-NEXT:    [[TMP196:%.*]] = add <2 x i32> [[TMP210]], [[TMP181]]
; CHECK-NEXT:    [[TMP232:%.*]] = sub <2 x i32> [[TMP210]], [[TMP181]]
; CHECK-NEXT:    [[TMP198:%.*]] = shufflevector <2 x i32> [[TMP196]], <2 x i32> [[TMP232]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP233:%.*]] = add <2 x i32> [[TMP174]], [[TMP198]]
; CHECK-NEXT:    [[TMP234:%.*]] = xor <2 x i32> [[TMP233]], [[TMP195]]
; CHECK-NEXT:    [[TMP235:%.*]] = extractelement <2 x i32> [[TMP234]], i32 1
; CHECK-NEXT:    [[ADD113_2:%.*]] = add i32 [[ADD112_2]], [[TMP235]]
; CHECK-NEXT:    [[TMP202:%.*]] = extractelement <2 x i32> [[TMP210]], i32 0
; CHECK-NEXT:    [[TMP203:%.*]] = extractelement <2 x i32> [[TMP181]], i32 0
; CHECK-NEXT:    [[TMP236:%.*]] = shufflevector <2 x i32> [[TMP181]], <2 x i32> [[TMP210]], <2 x i32> <i32 0, i32 2>
...
; CHECK-NEXT:    [[XOR_I53_2:%.*]] = extractelement <2 x i32> [[TMP234]], i32 0
