...
; CHECK-NEXT:    [[FIRST:%.*]] = call i32 @llvm.vp.first.nxv16i1(<vscale x 16 x i1> [[MISMATCH_CMP]], <vscale x 16 x i1> splat (i1 true), i32 [[TMP19]])
...
; LMUL8-NEXT:    [[FIRST:%.*]] = call i32 @llvm.vp.first.nxv64i1(<vscale x 64 x i1> [[MISMATCH_CMP]], <vscale x 64 x i1> splat (i1 true), i32 [[TMP19]])
...
; LOOP-DEL-NEXT:    [[FIRST:%.*]] = call i32 @llvm.vp.first.nxv16i1(<vscale x 16 x i1> [[MISMATCH_CMP]], <vscale x 16 x i1> splat (i1 true), i32 [[TMP19]])
...
; CHECK-NEXT:    [[FIRST:%.*]] = call i32 @llvm.vp.first.nxv16i1(<vscale x 16 x i1> [[MISMATCH_CMP]], <vscale x 16 x i1> splat (i1 true), i32 [[TMP15]])
...
; LMUL8-NEXT:    [[FIRST:%.*]] = call i32 @llvm.vp.first.nxv64i1(<vscale x 64 x i1> [[MISMATCH_CMP]], <vscale x 64 x i1> splat (i1 true), i32 [[TMP15]])
