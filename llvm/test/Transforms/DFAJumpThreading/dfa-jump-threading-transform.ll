...
; CHECK-NEXT:    br i1 [[CMP2:%.*]], label [[SI_UNFOLD_TRUE:%.*]], label [[BB7_JT0]]
; CHECK:       si.unfold.true:
; CHECK-NEXT:    br i1 [[CMP1:%.*]], label [[BB7_JT0]], label [[SI_UNFOLD_FALSE:%.*]]
; CHECK:       si.unfold.false:
; CHECK-NEXT:    br label [[BB7:%.*]]
; CHECK:       BB7:
; CHECK-NEXT:    switch i32 poison, label [[BB1_BACKEDGE]] [
; CHECK-NEXT:      i32 0, label [[BB1]]
; CHECK-NEXT:      i32 1, label [[BB8:%.*]]
; CHECK-NEXT:    ]
; CHECK:       BB7.jt1:
; CHECK-NEXT:    [[D_PROMOTED4_JT1:%.*]] = phi i16 [ 1, [[SI_UNFOLD_FALSE]] ]
; CHECK-NEXT:    [[_3_JT1:%.*]] = phi i32 [ 1, [[SI_UNFOLD_FALSE]] ]
; CHECK-NEXT:    br label [[BB8]]
; CHECK:       BB7.jt0:
; CHECK-NEXT:    [[D_PROMOTED4_JT0:%.*]] = phi i16 [ 0, [[BB1]] ], [ 1, [[BB2]] ], [ 1, [[SI_UNFOLD_TRUE]] ]
; CHECK-NEXT:    [[_3_JT0:%.*]] = phi i32 [ 0, [[BB1]] ], [ 0, [[BB2]] ], [ 0, [[SI_UNFOLD_TRUE]] ]
; CHECK-NEXT:    br label [[BB1]]
; CHECK:       BB1.backedge:
; CHECK-NEXT:    br label [[BB1]]
; CHECK:       BB8:
...
; CHECK-NEXT:    br i1 [[NOT2]], label [[SI_UNFOLD_TRUE:%.*]], label [[SELECT_UNFOLD_JT0]]
; CHECK:       si.unfold.true:
; CHECK-NEXT:    br i1 [[CMP1:%.*]], label [[SELECT_UNFOLD_JT0]], label [[SI_UNFOLD_FALSE:%.*]]
; CHECK:       si.unfold.false:
; CHECK-NEXT:    br label [[SELECT_UNFOLD:%.*]]
; CHECK:       select.unfold:
; CHECK-NEXT:    switch i32 poison, label [[BB2:%.*]] [
; CHECK-NEXT:      i32 0, label [[DOTPREHEADER_PREHEADER:%.*]]
; CHECK-NEXT:      i32 1, label [[DOTLOOPEXIT6]]
; CHECK-NEXT:    ]
; CHECK:       select.unfold.jt1:
; CHECK-NEXT:    [[_2_JT1:%.*]] = phi i32 [ 1, [[SI_UNFOLD_FALSE]] ]
; CHECK-NEXT:    br label [[DOTLOOPEXIT6]]
; CHECK:       select.unfold.jt0:
; CHECK-NEXT:    [[_2_JT0:%.*]] = phi i32 [ 0, [[DOTLOOPEXIT6]] ], [ 0, [[BB1]] ], [ 0, [[SI_UNFOLD_TRUE]] ]
