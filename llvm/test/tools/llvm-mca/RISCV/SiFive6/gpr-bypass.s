...
# RUN: llvm-mca -mtriple=riscv64 -mcpu=sifive-u64 -mattr=+zba,+zbb -timeline \
...
# CHECK-NEXT: Total Cycles:      116
# CHECK-NEXT: Total uOps:        91

# CHECK:      Dispatch Width:    1
# CHECK-NEXT: uOps Per Cycle:    0.78
# CHECK-NEXT: IPC:               0.78
# CHECK-NEXT: Block RThroughput: 91.0
...
# CHECK-NEXT:  1      3     1.00                        lui	a0, 1
# CHECK-NEXT:  1      3     1.00                        auipc	a1, 1
# CHECK-NEXT:  1      3     1.00                        add	a0, a0, a1
# CHECK-NEXT:  1      3     1.00                        addi	a0, a0, 1
# CHECK-NEXT:  1      3     1.00                        addw	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        addiw	a0, a0, 1
# CHECK-NEXT:  1      3     1.00                        sub	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        subw	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        and	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        andi	a0, a0, 1
# CHECK-NEXT:  1      3     1.00                        or	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        ori	a0, a0, 1
# CHECK-NEXT:  1      3     1.00                        xor	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        xori	a0, a0, 1
# CHECK-NEXT:  1      3     1.00                        sll	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        slli	a0, a0, 1
# CHECK-NEXT:  1      3     1.00                        sllw	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        slliw	a0, a0, 1
# CHECK-NEXT:  1      3     1.00                        srl	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        srli	a0, a0, 1
# CHECK-NEXT:  1      3     1.00                        srlw	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        srliw	a0, a0, 1
# CHECK-NEXT:  1      3     1.00                        sra	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        srai	a0, a0, 1
# CHECK-NEXT:  1      3     1.00                        sraw	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        sraiw	a0, a0, 1
# CHECK-NEXT:  1      3     1.00                        slt	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        slti	a0, a0, 1
# CHECK-NEXT:  1      3     1.00                        sltu	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        seqz	a0, a0
# CHECK-NEXT:  1      3     1.00                        mul	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        add	a0, a0, a0
...
# CHECK-NEXT:  1      3     1.00                        add.uw	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        slli.uw	a0, a0, 1
...
# CHECK-NEXT:  1      3     1.00                        andn	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        orn	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        xnor	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        sext.b	a0, a0
# CHECK-NEXT:  1      3     1.00                        sext.h	a0, a0
# CHECK-NEXT:  1      3     1.00                        zext.h	a0, a0
...
# CHECK-NEXT:  1      3     1.00                        add	a0, a0, a0
# CHECK-NEXT:  1      3     1.00                        rev8	a0, a0
...
# CHECK:      Resources:
# CHECK-NEXT: [0]   - SiFive6FDiv
# CHECK-NEXT: [1]   - SiFive6IDiv
# CHECK-NEXT: [2]   - SiFive6Pipe
...
# CHECK:      Timeline view:
# CHECK-NEXT:                     0123456789          0123456789          0123456789          0123456789          0123456789          012345
