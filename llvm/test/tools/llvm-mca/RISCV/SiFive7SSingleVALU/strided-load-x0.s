...
# RUN: llvm-mca -mtriple=riscv64 -mcpu=sifive-x392-ea-singlevalu -iterations=1 < %s | FileCheck %s
...
# CHECK:      Resources:
# CHECK-NEXT: [0]   - VLEN1024SiFive7NFDiv
# CHECK-NEXT: [1]   - VLEN1024SiFive7NIDiv
# CHECK-NEXT: [2]   - VLEN1024SiFive7NMem
# CHECK-NEXT: [3]   - VLEN1024SiFive7NPipeA
# CHECK-NEXT: [4]   - VLEN1024SiFive7NPipeB
# CHECK-NEXT: [5]   - VLEN1024SiFive7NVA
# CHECK-NEXT: [6]   - VLEN1024SiFive7NVCQ
# CHECK-NEXT: [7]   - VLEN1024SiFive7NVL
# CHECK-NEXT: [8]   - VLEN1024SiFive7NVS
