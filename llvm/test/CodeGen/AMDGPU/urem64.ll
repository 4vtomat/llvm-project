...
; GCN:       ; %bb.0:
; GCN-NEXT:    s_load_dwordx2 s[12:13], s[2:3], 0xd
; GCN-NEXT:    s_load_dwordx4 s[8:11], s[2:3], 0x9
...
; GCN-IR-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0xd
; GCN-IR-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x9
...
; GCN:       ; %bb.0:
; GCN-NEXT:    s_load_dword s0, s[2:3], 0xe
; GCN-NEXT:    s_mov_b32 s7, 0xf000
; GCN-NEXT:    s_mov_b32 s6, -1
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-IR:       ; %bb.0:
; GCN-IR-NEXT:    s_load_dword s0, s[2:3], 0xe
...
; GCN:       ; %bb.0:
; GCN-NEXT:    s_load_dwordx8 s[4:11], s[2:3], 0xd
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_mov_b32 s6, -1
; GCN-NEXT:    s_lshr_b32 s0, s9, 1
; GCN-NEXT:    v_cvt_f32_u32_e32 v0, s0
; GCN-NEXT:    s_sub_i32 s1, 0, s0
; GCN-NEXT:    s_lshr_b32 s4, s5, 1
; GCN-NEXT:    s_lshr_b32 s8, s7, 1
; GCN-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GCN-NEXT:    s_mov_b32 s7, 0xf000
; GCN-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GCN-NEXT:    v_cvt_u32_f32_e32 v0, v0
...
; GCN-NEXT:    s_mul_i32 s5, s5, s0
; GCN-NEXT:    s_sub_i32 s4, s4, s5
; GCN-NEXT:    s_sub_i32 s5, s4, s0
; GCN-NEXT:    s_cmp_ge_u32 s4, s0
; GCN-NEXT:    s_cselect_b32 s4, s5, s4
; GCN-NEXT:    s_sub_i32 s5, s4, s0
; GCN-NEXT:    s_cmp_ge_u32 s4, s0
; GCN-NEXT:    s_cselect_b32 s0, s5, s4
; GCN-NEXT:    s_sub_i32 s4, 0, s1
; GCN-NEXT:    v_mul_lo_u32 v0, s4, v1
...
; GCN-IR:       ; %bb.0:
; GCN-IR-NEXT:    s_load_dwordx8 s[4:11], s[2:3], 0xd
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    s_mov_b32 s6, -1
; GCN-IR-NEXT:    s_lshr_b32 s0, s9, 1
; GCN-IR-NEXT:    v_cvt_f32_u32_e32 v0, s0
; GCN-IR-NEXT:    s_sub_i32 s1, 0, s0
; GCN-IR-NEXT:    s_lshr_b32 s4, s5, 1
; GCN-IR-NEXT:    s_lshr_b32 s8, s7, 1
; GCN-IR-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GCN-IR-NEXT:    s_mov_b32 s7, 0xf000
; GCN-IR-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GCN-IR-NEXT:    v_cvt_u32_f32_e32 v0, v0
...
; GCN-IR-NEXT:    v_cvt_f32_u32_e32 v2, s1
; GCN-IR-NEXT:    v_mul_hi_u32 v1, v0, v1
...
; GCN-IR-NEXT:    s_mul_i32 s5, s5, s0
; GCN-IR-NEXT:    s_sub_i32 s4, s4, s5
; GCN-IR-NEXT:    s_sub_i32 s5, s4, s0
; GCN-IR-NEXT:    s_cmp_ge_u32 s4, s0
; GCN-IR-NEXT:    s_cselect_b32 s4, s5, s4
; GCN-IR-NEXT:    s_sub_i32 s5, s4, s0
; GCN-IR-NEXT:    s_cmp_ge_u32 s4, s0
; GCN-IR-NEXT:    s_cselect_b32 s0, s5, s4
; GCN-IR-NEXT:    s_sub_i32 s4, 0, s1
; GCN-IR-NEXT:    v_mul_lo_u32 v0, s4, v1
; GCN-IR-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0x9
...
; GCN-IR-NEXT:    v_readfirstlane_b32 s0, v2
; GCN-IR-NEXT:    s_mul_i32 s0, s0, s1
; GCN-IR-NEXT:    s_sub_i32 s0, s8, s0
; GCN-IR-NEXT:    s_sub_i32 s2, s0, s1
; GCN-IR-NEXT:    s_cmp_ge_u32 s0, s1
...
; GCN:       ; %bb.0:
; GCN-NEXT:    s_load_dword s4, s[2:3], 0xe
; GCN-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x9
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-IR:       ; %bb.0:
; GCN-IR-NEXT:    s_load_dword s4, s[2:3], 0xe
; GCN-IR-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x9
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-IR-NEXT:    s_sub_i32 s1, 0, s0
; GCN-IR-NEXT:    s_lshr_b32 s4, s5, 1
; GCN-IR-NEXT:    s_lshr_b32 s8, s7, 9
; GCN-IR-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GCN-IR-NEXT:    s_mov_b32 s7, 0xf000
; GCN-IR-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GCN-IR-NEXT:    v_cvt_u32_f32_e32 v0, v0
