...
; RUN: llc < %s -mtriple=riscv64 -mcpu=sifive-x280n -mattr=+v -riscv-force-tail-undisturbed -riscv-enable-subreg-liveness | FileCheck %s -check-prefix=X280
; RUN: llc < %s -mtriple=riscv64 -mcpu=sifive-x280 -mattr=+v -riscv-force-tail-undisturbed -riscv-enable-subreg-liveness | FileCheck %s -check-prefix=X280N
