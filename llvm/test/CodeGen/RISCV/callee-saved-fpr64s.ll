...
; ILP32-NEXT:    fld fs8, 200(a1)
; ILP32-NEXT:    fld fs9, 208(a1)
; ILP32-NEXT:    fld fs10, 216(a1)
...
; ILP32-NEXT:    fsd fs10, 216(a1)
; ILP32-NEXT:    fsd fs9, 208(a1)
; ILP32-NEXT:    fsd fs8, 200(a1)
...
; LP64-NEXT:    fld fs8, 200(a1)
; LP64-NEXT:    fld fs9, 208(a1)
; LP64-NEXT:    fld fs10, 216(a1)
...
; LP64-NEXT:    fsd fs10, 216(a1)
; LP64-NEXT:    fsd fs9, 208(a1)
; LP64-NEXT:    fsd fs8, 200(a1)
...
; LP64E-NEXT:    fld fs8, 200(a1)
; LP64E-NEXT:    fld fs9, 208(a1)
; LP64E-NEXT:    fld fs10, 216(a1)
...
; LP64E-NEXT:    fsd fs10, 216(a1)
; LP64E-NEXT:    fsd fs9, 208(a1)
; LP64E-NEXT:    fsd fs8, 200(a1)
...
; ILP32D-NEXT:    fld fs8, 200(a1)
; ILP32D-NEXT:    fld fs9, 208(a1)
; ILP32D-NEXT:    fld fs10, 216(a1)
...
; ILP32D-NEXT:    fsd fs10, 216(a1)
; ILP32D-NEXT:    fsd fs9, 208(a1)
; ILP32D-NEXT:    fsd fs8, 200(a1)
...
; LP64D-NEXT:    fld fs8, 200(a1)
; LP64D-NEXT:    fld fs9, 208(a1)
; LP64D-NEXT:    fld fs10, 216(a1)
...
; LP64D-NEXT:    fsd fs10, 216(a1)
; LP64D-NEXT:    fsd fs9, 208(a1)
; LP64D-NEXT:    fsd fs8, 200(a1)
