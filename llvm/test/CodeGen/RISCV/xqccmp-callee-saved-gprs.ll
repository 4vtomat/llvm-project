...
; RV32IXQCCMP-NEXT:    lui a2, %hi(var)
; RV32IXQCCMP-NEXT:    addi a2, a2, %lo(var)
; RV32IXQCCMP-NEXT:    lw a0, %lo(var)(a0)
; RV32IXQCCMP-NEXT:    sw a0, 28(sp) # 4-byte Folded Spill
; RV32IXQCCMP-NEXT:    lw a0, 4(a2)
; RV32IXQCCMP-NEXT:    sw a0, 24(sp) # 4-byte Folded Spill
; RV32IXQCCMP-NEXT:    lw a0, 8(a2)
; RV32IXQCCMP-NEXT:    sw a0, 20(sp) # 4-byte Folded Spill
; RV32IXQCCMP-NEXT:    lw a0, 12(a2)
; RV32IXQCCMP-NEXT:    sw a0, 16(sp) # 4-byte Folded Spill
; RV32IXQCCMP-NEXT:    lw a0, 16(a2)
; RV32IXQCCMP-NEXT:    sw a0, 12(sp) # 4-byte Folded Spill
; RV32IXQCCMP-NEXT:    lw t4, 20(a2)
; RV32IXQCCMP-NEXT:    lw t5, 24(a2)
; RV32IXQCCMP-NEXT:    lw t6, 28(a2)
; RV32IXQCCMP-NEXT:    lw s2, 32(a2)
; RV32IXQCCMP-NEXT:    lw s3, 36(a2)
; RV32IXQCCMP-NEXT:    lw s4, 40(a2)
; RV32IXQCCMP-NEXT:    lw s5, 44(a2)
; RV32IXQCCMP-NEXT:    lw s6, 48(a2)
; RV32IXQCCMP-NEXT:    lw s7, 52(a2)
; RV32IXQCCMP-NEXT:    lw s8, 56(a2)
; RV32IXQCCMP-NEXT:    lw s9, 60(a2)
; RV32IXQCCMP-NEXT:    lw s10, 64(a2)
; RV32IXQCCMP-NEXT:    lw s11, 68(a2)
; RV32IXQCCMP-NEXT:    lw ra, 72(a2)
; RV32IXQCCMP-NEXT:    lw t3, 76(a2)
; RV32IXQCCMP-NEXT:    lw s0, 80(a2)
; RV32IXQCCMP-NEXT:    lw s1, 84(a2)
; RV32IXQCCMP-NEXT:    lw t2, 88(a2)
; RV32IXQCCMP-NEXT:    lw t1, 92(a2)
; RV32IXQCCMP-NEXT:    lw t0, 96(a2)
; RV32IXQCCMP-NEXT:    lw a6, 116(a2)
; RV32IXQCCMP-NEXT:    lw a4, 120(a2)
; RV32IXQCCMP-NEXT:    lw a1, 124(a2)
; RV32IXQCCMP-NEXT:    lw a7, 100(a2)
; RV32IXQCCMP-NEXT:    lw a5, 104(a2)
; RV32IXQCCMP-NEXT:    lw a3, 108(a2)
; RV32IXQCCMP-NEXT:    lw a0, 112(a2)
; RV32IXQCCMP-NEXT:    sw a1, 124(a2)
; RV32IXQCCMP-NEXT:    sw a4, 120(a2)
; RV32IXQCCMP-NEXT:    sw a6, 116(a2)
; RV32IXQCCMP-NEXT:    sw a0, 112(a2)
; RV32IXQCCMP-NEXT:    sw a3, 108(a2)
; RV32IXQCCMP-NEXT:    sw a5, 104(a2)
; RV32IXQCCMP-NEXT:    sw a7, 100(a2)
; RV32IXQCCMP-NEXT:    sw t0, 96(a2)
; RV32IXQCCMP-NEXT:    sw t1, 92(a2)
; RV32IXQCCMP-NEXT:    sw t2, 88(a2)
; RV32IXQCCMP-NEXT:    sw s1, 84(a2)
; RV32IXQCCMP-NEXT:    sw s0, 80(a2)
; RV32IXQCCMP-NEXT:    sw t3, 76(a2)
; RV32IXQCCMP-NEXT:    sw ra, 72(a2)
; RV32IXQCCMP-NEXT:    sw s11, 68(a2)
; RV32IXQCCMP-NEXT:    sw s10, 64(a2)
; RV32IXQCCMP-NEXT:    sw s9, 60(a2)
; RV32IXQCCMP-NEXT:    sw s8, 56(a2)
; RV32IXQCCMP-NEXT:    sw s7, 52(a2)
; RV32IXQCCMP-NEXT:    sw s6, 48(a2)
; RV32IXQCCMP-NEXT:    sw s5, 44(a2)
; RV32IXQCCMP-NEXT:    sw s4, 40(a2)
; RV32IXQCCMP-NEXT:    sw s3, 36(a2)
; RV32IXQCCMP-NEXT:    sw s2, 32(a2)
; RV32IXQCCMP-NEXT:    sw t6, 28(a2)
; RV32IXQCCMP-NEXT:    sw t5, 24(a2)
; RV32IXQCCMP-NEXT:    sw t4, 20(a2)
; RV32IXQCCMP-NEXT:    lw a0, 12(sp) # 4-byte Folded Reload
; RV32IXQCCMP-NEXT:    sw a0, 16(a2)
; RV32IXQCCMP-NEXT:    lw a0, 16(sp) # 4-byte Folded Reload
; RV32IXQCCMP-NEXT:    sw a0, 12(a2)
; RV32IXQCCMP-NEXT:    lw a0, 20(sp) # 4-byte Folded Reload
; RV32IXQCCMP-NEXT:    sw a0, 8(a2)
; RV32IXQCCMP-NEXT:    lw a0, 24(sp) # 4-byte Folded Reload
; RV32IXQCCMP-NEXT:    sw a0, 4(a2)
; RV32IXQCCMP-NEXT:    lw a0, 28(sp) # 4-byte Folded Reload
; RV32IXQCCMP-NEXT:    lui a1, %hi(var)
; RV32IXQCCMP-NEXT:    sw a0, %lo(var)(a1)
...
; RV32IXQCCMP-WITH-FP-NEXT:    lui a2, %hi(var)
; RV32IXQCCMP-WITH-FP-NEXT:    addi a2, a2, %lo(var)
; RV32IXQCCMP-WITH-FP-NEXT:    lw a0, %lo(var)(a0)
; RV32IXQCCMP-WITH-FP-NEXT:    sw a0, -68(s0) # 4-byte Folded Spill
; RV32IXQCCMP-WITH-FP-NEXT:    lw a0, 4(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw a0, -72(s0) # 4-byte Folded Spill
; RV32IXQCCMP-WITH-FP-NEXT:    lw a0, 8(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw a0, -76(s0) # 4-byte Folded Spill
; RV32IXQCCMP-WITH-FP-NEXT:    lw a0, 12(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw a0, -80(s0) # 4-byte Folded Spill
; RV32IXQCCMP-WITH-FP-NEXT:    lw a0, 16(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw a0, -84(s0) # 4-byte Folded Spill
; RV32IXQCCMP-WITH-FP-NEXT:    lw a0, 20(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw a0, -88(s0) # 4-byte Folded Spill
; RV32IXQCCMP-WITH-FP-NEXT:    lw t5, 24(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw t6, 28(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s2, 32(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s3, 36(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s4, 40(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s5, 44(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s6, 48(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s7, 52(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s8, 56(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s9, 60(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s10, 64(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s11, 68(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw ra, 72(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s1, 76(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw t4, 80(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw t3, 84(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw t2, 88(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw t1, 92(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw t0, 96(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw a6, 116(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw a4, 120(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw a1, 124(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw a7, 100(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw a5, 104(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw a3, 108(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw a0, 112(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw a1, 124(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw a4, 120(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw a6, 116(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw a0, 112(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw a3, 108(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw a5, 104(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw a7, 100(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw t0, 96(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw t1, 92(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw t2, 88(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw t3, 84(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw t4, 80(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s1, 76(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw ra, 72(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s11, 68(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s10, 64(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s9, 60(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s8, 56(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s7, 52(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s6, 48(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s5, 44(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s4, 40(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s3, 36(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s2, 32(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw t6, 28(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    sw t5, 24(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw a0, -88(s0) # 4-byte Folded Reload
; RV32IXQCCMP-WITH-FP-NEXT:    sw a0, 20(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw a0, -84(s0) # 4-byte Folded Reload
; RV32IXQCCMP-WITH-FP-NEXT:    sw a0, 16(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw a0, -80(s0) # 4-byte Folded Reload
; RV32IXQCCMP-WITH-FP-NEXT:    sw a0, 12(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw a0, -76(s0) # 4-byte Folded Reload
; RV32IXQCCMP-WITH-FP-NEXT:    sw a0, 8(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw a0, -72(s0) # 4-byte Folded Reload
; RV32IXQCCMP-WITH-FP-NEXT:    sw a0, 4(a2)
; RV32IXQCCMP-WITH-FP-NEXT:    lw a0, -68(s0) # 4-byte Folded Reload
; RV32IXQCCMP-WITH-FP-NEXT:    lui a1, %hi(var)
; RV32IXQCCMP-WITH-FP-NEXT:    sw a0, %lo(var)(a1)
...
; RV64IXQCCMP-NEXT:    lui a2, %hi(var)
; RV64IXQCCMP-NEXT:    addi a2, a2, %lo(var)
; RV64IXQCCMP-NEXT:    lw a0, %lo(var)(a0)
; RV64IXQCCMP-NEXT:    sd a0, 40(sp) # 8-byte Folded Spill
; RV64IXQCCMP-NEXT:    lw a0, 4(a2)
; RV64IXQCCMP-NEXT:    sd a0, 32(sp) # 8-byte Folded Spill
; RV64IXQCCMP-NEXT:    lw a0, 8(a2)
; RV64IXQCCMP-NEXT:    sd a0, 24(sp) # 8-byte Folded Spill
; RV64IXQCCMP-NEXT:    lw a0, 12(a2)
; RV64IXQCCMP-NEXT:    sd a0, 16(sp) # 8-byte Folded Spill
; RV64IXQCCMP-NEXT:    lw a0, 16(a2)
; RV64IXQCCMP-NEXT:    sd a0, 8(sp) # 8-byte Folded Spill
; RV64IXQCCMP-NEXT:    lw t4, 20(a2)
; RV64IXQCCMP-NEXT:    lw t5, 24(a2)
; RV64IXQCCMP-NEXT:    lw t6, 28(a2)
; RV64IXQCCMP-NEXT:    lw s2, 32(a2)
; RV64IXQCCMP-NEXT:    lw s3, 36(a2)
; RV64IXQCCMP-NEXT:    lw s4, 40(a2)
; RV64IXQCCMP-NEXT:    lw s5, 44(a2)
; RV64IXQCCMP-NEXT:    lw s6, 48(a2)
; RV64IXQCCMP-NEXT:    lw s7, 52(a2)
; RV64IXQCCMP-NEXT:    lw s8, 56(a2)
; RV64IXQCCMP-NEXT:    lw s9, 60(a2)
; RV64IXQCCMP-NEXT:    lw s10, 64(a2)
; RV64IXQCCMP-NEXT:    lw s11, 68(a2)
; RV64IXQCCMP-NEXT:    lw ra, 72(a2)
; RV64IXQCCMP-NEXT:    lw t3, 76(a2)
; RV64IXQCCMP-NEXT:    lw s0, 80(a2)
; RV64IXQCCMP-NEXT:    lw s1, 84(a2)
; RV64IXQCCMP-NEXT:    lw t2, 88(a2)
; RV64IXQCCMP-NEXT:    lw t1, 92(a2)
; RV64IXQCCMP-NEXT:    lw t0, 96(a2)
; RV64IXQCCMP-NEXT:    lw a6, 116(a2)
; RV64IXQCCMP-NEXT:    lw a4, 120(a2)
; RV64IXQCCMP-NEXT:    lw a1, 124(a2)
; RV64IXQCCMP-NEXT:    lw a7, 100(a2)
; RV64IXQCCMP-NEXT:    lw a5, 104(a2)
; RV64IXQCCMP-NEXT:    lw a3, 108(a2)
; RV64IXQCCMP-NEXT:    lw a0, 112(a2)
; RV64IXQCCMP-NEXT:    sw a1, 124(a2)
; RV64IXQCCMP-NEXT:    sw a4, 120(a2)
; RV64IXQCCMP-NEXT:    sw a6, 116(a2)
; RV64IXQCCMP-NEXT:    sw a0, 112(a2)
; RV64IXQCCMP-NEXT:    sw a3, 108(a2)
; RV64IXQCCMP-NEXT:    sw a5, 104(a2)
; RV64IXQCCMP-NEXT:    sw a7, 100(a2)
; RV64IXQCCMP-NEXT:    sw t0, 96(a2)
; RV64IXQCCMP-NEXT:    sw t1, 92(a2)
; RV64IXQCCMP-NEXT:    sw t2, 88(a2)
; RV64IXQCCMP-NEXT:    sw s1, 84(a2)
; RV64IXQCCMP-NEXT:    sw s0, 80(a2)
; RV64IXQCCMP-NEXT:    sw t3, 76(a2)
; RV64IXQCCMP-NEXT:    sw ra, 72(a2)
; RV64IXQCCMP-NEXT:    sw s11, 68(a2)
; RV64IXQCCMP-NEXT:    sw s10, 64(a2)
; RV64IXQCCMP-NEXT:    sw s9, 60(a2)
; RV64IXQCCMP-NEXT:    sw s8, 56(a2)
; RV64IXQCCMP-NEXT:    sw s7, 52(a2)
; RV64IXQCCMP-NEXT:    sw s6, 48(a2)
; RV64IXQCCMP-NEXT:    sw s5, 44(a2)
; RV64IXQCCMP-NEXT:    sw s4, 40(a2)
; RV64IXQCCMP-NEXT:    sw s3, 36(a2)
; RV64IXQCCMP-NEXT:    sw s2, 32(a2)
; RV64IXQCCMP-NEXT:    sw t6, 28(a2)
; RV64IXQCCMP-NEXT:    sw t5, 24(a2)
; RV64IXQCCMP-NEXT:    sw t4, 20(a2)
; RV64IXQCCMP-NEXT:    ld a0, 8(sp) # 8-byte Folded Reload
; RV64IXQCCMP-NEXT:    sw a0, 16(a2)
; RV64IXQCCMP-NEXT:    ld a0, 16(sp) # 8-byte Folded Reload
; RV64IXQCCMP-NEXT:    sw a0, 12(a2)
; RV64IXQCCMP-NEXT:    ld a0, 24(sp) # 8-byte Folded Reload
; RV64IXQCCMP-NEXT:    sw a0, 8(a2)
; RV64IXQCCMP-NEXT:    ld a0, 32(sp) # 8-byte Folded Reload
; RV64IXQCCMP-NEXT:    sw a0, 4(a2)
; RV64IXQCCMP-NEXT:    ld a0, 40(sp) # 8-byte Folded Reload
; RV64IXQCCMP-NEXT:    lui a1, %hi(var)
; RV64IXQCCMP-NEXT:    sw a0, %lo(var)(a1)
...
; RV64IXQCCMP-WITH-FP-NEXT:    lui a2, %hi(var)
; RV64IXQCCMP-WITH-FP-NEXT:    addi a2, a2, %lo(var)
; RV64IXQCCMP-WITH-FP-NEXT:    lw a0, %lo(var)(a0)
; RV64IXQCCMP-WITH-FP-NEXT:    sd a0, -120(s0) # 8-byte Folded Spill
; RV64IXQCCMP-WITH-FP-NEXT:    lw a0, 4(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sd a0, -128(s0) # 8-byte Folded Spill
; RV64IXQCCMP-WITH-FP-NEXT:    lw a0, 8(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sd a0, -136(s0) # 8-byte Folded Spill
; RV64IXQCCMP-WITH-FP-NEXT:    lw a0, 12(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sd a0, -144(s0) # 8-byte Folded Spill
; RV64IXQCCMP-WITH-FP-NEXT:    lw a0, 16(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sd a0, -152(s0) # 8-byte Folded Spill
; RV64IXQCCMP-WITH-FP-NEXT:    lw a0, 20(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sd a0, -160(s0) # 8-byte Folded Spill
; RV64IXQCCMP-WITH-FP-NEXT:    lw t5, 24(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw t6, 28(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s2, 32(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s3, 36(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s4, 40(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s5, 44(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s6, 48(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s7, 52(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s8, 56(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s9, 60(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s10, 64(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s11, 68(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw ra, 72(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s1, 76(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw t4, 80(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw t3, 84(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw t2, 88(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw t1, 92(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw t0, 96(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw a6, 116(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw a4, 120(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw a1, 124(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw a7, 100(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw a5, 104(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw a3, 108(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    lw a0, 112(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw a1, 124(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw a4, 120(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw a6, 116(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw a0, 112(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw a3, 108(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw a5, 104(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw a7, 100(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw t0, 96(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw t1, 92(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw t2, 88(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw t3, 84(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw t4, 80(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s1, 76(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw ra, 72(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s11, 68(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s10, 64(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s9, 60(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s8, 56(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s7, 52(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s6, 48(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s5, 44(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s4, 40(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s3, 36(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s2, 32(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw t6, 28(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    sw t5, 24(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    ld a0, -160(s0) # 8-byte Folded Reload
; RV64IXQCCMP-WITH-FP-NEXT:    sw a0, 20(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    ld a0, -152(s0) # 8-byte Folded Reload
; RV64IXQCCMP-WITH-FP-NEXT:    sw a0, 16(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    ld a0, -144(s0) # 8-byte Folded Reload
; RV64IXQCCMP-WITH-FP-NEXT:    sw a0, 12(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    ld a0, -136(s0) # 8-byte Folded Reload
; RV64IXQCCMP-WITH-FP-NEXT:    sw a0, 8(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    ld a0, -128(s0) # 8-byte Folded Reload
; RV64IXQCCMP-WITH-FP-NEXT:    sw a0, 4(a2)
; RV64IXQCCMP-WITH-FP-NEXT:    ld a0, -120(s0) # 8-byte Folded Reload
; RV64IXQCCMP-WITH-FP-NEXT:    lui a1, %hi(var)
; RV64IXQCCMP-WITH-FP-NEXT:    sw a0, %lo(var)(a1)
...
; RV32IXQCCMP-NEXT:    sw a0, 12(sp) # 4-byte Folded Spill
; RV32IXQCCMP-NEXT:    lw s2, 84(s0)
; RV32IXQCCMP-NEXT:    lw s3, 88(s0)
; RV32IXQCCMP-NEXT:    lw s4, 92(s0)
; RV32IXQCCMP-NEXT:    lw s5, 96(s0)
; RV32IXQCCMP-NEXT:    lw s6, 100(s0)
; RV32IXQCCMP-NEXT:    lw s7, 104(s0)
; RV32IXQCCMP-NEXT:    lw s8, 108(s0)
; RV32IXQCCMP-NEXT:    lw s9, 112(s0)
; RV32IXQCCMP-NEXT:    lw s10, 116(s0)
; RV32IXQCCMP-NEXT:    lw s11, 120(s0)
; RV32IXQCCMP-NEXT:    lw s1, 124(s0)
; RV32IXQCCMP-NEXT:    call callee
; RV32IXQCCMP-NEXT:    sw s1, 124(s0)
; RV32IXQCCMP-NEXT:    sw s11, 120(s0)
; RV32IXQCCMP-NEXT:    sw s10, 116(s0)
; RV32IXQCCMP-NEXT:    sw s9, 112(s0)
; RV32IXQCCMP-NEXT:    sw s8, 108(s0)
; RV32IXQCCMP-NEXT:    sw s7, 104(s0)
; RV32IXQCCMP-NEXT:    sw s6, 100(s0)
; RV32IXQCCMP-NEXT:    sw s5, 96(s0)
; RV32IXQCCMP-NEXT:    sw s4, 92(s0)
; RV32IXQCCMP-NEXT:    sw s3, 88(s0)
; RV32IXQCCMP-NEXT:    sw s2, 84(s0)
; RV32IXQCCMP-NEXT:    lw a0, 12(sp) # 4-byte Folded Reload
...
; RV32IXQCCMP-WITH-FP-NEXT:    lw s5, 88(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s6, 92(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s7, 96(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s8, 100(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s9, 104(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s10, 108(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s11, 112(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s2, 116(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s3, 120(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    lw s4, 124(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    call callee
; RV32IXQCCMP-WITH-FP-NEXT:    sw s4, 124(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s3, 120(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s2, 116(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s11, 112(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s10, 108(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s9, 104(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s8, 100(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s7, 96(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s6, 92(s1)
; RV32IXQCCMP-WITH-FP-NEXT:    sw s5, 88(s1)
...
; RV64IXQCCMP-NEXT:    sd a0, 8(sp) # 8-byte Folded Spill
; RV64IXQCCMP-NEXT:    lw s2, 84(s0)
; RV64IXQCCMP-NEXT:    lw s3, 88(s0)
; RV64IXQCCMP-NEXT:    lw s4, 92(s0)
; RV64IXQCCMP-NEXT:    lw s5, 96(s0)
; RV64IXQCCMP-NEXT:    lw s6, 100(s0)
; RV64IXQCCMP-NEXT:    lw s7, 104(s0)
; RV64IXQCCMP-NEXT:    lw s8, 108(s0)
; RV64IXQCCMP-NEXT:    lw s9, 112(s0)
; RV64IXQCCMP-NEXT:    lw s10, 116(s0)
; RV64IXQCCMP-NEXT:    lw s11, 120(s0)
; RV64IXQCCMP-NEXT:    lw s1, 124(s0)
; RV64IXQCCMP-NEXT:    call callee
; RV64IXQCCMP-NEXT:    sw s1, 124(s0)
; RV64IXQCCMP-NEXT:    sw s11, 120(s0)
; RV64IXQCCMP-NEXT:    sw s10, 116(s0)
; RV64IXQCCMP-NEXT:    sw s9, 112(s0)
; RV64IXQCCMP-NEXT:    sw s8, 108(s0)
; RV64IXQCCMP-NEXT:    sw s7, 104(s0)
; RV64IXQCCMP-NEXT:    sw s6, 100(s0)
; RV64IXQCCMP-NEXT:    sw s5, 96(s0)
; RV64IXQCCMP-NEXT:    sw s4, 92(s0)
; RV64IXQCCMP-NEXT:    sw s3, 88(s0)
; RV64IXQCCMP-NEXT:    sw s2, 84(s0)
; RV64IXQCCMP-NEXT:    ld a0, 8(sp) # 8-byte Folded Reload
...
; RV64IXQCCMP-WITH-FP-NEXT:    lw s5, 88(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s6, 92(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s7, 96(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s8, 100(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s9, 104(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s10, 108(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s11, 112(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s2, 116(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s3, 120(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    lw s4, 124(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    call callee
; RV64IXQCCMP-WITH-FP-NEXT:    sw s4, 124(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s3, 120(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s2, 116(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s11, 112(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s10, 108(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s9, 104(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s8, 100(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s7, 96(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s6, 92(s1)
; RV64IXQCCMP-WITH-FP-NEXT:    sw s5, 88(s1)
