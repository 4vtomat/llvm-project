...
entry:
  ...
  %vqmovn_v1.i.i = tail call <8 x i8> @llvm.aarch64.neon.sqxtn.v8i8(<8 x i16> %1)
  %shuffle.i.i = shufflevector <8 x i8> %0, <8 x i8> %vqmovn_v1.i.i, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
...
entry:
  ...
  %vqmovn_v1.i.i = tail call <4 x i16> @llvm.aarch64.neon.sqxtn.v4i16(<4 x i32> %1)
  %shuffle.i.i = shufflevector <4 x i16> %0, <4 x i16> %vqmovn_v1.i.i, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
entry:
  ...
  %vqmovn_v1.i.i = tail call <2 x i32> @llvm.aarch64.neon.sqxtn.v2i32(<2 x i64> %1)
  %shuffle.i.i = shufflevector <2 x i32> %0, <2 x i32> %vqmovn_v1.i.i, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
entry:
  %0 = load <8 x i8>, ptr %in_0, align 1
  %1 = load <8 x i16>, ptr %in_1, align 2
  %vqmovn_v1.i.i = tail call <8 x i8> @llvm.aarch64.neon.uqxtn.v8i8(<8 x i16> %1)
  %shuffle.i.i = shufflevector <8 x i8> %0, <8 x i8> %vqmovn_v1.i.i, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  store <16 x i8> %shuffle.i.i, ptr %out, align 1
  ret void
}
...
entry:
  %0 = load <2 x i32>, ptr %in_0, align 4
  %1 = load <2 x i64>, ptr %in_1, align 8
  %vqmovn_v1.i.i = tail call <2 x i32> @llvm.aarch64.neon.uqxtn.v2i32(<2 x i64> %1)
  %shuffle.i.i = shufflevector <2 x i32> %0, <2 x i32> %vqmovn_v1.i.i, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  store <4 x i32> %shuffle.i.i, ptr %out, align 4
  ret void
}
...
entry:
  ...
  %vqmovn_v1.i = tail call <8 x i8> @llvm.aarch64.neon.sqxtn.v8i8(<8 x i16> %0)
  store <8 x i8> %vqmovn_v1.i, ptr %out, align 1
  ret void
}
...
entry:
  ...
  %vqmovn_v1.i = tail call <4 x i16> @llvm.aarch64.neon.sqxtn.v4i16(<4 x i32> %0)
  store <4 x i16> %vqmovn_v1.i, ptr %out, align 2
  ret void
}
...
entry:
  ...
  %vqmovn_v1.i = tail call <2 x i32> @llvm.aarch64.neon.sqxtn.v2i32(<2 x i64> %0)
  store <2 x i32> %vqmovn_v1.i, ptr %out, align 4
  ret void
}
...
entry:
  %0 = load <8 x i16>, ptr %in_0, align 2
  %vqmovn_v1.i = tail call <8 x i8> @llvm.aarch64.neon.uqxtn.v8i8(<8 x i16> %0)
  store <8 x i8> %vqmovn_v1.i, ptr %out, align 1
  ret void
}
...
entry:
  %0 = load <4 x i32>, ptr %in_0, align 4
  %vqmovn_v1.i = tail call <4 x i16> @llvm.aarch64.neon.uqxtn.v4i16(<4 x i32> %0)
  store <4 x i16> %vqmovn_v1.i, ptr %out, align 2
  ret void
}
...
entry:
  %0 = load <2 x i64>, ptr %in_0, align 8
  %vqmovn_v1.i = tail call <2 x i32> @llvm.aarch64.neon.uqxtn.v2i32(<2 x i64> %0)
  store <2 x i32> %vqmovn_v1.i, ptr %out, align 4
  ret void
}
