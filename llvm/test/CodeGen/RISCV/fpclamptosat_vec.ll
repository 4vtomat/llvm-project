...
<<<<<<< HEAD
; RUN:   -target-abi=lp64d -riscv-v-vector-bits-min=0 | FileCheck %s
; end SIFIVE
=======
...
; CHECK-V-NEXT:    vsetivli zero, 2, e64, m2, tu, mu
; CHECK-V-NEXT:    vslideup.vi v10, v8, 1
; CHECK-V-NEXT:    addi a0, sp, 16
; CHECK-V-NEXT:    vsetivli zero, 1, e64, m1, ta, mu
; CHECK-V-NEXT:    vle64.v v8, (a0)
; CHECK-V-NEXT:    vsetivli zero, 3, e64, m2, tu, mu
; CHECK-V-NEXT:    vslideup.vi v10, v8, 2
; CHECK-V-NEXT:    addi a0, sp, 8
; CHECK-V-NEXT:    vsetivli zero, 1, e64, m1, ta, mu
; CHECK-V-NEXT:    vle64.v v8, (a0)
; CHECK-V-NEXT:    vsetivli zero, 4, e64, m2, tu, mu
...
; CHECK-V-NEXT:    vsetivli zero, 2, e32, m2, tu, mu
; CHECK-V-NEXT:    vslideup.vi v8, v10, 1
; CHECK-V-NEXT:    addi a0, sp, 24
; CHECK-V-NEXT:    vsetivli zero, 1, e32, mf2, ta, mu
; CHECK-V-NEXT:    vle32.v v10, (a0)
; CHECK-V-NEXT:    vsetivli zero, 3, e32, m2, tu, mu
; CHECK-V-NEXT:    vslideup.vi v8, v10, 2
; CHECK-V-NEXT:    addi a0, sp, 20
; CHECK-V-NEXT:    vsetivli zero, 1, e32, mf2, ta, mu
; CHECK-V-NEXT:    vle32.v v10, (a0)
; CHECK-V-NEXT:    vsetivli zero, 4, e32, m2, tu, mu
; CHECK-V-NEXT:    vslideup.vi v8, v10, 3
; CHECK-V-NEXT:    addi a0, sp, 16
; CHECK-V-NEXT:    vsetivli zero, 1, e32, mf2, ta, mu
; CHECK-V-NEXT:    vle32.v v10, (a0)
; CHECK-V-NEXT:    vsetivli zero, 5, e32, m2, tu, mu
; CHECK-V-NEXT:    vslideup.vi v8, v10, 4
; CHECK-V-NEXT:    addi a0, sp, 12
; CHECK-V-NEXT:    vsetivli zero, 1, e32, mf2, ta, mu
; CHECK-V-NEXT:    vle32.v v10, (a0)
; CHECK-V-NEXT:    vsetivli zero, 6, e32, m2, tu, mu
; CHECK-V-NEXT:    vslideup.vi v8, v10, 5
; CHECK-V-NEXT:    addi a0, sp, 8
; CHECK-V-NEXT:    vsetivli zero, 1, e32, mf2, ta, mu
; CHECK-V-NEXT:    vle32.v v10, (a0)
; CHECK-V-NEXT:    vsetivli zero, 7, e32, m2, tu, mu
; CHECK-V-NEXT:    vslideup.vi v8, v10, 6
; CHECK-V-NEXT:    addi a0, sp, 4
; CHECK-V-NEXT:    vsetivli zero, 1, e32, mf2, ta, mu
; CHECK-V-NEXT:    vle32.v v10, (a0)
; CHECK-V-NEXT:    vsetivli zero, 8, e32, m2, tu, mu
...
; CHECK-V-NEXT:    vsetivli zero, 0, e64, m1, ta, mu
; CHECK-V-NEXT:    addi a0, sp, 48
...
; CHECK-V-NEXT:    vsetivli zero, 2, e64, m1, tu, mu
...
; CHECK-V-NEXT:    mv s0, a0
; CHECK-V-NEXT:    mv s1, a1
; CHECK-V-NEXT:    vsetivli zero, 0, e32, mf2, ta, mu
; CHECK-V-NEXT:    addi a0, sp, 48
; CHECK-V-NEXT:    vl1r.v v8, (a0) # Unknown-size Folded Reload
; CHECK-V-NEXT:    vfmv.f.s fa0, v8
; CHECK-V-NEXT:    call __fixsfti@plt
