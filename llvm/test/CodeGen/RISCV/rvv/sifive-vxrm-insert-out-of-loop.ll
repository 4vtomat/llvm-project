...
; RV64P670-NEXT:    addi sp, sp, -32
; RV64P670-NEXT:    .cfi_def_cfa_offset 32
; RV64P670-NEXT:    sd s0, 24(sp) # 8-byte Folded Spill
; RV64P670-NEXT:    sd s1, 16(sp) # 8-byte Folded Spill
; RV64P670-NEXT:    sd s2, 8(sp) # 8-byte Folded Spill
; RV64P670-NEXT:    sd s3, 0(sp) # 8-byte Folded Spill
...
; RV64P670-NEXT:    add t1, a0, a6
; RV64P670-NEXT:    csrr t5, vlenb
; RV64P670-NEXT:    li t0, 0
; RV64P670-NEXT:    zext.w s1, s1
; RV64P670-NEXT:    mul s0, a1, s1
; RV64P670-NEXT:    add t2, t1, s0
; RV64P670-NEXT:    mul t1, a3, s1
; RV64P670-NEXT:    add s0, a2, a6
; RV64P670-NEXT:    mul s1, a5, s1
; RV64P670-NEXT:    add t3, s0, t1
; RV64P670-NEXT:    add s0, a4, a6
; RV64P670-NEXT:    slli t1, t5, 1
; RV64P670-NEXT:    add t4, s0, s1
; RV64P670-NEXT:    sltu s0, a0, t3
; RV64P670-NEXT:    sltu s1, a2, t2
...
; RV64P670-NEXT:    sltu s0, a4, t2
; RV64P670-NEXT:    maxu t3, t1, s1
; RV64P670-NEXT:    sltu s1, a0, t4
; RV64P670-NEXT:    mv t4, a0
; RV64P670-NEXT:    and s0, s0, s1
; RV64P670-NEXT:    or s1, a1, a5
; RV64P670-NEXT:    slti s1, s1, 0
; RV64P670-NEXT:    or s0, s0, s1
; RV64P670-NEXT:    or s1, t6, s0
; RV64P670-NEXT:    sltu s0, a6, t3
; RV64P670-NEXT:    slli t3, t5, 28
; RV64P670-NEXT:    or s0, s0, s1
; RV64P670-NEXT:    andi t2, s0, 1
...
; RV64P670-NEXT:    add t4, t4, a1
; RV64P670-NEXT:    add a2, a2, a3
; RV64P670-NEXT:    add a4, a4, a5
; RV64P670-NEXT:    addiw s1, t0, 1
; RV64P670-NEXT:    addi t0, t0, 1
; RV64P670-NEXT:    beq s1, a7, .LBB0_11
...
; RV64P670-NEXT:    add s1, a2, t6
; RV64P670-NEXT:    add s0, a4, t6
; RV64P670-NEXT:    vl2r.v v8, (s1)
; RV64P670-NEXT:    vl2r.v v10, (s0)
; RV64P670-NEXT:    add s0, t4, t6
; RV64P670-NEXT:    add t6, t6, t1
; RV64P670-NEXT:    vaaddu.vv v8, v8, v10
; RV64P670-NEXT:    vs2r.v v8, (s0)
; RV64P670-NEXT:    bne t6, t5, .LBB0_7
...
; RV64P670-NEXT:    add s3, a4, t5
; RV64P670-NEXT:    add t6, t6, s0
; RV64P670-NEXT:    add s0, t4, t5
; RV64P670-NEXT:    add t5, t5, a2
; RV64P670-NEXT:  .LBB0_10: # %for.body4.us
; RV64P670-NEXT:    # Parent Loop BB0_4 Depth=1
; RV64P670-NEXT:    # => This Inner Loop Header: Depth=2
; RV64P670-NEXT:    lbu s2, 0(t5)
; RV64P670-NEXT:    lbu s1, 0(s3)
; RV64P670-NEXT:    addi s3, s3, 1
; RV64P670-NEXT:    addi t5, t5, 1
; RV64P670-NEXT:    add s1, s1, s2
...
; RV64P670-NEXT:    ld s0, 24(sp) # 8-byte Folded Reload
; RV64P670-NEXT:    ld s1, 16(sp) # 8-byte Folded Reload
; RV64P670-NEXT:    ld s2, 8(sp) # 8-byte Folded Reload
; RV64P670-NEXT:    ld s3, 0(sp) # 8-byte Folded Reload
...
; RV64X60-NEXT:    addi sp, sp, -32
; RV64X60-NEXT:    .cfi_def_cfa_offset 32
; RV64X60-NEXT:    sd s0, 24(sp) # 8-byte Folded Spill
; RV64X60-NEXT:    sd s1, 16(sp) # 8-byte Folded Spill
; RV64X60-NEXT:    sd s2, 8(sp) # 8-byte Folded Spill
; RV64X60-NEXT:    sd s3, 0(sp) # 8-byte Folded Spill
...
; RV64X60-NEXT:    addi t1, a7, -1
; RV64X60-NEXT:    add t4, a0, a6
; RV64X60-NEXT:    add t5, a2, a6
; RV64X60-NEXT:    add t2, a4, a6
; RV64X60-NEXT:    csrr t3, vlenb
; RV64X60-NEXT:    zext.w s0, t1
...
; RV64X60-NEXT:    mul s0, a5, s0
; RV64X60-NEXT:    add t2, t2, s0
; RV64X60-NEXT:    sltu s0, a0, t5
; RV64X60-NEXT:    sltu s1, a2, t4
; RV64X60-NEXT:    and t1, s0, s1
; RV64X60-NEXT:    or t5, a1, a3
; RV64X60-NEXT:    sltu s0, a0, t2
; RV64X60-NEXT:    sltu s1, a4, t4
; RV64X60-NEXT:    and t2, s0, s1
; RV64X60-NEXT:    or s1, a1, a5
; RV64X60-NEXT:    slti s0, t5, 0
; RV64X60-NEXT:    or t4, t1, s0
; RV64X60-NEXT:    slli t1, t3, 1
; RV64X60-NEXT:    slti s1, s1, 0
; RV64X60-NEXT:    maxu s0, t1, t6
; RV64X60-NEXT:    sltu s0, a6, s0
; RV64X60-NEXT:    or s1, t2, s1
; RV64X60-NEXT:    or s1, t4, s1
; RV64X60-NEXT:    or s0, s0, s1
; RV64X60-NEXT:    andi t2, s0, 1
; RV64X60-NEXT:    slli t3, t3, 28
; RV64X60-NEXT:    mv t4, a0
...
; RV64X60-NEXT:    sub s0, t3, t1
; RV64X60-NEXT:    and t5, s0, a6
...
; RV64X60-NEXT:    add s1, a2, t6
; RV64X60-NEXT:    vl2r.v v8, (s1)
; RV64X60-NEXT:    add s0, a4, t6
; RV64X60-NEXT:    vl2r.v v10, (s0)
; RV64X60-NEXT:    add s0, t4, t6
; RV64X60-NEXT:    vaaddu.vv v8, v8, v10
; RV64X60-NEXT:    add t6, t6, t1
; RV64X60-NEXT:    vs2r.v v8, (s0)
; RV64X60-NEXT:    bne t6, t5, .LBB0_7
; RV64X60-NEXT:  # %bb.8: # %middle.block
; RV64X60-NEXT:    # in Loop: Header=BB0_4 Depth=1
; RV64X60-NEXT:    beq t5, a6, .LBB0_3
; RV64X60-NEXT:  .LBB0_9: # %for.body4.us.preheader
; RV64X60-NEXT:    # in Loop: Header=BB0_4 Depth=1
; RV64X60-NEXT:    mul s0, a1, t0
; RV64X60-NEXT:    add s1, a0, a6
; RV64X60-NEXT:    add t6, t4, t5
; RV64X60-NEXT:    add s2, s1, s0
; RV64X60-NEXT:    add s1, a4, t5
; RV64X60-NEXT:    add t5, t5, a2
; RV64X60-NEXT:  .LBB0_10: # %for.body4.us
; RV64X60-NEXT:    # Parent Loop BB0_4 Depth=1
; RV64X60-NEXT:    # => This Inner Loop Header: Depth=2
; RV64X60-NEXT:    lbu s3, 0(t5)
; RV64X60-NEXT:    lbu s0, 0(s1)
; RV64X60-NEXT:    add s0, s0, s3
; RV64X60-NEXT:    addi s0, s0, 1
; RV64X60-NEXT:    srli s0, s0, 1
; RV64X60-NEXT:    sb s0, 0(t6)
; RV64X60-NEXT:    addi t6, t6, 1
; RV64X60-NEXT:    addi s1, s1, 1
; RV64X60-NEXT:    addi t5, t5, 1
; RV64X60-NEXT:    bne t6, s2, .LBB0_10
; RV64X60-NEXT:    j .LBB0_3
; RV64X60-NEXT:  .LBB0_11:
; RV64X60-NEXT:    ld s0, 24(sp) # 8-byte Folded Reload
; RV64X60-NEXT:    ld s1, 16(sp) # 8-byte Folded Reload
; RV64X60-NEXT:    ld s2, 8(sp) # 8-byte Folded Reload
; RV64X60-NEXT:    ld s3, 0(sp) # 8-byte Folded Reload
...
; RV64-NEXT:    sltu t5, a0, t5
; RV64-NEXT:    sltu t4, a4, t4
; RV64-NEXT:    and t4, t5, t4
; RV64-NEXT:    or t5, a1, a3
