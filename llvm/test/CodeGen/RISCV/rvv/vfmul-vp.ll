...
define <vscale x 1 x bfloat> @vfmul_vv_nxv1bf16(<vscale x 1 x bfloat> %va, <vscale x 1 x bfloat> %b, <vscale x 1 x i1> %m, i32 zeroext %evl) {
...
; ZVFH-NEXT:    vfmul.vv v9, v9, v10, v0.t
...
; ZVFBFA-NEXT:    vfmul.vv v8, v8, v9, v0.t
; ZVFBFA-NEXT:    ret
  %v = call <vscale x 1 x bfloat> @llvm.vp.fmul.nxv1bf16(<vscale x 1 x bfloat> %va, <vscale x 1 x bfloat> %b, <vscale x 1 x i1> %m, i32 %evl)
  ret <vscale x 1 x bfloat> %v
}

define <vscale x 1 x bfloat> @vfmul_vv_nxv1bf16_unmasked(<vscale x 1 x bfloat> %va, <vscale x 1 x bfloat> %b, i32 zeroext %evl) {
; ZVFH-LABEL: vfmul_vv_nxv1bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
...
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfmul_vv_nxv1bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_nxv1bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, mf4, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v8, v8, v9
; ZVFBFA-NEXT:    ret
  %v = call <vscale x 1 x bfloat> @llvm.vp.fmul.nxv1bf16(<vscale x 1 x bfloat> %va, <vscale x 1 x bfloat> %b, <vscale x 1 x i1> splat (i1 true), i32 %evl)
  ret <vscale x 1 x bfloat> %v
}

define <vscale x 1 x bfloat> @vfmul_vf_nxv1bf16(<vscale x 1 x bfloat> %va, bfloat %b, <vscale x 1 x i1> %m, i32 zeroext %evl) {
...
; ZVFH-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFH-NEXT:    vfmul.vv v9, v10, v8, v0.t
; ZVFH-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v9, v0.t
; ZVFH-NEXT:    ret
;
...
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, mf4, ta, ma
; ZVFBFA-NEXT:    vfmul.vf v8, v8, fa0, v0.t
; ZVFBFA-NEXT:    ret
  ...
  %v = call <vscale x 1 x bfloat> @llvm.vp.fmul.nxv1bf16(<vscale x 1 x bfloat> %va, <vscale x 1 x bfloat> %vb, <vscale x 1 x i1> %m, i32 %evl)
  ret <vscale x 1 x bfloat> %v
}

define <vscale x 1 x bfloat> @vfmul_vf_nxv1bf16_unmasked(<vscale x 1 x bfloat> %va, bfloat %b, i32 zeroext %evl) {
; ZVFH-LABEL: vfmul_vf_nxv1bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    fmv.x.w a1, fa0
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; ZVFH-NEXT:    vmv.v.x v9, a1
...
; ZVFH-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFH-NEXT:    vfmul.vv v9, v10, v8
; ZVFH-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v9
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfmul_vf_nxv1bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    fmv.x.w a1, fa0
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; ZVFHMIN-NEXT:    vmv.v.x v9, a1
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv1bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, mf4, ta, ma
...
; ZVFBFA-NEXT:    ret
  %elt.head = insertelement <vscale x 1 x bfloat> poison, bfloat %b, i32 0
  %vb = shufflevector <vscale x 1 x bfloat> %elt.head, <vscale x 1 x bfloat> poison, <vscale x 1 x i32> zeroinitializer
  %v = call <vscale x 1 x bfloat> @llvm.vp.fmul.nxv1bf16(<vscale x 1 x bfloat> %va, <vscale x 1 x bfloat> %vb, <vscale x 1 x i1> splat (i1 true), i32 %evl)
  ret <vscale x 1 x bfloat> %v
}

define <vscale x 2 x bfloat> @vfmul_vv_nxv2bf16(<vscale x 2 x bfloat> %va, <vscale x 2 x bfloat> %b, <vscale x 2 x i1> %m, i32 zeroext %evl) {
...
; ZVFBFA-NEXT:    vfmul.vv v8, v8, v9, v0.t
; ZVFBFA-NEXT:    ret
  %v = call <vscale x 2 x bfloat> @llvm.vp.fmul.nxv2bf16(<vscale x 2 x bfloat> %va, <vscale x 2 x bfloat> %b, <vscale x 2 x i1> %m, i32 %evl)
  ret <vscale x 2 x bfloat> %v
}

define <vscale x 2 x bfloat> @vfmul_vv_nxv2bf16_unmasked(<vscale x 2 x bfloat> %va, <vscale x 2 x bfloat> %b, i32 zeroext %evl) {
; ZVFH-LABEL: vfmul_vv_nxv2bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFH-NEXT:    vfwcvtbf16.f.f.v v10, v9
; ZVFH-NEXT:    vfwcvtbf16.f.f.v v9, v8
...
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfmul_vv_nxv2bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vfwcvtbf16.f.f.v v10, v9
; ZVFHMIN-NEXT:    vfwcvtbf16.f.f.v v9, v8
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_nxv2bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, mf2, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v8, v8, v9
; ZVFBFA-NEXT:    ret
  %v = call <vscale x 2 x bfloat> @llvm.vp.fmul.nxv2bf16(<vscale x 2 x bfloat> %va, <vscale x 2 x bfloat> %b, <vscale x 2 x i1> splat (i1 true), i32 %evl)
  ret <vscale x 2 x bfloat> %v
}

define <vscale x 2 x bfloat> @vfmul_vf_nxv2bf16(<vscale x 2 x bfloat> %va, bfloat %b, <vscale x 2 x i1> %m, i32 zeroext %evl) {
...
; ZVFBFA-NEXT:    ret
  ...
  %v = call <vscale x 2 x bfloat> @llvm.vp.fmul.nxv2bf16(<vscale x 2 x bfloat> %va, <vscale x 2 x bfloat> %vb, <vscale x 2 x i1> %m, i32 %evl)
  ret <vscale x 2 x bfloat> %v
}

define <vscale x 2 x bfloat> @vfmul_vf_nxv2bf16_unmasked(<vscale x 2 x bfloat> %va, bfloat %b, i32 zeroext %evl) {
; ZVFH-LABEL: vfmul_vf_nxv2bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    fmv.x.w a1, fa0
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFH-NEXT:    vmv.v.x v9, a1
...
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfmul_vf_nxv2bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    fmv.x.w a1, fa0
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vmv.v.x v9, a1
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv2bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, mf2, ta, ma
; ZVFBFA-NEXT:    vfmul.vf v8, v8, fa0
; ZVFBFA-NEXT:    ret
  %elt.head = insertelement <vscale x 2 x bfloat> poison, bfloat %b, i32 0
  %vb = shufflevector <vscale x 2 x bfloat> %elt.head, <vscale x 2 x bfloat> poison, <vscale x 2 x i32> zeroinitializer
  %v = call <vscale x 2 x bfloat> @llvm.vp.fmul.nxv2bf16(<vscale x 2 x bfloat> %va, <vscale x 2 x bfloat> %vb, <vscale x 2 x i1> splat (i1 true), i32 %evl)
  ret <vscale x 2 x bfloat> %v
}

define <vscale x 4 x bfloat> @vfmul_vv_nxv4bf16(<vscale x 4 x bfloat> %va, <vscale x 4 x bfloat> %b, <vscale x 4 x i1> %m, i32 zeroext %evl) {
...
; ZVFH-NEXT:    vfmul.vv v10, v12, v10, v0.t
...
; ZVFBFA-NEXT:    vfmul.vv v8, v8, v9, v0.t
; ZVFBFA-NEXT:    ret
  %v = call <vscale x 4 x bfloat> @llvm.vp.fmul.nxv4bf16(<vscale x 4 x bfloat> %va, <vscale x 4 x bfloat> %b, <vscale x 4 x i1> %m, i32 %evl)
  ret <vscale x 4 x bfloat> %v
}

define <vscale x 4 x bfloat> @vfmul_vv_nxv4bf16_unmasked(<vscale x 4 x bfloat> %va, <vscale x 4 x bfloat> %b, i32 zeroext %evl) {
; ZVFH-LABEL: vfmul_vv_nxv4bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, m1, ta, ma
; ZVFH-NEXT:    vfwcvtbf16.f.f.v v10, v9
...
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfmul_vv_nxv4bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, m1, ta, ma
; ZVFHMIN-NEXT:    vfwcvtbf16.f.f.v v10, v9
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_nxv4bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, m1, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v8, v8, v9
; ZVFBFA-NEXT:    ret
  %v = call <vscale x 4 x bfloat> @llvm.vp.fmul.nxv4bf16(<vscale x 4 x bfloat> %va, <vscale x 4 x bfloat> %b, <vscale x 4 x i1> splat (i1 true), i32 %evl)
  ret <vscale x 4 x bfloat> %v
}

define <vscale x 4 x bfloat> @vfmul_vf_nxv4bf16(<vscale x 4 x bfloat> %va, bfloat %b, <vscale x 4 x i1> %m, i32 zeroext %evl) {
...
; ZVFH-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; ZVFH-NEXT:    vfmul.vv v10, v10, v8, v0.t
; ZVFH-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v10, v0.t
; ZVFH-NEXT:    ret
;
...
; ZVFBFA-NEXT:    ret
  ...
  %v = call <vscale x 4 x bfloat> @llvm.vp.fmul.nxv4bf16(<vscale x 4 x bfloat> %va, <vscale x 4 x bfloat> %vb, <vscale x 4 x i1> %m, i32 %evl)
  ret <vscale x 4 x bfloat> %v
}

define <vscale x 4 x bfloat> @vfmul_vf_nxv4bf16_unmasked(<vscale x 4 x bfloat> %va, bfloat %b, i32 zeroext %evl) {
; ZVFH-LABEL: vfmul_vf_nxv4bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    fmv.x.w a1, fa0
; ZVFH-NEXT:    vsetvli zero, a0, e16, m1, ta, ma
; ZVFH-NEXT:    vmv.v.x v12, a1
...
; ZVFH-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; ZVFH-NEXT:    vfmul.vv v10, v10, v8
; ZVFH-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v10
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfmul_vf_nxv4bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    fmv.x.w a1, fa0
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, m1, ta, ma
; ZVFHMIN-NEXT:    vmv.v.x v12, a1
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv4bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, m1, ta, ma
; ZVFBFA-NEXT:    vfmul.vf v8, v8, fa0
; ZVFBFA-NEXT:    ret
  %elt.head = insertelement <vscale x 4 x bfloat> poison, bfloat %b, i32 0
  %vb = shufflevector <vscale x 4 x bfloat> %elt.head, <vscale x 4 x bfloat> poison, <vscale x 4 x i32> zeroinitializer
  %v = call <vscale x 4 x bfloat> @llvm.vp.fmul.nxv4bf16(<vscale x 4 x bfloat> %va, <vscale x 4 x bfloat> %vb, <vscale x 4 x i1> splat (i1 true), i32 %evl)
  ret <vscale x 4 x bfloat> %v
}

define <vscale x 8 x bfloat> @vfmul_vv_nxv8bf16(<vscale x 8 x bfloat> %va, <vscale x 8 x bfloat> %b, <vscale x 8 x i1> %m, i32 zeroext %evl) {
...
; ZVFH-NEXT:    vfmul.vv v12, v16, v12, v0.t
...
; ZVFBFA-NEXT:    vfmul.vv v8, v8, v10, v0.t
; ZVFBFA-NEXT:    ret
  %v = call <vscale x 8 x bfloat> @llvm.vp.fmul.nxv8bf16(<vscale x 8 x bfloat> %va, <vscale x 8 x bfloat> %b, <vscale x 8 x i1> %m, i32 %evl)
  ret <vscale x 8 x bfloat> %v
}

define <vscale x 8 x bfloat> @vfmul_vv_nxv8bf16_unmasked(<vscale x 8 x bfloat> %va, <vscale x 8 x bfloat> %b, i32 zeroext %evl) {
; ZVFH-LABEL: vfmul_vv_nxv8bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
...
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfmul_vv_nxv8bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_nxv8bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v8, v8, v10
; ZVFBFA-NEXT:    ret
  %v = call <vscale x 8 x bfloat> @llvm.vp.fmul.nxv8bf16(<vscale x 8 x bfloat> %va, <vscale x 8 x bfloat> %b, <vscale x 8 x i1> splat (i1 true), i32 %evl)
  ret <vscale x 8 x bfloat> %v
}

define <vscale x 8 x bfloat> @vfmul_vf_nxv8bf16(<vscale x 8 x bfloat> %va, bfloat %b, <vscale x 8 x i1> %m, i32 zeroext %evl) {
...
; ZVFH-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFH-NEXT:    vfmul.vv v12, v12, v8, v0.t
; ZVFH-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v12, v0.t
; ZVFH-NEXT:    ret
;
...
; ZVFBFA-NEXT:    ret
  ...
  %v = call <vscale x 8 x bfloat> @llvm.vp.fmul.nxv8bf16(<vscale x 8 x bfloat> %va, <vscale x 8 x bfloat> %vb, <vscale x 8 x i1> %m, i32 %evl)
  ret <vscale x 8 x bfloat> %v
}

define <vscale x 8 x bfloat> @vfmul_vf_nxv8bf16_unmasked(<vscale x 8 x bfloat> %va, bfloat %b, i32 zeroext %evl) {
; ZVFH-LABEL: vfmul_vf_nxv8bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    fmv.x.w a1, fa0
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmv.v.x v16, a1
...
; ZVFH-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFH-NEXT:    vfmul.vv v12, v12, v8
; ZVFH-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v12
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfmul_vf_nxv8bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    fmv.x.w a1, fa0
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFHMIN-NEXT:    vmv.v.x v16, a1
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv8bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vfmul.vf v8, v8, fa0
; ZVFBFA-NEXT:    ret
  %elt.head = insertelement <vscale x 8 x bfloat> poison, bfloat %b, i32 0
  %vb = shufflevector <vscale x 8 x bfloat> %elt.head, <vscale x 8 x bfloat> poison, <vscale x 8 x i32> zeroinitializer
  %v = call <vscale x 8 x bfloat> @llvm.vp.fmul.nxv8bf16(<vscale x 8 x bfloat> %va, <vscale x 8 x bfloat> %vb, <vscale x 8 x i1> splat (i1 true), i32 %evl)
  ret <vscale x 8 x bfloat> %v
}

define <vscale x 16 x bfloat> @vfmul_vv_nxv16bf16(<vscale x 16 x bfloat> %va, <vscale x 16 x bfloat> %b, <vscale x 16 x i1> %m, i32 zeroext %evl) {
...
; ZVFH-NEXT:    vfmul.vv v16, v24, v16, v0.t
...
; ZVFBFA-NEXT:    vfmul.vv v8, v8, v12, v0.t
; ZVFBFA-NEXT:    ret
  %v = call <vscale x 16 x bfloat> @llvm.vp.fmul.nxv16bf16(<vscale x 16 x bfloat> %va, <vscale x 16 x bfloat> %b, <vscale x 16 x i1> %m, i32 %evl)
  ret <vscale x 16 x bfloat> %v
}

define <vscale x 16 x bfloat> @vfmul_vv_nxv16bf16_unmasked(<vscale x 16 x bfloat> %va, <vscale x 16 x bfloat> %b, i32 zeroext %evl) {
; ZVFH-LABEL: vfmul_vv_nxv16bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
...
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfmul_vv_nxv16bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_nxv16bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, m4, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v8, v8, v12
; ZVFBFA-NEXT:    ret
  %v = call <vscale x 16 x bfloat> @llvm.vp.fmul.nxv16bf16(<vscale x 16 x bfloat> %va, <vscale x 16 x bfloat> %b, <vscale x 16 x i1> splat (i1 true), i32 %evl)
  ret <vscale x 16 x bfloat> %v
}

define <vscale x 16 x bfloat> @vfmul_vf_nxv16bf16(<vscale x 16 x bfloat> %va, bfloat %b, <vscale x 16 x i1> %m, i32 zeroext %evl) {
...
; ZVFH-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFH-NEXT:    vfmul.vv v16, v16, v8, v0.t
; ZVFH-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v16, v0.t
; ZVFH-NEXT:    ret
;
...
; ZVFBFA-NEXT:    ret
  ...
  %v = call <vscale x 16 x bfloat> @llvm.vp.fmul.nxv16bf16(<vscale x 16 x bfloat> %va, <vscale x 16 x bfloat> %vb, <vscale x 16 x i1> %m, i32 %evl)
  ret <vscale x 16 x bfloat> %v
}

define <vscale x 16 x bfloat> @vfmul_vf_nxv16bf16_unmasked(<vscale x 16 x bfloat> %va, bfloat %b, i32 zeroext %evl) {
; ZVFH-LABEL: vfmul_vf_nxv16bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    fmv.x.w a1, fa0
; ZVFH-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
; ZVFH-NEXT:    vmv.v.x v24, a1
...
; ZVFH-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFH-NEXT:    vfmul.vv v16, v16, v8
; ZVFH-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v16
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfmul_vf_nxv16bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    fmv.x.w a1, fa0
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
; ZVFHMIN-NEXT:    vmv.v.x v24, a1
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv16bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, m4, ta, ma
; ZVFBFA-NEXT:    vfmul.vf v8, v8, fa0
; ZVFBFA-NEXT:    ret
  %elt.head = insertelement <vscale x 16 x bfloat> poison, bfloat %b, i32 0
  %vb = shufflevector <vscale x 16 x bfloat> %elt.head, <vscale x 16 x bfloat> poison, <vscale x 16 x i32> zeroinitializer
  %v = call <vscale x 16 x bfloat> @llvm.vp.fmul.nxv16bf16(<vscale x 16 x bfloat> %va, <vscale x 16 x bfloat> %vb, <vscale x 16 x i1> splat (i1 true), i32 %evl)
  ret <vscale x 16 x bfloat> %v
}

define <vscale x 32 x bfloat> @vfmul_vv_nxv32bf16(<vscale x 32 x bfloat> %va, <vscale x 32 x bfloat> %b, <vscale x 32 x i1> %m, i32 zeroext %evl) {
...
; ZVFH-NEXT:    vfwcvtbf16.f.f.v v16, v12, v0.t
; ZVFH-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFH-NEXT:    vfmul.vv v16, v16, v24, v0.t
; ZVFH-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v12, v16, v0.t
; ZVFH-NEXT:    bltu a0, a1, .LBB20_2
; ZVFH-NEXT:  # %bb.1:
; ZVFH-NEXT:    mv a0, a1
; ZVFH-NEXT:  .LBB20_2:
...
; ZVFBFA-NEXT:    vfmul.vv v8, v8, v16, v0.t
; ZVFBFA-NEXT:    ret
  %v = call <vscale x 32 x bfloat> @llvm.vp.fmul.nxv32bf16(<vscale x 32 x bfloat> %va, <vscale x 32 x bfloat> %b, <vscale x 32 x i1> %m, i32 %evl)
  ret <vscale x 32 x bfloat> %v
}

define <vscale x 32 x bfloat> @vfmul_vv_nxv32bf16_unmasked(<vscale x 32 x bfloat> %va, <vscale x 32 x bfloat> %b, i32 zeroext %evl) {
; ZVFH-LABEL: vfmul_vv_nxv32bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    addi sp, sp, -16
; ZVFH-NEXT:    .cfi_def_cfa_offset 16
; ZVFH-NEXT:    csrr a1, vlenb
...
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfmul_vv_nxv32bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    addi sp, sp, -16
; ZVFHMIN-NEXT:    .cfi_def_cfa_offset 16
; ZVFHMIN-NEXT:    csrr a1, vlenb
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_nxv32bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, m8, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v8, v8, v16
; ZVFBFA-NEXT:    ret
  %v = call <vscale x 32 x bfloat> @llvm.vp.fmul.nxv32bf16(<vscale x 32 x bfloat> %va, <vscale x 32 x bfloat> %b, <vscale x 32 x i1> splat (i1 true), i32 %evl)
  ret <vscale x 32 x bfloat> %v
}

define <vscale x 32 x bfloat> @vfmul_vf_nxv32bf16(<vscale x 32 x bfloat> %va, bfloat %b, <vscale x 32 x i1> %m, i32 zeroext %evl) {
...
; ZVFBFA-NEXT:    ret
  ...
  %v = call <vscale x 32 x bfloat> @llvm.vp.fmul.nxv32bf16(<vscale x 32 x bfloat> %va, <vscale x 32 x bfloat> %vb, <vscale x 32 x i1> %m, i32 %evl)
  ret <vscale x 32 x bfloat> %v
}

define <vscale x 32 x bfloat> @vfmul_vf_nxv32bf16_unmasked(<vscale x 32 x bfloat> %va, bfloat %b, i32 zeroext %evl) {
; ZVFH-LABEL: vfmul_vf_nxv32bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    addi sp, sp, -16
; ZVFH-NEXT:    .cfi_def_cfa_offset 16
; ZVFH-NEXT:    csrr a1, vlenb
...
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfmul_vf_nxv32bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    addi sp, sp, -16
; ZVFHMIN-NEXT:    .cfi_def_cfa_offset 16
; ZVFHMIN-NEXT:    csrr a1, vlenb
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv32bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, m8, ta, ma
; ZVFBFA-NEXT:    vfmul.vf v8, v8, fa0
; ZVFBFA-NEXT:    ret
  %elt.head = insertelement <vscale x 32 x bfloat> poison, bfloat %b, i32 0
  %vb = shufflevector <vscale x 32 x bfloat> %elt.head, <vscale x 32 x bfloat> poison, <vscale x 32 x i32> zeroinitializer
  %v = call <vscale x 32 x bfloat> @llvm.vp.fmul.nxv32bf16(<vscale x 32 x bfloat> %va, <vscale x 32 x bfloat> %vb, <vscale x 32 x i1> splat (i1 true), i32 %evl)
  ret <vscale x 32 x bfloat> %v
}
...
; ZVFBFA-NEXT:    vfmul.vv v9, v9, v10, v0.t
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_nxv1f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
...
; ZVFBFA-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v9, v10, v8, v0.t
; ZVFBFA-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFBFA-NEXT:    vfncvt.f.f.w v8, v9, v0.t
; ZVFBFA-NEXT:    ret
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv1f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    fmv.x.w a1, fa0
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; ZVFBFA-NEXT:    vmv.v.x v9, a1
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_nxv2f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFBFA-NEXT:    vfwcvt.f.f.v v10, v9
; ZVFBFA-NEXT:    vfwcvt.f.f.v v9, v8
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv2f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    fmv.x.w a1, fa0
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFBFA-NEXT:    vmv.v.x v9, a1
...
; ZVFBFA-NEXT:    vfmul.vv v10, v12, v10, v0.t
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_nxv4f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, m1, ta, ma
; ZVFBFA-NEXT:    vfwcvt.f.f.v v10, v9
...
; ZVFBFA-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v10, v10, v8, v0.t
; ZVFBFA-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; ZVFBFA-NEXT:    vfncvt.f.f.w v8, v10, v0.t
; ZVFBFA-NEXT:    ret
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv4f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    fmv.x.w a1, fa0
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, m1, ta, ma
; ZVFBFA-NEXT:    vmv.v.x v12, a1
...
; ZVFBFA-NEXT:    vfmul.vv v12, v16, v12, v0.t
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_nxv8f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
...
; ZVFBFA-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v12, v12, v8, v0.t
; ZVFBFA-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFBFA-NEXT:    vfncvt.f.f.w v8, v12, v0.t
; ZVFBFA-NEXT:    ret
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv8f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    fmv.x.w a1, fa0
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFBFA-NEXT:    vmv.v.x v16, a1
...
; ZVFBFA-NEXT:    vfmul.vv v16, v24, v16, v0.t
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_nxv16f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
...
; ZVFBFA-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v16, v16, v8, v0.t
; ZVFBFA-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFBFA-NEXT:    vfncvt.f.f.w v8, v16, v0.t
; ZVFBFA-NEXT:    ret
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv16f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    fmv.x.w a1, fa0
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
; ZVFBFA-NEXT:    vmv.v.x v24, a1
...
; ZVFBFA-NEXT:    vfwcvt.f.f.v v16, v12, v0.t
; ZVFBFA-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v16, v16, v24, v0.t
; ZVFBFA-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFBFA-NEXT:    vfncvt.f.f.w v12, v16, v0.t
; ZVFBFA-NEXT:    bltu a0, a1, .LBB44_2
; ZVFBFA-NEXT:  # %bb.1:
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_nxv32f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    addi sp, sp, -16
; ZVFBFA-NEXT:    .cfi_def_cfa_offset 16
; ZVFBFA-NEXT:    csrr a1, vlenb
...
; ZVFBFA-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFBFA-NEXT:    vfncvt.f.f.w v12, v16, v0.t
; ZVFBFA-NEXT:    bltu a0, a1, .LBB45_2
; ZVFBFA-NEXT:  # %bb.1:
; ZVFBFA-NEXT:    mv a0, a1
; ZVFBFA-NEXT:  .LBB45_2:
; ZVFBFA-NEXT:    addi a1, sp, 16
...
; ZVFBFA-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFBFA-NEXT:    vfncvt.f.f.w v12, v16, v0.t
; ZVFBFA-NEXT:    bltu a0, a1, .LBB46_2
; ZVFBFA-NEXT:  # %bb.1:
; ZVFBFA-NEXT:    mv a0, a1
; ZVFBFA-NEXT:  .LBB46_2:
; ZVFBFA-NEXT:    vmv1r.v v0, v7
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv32f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    addi sp, sp, -16
; ZVFBFA-NEXT:    .cfi_def_cfa_offset 16
; ZVFBFA-NEXT:    csrr a1, vlenb
...
; ZVFBFA-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFBFA-NEXT:    vfncvt.f.f.w v12, v16, v0.t
; ZVFBFA-NEXT:    bltu a0, a1, .LBB47_2
; ZVFBFA-NEXT:  # %bb.1:
; ZVFBFA-NEXT:    mv a0, a1
; ZVFBFA-NEXT:  .LBB47_2:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
