...
; RUN: llc -mtriple=riscv64 -mattr=+d,+v,+experimental-zfbfmin,+xsfvfbfa -target-abi lp64d -verify-machineinstrs < %s | FileCheck %s
; RUN: llc -mtriple=riscv32 -mattr=+d,+v,+experimental-zfbfmin,+xsfvfbfa -target-abi ilp32d -verify-machineinstrs < %s | FileCheck %s
