...
<<<<<<< HEAD
; RV32-LABEL: vfptrunc_v32f32_v32f64:
; RV32:       # %bb.0:
...
; RV32-NEXT:    li a1, 16
; RV32-NEXT:    vfncvt.f.f.w v8, v16, v0.t
...
; RV32-NEXT:    vfncvt.f.f.w v16, v24, v0.t
; RV32-NEXT:    li a0, 32
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vfptrunc_v32f32_v32f64:
; RV64:       # %bb.0:
...
; RV64-NEXT:    li a1, 16
; RV64-NEXT:    vfncvt.f.f.w v8, v16, v0.t
...
; RV64-NEXT:    vfncvt.f.f.w v16, v24, v0.t
; RV64-NEXT:    li a0, 32
