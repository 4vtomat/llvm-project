...
define zeroext i32 @vp_popcount_nxv64i1_zeroext(<vscale x 64 x i1> %m, <vscale x 64 x i1> %op, i32 zeroext %evl) {
; RV32-LABEL: vp_popcount_nxv64i1_zeroext:
; RV32:       # %bb.0: # %entry
; RV32-NEXT:    vsetvli zero, a0, e8, m8, ta, ma
; RV32-NEXT:    vcpop.m a0, v8, v0.t
; RV32-NEXT:    ret
;
; RV64-LABEL: vp_popcount_nxv64i1_zeroext:
; RV64:       # %bb.0: # %entry
...
define signext i32 @vp_popcount_nxv64i1_signext(<vscale x 64 x i1> %m, <vscale x 64 x i1> %op, i32 zeroext %evl) {
; RV32-LABEL: vp_popcount_nxv64i1_signext:
; RV32:       # %bb.0: # %entry
; RV32-NEXT:    vsetvli zero, a0, e8, m8, ta, ma
; RV32-NEXT:    vcpop.m a0, v8, v0.t
; RV32-NEXT:    ret
;
; RV64-LABEL: vp_popcount_nxv64i1_signext:
; RV64:       # %bb.0: # %entry
; RV64-NEXT:    vsetvli zero, a0, e8, m8, ta, ma
; RV64-NEXT:    vcpop.m a0, v8, v0.t
