...
; RUN: llc < %s -mtriple=riscv64 -mattr=+zve64x -verify-machineinstrs | FileCheck %s --check-prefixes=CHECK,CHECK-ZVE64X
; RUN: llc < %s -mtriple=riscv64 -mattr=+v -verify-machineinstrs | FileCheck %s --check-prefixes=CHECK,CHECK-V
...
; CHECK-ZVE64X-LABEL: sshl_sat_v2i8_splat:
; CHECK-ZVE64X:       # %bb.0:
...
; CHECK-ZVE64X-LABEL: sshl_sat_v4i8_splat:
; CHECK-ZVE64X:       # %bb.0:
; CHECK-ZVE64X-NEXT:    li a1, 1
; CHECK-ZVE64X-NEXT:    sll a0, a1, a0
; CHECK-ZVE64X-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
...
; CHECK-ZVE64X-LABEL: sshl_sat_v8i8_splat:
; CHECK-ZVE64X:       # %bb.0:
; CHECK-ZVE64X-NEXT:    li a1, 1
; CHECK-ZVE64X-NEXT:    sll a0, a1, a0
; CHECK-ZVE64X-NEXT:    vsetivli zero, 8, e8, m1, ta, ma
...
; CHECK-ZVE64X-LABEL: sshl_sat_v16i8_splat:
; CHECK-ZVE64X:       # %bb.0:
; CHECK-ZVE64X-NEXT:    li a1, 1
; CHECK-ZVE64X-NEXT:    sll a0, a1, a0
; CHECK-ZVE64X-NEXT:    vsetivli zero, 16, e8, m2, ta, ma
...
; CHECK-ZVE64X-LABEL: sshl_sat_v32i8_splat:
; CHECK-ZVE64X:       # %bb.0:
; CHECK-ZVE64X-NEXT:    li a1, 1
; CHECK-ZVE64X-NEXT:    sll a0, a1, a0
...
; CHECK-ZVE64X-LABEL: sshl_sat_v2i16_splat:
; CHECK-ZVE64X:       # %bb.0:
; CHECK-ZVE64X-NEXT:    li a1, 1
; CHECK-ZVE64X-NEXT:    sll a0, a1, a0
; CHECK-ZVE64X-NEXT:    vsetivli zero, 2, e16, mf2, ta, ma
...
; CHECK-ZVE64X-LABEL: sshl_sat_v4i16_splat:
; CHECK-ZVE64X:       # %bb.0:
; CHECK-ZVE64X-NEXT:    li a1, 1
; CHECK-ZVE64X-NEXT:    sll a0, a1, a0
; CHECK-ZVE64X-NEXT:    vsetivli zero, 4, e16, m1, ta, ma
...
; CHECK-ZVE64X-LABEL: sshl_sat_v8i16_splat:
; CHECK-ZVE64X:       # %bb.0:
; CHECK-ZVE64X-NEXT:    li a1, 1
; CHECK-ZVE64X-NEXT:    sll a0, a1, a0
; CHECK-ZVE64X-NEXT:    vsetivli zero, 8, e16, m2, ta, ma
...
; CHECK-ZVE64X-LABEL: sshl_sat_v16i16_splat:
; CHECK-ZVE64X:       # %bb.0:
; CHECK-ZVE64X-NEXT:    li a1, 1
; CHECK-ZVE64X-NEXT:    sll a0, a1, a0
; CHECK-ZVE64X-NEXT:    vsetivli zero, 16, e16, m4, ta, ma
...
; CHECK-ZVE64X-LABEL: sshl_sat_v2i32_splat:
; CHECK-ZVE64X:       # %bb.0:
; CHECK-ZVE64X-NEXT:    li a1, 1
; CHECK-ZVE64X-NEXT:    sll a0, a1, a0
; CHECK-ZVE64X-NEXT:    vsetivli zero, 2, e32, m1, ta, ma
...
; CHECK-ZVE64X-LABEL: sshl_sat_v4i32_splat:
; CHECK-ZVE64X:       # %bb.0:
; CHECK-ZVE64X-NEXT:    li a1, 1
; CHECK-ZVE64X-NEXT:    sll a0, a1, a0
; CHECK-ZVE64X-NEXT:    vsetivli zero, 4, e32, m2, ta, ma
...
; CHECK-ZVE64X-LABEL: sshl_sat_v8i32_splat:
; CHECK-ZVE64X:       # %bb.0:
; CHECK-ZVE64X-NEXT:    li a1, 1
; CHECK-ZVE64X-NEXT:    sll a0, a1, a0
; CHECK-ZVE64X-NEXT:    vsetivli zero, 8, e32, m4, ta, ma
...
; CHECK-ZVE64X-NEXT:    vsll.vv v14, v8, v10
; CHECK-ZVE64X-NEXT:    vsra.vv v10, v14, v10
; CHECK-ZVE64X-NEXT:    vmsne.vv v0, v8, v10
; CHECK-ZVE64X-NEXT:    vmerge.vvm v8, v14, v12, v0
; CHECK-ZVE64X-NEXT:    ret
;
...
; CHECK-V-NEXT:    vsll.vv v11, v8, v9
; CHECK-V-NEXT:    vsra.vv v9, v11, v9
; CHECK-V-NEXT:    vmsne.vv v0, v8, v9
; CHECK-V-NEXT:    vmerge.vvm v8, v11, v10, v0
; CHECK-V-NEXT:    ret
...
; CHECK-ZVE64X-NEXT:    srli a1, a0, 1
; CHECK-ZVE64X-NEXT:    slli a0, a0, 63
; CHECK-ZVE64X-NEXT:    vmv.v.x v16, a1
; CHECK-ZVE64X-NEXT:    vmerge.vxm v16, v16, a0, v0
; CHECK-ZVE64X-NEXT:    vsll.vv v20, v8, v12
; CHECK-ZVE64X-NEXT:    vsra.vv v12, v20, v12
; CHECK-ZVE64X-NEXT:    vmsne.vv v0, v8, v12
; CHECK-ZVE64X-NEXT:    vmerge.vvm v8, v20, v16, v0
; CHECK-ZVE64X-NEXT:    ret
;
...
; CHECK-V-NEXT:    srli a1, a0, 1
; CHECK-V-NEXT:    slli a0, a0, 63
; CHECK-V-NEXT:    vmv.v.x v12, a1
; CHECK-V-NEXT:    vmerge.vxm v12, v12, a0, v0
; CHECK-V-NEXT:    vsll.vv v14, v8, v10
; CHECK-V-NEXT:    vsra.vv v10, v14, v10
; CHECK-V-NEXT:    vmsne.vv v0, v8, v10
; CHECK-V-NEXT:    vmerge.vvm v8, v14, v12, v0
; CHECK-V-NEXT:    ret
