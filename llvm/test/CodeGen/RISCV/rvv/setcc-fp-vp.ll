...
<<<<<<< HEAD
; RV32-LABEL: fcmp_oeq_vv_nxv64f16:
; RV32:       # %bb.0:
...
; RV32-NEXT:    vl8re16.v v0, (a0)
; RV32-NEXT:    addi a0, sp, 16
; RV32-NEXT:    vs8r.v v0, (a0) # Unknown-size Folded Spill
; RV32-NEXT:    vslidedown.vx v0, v24, a1
...
; RV32-NEXT:    vsetvli zero, a0, e8, m1, tu, ma
; RV32-NEXT:    vslideup.vx v16, v1, a1
...
; RV32-NEXT:    ret
;
; RV64-LABEL: fcmp_oeq_vv_nxv64f16:
; RV64:       # %bb.0:
...
; RV64-NEXT:    vl8re16.v v0, (a0)
; RV64-NEXT:    addi a0, sp, 16
; RV64-NEXT:    vs8r.v v0, (a0) # Unknown-size Folded Spill
; RV64-NEXT:    vslidedown.vx v0, v24, a1
...
; RV64-NEXT:    vsetvli zero, a0, e8, m1, tu, ma
; RV64-NEXT:    vslideup.vx v16, v1, a1
...
<<<<<<< HEAD
; RV32-LABEL: fcmp_oeq_vv_nxv32f64:
; RV32:       # %bb.0:
; RV32-NEXT:    addi sp, sp, -16
; RV32-NEXT:    .cfi_def_cfa_offset 16
; RV32-NEXT:    csrr a1, vlenb
...
; RV32-NEXT:    vslidedown.vx v1, v0, a4
; RV32-NEXT:    srli a1, a3, 3
; RV32-NEXT:    vsetvli a5, zero, e8, mf4, ta, ma
; RV32-NEXT:    vslidedown.vx v0, v0, a1
; RV32-NEXT:    li a5, 24
; RV32-NEXT:    slli t1, a3, 3
; RV32-NEXT:    add a7, a2, t1
; RV32-NEXT:    vl8re64.v v8, (a7)
; RV32-NEXT:    mul t0, a3, a5
; RV32-NEXT:    slli a5, a3, 1
; RV32-NEXT:    slli t2, a3, 4
; RV32-NEXT:    mv a7, a6
; RV32-NEXT:    bltu a6, a5, .LBB171_2
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    mv a7, a5
; RV32-NEXT:  .LBB171_2:
; RV32-NEXT:    add t0, a2, t0
; RV32-NEXT:    add t1, a0, t1
...
; RV32-NEXT:    sub a2, a7, a3
; RV32-NEXT:    sltu t3, a7, a2
; RV32-NEXT:    addi t3, t3, -1
; RV32-NEXT:    and a2, t3, a2
; RV32-NEXT:    vsetvli zero, a2, e64, m8, ta, ma
; RV32-NEXT:    csrr a2, vlenb
; RV32-NEXT:    slli a2, a2, 5
; RV32-NEXT:    add a2, sp, a2
; RV32-NEXT:    addi a2, a2, 16
; RV32-NEXT:    vl8re8.v v16, (a2) # Unknown-size Folded Reload
; RV32-NEXT:    vmfeq.vv v2, v16, v8, v0.t
; RV32-NEXT:    bltu a7, a3, .LBB171_4
; RV32-NEXT:  # %bb.3:
; RV32-NEXT:    mv a7, a3
; RV32-NEXT:  .LBB171_4:
; RV32-NEXT:    vsetvli a2, zero, e8, mf4, ta, ma
; RV32-NEXT:    vslidedown.vx v17, v1, a1
; RV32-NEXT:    vl8re64.v v8, (t0)
; RV32-NEXT:    csrr a2, vlenb
; RV32-NEXT:    slli a2, a2, 5
; RV32-NEXT:    add a2, sp, a2
; RV32-NEXT:    addi a2, a2, 16
; RV32-NEXT:    vs8r.v v8, (a2) # Unknown-size Folded Spill
; RV32-NEXT:    vl8re64.v v8, (t1)
; RV32-NEXT:    csrr a2, vlenb
; RV32-NEXT:    li t0, 24
...
; RV32-NEXT:    addi a0, a0, 16
; RV32-NEXT:    vl8re8.v v8, (a0) # Unknown-size Folded Reload
; RV32-NEXT:    vmfeq.vv v18, v24, v8, v0.t
; RV32-NEXT:    add a0, a1, a1
; RV32-NEXT:    vsetvli zero, a0, e8, mf2, tu, ma
; RV32-NEXT:    sub a0, a6, a5
; RV32-NEXT:    sltu a2, a6, a0
; RV32-NEXT:    addi a2, a2, -1
; RV32-NEXT:    and a0, a2, a0
; RV32-NEXT:    vslideup.vx v18, v2, a1
; RV32-NEXT:    mv a2, a0
; RV32-NEXT:    bltu a0, a3, .LBB171_6
; RV32-NEXT:  # %bb.5:
; RV32-NEXT:    mv a2, a3
; RV32-NEXT:  .LBB171_6:
; RV32-NEXT:    vsetvli zero, a2, e64, m8, ta, ma
...
; RV32-NEXT:    vmfeq.vv v16, v24, v8, v0.t
; RV32-NEXT:    add a2, a4, a1
; RV32-NEXT:    vsetvli zero, a2, e8, mf2, tu, ma
; RV32-NEXT:    vslideup.vx v18, v16, a4
; RV32-NEXT:    sub a2, a0, a3
...
; RV32-NEXT:    vslideup.vx v18, v16, a0
...
; RV32-NEXT:    ret
;
; RV64-LABEL: fcmp_oeq_vv_nxv32f64:
; RV64:       # %bb.0:
; RV64-NEXT:    addi sp, sp, -16
; RV64-NEXT:    .cfi_def_cfa_offset 16
; RV64-NEXT:    csrr a1, vlenb
...
; RV64-NEXT:    vslidedown.vx v1, v0, a4
; RV64-NEXT:    srli a1, a3, 3
; RV64-NEXT:    vsetvli a5, zero, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vx v0, v0, a1
; RV64-NEXT:    li a5, 24
; RV64-NEXT:    slli t1, a3, 3
; RV64-NEXT:    add a7, a2, t1
; RV64-NEXT:    vl8re64.v v8, (a7)
; RV64-NEXT:    mul t0, a3, a5
; RV64-NEXT:    slli a5, a3, 1
; RV64-NEXT:    slli t2, a3, 4
; RV64-NEXT:    mv a7, a6
; RV64-NEXT:    bltu a6, a5, .LBB171_2
; RV64-NEXT:  # %bb.1:
; RV64-NEXT:    mv a7, a5
; RV64-NEXT:  .LBB171_2:
; RV64-NEXT:    add t0, a2, t0
; RV64-NEXT:    add t1, a0, t1
; RV64-NEXT:    add t2, a2, t2
...
; RV64-NEXT:    sub a2, a7, a3
; RV64-NEXT:    sltu t3, a7, a2
; RV64-NEXT:    addiw t3, t3, -1
; RV64-NEXT:    and a2, t3, a2
; RV64-NEXT:    vsetvli zero, a2, e64, m8, ta, ma
; RV64-NEXT:    csrr a2, vlenb
; RV64-NEXT:    slli a2, a2, 5
; RV64-NEXT:    add a2, sp, a2
; RV64-NEXT:    addi a2, a2, 16
; RV64-NEXT:    vl8re8.v v16, (a2) # Unknown-size Folded Reload
; RV64-NEXT:    vmfeq.vv v2, v16, v8, v0.t
; RV64-NEXT:    bltu a7, a3, .LBB171_4
; RV64-NEXT:  # %bb.3:
; RV64-NEXT:    mv a7, a3
; RV64-NEXT:  .LBB171_4:
; RV64-NEXT:    vsetvli a2, zero, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vx v17, v1, a1
; RV64-NEXT:    vl8re64.v v8, (t0)
; RV64-NEXT:    csrr a2, vlenb
; RV64-NEXT:    slli a2, a2, 5
; RV64-NEXT:    add a2, sp, a2
; RV64-NEXT:    addi a2, a2, 16
; RV64-NEXT:    vs8r.v v8, (a2) # Unknown-size Folded Spill
; RV64-NEXT:    vl8re64.v v8, (t1)
; RV64-NEXT:    csrr a2, vlenb
; RV64-NEXT:    li t0, 24
; RV64-NEXT:    mul a2, a2, t0
; RV64-NEXT:    add a2, sp, a2
; RV64-NEXT:    addi a2, a2, 16
; RV64-NEXT:    vs8r.v v8, (a2) # Unknown-size Folded Spill
; RV64-NEXT:    vl8re64.v v8, (t2)
; RV64-NEXT:    csrr a2, vlenb
...
; RV64-NEXT:    addi a0, a0, 16
; RV64-NEXT:    vl8re8.v v8, (a0) # Unknown-size Folded Reload
; RV64-NEXT:    vmfeq.vv v18, v24, v8, v0.t
; RV64-NEXT:    add a0, a1, a1
; RV64-NEXT:    vsetvli zero, a0, e8, mf2, tu, ma
; RV64-NEXT:    sub a0, a6, a5
; RV64-NEXT:    sltu a2, a6, a0
; RV64-NEXT:    addiw a2, a2, -1
; RV64-NEXT:    and a0, a2, a0
; RV64-NEXT:    vslideup.vx v18, v2, a1
; RV64-NEXT:    mv a2, a0
; RV64-NEXT:    bltu a0, a3, .LBB171_6
; RV64-NEXT:  # %bb.5:
; RV64-NEXT:    mv a2, a3
; RV64-NEXT:  .LBB171_6:
; RV64-NEXT:    vsetvli zero, a2, e64, m8, ta, ma
...
; RV64-NEXT:    vmfeq.vv v16, v24, v8, v0.t
; RV64-NEXT:    add a2, a4, a1
; RV64-NEXT:    vsetvli zero, a2, e8, mf2, tu, ma
; RV64-NEXT:    vslideup.vx v18, v16, a4
; RV64-NEXT:    sub a2, a0, a3
...
; RV64-NEXT:    vslideup.vx v18, v16, a0
; RV64-NEXT:    vmv1r.v v0, v18
; RV64-NEXT:    csrr a0, vlenb
; RV64-NEXT:    li a1, 48
