...
; CHECK-NEXT:    sltu a7, a5, a0
; CHECK-NEXT:    addi a7, a7, -1
; CHECK-NEXT:    and a7, a7, a0
...
; CHECK-NEXT:    vslidedown.vx v8, v24, a0
; CHECK-NEXT:    csrr t0, vlenb
; CHECK-NEXT:    add t0, sp, t0
; CHECK-NEXT:    addi t0, t0, 16
...
; CHECK-NEXT:    vs8r.v v0, (a6) # Unknown-size Folded Spill
; CHECK-NEXT:    vfwcvtbf16.f.f.v v8, v4
; CHECK-NEXT:    bltu a5, a3, .LBB85_2
; CHECK-NEXT:  # %bb.1:
; CHECK-NEXT:    mv a5, a3
; CHECK-NEXT:  .LBB85_2:
; CHECK-NEXT:    addi a6, sp, 16
; CHECK-NEXT:    vl1r.v v0, (a6) # Unknown-size Folded Reload
...
; CHECK-NEXT:    vslideup.vx v6, v7, a1
...
; CHECK-NEXT:    vsetvli zero, a5, e8, mf2, ta, ma
; CHECK-NEXT:    vslideup.vx v0, v5, a1
...
; ZVFHMIN-NEXT:    slli a5, a1, 3
; ZVFHMIN-NEXT:    slli a4, a1, 2
; ZVFHMIN-NEXT:    slli a3, a1, 1
; ZVFHMIN-NEXT:    add a6, a0, a5
; ZVFHMIN-NEXT:    sub a0, a2, a4
; ZVFHMIN-NEXT:    sltu a5, a2, a0
; ZVFHMIN-NEXT:    addi a5, a5, -1
; ZVFHMIN-NEXT:    and a5, a5, a0
; ZVFHMIN-NEXT:    sub a0, a5, a3
; ZVFHMIN-NEXT:    sltu a7, a5, a0
; ZVFHMIN-NEXT:    addi a7, a7, -1
; ZVFHMIN-NEXT:    and a7, a7, a0
; ZVFHMIN-NEXT:    srli a0, a1, 1
...
; ZVFHMIN-NEXT:    vslidedown.vx v8, v24, a0
; ZVFHMIN-NEXT:    csrr t0, vlenb
; ZVFHMIN-NEXT:    add t0, sp, t0
; ZVFHMIN-NEXT:    addi t0, t0, 16
...
; ZVFHMIN-NEXT:    vs8r.v v0, (a6) # Unknown-size Folded Spill
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v4
; ZVFHMIN-NEXT:    bltu a5, a3, .LBB171_2
; ZVFHMIN-NEXT:  # %bb.1:
; ZVFHMIN-NEXT:    mv a5, a3
; ZVFHMIN-NEXT:  .LBB171_2:
; ZVFHMIN-NEXT:    addi a6, sp, 16
; ZVFHMIN-NEXT:    vl1r.v v0, (a6) # Unknown-size Folded Reload
...
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFHMIN-NEXT:    vmfeq.vv v5, v24, v16, v0.t
; ZVFHMIN-NEXT:    vsetvli zero, a5, e8, mf2, ta, ma
; ZVFHMIN-NEXT:    vslideup.vx v6, v7, a1
...
; ZVFHMIN-NEXT:    vsetvli zero, a5, e8, mf2, ta, ma
; ZVFHMIN-NEXT:    vslideup.vx v0, v5, a1
