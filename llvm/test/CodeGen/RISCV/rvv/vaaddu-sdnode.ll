...
; RUN: llc -mtriple=riscv32 -mattr=+v,+use-fixed-point -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,RV32
; RUN: llc -mtriple=riscv64 -mattr=+v,+use-fixed-point -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,RV64
; RUN: llc -mtriple=riscv32 -mattr=+v,-use-fixed-point -verify-machineinstrs < %s | FileCheck %s --check-prefixes=NOFIXED,RV32
; RUN: llc -mtriple=riscv64 -mattr=+v,-use-fixed-point -verify-machineinstrs < %s | FileCheck %s --check-prefixes=NOFIXED,RV64
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_nxv8i8_floor:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; NOFIXED-NEXT:    vand.vv v10, v8, v9
; NOFIXED-NEXT:    vxor.vv v8, v8, v9
; NOFIXED-NEXT:    vsrl.vi v8, v8, 1
; NOFIXED-NEXT:    vadd.vv v8, v10, v8
; NOFIXED-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vx_nxv8i8_floor:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a1, zero, e8, m1, ta, ma
; NOFIXED-NEXT:    vand.vx v9, v8, a0
; NOFIXED-NEXT:    vxor.vx v8, v8, a0
; NOFIXED-NEXT:    vsrl.vi v8, v8, 1
; NOFIXED-NEXT:    vadd.vv v8, v9, v8
; NOFIXED-NEXT:    ret
  %xzv = zext <vscale x 8 x i8> %x to <vscale x 8 x i16>
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_nxv8i8_floor_sexti16:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; NOFIXED-NEXT:    vand.vv v10, v8, v9
; NOFIXED-NEXT:    vxor.vv v8, v8, v9
; NOFIXED-NEXT:    vsra.vi v8, v8, 1
; NOFIXED-NEXT:    vadd.vv v8, v10, v8
; NOFIXED-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_nxv8i8_floor_zexti32:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; NOFIXED-NEXT:    vand.vv v10, v8, v9
; NOFIXED-NEXT:    vxor.vv v8, v8, v9
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_nxv8i8_floor_lshr2:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; NOFIXED-NEXT:    vwaddu.vv v10, v8, v9
; NOFIXED-NEXT:    vnsrl.wi v8, v10, 2
; NOFIXED-NEXT:    ret
  %xzv = zext <vscale x 8 x i8> %x to <vscale x 8 x i16>
  %yzv = zext <vscale x 8 x i8> %y to <vscale x 8 x i16>
  %add = add nuw nsw <vscale x 8 x i16> %xzv, %yzv
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_nxv8i16_floor:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; NOFIXED-NEXT:    vand.vv v12, v8, v10
; NOFIXED-NEXT:    vxor.vv v8, v8, v10
; NOFIXED-NEXT:    vsrl.vi v8, v8, 1
; NOFIXED-NEXT:    vadd.vv v8, v12, v8
; NOFIXED-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vx_nxv8i16_floor:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a1, zero, e16, m2, ta, ma
; NOFIXED-NEXT:    vand.vx v10, v8, a0
; NOFIXED-NEXT:    vxor.vx v8, v8, a0
; NOFIXED-NEXT:    vsrl.vi v8, v8, 1
; NOFIXED-NEXT:    vadd.vv v8, v10, v8
; NOFIXED-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_nxv8i32_floor:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; NOFIXED-NEXT:    vand.vv v16, v8, v12
; NOFIXED-NEXT:    vxor.vv v8, v8, v12
; NOFIXED-NEXT:    vsrl.vi v8, v8, 1
; NOFIXED-NEXT:    vadd.vv v8, v16, v8
; NOFIXED-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vx_nxv8i32_floor:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a1, zero, e32, m4, ta, ma
; NOFIXED-NEXT:    vand.vx v12, v8, a0
; NOFIXED-NEXT:    vxor.vx v8, v8, a0
; NOFIXED-NEXT:    vsrl.vi v8, v8, 1
; NOFIXED-NEXT:    vadd.vv v8, v12, v8
; NOFIXED-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_nxv8i64_floor:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a0, zero, e64, m8, ta, ma
; NOFIXED-NEXT:    vand.vv v24, v8, v16
; NOFIXED-NEXT:    vxor.vv v8, v8, v16
; NOFIXED-NEXT:    vsrl.vi v8, v8, 1
; NOFIXED-NEXT:    vadd.vv v8, v24, v8
; NOFIXED-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_nxv8i8_ceil:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; NOFIXED-NEXT:    vor.vv v10, v8, v9
; NOFIXED-NEXT:    vxor.vv v8, v8, v9
; NOFIXED-NEXT:    vsrl.vi v8, v8, 1
; NOFIXED-NEXT:    vsub.vv v8, v10, v8
; NOFIXED-NEXT:    ret
  %xzv = zext <vscale x 8 x i8> %x to <vscale x 8 x i16>
  %yzv = zext <vscale x 8 x i8> %y to <vscale x 8 x i16>
  %add = add nuw nsw <vscale x 8 x i16> %xzv, %yzv
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vx_nxv8i8_ceil:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a1, zero, e8, m1, ta, ma
; NOFIXED-NEXT:    vor.vx v9, v8, a0
; NOFIXED-NEXT:    vxor.vx v8, v8, a0
; NOFIXED-NEXT:    vsrl.vi v8, v8, 1
; NOFIXED-NEXT:    vsub.vv v8, v9, v8
; NOFIXED-NEXT:    ret
  %xzv = zext <vscale x 8 x i8> %x to <vscale x 8 x i16>
  %yhead = insertelement <vscale x 8 x i8> poison, i8 %y, i32 0
  %ysplat = shufflevector <vscale x 8 x i8> %yhead, <vscale x 8 x i8> poison, <vscale x 8 x i32> zeroinitializer
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_nxv8i8_ceil_sexti16:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; NOFIXED-NEXT:    vor.vv v10, v8, v9
; NOFIXED-NEXT:    vxor.vv v8, v8, v9
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_nxv8i8_ceil_zexti32:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; NOFIXED-NEXT:    vor.vv v10, v8, v9
; NOFIXED-NEXT:    vxor.vv v8, v8, v9
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_nxv8i8_ceil_lshr2:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; NOFIXED-NEXT:    vwaddu.vv v10, v8, v9
; NOFIXED-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; NOFIXED-NEXT:    vadd.vi v8, v10, 2
; NOFIXED-NEXT:    vsetvli zero, zero, e8, m1, ta, ma
; NOFIXED-NEXT:    vnsrl.wi v8, v8, 2
; NOFIXED-NEXT:    ret
  %xzv = zext <vscale x 8 x i8> %x to <vscale x 8 x i16>
  %yzv = zext <vscale x 8 x i8> %y to <vscale x 8 x i16>
  %add = add nuw nsw <vscale x 8 x i16> %xzv, %yzv
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_nxv8i8_ceil_add2:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; NOFIXED-NEXT:    vwaddu.vv v10, v8, v9
; NOFIXED-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_nxv8i16_ceil:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; NOFIXED-NEXT:    vor.vv v12, v8, v10
; NOFIXED-NEXT:    vxor.vv v8, v8, v10
; NOFIXED-NEXT:    vsrl.vi v8, v8, 1
; NOFIXED-NEXT:    vsub.vv v8, v12, v8
; NOFIXED-NEXT:    ret
  %xzv = zext <vscale x 8 x i16> %x to <vscale x 8 x i32>
  %yzv = zext <vscale x 8 x i16> %y to <vscale x 8 x i32>
  %add = add nuw nsw <vscale x 8 x i32> %xzv, %yzv
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vx_nxv8i16_ceil:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a1, zero, e16, m2, ta, ma
; NOFIXED-NEXT:    vor.vx v10, v8, a0
; NOFIXED-NEXT:    vxor.vx v8, v8, a0
; NOFIXED-NEXT:    vsrl.vi v8, v8, 1
; NOFIXED-NEXT:    vsub.vv v8, v10, v8
; NOFIXED-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_nxv8i32_ceil:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; NOFIXED-NEXT:    vor.vv v16, v8, v12
; NOFIXED-NEXT:    vxor.vv v8, v8, v12
; NOFIXED-NEXT:    vsrl.vi v8, v8, 1
; NOFIXED-NEXT:    vsub.vv v8, v16, v8
; NOFIXED-NEXT:    ret
  %xzv = zext <vscale x 8 x i32> %x to <vscale x 8 x i64>
  %yzv = zext <vscale x 8 x i32> %y to <vscale x 8 x i64>
  %add = add nuw nsw <vscale x 8 x i64> %xzv, %yzv
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vx_nxv8i32_ceil:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a1, zero, e32, m4, ta, ma
; NOFIXED-NEXT:    vor.vx v12, v8, a0
; NOFIXED-NEXT:    vxor.vx v8, v8, a0
; NOFIXED-NEXT:    vsrl.vi v8, v8, 1
; NOFIXED-NEXT:    vsub.vv v8, v12, v8
; NOFIXED-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_nxv8i64_ceil:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetvli a0, zero, e64, m8, ta, ma
; NOFIXED-NEXT:    vor.vv v24, v8, v16
; NOFIXED-NEXT:    vxor.vv v8, v8, v16
; NOFIXED-NEXT:    vsrl.vi v8, v8, 1
; NOFIXED-NEXT:    vsub.vv v8, v24, v8
; NOFIXED-NEXT:    ret
  %xzv = zext <vscale x 8 x i64> %x to <vscale x 8 x i128>
  %yzv = zext <vscale x 8 x i64> %y to <vscale x 8 x i128>
  %add = add nuw nsw <vscale x 8 x i128> %xzv, %yzv
