...
; RV32-LABEL: vp_round_nxv16f64_unmasked:
; RV32:       # %bb.0:
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    sub a2, a0, a1
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vp_round_nxv16f64_unmasked:
; RV64:       # %bb.0:
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    sub a2, a0, a1
