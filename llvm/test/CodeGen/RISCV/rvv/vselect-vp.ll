...
; RV32-NEXT:    srli a4, a1, 2
; RV32-NEXT:    vl8re32.v v0, (a0)
; RV32-NEXT:    addi a0, sp, 16
; RV32-NEXT:    vs8r.v v0, (a0) # Unknown-size Folded Spill
; RV32-NEXT:    vsetvli a0, zero, e8, mf2, ta, ma
; RV32-NEXT:    vslidedown.vx v0, v24, a4
; RV32-NEXT:    vsetvli zero, a3, e32, m8, ta, ma
; RV32-NEXT:    vmerge.vvm v16, v8, v16, v0
; RV32-NEXT:    bltu a1, a2, .LBB28_2
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    mv a1, a2
; RV32-NEXT:  .LBB28_2:
...
; RV64-NEXT:    vs8r.v v0, (a0) # Unknown-size Folded Spill
; RV64-NEXT:    vsetvli a0, zero, e8, mf2, ta, ma
; RV64-NEXT:    vslidedown.vx v0, v24, a4
