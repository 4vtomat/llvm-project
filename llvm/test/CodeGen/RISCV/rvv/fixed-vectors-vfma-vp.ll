...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vs8r.v v8, (a1) # Unknown-size Folded Spill
; RV32-NEXT:    addi a1, a2, 128
; RV32-NEXT:    addi a2, a4, -16
...
; RV32-NEXT:    vfmadd.vv v8, v24, v16, v0.t
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    slli a1, a1, 3
; RV32-NEXT:    add a1, sp, a1
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vs8r.v v8, (a1) # Unknown-size Folded Spill
; RV32-NEXT:    bltu a4, a0, .LBB50_2
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    li a4, 16
; RV32-NEXT:  .LBB50_2:
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vs8r.v v8, (a1) # Unknown-size Folded Spill
; RV64-NEXT:    addi a1, a2, 128
; RV64-NEXT:    addi a2, a4, -16
...
; RV64-NEXT:    vfmadd.vv v8, v24, v16, v0.t
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    slli a1, a1, 3
; RV64-NEXT:    add a1, sp, a1
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vs8r.v v8, (a1) # Unknown-size Folded Spill
; RV64-NEXT:    bltu a4, a0, .LBB50_2
; RV64-NEXT:  # %bb.1:
; RV64-NEXT:    li a4, 16
; RV64-NEXT:  .LBB50_2:
...
; RV32-LABEL: vfma_vv_v32f64_unmasked:
; RV32:       # %bb.0:
; RV32-NEXT:    addi sp, sp, -16
; RV32-NEXT:    .cfi_def_cfa_offset 16
; RV32-NEXT:    csrr a1, vlenb
...
; RV32-NEXT:    addi a0, a0, 16
; RV32-NEXT:    vl8re8.v v24, (a0) # Unknown-size Folded Reload
; RV32-NEXT:    vfmadd.vv v0, v8, v24
; RV32-NEXT:    addi a0, a4, -16
; RV32-NEXT:    sltu a1, a4, a0
...
; RV32-NEXT:    addi a0, sp, 16
; RV32-NEXT:    vl8re8.v v24, (a0) # Unknown-size Folded Reload
; RV32-NEXT:    vfmadd.vv v24, v16, v8
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vfma_vv_v32f64_unmasked:
; RV64:       # %bb.0:
; RV64-NEXT:    addi sp, sp, -16
; RV64-NEXT:    .cfi_def_cfa_offset 16
; RV64-NEXT:    csrr a1, vlenb
...
; RV64-NEXT:    addi a0, a0, 16
; RV64-NEXT:    vl8re8.v v24, (a0) # Unknown-size Folded Reload
; RV64-NEXT:    vfmadd.vv v0, v8, v24
; RV64-NEXT:    addi a0, a4, -16
; RV64-NEXT:    sltu a1, a4, a0
...
; RV64-NEXT:    addi a0, sp, 16
; RV64-NEXT:    vl8re8.v v24, (a0) # Unknown-size Folded Reload
; RV64-NEXT:    vfmadd.vv v24, v16, v8
