...
define <vscale x 1 x bfloat> @intrinsic_vfwcvtbf16_f.f.v.alt_nxv1bf16_nxv1i8(<vscale x 1 x i8> %0, iXLen %1) nounwind {
; CHECK-LABEL: intrinsic_vfwcvtbf16_f.f.v.alt_nxv1bf16_nxv1i8:
; CHECK:       # %bb.0: # %entry
...
define <vscale x 2 x bfloat> @intrinsic_vfwcvtbf16_f.f.v.alt_nxv2bf16_nxv2i8(<vscale x 2 x i8> %0, iXLen %1) nounwind {
; CHECK-LABEL: intrinsic_vfwcvtbf16_f.f.v.alt_nxv2bf16_nxv2i8:
; CHECK:       # %bb.0: # %entry
...
define <vscale x 4 x bfloat> @intrinsic_vfwcvtbf16_f.f.v.alt_nxv4bf16_nxv4i8(<vscale x 4 x i8> %0, iXLen %1) nounwind {
; CHECK-LABEL: intrinsic_vfwcvtbf16_f.f.v.alt_nxv4bf16_nxv4i8:
; CHECK:       # %bb.0: # %entry
...
define <vscale x 8 x bfloat> @intrinsic_vfwcvtbf16_f.f.v.alt_nxv8bf16_nxv8i8(<vscale x 8 x i8> %0, iXLen %1) nounwind {
; CHECK-LABEL: intrinsic_vfwcvtbf16_f.f.v.alt_nxv8bf16_nxv8i8:
; CHECK:       # %bb.0: # %entry
...
define <vscale x 16 x bfloat> @intrinsic_vfwcvtbf16_f.f.v.alt_nxv16bf16_nxv16i8(<vscale x 16 x i8> %0, iXLen %1) nounwind {
; CHECK-LABEL: intrinsic_vfwcvtbf16_f.f.v.alt_nxv16bf16_nxv16i8:
; CHECK:       # %bb.0: # %entry
...
define <vscale x 32 x bfloat> @intrinsic_vfwcvtbf16_f.f.v.alt_nxv32bf16_nxv32i8(<vscale x 32 x i8> %0, iXLen %1) nounwind {
; CHECK-LABEL: intrinsic_vfwcvtbf16_f.f.v.alt_nxv32bf16_nxv32i8:
; CHECK:       # %bb.0: # %entry
