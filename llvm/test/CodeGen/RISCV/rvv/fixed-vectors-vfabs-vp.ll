...
; RV32-LABEL: vfabs_vv_v32f64_unmasked:
; RV32:       # %bb.0:
; RV32-NEXT:    li a2, 16
; RV32-NEXT:    mv a1, a0
...
; RV32-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; RV32-NEXT:    vfabs.v v16, v16
; RV32-NEXT:    ret
;
; RV64-LABEL: vfabs_vv_v32f64_unmasked:
; RV64:       # %bb.0:
; RV64-NEXT:    li a2, 16
; RV64-NEXT:    mv a1, a0
