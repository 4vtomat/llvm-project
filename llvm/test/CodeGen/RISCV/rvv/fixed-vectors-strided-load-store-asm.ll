...
; ZVE32F-NEXT:    sd a6, 0(a7)
; ZVE32F-NEXT:    add a5, a0, a5
; ZVE32F-NEXT:    sd t0, 0(a5)
; ZVE32F-NEXT:    sd t1, 80(a7)
; ZVE32F-NEXT:    addi a2, a2, 4
; ZVE32F-NEXT:    addi a1, a1, 32
; ZVE32F-NEXT:    sd t2, 80(a5)
; ZVE32F-NEXT:    addi a4, a4, 4
...
; OPTV-NEXT:    sd a6, 0(a7)
; OPTV-NEXT:    add a5, a0, a5
; OPTV-NEXT:    sd t0, 0(a5)
; OPTV-NEXT:    sd t1, 80(a7)
; OPTV-NEXT:    addi a2, a2, 4
; OPTV-NEXT:    addi a1, a1, 32
; OPTV-NEXT:    sd t2, 80(a5)
; OPTV-NEXT:    addi a4, a4, 4
