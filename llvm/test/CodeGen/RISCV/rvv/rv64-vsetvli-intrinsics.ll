...
; RUN:   -riscv-force-tail-undisturbed | FileCheck --check-prefix=CHECK-TU %s
...
; CHECK-NEXT:    ret
;
; CHECK-TU-LABEL: test_vsetvli_e8m1:
; CHECK-TU:       # %bb.0:
; CHECK-TU-NEXT:    vsetvli zero, a0, e8, m1, tu, mu
; CHECK-TU-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-TU-LABEL: test_vsetvli_e16mf4:
; CHECK-TU:       # %bb.0:
; CHECK-TU-NEXT:    vsetvli zero, a0, e16, mf4, tu, mu
; CHECK-TU-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-TU-LABEL: test_vsetvli_e32mf8_zero_avl:
; CHECK-TU:       # %bb.0:
; CHECK-TU-NEXT:    vsetivli zero, 0, e16, mf4, tu, mu
; CHECK-TU-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-TU-LABEL: test_vsetvlimax_e32m2:
; CHECK-TU:       # %bb.0:
; CHECK-TU-NEXT:    vsetvli a0, zero, e32, m2, tu, mu
; CHECK-TU-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-TU-LABEL: test_vsetvlimax_e64m4:
; CHECK-TU:       # %bb.0:
; CHECK-TU-NEXT:    vsetvli a0, zero, e64, m4, tu, mu
; CHECK-TU-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-TU-LABEL: test_vsetvli_opt_e8m1:
; CHECK-TU:       # %bb.0:
; CHECK-TU-NEXT:    vsetvli a0, a0, e8, m1, tu, mu
; CHECK-TU-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-TU-LABEL: test_vsetvli_opt_e8m1_nouse:
; CHECK-TU:       # %bb.0:
; CHECK-TU-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-TU-LABEL: test_vsetvli_opt_e16mf4:
; CHECK-TU:       # %bb.0:
; CHECK-TU-NEXT:    vsetvli a0, a0, e16, mf4, tu, mu
; CHECK-TU-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-TU-LABEL: test_vsetvli_opt_e32mf8_zero_avl:
; CHECK-TU:       # %bb.0:
; CHECK-TU-NEXT:    vsetivli a0, 0, e16, mf4, tu, mu
; CHECK-TU-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-TU-LABEL: test_vsetvlimax_opt_e32m2:
; CHECK-TU:       # %bb.0:
; CHECK-TU-NEXT:    vsetvli a0, zero, e32, m2, tu, mu
; CHECK-TU-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-TU-LABEL: test_vsetvlimax_opt_e32m2_nouse:
; CHECK-TU:       # %bb.0:
; CHECK-TU-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-TU-LABEL: test_vsetvlimax_opt_e64m4:
; CHECK-TU:       # %bb.0:
; CHECK-TU-NEXT:    vsetvli a0, zero, e64, m4, tu, mu
; CHECK-TU-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-TU-LABEL: redundant_vsetvli:
; CHECK-TU:       # %bb.0:
; CHECK-TU-NEXT:    vsetvli zero, a0, e32, m2, tu, mu
; CHECK-TU-NEXT:    vle32.v v8, (a1)
; CHECK-TU-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-TU-LABEL: repeated_vsetvli:
; CHECK-TU:       # %bb.0:
; CHECK-TU-NEXT:    vsetvli a0, a0, e32, m2, tu, mu
; CHECK-TU-NEXT:    vsetvli zero, a0, e32, m2, tu, mu
; CHECK-TU-NEXT:    vle32.v v8, (a1)
; CHECK-TU-NEXT:    ret
