...
; RUN: sed 's/iXLen/i32/g' %s | llc -mtriple=riscv32 -mattr=+v,+experimental-zfbfmin,+xsfvfbfa \
; RUN:   -verify-machineinstrs -target-abi=ilp32d | FileCheck %s
; RUN: sed 's/iXLen/i64/g' %s | llc -mtriple=riscv64 -mattr=+v,+experimental-zfbfmin,+xsfvfbfa \
...
; CHECK-NEXT:    vmfeq.vv v8, v8, v10
; CHECK-NEXT:    vmv1r.v v9, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    vmfeq.vv v9, v10, v12, v0.t
...
; CHECK-NEXT:    vmfeq.vv v8, v8, v12
; CHECK-NEXT:    vmv1r.v v9, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    vmfeq.vv v9, v12, v16, v0.t
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    ret
entry:
