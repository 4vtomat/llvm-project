...
; RV32-LABEL: vadd_vi_nxv128i8:
; RV32:       # %bb.0:
; RV32-NEXT:    vmv1r.v v24, v0
; RV32-NEXT:    vsetvli a2, zero, e8, m8, ta, ma
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vadd_vi_nxv128i8:
; RV64:       # %bb.0:
; RV64-NEXT:    vmv1r.v v24, v0
; RV64-NEXT:    vsetvli a2, zero, e8, m8, ta, ma
...
; RV32-LABEL: vadd_vi_nxv128i8_unmasked:
; RV32:       # %bb.0:
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vadd_vi_nxv128i8_unmasked:
; RV64:       # %bb.0:
...
; RV32-LABEL: vadd_vi_nxv32i32_unmasked:
; RV32:       # %bb.0:
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    slli a1, a1, 1
; RV32-NEXT:    sub a2, a0, a1
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vadd_vi_nxv32i32_unmasked:
; RV64:       # %bb.0:
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    slli a1, a1, 1
; RV64-NEXT:    sub a2, a0, a1
