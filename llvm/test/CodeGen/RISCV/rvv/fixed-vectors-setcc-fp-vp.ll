...
; RV32-LABEL: fcmp_oeq_vv_v128f16:
; RV32:       # %bb.0:
...
; RV32-NEXT:    vsetivli zero, 16, e8, m1, tu, ma
; RV32-NEXT:    vslideup.vi v16, v1, 8
...
; RV32-NEXT:    ret
;
; RV64-LABEL: fcmp_oeq_vv_v128f16:
; RV64:       # %bb.0:
...
; RV64-NEXT:    vsetivli zero, 16, e8, m1, tu, ma
; RV64-NEXT:    vslideup.vi v16, v1, 8
