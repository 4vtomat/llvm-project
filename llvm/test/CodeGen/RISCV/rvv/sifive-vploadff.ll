...
declare { <vscale x 2 x float>, i32 } @llvm.vp.load.ff.nxv2float.p0(ptr, <vscale x 2 x i1>, i32)

define { <vscale x 2 x float>, i32 } @vploadff_nxv2float(ptr %ptr, <vscale x 2 x i1> %m, i32 zeroext %evl) {
; CHECK-LABEL: vploadff_nxv2float:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, m1, ta, ma
; CHECK-NEXT:    vle32ff.v v8, (a0), v0.t
; CHECK-NEXT:    csrr a0, vl
; CHECK-NEXT:    ret
  %load = call { <vscale x 2 x float>, i32 } @llvm.vp.load.ff.nxv2float.p0(ptr %ptr, <vscale x 2 x i1> %m, i32 %evl)
  ret { <vscale x 2 x float>, i32 } %load
}

define { <vscale x 2 x float>, i32 } @vploadff_nxv2float_allones_mask(ptr %ptr, i32 zeroext %evl) {
; CHECK-LABEL: vploadff_nxv2float_allones_mask:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, m1, ta, ma
; CHECK-NEXT:    vle32ff.v v8, (a0)
; CHECK-NEXT:    csrr a0, vl
; CHECK-NEXT:    ret
  %a = insertelement <vscale x 2 x i1> poison, i1 true, i32 0
  %b = shufflevector <vscale x 2 x i1> %a, <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer
  %load = call { <vscale x 2 x float>, i32 } @llvm.vp.load.ff.nxv2float.p0(ptr %ptr, <vscale x 2 x i1> %b, i32 %evl)
  ret { <vscale x 2 x float>, i32 } %load
}

declare { <vscale x 4 x float>, i32 } @llvm.vp.load.ff.nxv4float.p0(ptr, <vscale x 4 x i1>, i32)

define { <vscale x 4 x float>, i32 } @vploadff_nxv4float(ptr %ptr, <vscale x 4 x i1> %m, i32 zeroext %evl) {
; CHECK-LABEL: vploadff_nxv4float:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, m2, ta, ma
; CHECK-NEXT:    vle32ff.v v8, (a0), v0.t
; CHECK-NEXT:    csrr a0, vl
; CHECK-NEXT:    ret
  %load = call { <vscale x 4 x float>, i32 } @llvm.vp.load.ff.nxv4float.p0(ptr %ptr, <vscale x 4 x i1> %m, i32 %evl)
  ret { <vscale x 4 x float>, i32 } %load
}

define { <vscale x 4 x float>, i32 } @vploadff_nxv4float_allones_mask(ptr %ptr, i32 zeroext %evl) {
; CHECK-LABEL: vploadff_nxv4float_allones_mask:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, m2, ta, ma
; CHECK-NEXT:    vle32ff.v v8, (a0)
; CHECK-NEXT:    csrr a0, vl
; CHECK-NEXT:    ret
  %a = insertelement <vscale x 4 x i1> poison, i1 true, i32 0
  %b = shufflevector <vscale x 4 x i1> %a, <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer
  %load = call { <vscale x 4 x float>, i32 } @llvm.vp.load.ff.nxv4float.p0(ptr %ptr, <vscale x 4 x i1> %b, i32 %evl)
  ret { <vscale x 4 x float>, i32 } %load
}

declare { <vscale x 8 x float>, i32 } @llvm.vp.load.ff.nxv8float.p0(ptr, <vscale x 8 x i1>, i32)

define { <vscale x 8 x float>, i32 } @vploadff_nxv8float(ptr %ptr, <vscale x 8 x i1> %m, i32 zeroext %evl) {
; CHECK-LABEL: vploadff_nxv8float:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, m4, ta, ma
; CHECK-NEXT:    vle32ff.v v8, (a0), v0.t
; CHECK-NEXT:    csrr a0, vl
; CHECK-NEXT:    ret
  %load = call { <vscale x 8 x float>, i32 } @llvm.vp.load.ff.nxv8float.p0(ptr %ptr, <vscale x 8 x i1> %m, i32 %evl)
  ret { <vscale x 8 x float>, i32 } %load
}

define { <vscale x 8 x float>, i32 } @vploadff_nxv8float_allones_mask(ptr %ptr, i32 zeroext %evl) {
; CHECK-LABEL: vploadff_nxv8float_allones_mask:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, m4, ta, ma
; CHECK-NEXT:    vle32ff.v v8, (a0)
; CHECK-NEXT:    csrr a0, vl
; CHECK-NEXT:    ret
  %a = insertelement <vscale x 8 x i1> poison, i1 true, i32 0
  %b = shufflevector <vscale x 8 x i1> %a, <vscale x 8 x i1> poison, <vscale x 8 x i32> zeroinitializer
  %load = call { <vscale x 8 x float>, i32 } @llvm.vp.load.ff.nxv8float.p0(ptr %ptr, <vscale x 8 x i1> %b, i32 %evl)
  ret { <vscale x 8 x float>, i32 } %load
}

declare { <vscale x 16 x float>, i32 } @llvm.vp.load.ff.nxv16float.p0(ptr, <vscale x 16 x i1>, i32)

define { <vscale x 16 x float>, i32 } @vploadff_nxv16float(ptr %ptr, <vscale x 16 x i1> %m, i32 zeroext %evl) {
; CHECK-LABEL: vploadff_nxv16float:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, m8, ta, ma
; CHECK-NEXT:    vle32ff.v v8, (a0), v0.t
; CHECK-NEXT:    csrr a0, vl
; CHECK-NEXT:    ret
  %load = call { <vscale x 16 x float>, i32 } @llvm.vp.load.ff.nxv16float.p0(ptr %ptr, <vscale x 16 x i1> %m, i32 %evl)
  ret { <vscale x 16 x float>, i32 } %load
}

define { <vscale x 16 x float>, i32 } @vploadff_nxv16float_allones_mask(ptr %ptr, i32 zeroext %evl) {
; CHECK-LABEL: vploadff_nxv16float_allones_mask:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, m8, ta, ma
; CHECK-NEXT:    vle32ff.v v8, (a0)
; CHECK-NEXT:    csrr a0, vl
; CHECK-NEXT:    ret
  %a = insertelement <vscale x 16 x i1> poison, i1 true, i32 0
  %b = shufflevector <vscale x 16 x i1> %a, <vscale x 16 x i1> poison, <vscale x 16 x i32> zeroinitializer
  %load = call { <vscale x 16 x float>, i32 } @llvm.vp.load.ff.nxv16float.p0(ptr %ptr, <vscale x 16 x i1> %b, i32 %evl)
  ret { <vscale x 16 x float>, i32 } %load
}
...
declare { <vscale x 2 x double>, i32 } @llvm.vp.load.ff.nxv2double.p0(ptr, <vscale x 2 x i1>, i32)

define { <vscale x 2 x double>, i32 } @vploadff_nxv2double(ptr %ptr, <vscale x 2 x i1> %m, i32 zeroext %evl) {
; CHECK-LABEL: vploadff_nxv2double:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e64, m2, ta, ma
; CHECK-NEXT:    vle64ff.v v8, (a0), v0.t
; CHECK-NEXT:    csrr a0, vl
; CHECK-NEXT:    ret
  %load = call { <vscale x 2 x double>, i32 } @llvm.vp.load.ff.nxv2double.p0(ptr %ptr, <vscale x 2 x i1> %m, i32 %evl)
  ret { <vscale x 2 x double>, i32 } %load
}

define { <vscale x 2 x double>, i32 } @vploadff_nxv2double_allones_mask(ptr %ptr, i32 zeroext %evl) {
; CHECK-LABEL: vploadff_nxv2double_allones_mask:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e64, m2, ta, ma
; CHECK-NEXT:    vle64ff.v v8, (a0)
; CHECK-NEXT:    csrr a0, vl
; CHECK-NEXT:    ret
  %a = insertelement <vscale x 2 x i1> poison, i1 true, i32 0
  %b = shufflevector <vscale x 2 x i1> %a, <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer
  %load = call { <vscale x 2 x double>, i32 } @llvm.vp.load.ff.nxv2double.p0(ptr %ptr, <vscale x 2 x i1> %b, i32 %evl)
  ret { <vscale x 2 x double>, i32 } %load
}

declare { <vscale x 4 x double>, i32 } @llvm.vp.load.ff.nxv4double.p0(ptr, <vscale x 4 x i1>, i32)

define { <vscale x 4 x double>, i32 } @vploadff_nxv4double(ptr %ptr, <vscale x 4 x i1> %m, i32 zeroext %evl) {
; CHECK-LABEL: vploadff_nxv4double:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e64, m4, ta, ma
; CHECK-NEXT:    vle64ff.v v8, (a0), v0.t
; CHECK-NEXT:    csrr a0, vl
; CHECK-NEXT:    ret
  %load = call { <vscale x 4 x double>, i32 } @llvm.vp.load.ff.nxv4double.p0(ptr %ptr, <vscale x 4 x i1> %m, i32 %evl)
  ret { <vscale x 4 x double>, i32 } %load
}

define { <vscale x 4 x double>, i32 } @vploadff_nxv4double_allones_mask(ptr %ptr, i32 zeroext %evl) {
; CHECK-LABEL: vploadff_nxv4double_allones_mask:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e64, m4, ta, ma
; CHECK-NEXT:    vle64ff.v v8, (a0)
; CHECK-NEXT:    csrr a0, vl
; CHECK-NEXT:    ret
  %a = insertelement <vscale x 4 x i1> poison, i1 true, i32 0
  %b = shufflevector <vscale x 4 x i1> %a, <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer
  %load = call { <vscale x 4 x double>, i32 } @llvm.vp.load.ff.nxv4double.p0(ptr %ptr, <vscale x 4 x i1> %b, i32 %evl)
  ret { <vscale x 4 x double>, i32 } %load
}

declare { <vscale x 8 x double>, i32 } @llvm.vp.load.ff.nxv8double.p0(ptr, <vscale x 8 x i1>, i32)

define { <vscale x 8 x double>, i32 } @vploadff_nxv8double(ptr %ptr, <vscale x 8 x i1> %m, i32 zeroext %evl) {
; CHECK-LABEL: vploadff_nxv8double:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; CHECK-NEXT:    vle64ff.v v8, (a0), v0.t
; CHECK-NEXT:    csrr a0, vl
; CHECK-NEXT:    ret
  %load = call { <vscale x 8 x double>, i32 } @llvm.vp.load.ff.nxv8double.p0(ptr %ptr, <vscale x 8 x i1> %m, i32 %evl)
  ret { <vscale x 8 x double>, i32 } %load
}

define { <vscale x 8 x double>, i32 } @vploadff_nxv8double_allones_mask(ptr %ptr, i32 zeroext %evl) {
; CHECK-LABEL: vploadff_nxv8double_allones_mask:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; CHECK-NEXT:    vle64ff.v v8, (a0)
; CHECK-NEXT:    csrr a0, vl
; CHECK-NEXT:    ret
  %a = insertelement <vscale x 8 x i1> poison, i1 true, i32 0
  %b = shufflevector <vscale x 8 x i1> %a, <vscale x 8 x i1> poison, <vscale x 8 x i32> zeroinitializer
  %load = call { <vscale x 8 x double>, i32 } @llvm.vp.load.ff.nxv8double.p0(ptr %ptr, <vscale x 8 x i1> %b, i32 %evl)
  ret { <vscale x 8 x double>, i32 } %load
}
