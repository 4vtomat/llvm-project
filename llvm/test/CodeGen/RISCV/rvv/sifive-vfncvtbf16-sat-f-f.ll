...
declare <vscale x 1 x i8> @llvm.riscv.vfncvt.sat.f.f.w.nxv1i8.nxv1bf16(
  <vscale x 1 x i8>,
  <vscale x 1 x bfloat>,
  iXLen, iXLen);
...
declare <vscale x 2 x i8> @llvm.riscv.vfncvt.sat.f.f.w.nxv2i8.nxv2bf16(
  <vscale x 2 x i8>,
  <vscale x 2 x bfloat>,
  iXLen, iXLen);
...
declare <vscale x 4 x i8> @llvm.riscv.vfncvt.sat.f.f.w.nxv4i8.nxv4bf16(
  <vscale x 4 x i8>,
  <vscale x 4 x bfloat>,
  iXLen, iXLen);
...
declare <vscale x 8 x i8> @llvm.riscv.vfncvt.sat.f.f.w.nxv8i8.nxv8bf16(
  <vscale x 8 x i8>,
  <vscale x 8 x bfloat>,
  iXLen, iXLen);
...
declare <vscale x 16 x i8> @llvm.riscv.vfncvt.sat.f.f.w.nxv16i8.nxv16bf16(
  <vscale x 16 x i8>,
...
declare <vscale x 32 x i8> @llvm.riscv.vfncvt.sat.f.f.w.nxv32i8.nxv32bf16(
  <vscale x 32 x i8>,
