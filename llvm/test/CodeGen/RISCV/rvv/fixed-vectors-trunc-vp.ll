...
; RV32-NEXT:    addi t4, a1, 512
; RV32-NEXT:    addi t3, a1, 640
; RV32-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV32-NEXT:    vslidedown.vi v0, v4, 2
; RV32-NEXT:    addi t5, t5, -1
; RV32-NEXT:    vslidedown.vi v3, v5, 2
; RV32-NEXT:    addi t1, a1, 384
; RV32-NEXT:    li a3, 32
; RV32-NEXT:    addi t6, a6, -32
; RV32-NEXT:    sltu a6, a6, t6
; RV32-NEXT:    addi a6, a6, -1
; RV32-NEXT:    and a6, a6, t6
; RV32-NEXT:    addi t6, a6, -16
; RV32-NEXT:    sltu s0, a6, t6
...
; RV32-NEXT:    vs8r.v v8, (t4) # Unknown-size Folded Spill
; RV32-NEXT:    vle64.v v16, (t3)
; RV32-NEXT:    and t3, t5, t0
...
; RV32-NEXT:    vs8r.v v24, (t0) # Unknown-size Folded Spill
; RV32-NEXT:    and t2, s0, t6
; RV32-NEXT:    addi a1, a1, 256
; RV32-NEXT:    mv t0, a4
; RV32-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV32-NEXT:    vslidedown.vi v2, v6, 2
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV32-NEXT:    vle64.v v24, (t1)
; RV32-NEXT:    csrr t1, vlenb
; RV32-NEXT:    slli t1, t1, 3
; RV32-NEXT:    add t1, sp, t1
; RV32-NEXT:    addi t1, t1, 16
; RV32-NEXT:    vs8r.v v24, (t1) # Unknown-size Folded Spill
; RV32-NEXT:    bltu a4, a3, .LBB16_8
; RV32-NEXT:  # %bb.7:
; RV32-NEXT:    li t0, 32
; RV32-NEXT:  .LBB16_8:
; RV32-NEXT:    vsetvli zero, t3, e32, m4, ta, ma
...
; RV32-NEXT:    add t1, sp, t1
; RV32-NEXT:    addi t1, t1, 16
; RV32-NEXT:    vl8r.v v24, (t1) # Unknown-size Folded Reload
...
; RV32-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV32-NEXT:    vslidedown.vi v25, v7, 2
; RV32-NEXT:    addi a1, sp, 16
; RV32-NEXT:    vl8r.v v8, (a1) # Unknown-size Folded Reload
...
; RV64-NEXT:    addi t4, a1, 512
; RV64-NEXT:    addi t3, a1, 640
; RV64-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vi v0, v4, 2
; RV64-NEXT:    addi t5, t5, -1
; RV64-NEXT:    vslidedown.vi v3, v5, 2
; RV64-NEXT:    addi t1, a1, 384
; RV64-NEXT:    li a3, 32
; RV64-NEXT:    addi t6, a6, -32
; RV64-NEXT:    sltu a6, a6, t6
; RV64-NEXT:    addi a6, a6, -1
; RV64-NEXT:    and a6, a6, t6
; RV64-NEXT:    addi t6, a6, -16
; RV64-NEXT:    sltu s0, a6, t6
...
; RV64-NEXT:    addi t4, t4, 32
; RV64-NEXT:    vs8r.v v8, (t4) # Unknown-size Folded Spill
; RV64-NEXT:    vle64.v v16, (t3)
; RV64-NEXT:    and t3, t5, t0
; RV64-NEXT:    vle64.v v8, (t2)
; RV64-NEXT:    vle64.v v24, (a1)
; RV64-NEXT:    csrr t0, vlenb
; RV64-NEXT:    li t2, 40
; RV64-NEXT:    mul t0, t0, t2
; RV64-NEXT:    add t0, sp, t0
; RV64-NEXT:    addi t0, t0, 32
; RV64-NEXT:    vs8r.v v24, (t0) # Unknown-size Folded Spill
; RV64-NEXT:    and t2, s0, t6
; RV64-NEXT:    addi a1, a1, 256
; RV64-NEXT:    mv t0, a4
; RV64-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vi v2, v6, 2
; RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV64-NEXT:    vle64.v v24, (t1)
; RV64-NEXT:    csrr t1, vlenb
; RV64-NEXT:    slli t1, t1, 3
; RV64-NEXT:    add t1, sp, t1
; RV64-NEXT:    addi t1, t1, 32
; RV64-NEXT:    vs8r.v v24, (t1) # Unknown-size Folded Spill
; RV64-NEXT:    bltu a4, a3, .LBB16_8
; RV64-NEXT:  # %bb.7:
; RV64-NEXT:    li t0, 32
; RV64-NEXT:  .LBB16_8:
; RV64-NEXT:    vsetvli zero, t3, e32, m4, ta, ma
...
; RV64-NEXT:    add t1, sp, t1
; RV64-NEXT:    addi t1, t1, 32
; RV64-NEXT:    vl8r.v v24, (t1) # Unknown-size Folded Reload
...
; RV64-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vi v25, v7, 2
; RV64-NEXT:    addi a1, sp, 32
; RV64-NEXT:    vl8r.v v8, (a1) # Unknown-size Folded Reload
