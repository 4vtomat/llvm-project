...
; RV32-LABEL: vp_roundeven_nxv16f64:
; RV32:       # %bb.0:
...
; RV32-NEXT:    vsetvli zero, zero, e64, m8, ta, mu
; RV32-NEXT:    addi a2, sp, 16
; RV32-NEXT:    vl8re8.v v24, (a2) # Unknown-size Folded Reload
...
; RV32-NEXT:    vsetvli zero, zero, e64, m8, ta, mu
; RV32-NEXT:    vmflt.vf v1, v16, ft0, v0.t
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vp_roundeven_nxv16f64:
; RV64:       # %bb.0:
...
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, mu
; RV64-NEXT:    addi a2, sp, 16
; RV64-NEXT:    vl8re8.v v24, (a2) # Unknown-size Folded Reload
...
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, mu
; RV64-NEXT:    vmflt.vf v1, v16, ft0, v0.t
...
; RV32-LABEL: vp_roundeven_nxv16f64_unmasked:
; RV32:       # %bb.0:
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    sub a2, a0, a1
; RV32-NEXT:    lui a3, %hi(.LCPI33_0)
; RV32-NEXT:    fld ft0, %lo(.LCPI33_0)(a3)
; RV32-NEXT:    sltu a3, a0, a2
; RV32-NEXT:    addi a3, a3, -1
; RV32-NEXT:    and a2, a3, a2
; RV32-NEXT:    vsetvli zero, a2, e64, m8, ta, ma
; RV32-NEXT:    vfabs.v v24, v16
; RV32-NEXT:    vmflt.vf v0, v24, ft0
; RV32-NEXT:    fsrmi a2, 0
; RV32-NEXT:    vfcvt.x.f.v v24, v16, v0.t
; RV32-NEXT:    fsrm a2
; RV32-NEXT:    vfcvt.f.x.v v24, v24, v0.t
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vp_roundeven_nxv16f64_unmasked:
; RV64:       # %bb.0:
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    sub a2, a0, a1
; RV64-NEXT:    lui a3, %hi(.LCPI33_0)
; RV64-NEXT:    fld ft0, %lo(.LCPI33_0)(a3)
; RV64-NEXT:    sltu a3, a0, a2
; RV64-NEXT:    addiw a3, a3, -1
; RV64-NEXT:    and a2, a3, a2
; RV64-NEXT:    vsetvli zero, a2, e64, m8, ta, ma
; RV64-NEXT:    vfabs.v v24, v16
; RV64-NEXT:    vmflt.vf v0, v24, ft0
; RV64-NEXT:    fsrmi a2, 0
; RV64-NEXT:    vfcvt.x.f.v v24, v16, v0.t
; RV64-NEXT:    fsrm a2
; RV64-NEXT:    vfcvt.f.x.v v24, v24, v0.t
