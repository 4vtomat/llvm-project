...
; CHECK-NEXT:    ret
entry:
  tail call void @llvm.memset.p0.i8.i64(ptr align 1 %dst, i8 %val, i32 2040, i1 false)
  ret void
}
...
; CHECK-NEXT:    ret
entry:
  tail call void @llvm.memset.p0.i8.i64(ptr align 1 %dst, i8 %val, i32 384, i1 false)
  ret void
}
...
; CHECK-NEXT:    ret
entry:
  tail call void @llvm.memset.p0.i8.i64(ptr align 1 %dst, i8 %val, i32 2048, i1 false)
  ret void
}


declare void @llvm.memset.p0.i8.i64(ptr noalias nocapture writeonly, i8 noalias readonly, i32, i1 immarg)
