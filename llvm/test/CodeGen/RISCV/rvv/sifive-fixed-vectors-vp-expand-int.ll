...
define <2 x i64> @test_vp_expand_v2i64(<2 x i64> %src, <2 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v2i64:
; CHECK:       # %bb.0:
...
define <2 x i32> @test_vp_expand_v2i32(<2 x i32> %src, <2 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v2i32:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; CHECK-NEXT:    viota.m v10, v0
...
define <4 x i32> @test_vp_expand_v4i32(<4 x i32> %src, <4 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v4i32:
; CHECK:       # %bb.0:
...
define <2 x i16> @test_vp_expand_v2i16(<2 x i16> %src, <2 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v2i16:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; CHECK-NEXT:    viota.m v10, v0
; CHECK-NEXT:    vrgatherei16.vv v9, v8, v10, v0.t
...
define <4 x i16> @test_vp_expand_v4i16(<4 x i16> %src, <4 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v4i16:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; CHECK-NEXT:    viota.m v10, v0
; CHECK-NEXT:    vrgatherei16.vv v9, v8, v10, v0.t
...
define <8 x i16> @test_vp_expand_v8i16(<8 x i16> %src, <8 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v8i16:
; CHECK:       # %bb.0:
...
define <2 x i8> @test_vp_expand_v2i8(<2 x i8> %src, <2 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v2i8:
; CHECK:       # %bb.0:
...
define <4 x i8> @test_vp_expand_v4i8(<4 x i8> %src, <4 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v4i8:
; CHECK:       # %bb.0:
...
define <8 x i8> @test_vp_expand_v8i8(<8 x i8> %src, <8 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v8i8:
; CHECK:       # %bb.0:
...
define <16 x i8> @test_vp_expand_v16i8(<16 x i8> %src, <16 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v16i8:
; CHECK:       # %bb.0:
...
define <4 x i64> @test_vp_expand_v4i64(<4 x i64> %src, <4 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v4i64:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
...
define <8 x i32> @test_vp_expand_v8i32(<8 x i32> %src, <8 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v8i32:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, m1, ta, ma
; CHECK-NEXT:    viota.m v12, v0
...
define <16 x i16> @test_vp_expand_v16i16(<16 x i16> %src, <16 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v16i16:
; CHECK:       # %bb.0:
...
define <32 x i8> @test_vp_expand_v32i8(<32 x i8> %src, <32 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v32i8:
; CHECK:       # %bb.0:
...
define <8 x i64> @test_vp_expand_v8i64(<8 x i64> %src, <8 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v8i64:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, m1, ta, ma
...
define <16 x i32> @test_vp_expand_v16i32(<16 x i32> %src, <16 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v16i32:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; CHECK-NEXT:    viota.m v16, v0
...
define <32 x i16> @test_vp_expand_v32i16(<32 x i16> %src, <32 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v32i16:
; CHECK:       # %bb.0:
...
define <64 x i8> @test_vp_expand_v64i8(<64 x i8> %src, <64 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v64i8:
; CHECK:       # %bb.0:
...
define <16 x i64> @test_vp_expand_v16i64(<16 x i64> %src, <16 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v16i64:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
...
define <32 x i32> @test_vp_expand_v32i32(<32 x i32> %src, <32 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v32i32:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
; CHECK-NEXT:    viota.m v24, v0
...
define <64 x i16> @test_vp_expand_v64i16(<64 x i16> %src, <64 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_expand_v64i16:
; CHECK:       # %bb.0:
