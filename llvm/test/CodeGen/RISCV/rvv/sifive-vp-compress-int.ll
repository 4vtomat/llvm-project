...
define <vscale x 1 x i64> @test_vp_compress_nxv1i64(<vscale x 1 x i64> %src, <vscale x 1 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_nxv1i64:
; CHECK:       # %bb.0:
...
define <vscale x 2 x i32> @test_vp_compress_nxv2i32(<vscale x 2 x i32> %src, <vscale x 2 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_nxv2i32:
; CHECK:       # %bb.0:
...
define <vscale x 4 x i16> @test_vp_compress_nxv4i16(<vscale x 4 x i16> %src, <vscale x 4 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_nxv4i16:
; CHECK:       # %bb.0:
...
define <vscale x 8 x i8> @test_vp_compress_nxv8i8(<vscale x 8 x i8> %src, <vscale x 8 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_nxv8i8:
; CHECK:       # %bb.0:
...
define <vscale x 2 x i64> @test_vp_compress_nxv2i64(<vscale x 2 x i64> %src, <vscale x 2 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_nxv2i64:
; CHECK:       # %bb.0:
...
define <vscale x 4 x i32> @test_vp_compress_nxv4i32(<vscale x 4 x i32> %src, <vscale x 4 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_nxv4i32:
; CHECK:       # %bb.0:
...
define <vscale x 8 x i16> @test_vp_compress_nxv8i16(<vscale x 8 x i16> %src, <vscale x 8 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_nxv8i16:
; CHECK:       # %bb.0:
...
define <vscale x 16 x i8> @test_vp_compress_nxv16i8(<vscale x 16 x i8> %src, <vscale x 16 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_nxv16i8:
; CHECK:       # %bb.0:
...
define <vscale x 4 x i64> @test_vp_compress_nxv4i64(<vscale x 4 x i64> %src, <vscale x 4 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_nxv4i64:
; CHECK:       # %bb.0:
...
define <vscale x 8 x i32> @test_vp_compress_nxv8i32(<vscale x 8 x i32> %src, <vscale x 8 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_nxv8i32:
; CHECK:       # %bb.0:
...
define <vscale x 16 x i16> @test_vp_compress_nxv16i16(<vscale x 16 x i16> %src, <vscale x 16 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_nxv16i16:
; CHECK:       # %bb.0:
...
define <vscale x 32 x i8> @test_vp_compress_nxv32i8(<vscale x 32 x i8> %src, <vscale x 32 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_nxv32i8:
; CHECK:       # %bb.0:
...
define <vscale x 8 x i64> @test_vp_compress_nxv8i64(<vscale x 8 x i64> %src, <vscale x 8 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_nxv8i64:
; CHECK:       # %bb.0:
...
define <vscale x 16 x i32> @test_vp_compress_nxv16i32(<vscale x 16 x i32> %src, <vscale x 16 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_nxv16i32:
; CHECK:       # %bb.0:
...
define <vscale x 32 x i16> @test_vp_compress_nxv32i16(<vscale x 32 x i16> %src, <vscale x 32 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_nxv32i16:
; CHECK:       # %bb.0:
...
define <vscale x 64 x i8> @test_vp_compress_nxv64i8(<vscale x 64 x i8> %src, <vscale x 64 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_nxv64i8:
; CHECK:       # %bb.0:
