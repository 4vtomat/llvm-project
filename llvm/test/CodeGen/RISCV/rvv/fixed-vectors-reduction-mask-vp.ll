...
; RV32-LABEL: vpreduce_and_v256i1:
; RV32:       # %bb.0:
; RV32-NEXT:    li a3, 128
; RV32-NEXT:    mv a2, a1
; RV32-NEXT:    bltu a1, a3, .LBB14_2
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    li a2, 128
; RV32-NEXT:  .LBB14_2:
; RV32-NEXT:    vsetvli zero, a2, e8, m8, ta, ma
; RV32-NEXT:    vmnot.m v11, v0
; RV32-NEXT:    vmv1r.v v0, v9
; RV32-NEXT:    vcpop.m a2, v11, v0.t
...
; RV32-NEXT:    vmnot.m v8, v8
; RV32-NEXT:    vmv1r.v v0, v10
; RV32-NEXT:    vcpop.m a1, v8, v0.t
; RV32-NEXT:    seqz a1, a1
; RV32-NEXT:    and a0, a1, a0
; RV32-NEXT:    neg a0, a0
; RV32-NEXT:    ret
;
; RV64-LABEL: vpreduce_and_v256i1:
; RV64:       # %bb.0:
; RV64-NEXT:    li a3, 128
; RV64-NEXT:    mv a2, a1
; RV64-NEXT:    bltu a1, a3, .LBB14_2
; RV64-NEXT:  # %bb.1:
; RV64-NEXT:    li a2, 128
; RV64-NEXT:  .LBB14_2:
; RV64-NEXT:    vsetvli zero, a2, e8, m8, ta, ma
; RV64-NEXT:    vmnot.m v11, v0
; RV64-NEXT:    vmv1r.v v0, v9
; RV64-NEXT:    vcpop.m a2, v11, v0.t
...
; RV64-NEXT:    vmnot.m v8, v8
; RV64-NEXT:    vmv1r.v v0, v10
; RV64-NEXT:    vcpop.m a1, v8, v0.t
