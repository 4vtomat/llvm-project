...
; RV32-NEXT:    vslidedown.vx v0, v0, a6
; RV32-NEXT:    vsetvli zero, a5, e64, m8, ta, mu
; RV32-NEXT:    csrr a0, vlenb
; RV32-NEXT:    li a2, 24
...
; RV64-NEXT:    vsetvli zero, a5, e64, m8, ta, mu
; RV64-NEXT:    csrr a0, vlenb
; RV64-NEXT:    li a2, 24
...
; RV32-LABEL: vfma_vv_nxv16f64_unmasked:
; RV32:       # %bb.0:
; RV32-NEXT:    addi sp, sp, -16
; RV32-NEXT:    .cfi_def_cfa_offset 16
; RV32-NEXT:    csrr a1, vlenb
...
; RV32-NEXT:    addi a0, a0, 16
; RV32-NEXT:    vl8r.v v8, (a0) # Unknown-size Folded Reload
; RV32-NEXT:    vfmadd.vv v16, v8, v24
; RV32-NEXT:    bltu a4, a1, .LBB93_2
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    mv a4, a1
; RV32-NEXT:  .LBB93_2:
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vfma_vv_nxv16f64_unmasked:
; RV64:       # %bb.0:
; RV64-NEXT:    addi sp, sp, -16
; RV64-NEXT:    .cfi_def_cfa_offset 16
; RV64-NEXT:    csrr a1, vlenb
...
; RV64-NEXT:    addi a0, a0, 16
; RV64-NEXT:    vl8r.v v8, (a0) # Unknown-size Folded Reload
; RV64-NEXT:    vfmadd.vv v16, v8, v24
; RV64-NEXT:    bltu a4, a1, .LBB93_2
; RV64-NEXT:  # %bb.1:
; RV64-NEXT:    mv a4, a1
; RV64-NEXT:  .LBB93_2:
