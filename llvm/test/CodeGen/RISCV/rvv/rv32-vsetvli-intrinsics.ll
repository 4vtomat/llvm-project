...
; CHECK-NEXT:    ret
;
; CHECK-TU-LABEL: test_vsetvli_e64mf8:
; CHECK-TU:       # %bb.0:
; CHECK-TU-NEXT:    vsetvli zero, a0, e64, mf8, tu, mu
; CHECK-TU-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-TU-LABEL: test_vsetvli_e8mf2_zero_avl:
; CHECK-TU:       # %bb.0:
; CHECK-TU-NEXT:    vsetivli zero, 0, e8, mf2, tu, mu
; CHECK-TU-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-TU-LABEL: test_vsetvlimax_e64m8:
; CHECK-TU:       # %bb.0:
; CHECK-TU-NEXT:    vsetvli a0, zero, e64, m8, tu, mu
; CHECK-TU-NEXT:    ret
