...
; Testing downstream VFIRST patterns related to llvm/test/Transforms/LoopIdiom/RISCV/byte-compare-index.ll
...
; CHECK-NEXT:    vfirst.m a6, v8
; CHECK-NEXT:    bgez a6, .LBB0_9
; CHECK-NEXT:  # %bb.4: # %mismatch_vec_loop_inc
; CHECK-NEXT:    # in Loop: Header=BB0_3 Depth=1
; CHECK-NEXT:    add a5, a5, a2
; CHECK-NEXT:    bne a5, a3, .LBB0_3
; CHECK-NEXT:    j .LBB0_7
; CHECK-NEXT:  .LBB0_5: # %mismatch_loop
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
...
; CHECK-NEXT:    mv a0, a2
; CHECK-NEXT:    ret
; CHECK-NEXT:  .LBB0_9: # %mismatch_vec_loop_found
; CHECK-NEXT:    addw a0, a5, a6
; CHECK-NEXT:    ret
entry:
  %0 = add i32 %len, 1
...
mismatch_vec_loop:                                ; preds = %mismatch_vec_loop_inc, %mismatch_vec_loop_preheader
  ...
  %22 = call i32 @llvm.vp.first.nxv16i1(<vscale x 16 x i1> %mismatch.cmp, <vscale x 16 x i1> shufflevector (<vscale x 16 x i1> insertelement (<vscale x 16 x i1> poison, i1 true, i64 0), <vscale x 16 x i1> poison, <vscale x 16 x i32> zeroinitializer), i32 %19)
