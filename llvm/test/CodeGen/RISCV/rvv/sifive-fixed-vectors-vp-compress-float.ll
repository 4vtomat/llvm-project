...
define <2 x double> @test_vp_compress_v2f64(<2 x double> %src, <2 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_v2f64:
; CHECK:       # %bb.0:
...
define <2 x float> @test_vp_compress_v2f32(<2 x float> %src, <2 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_v2f32:
; CHECK:       # %bb.0:
...
define <4 x float> @test_vp_compress_v4f32(<4 x float> %src, <4 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_v4f32:
; CHECK:       # %bb.0:
...
define <4 x double> @test_vp_compress_v4f64(<4 x double> %src, <4 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_v4f64:
; CHECK:       # %bb.0:
...
define <8 x float> @test_vp_compress_v8f32(<8 x float> %src, <8 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_v8f32:
; CHECK:       # %bb.0:
...
define <8 x double> @test_vp_compress_v8f64(<8 x double> %src, <8 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_v8f64:
; CHECK:       # %bb.0:
...
define <16 x float> @test_vp_compress_v16f32(<16 x float> %src, <16 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_v16f32:
; CHECK:       # %bb.0:
...
define <16 x double> @test_vp_compress_v16f64(<16 x double> %src, <16 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_v16f64:
; CHECK:       # %bb.0:
...
define <32 x float> @test_vp_compress_v32f32(<32 x float> %src, <32 x i1> %mask, i32 zeroext %evl) {
; CHECK-LABEL: test_vp_compress_v32f32:
; CHECK:       # %bb.0:
