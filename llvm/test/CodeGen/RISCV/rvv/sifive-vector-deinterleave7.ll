...
; RUN: llc < %s -mtriple=riscv32 -mattr=+m,+v,+zfh,+experimental-zvfh | FileCheck %s --check-prefixes=CHECK,RV32
; RUN: llc < %s -mtriple=riscv64 -mattr=+m,+v,+zfh,+experimental-zvfh | FileCheck %s --check-prefixes=CHECK,RV64
...
; RV32-NEXT:    vmv2r.v v12, v4
; RV32-NEXT:    vmv1r.v v14, v21
; RV32-NEXT:    vid.v v16
; RV32-NEXT:    li a0, 7
...
; RV32-NEXT:    vmv2r.v v28, v12
; RV32-NEXT:    vmv1r.v v30, v14
...
; RV64-NEXT:    vmv2r.v v12, v4
; RV64-NEXT:    vmv1r.v v14, v21
; RV64-NEXT:    vid.v v16
; RV64-NEXT:    li a0, 7
...
; RV64-NEXT:    vmv2r.v v28, v12
; RV64-NEXT:    vmv1r.v v30, v14
