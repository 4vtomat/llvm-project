...
; CHECK-ASM-LABEL: fixed_vector_cc_1:
; CHECK-ASM:       # %bb.0:
; CHECK-ASM-NEXT:    ret
...
; CHECK-ASM-LABEL: rvv_vector_cc_1:
; CHECK-ASM:       # %bb.0:
; CHECK-ASM-NEXT:    ret
...
; CHECK-ASM-LABEL: rvv_vector_cc_2:
; CHECK-ASM:       # %bb.0:
; CHECK-ASM-NEXT:    ret
...
; CHECK-ASM-LABEL: rvv_vector_cc_3:
; CHECK-ASM:       # %bb.0:
; CHECK-ASM-NEXT:    ret
...
; CHECK-ASM-LABEL: rvv_vector_cc_4:
; CHECK-ASM:       # %bb.0:
; CHECK-ASM-NEXT:    ret
