...
declare <2 x i8> @llvm.experimental.vp.strided.load.v2i8.i64(i8*, i64, <2 x i1>, i32)

define <2 x i8> @strided_vpload_v2i8_i64(i8* %ptr, i64 %stride, <2 x i1> %m, i32 zeroext %evl) {
...
; CHECK-RV64-NEXT:    ret
  %load = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.i64(i8* %ptr, i64 %stride, <2 x i1> %m, i32 %evl)
  ret <2 x i8> %load
}
...
; CHECK-RV64-NEXT:    vlse8.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8(i8* %ptr, i32 %stride, <2 x i1> %m, i32 %evl)
  ret <2 x i8> %load
}

declare <4 x i8> @llvm.experimental.vp.strided.load.v4i8(i8*, i32, <4 x i1>, i32)
...
; CHECK-RV64-NEXT:    vlse8.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <4 x i8> @llvm.experimental.vp.strided.load.v4i8(i8* %ptr, i32 %stride, <4 x i1> %m, i32 %evl)
  ret <4 x i8> %load
}
...
; CHECK-RV64-NEXT:    ret
  ...
  %load = call <4 x i8> @llvm.experimental.vp.strided.load.v4i8(i8* %ptr, i32 %stride, <4 x i1> %b, i32 %evl)
  ret <4 x i8> %load
}

declare <8 x i8> @llvm.experimental.vp.strided.load.v8i8(i8*, i32, <8 x i1>, i32)
...
; CHECK-RV64-NEXT:    vlse8.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <8 x i8> @llvm.experimental.vp.strided.load.v8i8(i8* %ptr, i32 %stride, <8 x i1> %m, i32 %evl)
  ret <8 x i8> %load
}

declare <2 x i16> @llvm.experimental.vp.strided.load.v2i16(i16*, i32, <2 x i1>, i32)
...
; CHECK-RV64-NEXT:    ret
  %load = call <2 x i16> @llvm.experimental.vp.strided.load.v2i16(i16* %ptr, i32 %stride, <2 x i1> %m, i32 %evl)
  ret <2 x i16> %load
}

declare <4 x i16> @llvm.experimental.vp.strided.load.v4i16(i16*, i32, <4 x i1>, i32)
...
; CHECK-RV64-NEXT:    vlse16.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <4 x i16> @llvm.experimental.vp.strided.load.v4i16(i16* %ptr, i32 %stride, <4 x i1> %m, i32 %evl)
  ret <4 x i16> %load
}

declare <8 x i16> @llvm.experimental.vp.strided.load.v8i16(i16*, i32, <8 x i1>, i32)
...
; CHECK-RV64-NEXT:    vlse16.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <8 x i16> @llvm.experimental.vp.strided.load.v8i16(i16* %ptr, i32 %stride, <8 x i1> %m, i32 %evl)
  ret <8 x i16> %load
}
...
; CHECK-RV64-NEXT:    ret
  ...
  %load = call <8 x i16> @llvm.experimental.vp.strided.load.v8i16(i16* %ptr, i32 %stride, <8 x i1> %b, i32 %evl)
  ret <8 x i16> %load
}

declare <2 x i32> @llvm.experimental.vp.strided.load.v2i32(i32*, i32, <2 x i1>, i32)
...
; CHECK-RV64-NEXT:    ret
  %load = call <2 x i32> @llvm.experimental.vp.strided.load.v2i32(i32* %ptr, i32 %stride, <2 x i1> %m, i32 %evl)
  ret <2 x i32> %load
}

declare <4 x i32> @llvm.experimental.vp.strided.load.v4i32(i32*, i32, <4 x i1>, i32)
...
; CHECK-RV64-NEXT:    vlse32.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <4 x i32> @llvm.experimental.vp.strided.load.v4i32(i32* %ptr, i32 %stride, <4 x i1> %m, i32 %evl)
  ret <4 x i32> %load
}

declare <8 x i32> @llvm.experimental.vp.strided.load.v8i32(i32*, i32, <8 x i1>, i32)
...
; CHECK-RV64-NEXT:    vlse32.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <8 x i32> @llvm.experimental.vp.strided.load.v8i32(i32* %ptr, i32 %stride, <8 x i1> %m, i32 %evl)
  ret <8 x i32> %load
}
...
; CHECK-RV64-NEXT:    ret
  %a = insertelement <8 x i1> poison, i1 true, i32 0
  %b = shufflevector <8 x i1> %a, <8 x i1> poison, <8 x i32> zeroinitializer
  %load = call <8 x i32> @llvm.experimental.vp.strided.load.v8i32(i32* %ptr, i32 %stride, <8 x i1> %b, i32 %evl)
  ret <8 x i32> %load
}

declare <2 x i64> @llvm.experimental.vp.strided.load.v2i64(i64*, i32, <2 x i1>, i32)
...
; CHECK-RV64-NEXT:    ret
  %load = call <2 x i64> @llvm.experimental.vp.strided.load.v2i64(i64* %ptr, i32 %stride, <2 x i1> %m, i32 %evl)
  ret <2 x i64> %load
}

declare <4 x i64> @llvm.experimental.vp.strided.load.v4i64(i64*, i32, <4 x i1>, i32)
...
; CHECK-RV64-NEXT:    vlse64.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <4 x i64> @llvm.experimental.vp.strided.load.v4i64(i64* %ptr, i32 %stride, <4 x i1> %m, i32 %evl)
  ret <4 x i64> %load
}
...
; CHECK-RV64-NEXT:    ret
  %a = insertelement <4 x i1> poison, i1 true, i32 0
  %b = shufflevector <4 x i1> %a, <4 x i1> poison, <4 x i32> zeroinitializer
  %load = call <4 x i64> @llvm.experimental.vp.strided.load.v4i64(i64* %ptr, i32 %stride, <4 x i1> %b, i32 %evl)
  ret <4 x i64> %load
}

declare <8 x i64> @llvm.experimental.vp.strided.load.v8i64(i64*, i32, <8 x i1>, i32)
...
; CHECK-RV64-NEXT:    vlse64.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <8 x i64> @llvm.experimental.vp.strided.load.v8i64(i64* %ptr, i32 %stride, <8 x i1> %m, i32 %evl)
  ret <8 x i64> %load
}

declare <2 x half> @llvm.experimental.vp.strided.load.v2f16(half*, i32, <2 x i1>, i32)
...
; CHECK-RV64-NEXT:    vlse16.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <2 x half> @llvm.experimental.vp.strided.load.v2f16(half* %ptr, i32 %stride, <2 x i1> %m, i32 %evl)
  ret <2 x half> %load
}
...
; CHECK-RV64-NEXT:    ret
  ...
  %load = call <2 x half> @llvm.experimental.vp.strided.load.v2f16(half* %ptr, i32 %stride, <2 x i1> %b, i32 %evl)
  ret <2 x half> %load
}

declare <4 x half> @llvm.experimental.vp.strided.load.v4f16(half*, i32, <4 x i1>, i32)
...
; CHECK-RV64-NEXT:    vlse16.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <4 x half> @llvm.experimental.vp.strided.load.v4f16(half* %ptr, i32 %stride, <4 x i1> %m, i32 %evl)
  ret <4 x half> %load
}

declare <8 x half> @llvm.experimental.vp.strided.load.v8f16(half*, i32, <8 x i1>, i32)
...
; CHECK-RV64-NEXT:    vlse16.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <8 x half> @llvm.experimental.vp.strided.load.v8f16(half* %ptr, i32 %stride, <8 x i1> %m, i32 %evl)
  ret <8 x half> %load
}

declare <2 x float> @llvm.experimental.vp.strided.load.v2f32(float*, i32, <2 x i1>, i32)
...
; CHECK-RV64-NEXT:    vlse32.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <2 x float> @llvm.experimental.vp.strided.load.v2f32(float* %ptr, i32 %stride, <2 x i1> %m, i32 %evl)
  ret <2 x float> %load
}

declare <4 x float> @llvm.experimental.vp.strided.load.v4f32(float*, i32, <4 x i1>, i32)
...
; CHECK-RV64-NEXT:    vlse32.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <4 x float> @llvm.experimental.vp.strided.load.v4f32(float* %ptr, i32 %stride, <4 x i1> %m, i32 %evl)
  ret <4 x float> %load
}

declare <8 x float> @llvm.experimental.vp.strided.load.v8f32(float*, i32, <8 x i1>, i32)
...
; CHECK-RV64-NEXT:    vlse32.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <8 x float> @llvm.experimental.vp.strided.load.v8f32(float* %ptr, i32 %stride, <8 x i1> %m, i32 %evl)
  ret <8 x float> %load
}
...
; CHECK-RV64-NEXT:    ret
  %a = insertelement <8 x i1> poison, i1 true, i32 0
  %b = shufflevector <8 x i1> %a, <8 x i1> poison, <8 x i32> zeroinitializer
  %load = call <8 x float> @llvm.experimental.vp.strided.load.v8f32(float* %ptr, i32 %stride, <8 x i1> %b, i32 %evl)
  ret <8 x float> %load
}

declare <2 x double> @llvm.experimental.vp.strided.load.v2f64(double*, i32, <2 x i1>, i32)
...
; CHECK-RV64-NEXT:    vlse64.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <2 x double> @llvm.experimental.vp.strided.load.v2f64(double* %ptr, i32 %stride, <2 x i1> %m, i32 %evl)
  ret <2 x double> %load
}

declare <4 x double> @llvm.experimental.vp.strided.load.v4f64(double*, i32, <4 x i1>, i32)
...
; CHECK-RV64-NEXT:    vlse64.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <4 x double> @llvm.experimental.vp.strided.load.v4f64(double* %ptr, i32 %stride, <4 x i1> %m, i32 %evl)
  ret <4 x double> %load
}
...
; CHECK-RV64-NEXT:    ret
  %a = insertelement <4 x i1> poison, i1 true, i32 0
  %b = shufflevector <4 x i1> %a, <4 x i1> poison, <4 x i32> zeroinitializer
  %load = call <4 x double> @llvm.experimental.vp.strided.load.v4f64(double* %ptr, i32 %stride, <4 x i1> %b, i32 %evl)
  ret <4 x double> %load
}

declare <8 x double> @llvm.experimental.vp.strided.load.v8f64(double*, i32, <8 x i1>, i32)
...
; CHECK-RV64-NEXT:    vlse64.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    ret
  %load = call <8 x double> @llvm.experimental.vp.strided.load.v8f64(double* %ptr, i32 %stride, <8 x i1> %m, i32 %evl)
  ret <8 x double> %load
}
