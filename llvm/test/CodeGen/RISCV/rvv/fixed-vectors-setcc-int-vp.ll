...
; RV32-LABEL: icmp_eq_vx_swap_v256i8:
; RV32:       # %bb.0:
; RV32-NEXT:    vmv1r.v v24, v0
; RV32-NEXT:    li a3, 128
; RV32-NEXT:    vsetvli zero, a3, e8, m8, ta, ma
...
; RV32-NEXT:    ret
;
; RV64-LABEL: icmp_eq_vx_swap_v256i8:
; RV64:       # %bb.0:
; RV64-NEXT:    vmv1r.v v24, v0
; RV64-NEXT:    li a3, 128
; RV64-NEXT:    vsetvli zero, a3, e8, m8, ta, ma
...
; RV32-NEXT:    vslideup.vi v16, v1, 4
; RV32-NEXT:    vmv1r.v v0, v16
; RV32-NEXT:    csrr a0, vlenb
; RV32-NEXT:    slli a0, a0, 4
; RV32-NEXT:    add sp, sp, a0
...
; RV64-NEXT:    vslideup.vi v16, v1, 4
; RV64-NEXT:    vmv1r.v v0, v16
; RV64-NEXT:    csrr a0, vlenb
; RV64-NEXT:    slli a0, a0, 4
; RV64-NEXT:    add sp, sp, a0
...
; RV64-NEXT:    vmseq.vx v16, v8, a0, v0.t
; RV64-NEXT:    vsetivli zero, 8, e8, mf2, tu, ma
; RV64-NEXT:    vslideup.vi v16, v25, 4
; RV64-NEXT:    vmv1r.v v0, v16
; RV64-NEXT:    ret
...
; RV32-LABEL: icmp_eq_vx_swap_v64i32:
; RV32:       # %bb.0:
; RV32-NEXT:    vmv1r.v v24, v0
; RV32-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; RV32-NEXT:    vslidedown.vi v0, v0, 4
...
; RV32-NEXT:    ret
;
; RV64-LABEL: icmp_eq_vx_swap_v64i32:
; RV64:       # %bb.0:
; RV64-NEXT:    vmv1r.v v24, v0
; RV64-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; RV64-NEXT:    vslidedown.vi v0, v0, 4
