...
; MIN-256-NEXT:    ret
entry:
  tail call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 1 %dst, i8* align 1 %src, i32 1337, i1 false)
  ret void
}
...
; MIN-256-NEXT:    ret
entry:
  tail call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 1 %dst, i8* align 1 %src, i32 1024, i1 false)
  ret void
}
...
; MIN-256-NEXT:    ret
entry:
  tail call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 1 %dst, i8* align 1 %src, i32 237, i1 false)
  ret void
}
