...
; MIN-256-NEXT:    ret
entry:
  tail call void @llvm.memcpy.p0.p0.i32(ptr align 1 %dst, ptr align 1 %src, i32 1337, i1 false)
  ret void
}
...
; MIN-256-NEXT:    ret
entry:
  tail call void @llvm.memcpy.p0.p0.i32(ptr align 1 %dst, ptr align 1 %src, i32 1024, i1 false)
  ret void
}
...
; MIN-256-NEXT:    ret
entry:
  tail call void @llvm.memcpy.p0.p0.i32(ptr align 1 %dst, ptr align 1 %src, i32 237, i1 false)
  ret void
}
