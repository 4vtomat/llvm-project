...
; ZVE32X:       # %bb.0:
; ZVE32X-NEXT:    ld a1, 72(a0)
; ZVE32X-NEXT:    ld a2, 48(a0)
; ZVE32X-NEXT:    ld a3, 0(a0)
; ZVE32X-NEXT:    ld a4, 24(a0)
; ZVE32X-NEXT:    ld a5, 32(a0)
; ZVE32X-NEXT:    ld a6, 80(a0)
; ZVE32X-NEXT:    ld a7, 56(a0)
; ZVE32X-NEXT:    ld a0, 8(a0)
; ZVE32X-NEXT:    xor a4, a4, a5
