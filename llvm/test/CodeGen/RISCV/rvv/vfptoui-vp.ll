...
; RV32-LABEL: vfptoui_nxv32i16_nxv32f32:
; RV32:       # %bb.0:
...
; RV32-NEXT:    vfncvt.rtz.xu.f.w v12, v16, v0.t
...
; RV32-NEXT:    vfncvt.rtz.xu.f.w v8, v16, v0.t
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vfptoui_nxv32i16_nxv32f32:
; RV64:       # %bb.0:
...
; RV64-NEXT:    vfncvt.rtz.xu.f.w v12, v16, v0.t
...
; RV64-NEXT:    vfncvt.rtz.xu.f.w v8, v16, v0.t
...
; RV32-LABEL: vfptoui_nxv32i32_nxv32f32:
; RV32:       # %bb.0:
; RV32-NEXT:    vmv1r.v v24, v0
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    srli a2, a1, 2
...
; RV32-NEXT:    vfcvt.rtz.xu.f.v v16, v16, v0.t
...
; RV32-NEXT:    vmv1r.v v0, v24
; RV32-NEXT:    vfcvt.rtz.xu.f.v v8, v8, v0.t
; RV32-NEXT:    ret
;
; RV64-LABEL: vfptoui_nxv32i32_nxv32f32:
; RV64:       # %bb.0:
; RV64-NEXT:    vmv1r.v v24, v0
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    srli a2, a1, 2
...
; RV64-NEXT:    vfcvt.rtz.xu.f.v v16, v16, v0.t
...
; RV64-NEXT:    vmv1r.v v0, v24
; RV64-NEXT:    vfcvt.rtz.xu.f.v v8, v8, v0.t
; RV64-NEXT:    ret
...
; RV32-LABEL: vfptoui_nxv32i32_nxv32f32_unmasked:
; RV32:       # %bb.0:
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    slli a1, a1, 1
; RV32-NEXT:    sub a2, a0, a1
...
; RV32-NEXT:    and a2, a3, a2
; RV32-NEXT:    vsetvli zero, a2, e32, m8, ta, ma
; RV32-NEXT:    vfcvt.rtz.xu.f.v v16, v16
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vfptoui_nxv32i32_nxv32f32_unmasked:
; RV64:       # %bb.0:
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    slli a1, a1, 1
; RV64-NEXT:    sub a2, a0, a1
...
; RV64-NEXT:    and a2, a3, a2
; RV64-NEXT:    vsetvli zero, a2, e32, m8, ta, ma
; RV64-NEXT:    vfcvt.rtz.xu.f.v v16, v16
