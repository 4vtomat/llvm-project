...
; RV32-NEXT:    .cfi_escape 0x0f, 0x0f, 0x72, 0x00, 0x11, 0xd0, 0x00, 0x22, 0x11, 0xc8, 0x00, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 80 + 72 * vlenb
; RV32-NEXT:    mv s2, a7
; RV32-NEXT:    mv s1, a1
...
; RV32-NEXT:    add a2, s1, s8
; RV32-NEXT:    vl8re64.v v16, (a1)
; RV32-NEXT:    vl8re64.v v24, (a2)
...
; RV32-NEXT:    addi a1, a1, 32
; RV32-NEXT:    vs8r.v v16, (a1) # vscale x 64-byte Folded Spill
; RV32-NEXT:    add s2, s2, s9
; RV32-NEXT:    add a1, s1, s7
; RV32-NEXT:    vl8re64.v v16, (s2)
...
; RV32-NEXT:    addi a1, a1, 32
; RV32-NEXT:    vl8r.v v8, (a1) # vscale x 64-byte Folded Reload
; RV32-NEXT:    vs8r.v v8, (s5)
; RV32-NEXT:    add s4, s0, s4
; RV32-NEXT:    vs8r.v v0, (s4)
...
; RV64-NEXT:    .cfi_escape 0x0f, 0x0f, 0x72, 0x00, 0x11, 0x80, 0x01, 0x22, 0x11, 0xc8, 0x00, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 128 + 72 * vlenb
; RV64-NEXT:    mv s2, a7
; RV64-NEXT:    mv s1, a1
...
; RV64-NEXT:    add a2, s1, s8
; RV64-NEXT:    vl8re64.v v16, (a1)
; RV64-NEXT:    vl8re64.v v24, (a2)
...
; RV64-NEXT:    addi a1, a1, 32
; RV64-NEXT:    vs8r.v v16, (a1) # vscale x 64-byte Folded Spill
; RV64-NEXT:    add s2, s2, s9
; RV64-NEXT:    add a1, s1, s7
; RV64-NEXT:    vl8re64.v v16, (s2)
...
; RV64-NEXT:    addi a1, a1, 32
; RV64-NEXT:    vl8r.v v8, (a1) # vscale x 64-byte Folded Reload
; RV64-NEXT:    vs8r.v v8, (s5)
; RV64-NEXT:    add s4, s0, s4
; RV64-NEXT:    vs8r.v v0, (s4)
