...
; SIFIVE
; RUN: llc -mtriple=riscv32 -mattr=+d,+zfh,+experimental-zvfh,+v,+m -verify-machineinstrs < %s | FileCheck %s  --check-prefixes=CHECK,RV32
; RUN: llc -mtriple=riscv64 -mattr=+d,+zfh,+experimental-zvfh,+v,+m -verify-machineinstrs < %s | FileCheck %s  --check-prefixes=CHECK,RV64
...
; RV32-LABEL: vfptrunc_nxv16f32_nxv16f64:
; RV32:       # %bb.0:
...
; RV32-NEXT:    vfncvt.f.f.w v20, v24, v0.t
...
; RV32-NEXT:    vfncvt.f.f.w v16, v8, v0.t
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vfptrunc_nxv16f32_nxv16f64:
; RV64:       # %bb.0:
...
; RV64-NEXT:    vfncvt.f.f.w v20, v24, v0.t
...
; RV64-NEXT:    vfncvt.f.f.w v16, v8, v0.t
...
; RV32-LABEL: vfptrunc_nxv32f32_nxv32f64:
; RV32:       # %bb.0:
; RV32-NEXT:    addi sp, sp, -16
; RV32-NEXT:    .cfi_def_cfa_offset 16
; RV32-NEXT:    csrr a1, vlenb
...
; RV32-NEXT:    vfncvt.f.f.w v20, v8, v0.t
; RV32-NEXT:    bltu a4, a1, .LBB8_2
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    mv a4, a1
; RV32-NEXT:  .LBB8_2:
...
; RV32-NEXT:    vfncvt.f.f.w v12, v24, v0.t
; RV32-NEXT:    bltu a2, a1, .LBB8_6
; RV32-NEXT:  # %bb.5:
; RV32-NEXT:    mv a2, a1
; RV32-NEXT:  .LBB8_6:
; RV32-NEXT:    vsetvli zero, a2, e32, m4, ta, ma
...
; RV32-NEXT:    addi a0, a0, 16
; RV32-NEXT:    vl8re8.v v24, (a0) # Unknown-size Folded Reload
; RV32-NEXT:    vfncvt.f.f.w v8, v24, v0.t
; RV32-NEXT:    csrr a0, vlenb
; RV32-NEXT:    li a1, 24
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vfptrunc_nxv32f32_nxv32f64:
; RV64:       # %bb.0:
; RV64-NEXT:    addi sp, sp, -16
; RV64-NEXT:    .cfi_def_cfa_offset 16
; RV64-NEXT:    csrr a1, vlenb
...
; RV64-NEXT:    vfncvt.f.f.w v20, v8, v0.t
; RV64-NEXT:    bltu a4, a1, .LBB8_2
; RV64-NEXT:  # %bb.1:
; RV64-NEXT:    mv a4, a1
; RV64-NEXT:  .LBB8_2:
...
; RV64-NEXT:    vfncvt.f.f.w v12, v24, v0.t
; RV64-NEXT:    bltu a2, a1, .LBB8_6
; RV64-NEXT:  # %bb.5:
; RV64-NEXT:    mv a2, a1
; RV64-NEXT:  .LBB8_6:
; RV64-NEXT:    vsetvli zero, a2, e32, m4, ta, ma
...
; RV64-NEXT:    addi a0, a0, 16
; RV64-NEXT:    vl8re8.v v24, (a0) # Unknown-size Folded Reload
; RV64-NEXT:    vfncvt.f.f.w v8, v24, v0.t
; RV64-NEXT:    csrr a0, vlenb
; RV64-NEXT:    li a1, 24
