...
; RV32-LABEL: icmp_eq_vv_nxv128i8:
; RV32:       # %bb.0:
...
; RV32-NEXT:    ret
;
; RV64-LABEL: icmp_eq_vv_nxv128i8:
; RV64:       # %bb.0:
...
; RV32-LABEL: icmp_eq_vx_nxv128i8:
; RV32:       # %bb.0:
; RV32-NEXT:    vmv1r.v v24, v0
...
; RV32-NEXT:    ret
;
; RV64-LABEL: icmp_eq_vx_nxv128i8:
; RV64:       # %bb.0:
; RV64-NEXT:    vmv1r.v v24, v0
...
; RV32-LABEL: icmp_eq_vx_swap_nxv128i8:
; RV32:       # %bb.0:
; RV32-NEXT:    vmv1r.v v24, v0
; RV32-NEXT:    vsetvli a3, zero, e8, m8, ta, ma
; RV32-NEXT:    vlm.v v0, (a1)
...
; RV32-NEXT:    ret
;
; RV64-LABEL: icmp_eq_vx_swap_nxv128i8:
; RV64:       # %bb.0:
; RV64-NEXT:    vmv1r.v v24, v0
; RV64-NEXT:    vsetvli a3, zero, e8, m8, ta, ma
; RV64-NEXT:    vlm.v v0, (a1)
