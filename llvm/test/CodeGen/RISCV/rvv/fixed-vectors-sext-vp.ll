...
; RV32-LABEL: vsext_v32i64_v32i32:
; RV32:       # %bb.0:
...
; RV32-NEXT:    li a1, 16
; RV32-NEXT:    vsext.vf2 v16, v24, v0.t
...
; RV32-NEXT:    vsext.vf2 v24, v8, v0.t
; RV32-NEXT:    vmv.v.v v8, v24
; RV32-NEXT:    ret
;
; RV64-LABEL: vsext_v32i64_v32i32:
; RV64:       # %bb.0:
...
; RV64-NEXT:    li a1, 16
; RV64-NEXT:    vsext.vf2 v16, v24, v0.t
...
; RV64-NEXT:    vsext.vf2 v24, v8, v0.t
...
; RV32-LABEL: vsext_v32i64_v32i32_unmasked:
; RV32:       # %bb.0:
; RV32-NEXT:    addi a1, a0, -16
; RV32-NEXT:    sltu a2, a0, a1
; RV32-NEXT:    addi a2, a2, -1
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vsext_v32i64_v32i32_unmasked:
; RV64:       # %bb.0:
; RV64-NEXT:    addi a1, a0, -16
; RV64-NEXT:    sltu a2, a0, a1
; RV64-NEXT:    addiw a2, a2, -1
