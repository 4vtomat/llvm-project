...
; CHECK-NEXT:    vfmul.vv v9, v9, v11, v0.t
; CHECK-NEXT:    vfmul.vv v10, v8, v9, v0.t
; CHECK-NEXT:    vmv.v.v v11, v9
; CHECK-NEXT:    vfmadd.vv v11, v10, v12, v0.t
; CHECK-NEXT:    vfmul.vf v9, v9, fa4, v0.t
; CHECK-NEXT:    vfmul.vv v9, v9, v11, v0.t
; CHECK-NEXT:    vfmul.vv v10, v8, v9, v0.t
; CHECK-NEXT:    vfmadd.vv v9, v10, v12, v0.t
...
; CHECK-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; CHECK-NEXT:    vfmadd.vv v14, v12, v16, v0.t
; CHECK-NEXT:    vfmul.vf v10, v10, fa4, v0.t
; CHECK-NEXT:    vfmul.vv v10, v10, v14, v0.t
; CHECK-NEXT:    vfmul.vv v12, v8, v10, v0.t
; CHECK-NEXT:    vmv.v.v v14, v10
; CHECK-NEXT:    vfmadd.vv v14, v12, v16, v0.t
; CHECK-NEXT:    vfmul.vf v10, v10, fa4, v0.t
; CHECK-NEXT:    vfmul.vv v10, v10, v14, v0.t
; CHECK-NEXT:    vfmul.vv v12, v8, v10, v0.t
; CHECK-NEXT:    vfmadd.vv v10, v12, v16, v0.t
