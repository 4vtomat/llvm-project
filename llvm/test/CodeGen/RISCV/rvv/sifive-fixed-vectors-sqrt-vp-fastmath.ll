...
; CHECK-NEXT:    fld fa5, %lo(.LCPI6_2)(a0)
...
; CHECK-NEXT:    fld fa5, %lo(.LCPI7_2)(a0)
...
; CHECK-NEXT:    vfmul.vf v16, v16, fa4, v0.t
...
; CHECK-NEXT:    fld fa5, %lo(.LCPI8_2)(a0)
; CHECK-NEXT:    vfmul.vf v12, v20, fa4, v0.t
...
; CHECK-NEXT:    flh fa4, %lo(.LCPI18_2)(a1)
; CHECK-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; CHECK-NEXT:    vfmadd.vv v11, v8, v10, v0.t
...
; CHECK-NEXT:    flh fa4, %lo(.LCPI19_2)(a1)
; CHECK-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; CHECK-NEXT:    vfmadd.vv v11, v8, v10, v0.t
; CHECK-NEXT:    vfmul.vf v8, v9, fa5, v0.t
; CHECK-NEXT:    vfmul.vv v8, v8, v11, v0.t
...
; CHECK-NEXT:    flh fa4, %lo(.LCPI20_2)(a1)
; CHECK-NEXT:    vsetvli zero, a0, e16, m1, ta, ma
; CHECK-NEXT:    vfmadd.vv v11, v8, v10, v0.t
; CHECK-NEXT:    vfmul.vf v8, v9, fa5, v0.t
; CHECK-NEXT:    vfmul.vv v8, v8, v11, v0.t
...
; CHECK-NEXT:    fld fa5, %lo(.LCPI24_2)(a0)
; CHECK-NEXT:    vfmadd.vv v10, v8, v11, v0.t
...
; CHECK-NEXT:    fld fa5, %lo(.LCPI25_2)(a0)
; CHECK-NEXT:    vfmadd.vv v12, v8, v14, v0.t
...
; CHECK-NEXT:    fld fa5, %lo(.LCPI26_2)(a0)
; CHECK-NEXT:    vfmadd.vv v20, v8, v12, v0.t
; CHECK-NEXT:    vfmul.vf v8, v16, fa4, v0.t
