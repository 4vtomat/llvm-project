...
; ZVFH-NEXT:    vfsub.vv v9, v9, v10, v0.t
...
; ZVFBFA-NEXT:    vfsub.vv v8, v8, v9, v0.t
; ZVFBFA-NEXT:    ret
...
; ZVFH-LABEL: vfsub_vv_nxv1bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
...
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfsub_vv_nxv1bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vv_nxv1bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, mf4, ta, ma
...
; ZVFH-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFH-NEXT:    vfsub.vv v9, v10, v8, v0.t
; ZVFH-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v9, v0.t
; ZVFH-NEXT:    ret
;
...
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, mf4, ta, ma
; ZVFBFA-NEXT:    vfsub.vf v8, v8, fa0, v0.t
; ZVFBFA-NEXT:    ret
...
; ZVFH-LABEL: vfsub_vf_nxv1bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    fmv.x.h a1, fa0
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; ZVFH-NEXT:    vmv.v.x v9, a1
...
; ZVFH-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFH-NEXT:    vfsub.vv v9, v10, v8
; ZVFH-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v9
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfsub_vf_nxv1bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    fmv.x.h a1, fa0
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; ZVFHMIN-NEXT:    vmv.v.x v9, a1
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vf_nxv1bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, mf4, ta, ma
...
; ZVFH-LABEL: vfsub_vv_nxv2bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFH-NEXT:    vfwcvtbf16.f.f.v v10, v9
; ZVFH-NEXT:    vfwcvtbf16.f.f.v v9, v8
...
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfsub_vv_nxv2bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vfwcvtbf16.f.f.v v10, v9
; ZVFHMIN-NEXT:    vfwcvtbf16.f.f.v v9, v8
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vv_nxv2bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, mf2, ta, ma
; ZVFBFA-NEXT:    vfsub.vv v8, v8, v9
; ZVFBFA-NEXT:    ret
...
; ZVFH-LABEL: vfsub_vf_nxv2bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    fmv.x.h a1, fa0
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFH-NEXT:    vmv.v.x v9, a1
...
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfsub_vf_nxv2bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    fmv.x.h a1, fa0
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vmv.v.x v9, a1
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vf_nxv2bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, mf2, ta, ma
; ZVFBFA-NEXT:    vfsub.vf v8, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFH-NEXT:    vfsub.vv v10, v12, v10, v0.t
...
; ZVFH-LABEL: vfsub_vv_nxv4bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, m1, ta, ma
; ZVFH-NEXT:    vfwcvtbf16.f.f.v v10, v9
...
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfsub_vv_nxv4bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, m1, ta, ma
; ZVFHMIN-NEXT:    vfwcvtbf16.f.f.v v10, v9
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vv_nxv4bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, m1, ta, ma
; ZVFBFA-NEXT:    vfsub.vv v8, v8, v9
; ZVFBFA-NEXT:    ret
...
; ZVFH-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; ZVFH-NEXT:    vfsub.vv v10, v10, v8, v0.t
; ZVFH-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v10, v0.t
; ZVFH-NEXT:    ret
;
...
; ZVFH-LABEL: vfsub_vf_nxv4bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    fmv.x.h a1, fa0
; ZVFH-NEXT:    vsetvli zero, a0, e16, m1, ta, ma
; ZVFH-NEXT:    vmv.v.x v12, a1
...
; ZVFH-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; ZVFH-NEXT:    vfsub.vv v10, v10, v8
; ZVFH-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v10
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfsub_vf_nxv4bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    fmv.x.h a1, fa0
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, m1, ta, ma
; ZVFHMIN-NEXT:    vmv.v.x v12, a1
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vf_nxv4bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, m1, ta, ma
; ZVFBFA-NEXT:    vfsub.vf v8, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFH-NEXT:    vfsub.vv v12, v16, v12, v0.t
...
; ZVFBFA-NEXT:    vfsub.vv v8, v8, v10, v0.t
; ZVFBFA-NEXT:    ret
...
; ZVFH-LABEL: vfsub_vv_nxv8bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
...
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfsub_vv_nxv8bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vv_nxv8bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, m2, ta, ma
...
; ZVFH-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFH-NEXT:    vfsub.vv v12, v12, v8, v0.t
; ZVFH-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v12, v0.t
; ZVFH-NEXT:    ret
;
...
; ZVFH-LABEL: vfsub_vf_nxv8bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    fmv.x.h a1, fa0
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmv.v.x v16, a1
...
; ZVFH-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFH-NEXT:    vfsub.vv v12, v12, v8
; ZVFH-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v12
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfsub_vf_nxv8bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    fmv.x.h a1, fa0
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFHMIN-NEXT:    vmv.v.x v16, a1
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vf_nxv8bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vfsub.vf v8, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFA-NEXT:    vfsub.vv v8, v8, v12, v0.t
; ZVFBFA-NEXT:    ret
...
; ZVFH-LABEL: vfsub_vv_nxv16bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
...
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfsub_vv_nxv16bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vv_nxv16bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, m4, ta, ma
...
; ZVFH-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFH-NEXT:    vfsub.vv v16, v16, v8, v0.t
; ZVFH-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v16, v0.t
; ZVFH-NEXT:    ret
;
...
; ZVFH-LABEL: vfsub_vf_nxv16bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    fmv.x.h a1, fa0
; ZVFH-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
; ZVFH-NEXT:    vmv.v.x v24, a1
...
; ZVFH-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFH-NEXT:    vfsub.vv v16, v16, v8
; ZVFH-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v16
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfsub_vf_nxv16bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    fmv.x.h a1, fa0
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
; ZVFHMIN-NEXT:    vmv.v.x v24, a1
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vf_nxv16bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, m4, ta, ma
; ZVFBFA-NEXT:    vfsub.vf v8, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFA-NEXT:    vfsub.vv v8, v8, v16, v0.t
; ZVFBFA-NEXT:    ret
...
; ZVFH-LABEL: vfsub_vv_nxv32bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    addi sp, sp, -16
; ZVFH-NEXT:    .cfi_def_cfa_offset 16
; ZVFH-NEXT:    csrr a1, vlenb
...
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfsub_vv_nxv32bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    addi sp, sp, -16
; ZVFHMIN-NEXT:    .cfi_def_cfa_offset 16
; ZVFHMIN-NEXT:    csrr a1, vlenb
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vv_nxv32bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, m8, ta, ma
...
; ZVFH-LABEL: vfsub_vf_nxv32bf16_unmasked:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    addi sp, sp, -16
; ZVFH-NEXT:    .cfi_def_cfa_offset 16
; ZVFH-NEXT:    csrr a1, vlenb
...
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfsub_vf_nxv32bf16_unmasked:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    addi sp, sp, -16
; ZVFHMIN-NEXT:    .cfi_def_cfa_offset 16
; ZVFHMIN-NEXT:    csrr a1, vlenb
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vf_nxv32bf16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, m8, ta, ma
; ZVFBFA-NEXT:    vfsub.vf v8, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFA-NEXT:    vfsub.vv v9, v9, v10, v0.t
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vv_nxv1f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
...
; ZVFBFA-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFBFA-NEXT:    vfsub.vv v9, v10, v8, v0.t
; ZVFBFA-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFBFA-NEXT:    vfncvt.f.f.w v8, v9, v0.t
; ZVFBFA-NEXT:    ret
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vf_nxv1f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    fmv.x.w a1, fa0
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; ZVFBFA-NEXT:    vmv.v.x v9, a1
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vv_nxv2f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFBFA-NEXT:    vfwcvt.f.f.v v10, v9
; ZVFBFA-NEXT:    vfwcvt.f.f.v v9, v8
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vf_nxv2f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    fmv.x.w a1, fa0
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFBFA-NEXT:    vmv.v.x v9, a1
...
; ZVFBFA-NEXT:    vfsub.vv v10, v12, v10, v0.t
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vv_nxv4f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, m1, ta, ma
; ZVFBFA-NEXT:    vfwcvt.f.f.v v10, v9
...
; ZVFBFA-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; ZVFBFA-NEXT:    vfsub.vv v10, v10, v8, v0.t
; ZVFBFA-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; ZVFBFA-NEXT:    vfncvt.f.f.w v8, v10, v0.t
; ZVFBFA-NEXT:    ret
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vf_nxv4f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    fmv.x.w a1, fa0
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, m1, ta, ma
; ZVFBFA-NEXT:    vmv.v.x v12, a1
...
; ZVFBFA-NEXT:    vfsub.vv v12, v16, v12, v0.t
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vv_nxv8f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
...
; ZVFBFA-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFA-NEXT:    vfsub.vv v12, v12, v8, v0.t
; ZVFBFA-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFBFA-NEXT:    vfncvt.f.f.w v8, v12, v0.t
; ZVFBFA-NEXT:    ret
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vf_nxv8f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    fmv.x.w a1, fa0
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFBFA-NEXT:    vmv.v.x v16, a1
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vv_nxv16f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
...
; ZVFBFA-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFBFA-NEXT:    vfsub.vv v16, v16, v8, v0.t
; ZVFBFA-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFBFA-NEXT:    vfncvt.f.f.w v8, v16, v0.t
; ZVFBFA-NEXT:    ret
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vf_nxv16f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    fmv.x.w a1, fa0
; ZVFBFA-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
; ZVFBFA-NEXT:    vmv.v.x v24, a1
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vv_nxv32f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    addi sp, sp, -16
; ZVFBFA-NEXT:    .cfi_def_cfa_offset 16
; ZVFBFA-NEXT:    csrr a1, vlenb
...
; ZVFHMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfsub_vf_nxv32f16_unmasked:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    addi sp, sp, -16
; ZVFBFA-NEXT:    .cfi_def_cfa_offset 16
; ZVFBFA-NEXT:    csrr a1, vlenb
