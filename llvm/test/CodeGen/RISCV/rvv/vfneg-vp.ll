...
; RV32-NEXT:    vfneg.v v16, v16, v0.t
...
; RV32-NEXT:    vfneg.v v8, v8, v0.t
; RV32-NEXT:    ret
;
; RV64-LABEL: vfneg_vv_nxv16f64:
; RV64:       # %bb.0:
...
; RV64-NEXT:    vfneg.v v16, v16, v0.t
...
; RV32-LABEL: vfneg_vv_nxv16f64_unmasked:
; RV32:       # %bb.0:
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    sub a2, a0, a1
; RV32-NEXT:    sltu a3, a0, a2
...
; RV32-NEXT:    and a2, a3, a2
; RV32-NEXT:    vsetvli zero, a2, e64, m8, ta, ma
; RV32-NEXT:    vfneg.v v16, v16
; RV32-NEXT:    bltu a0, a1, .LBB33_2
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    mv a0, a1
; RV32-NEXT:  .LBB33_2:
; RV32-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; RV32-NEXT:    vfneg.v v8, v8
; RV32-NEXT:    ret
;
; RV64-LABEL: vfneg_vv_nxv16f64_unmasked:
; RV64:       # %bb.0:
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    sub a2, a0, a1
; RV64-NEXT:    sltu a3, a0, a2
...
; RV64-NEXT:    and a2, a3, a2
; RV64-NEXT:    vsetvli zero, a2, e64, m8, ta, ma
; RV64-NEXT:    vfneg.v v16, v16
; RV64-NEXT:    bltu a0, a1, .LBB33_2
; RV64-NEXT:  # %bb.1:
; RV64-NEXT:    mv a0, a1
; RV64-NEXT:  .LBB33_2:
; RV64-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; RV64-NEXT:    vfneg.v v8, v8
; RV64-NEXT:    ret
  %head = insertelement <vscale x 16 x i1> poison, i1 true, i32 0
  %m = shufflevector <vscale x 16 x i1> %head, <vscale x 16 x i1> poison, <vscale x 16 x i32> zeroinitializer
  %v = call <vscale x 16 x double> @llvm.vp.fneg.nxv16f64(<vscale x 16 x double> %va, <vscale x 16 x i1> %m, i32 %evl)
