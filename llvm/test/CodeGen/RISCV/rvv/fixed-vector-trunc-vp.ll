...
; RV32-LABEL: vtrunc_v128i7_v128i16:
; RV32:       # %bb.0:
...
; RV32-NEXT:    li a0, 128
; RV32-NEXT:    vsetvli zero, a0, e8, m8, tu, ma
; RV32-NEXT:    vslideup.vx v16, v8, a1
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vtrunc_v128i7_v128i16:
; RV64:       # %bb.0:
...
; RV64-NEXT:    li a0, 128
; RV64-NEXT:    vsetvli zero, a0, e8, m8, tu, ma
; RV64-NEXT:    vslideup.vx v16, v8, a1
...
; RV32-NEXT:    vsetivli zero, 8, e8, m1, ta, ma
; RV32-NEXT:    vslidedown.vi v3, v0, 8
; RV32-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; RV32-NEXT:    vslidedown.vi v2, v0, 4
; RV32-NEXT:    vslidedown.vi v27, v3, 4
; RV32-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV32-NEXT:    vslidedown.vi v0, v27, 2
; RV32-NEXT:    addi a2, a1, 512
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV32-NEXT:    addi a3, a1, 640
...
; RV32-NEXT:  .LBB16_2:
; RV32-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV32-NEXT:    vslidedown.vi v4, v2, 2
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
...
; RV32-NEXT:    vl8re8.v v16, (a5) # Unknown-size Folded Reload
...
; RV32-NEXT:    addi a5, a7, -32
; RV32-NEXT:    sltu a6, a7, a5
; RV32-NEXT:    addi a6, a6, -1
; RV32-NEXT:    and a5, a6, a5
; RV32-NEXT:    addi a6, a5, -16
; RV32-NEXT:    sltu t0, a5, a6
...
; RV32-NEXT:    bltu a5, a2, .LBB16_6
; RV32-NEXT:  # %bb.5:
; RV32-NEXT:    li a5, 16
; RV32-NEXT:  .LBB16_6:
; RV32-NEXT:    addi a6, a1, 384
...
; RV32-NEXT:  .LBB16_8:
; RV32-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV32-NEXT:    vslidedown.vi v4, v3, 2
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV32-NEXT:    vle64.v v16, (a6)
...
; RV64-NEXT:    vsetivli zero, 8, e8, m1, ta, ma
; RV64-NEXT:    vslidedown.vi v3, v0, 8
; RV64-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; RV64-NEXT:    vslidedown.vi v2, v0, 4
; RV64-NEXT:    vslidedown.vi v27, v3, 4
; RV64-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vi v0, v27, 2
; RV64-NEXT:    addi a2, a1, 512
; RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV64-NEXT:    addi a3, a1, 640
...
; RV64-NEXT:  .LBB16_2:
; RV64-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vi v4, v2, 2
; RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV64-NEXT:    vle64.v v8, (a5)
; RV64-NEXT:    vsetvli zero, a3, e32, m4, ta, ma
; RV64-NEXT:    li a3, 64
; RV64-NEXT:    vmv1r.v v0, v27
; RV64-NEXT:    csrr a5, vlenb
; RV64-NEXT:    li a6, 40
; RV64-NEXT:    mul a5, a5, a6
; RV64-NEXT:    add a5, sp, a5
; RV64-NEXT:    addi a5, a5, 16
; RV64-NEXT:    vl8re8.v v16, (a5) # Unknown-size Folded Reload
...
; RV64-NEXT:    add a5, sp, a5
; RV64-NEXT:    addi a5, a5, 16
; RV64-NEXT:    vs8r.v v24, (a5) # Unknown-size Folded Spill
; RV64-NEXT:    bltu a7, a3, .LBB16_4
; RV64-NEXT:  # %bb.3:
; RV64-NEXT:    li a7, 64
; RV64-NEXT:  .LBB16_4:
; RV64-NEXT:    li a3, 32
...
; RV64-NEXT:    addi a5, a7, -32
; RV64-NEXT:    sltu a6, a7, a5
; RV64-NEXT:    addiw a6, a6, -1
; RV64-NEXT:    and a5, a6, a5
; RV64-NEXT:    addi a6, a5, -16
; RV64-NEXT:    sltu t0, a5, a6
...
; RV64-NEXT:    vs8r.v v24, (a6) # Unknown-size Folded Spill
; RV64-NEXT:    bltu a5, a2, .LBB16_6
; RV64-NEXT:  # %bb.5:
; RV64-NEXT:    li a5, 16
; RV64-NEXT:  .LBB16_6:
; RV64-NEXT:    addi a6, a1, 384
...
; RV64-NEXT:  .LBB16_8:
; RV64-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vi v4, v3, 2
; RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
...
; RV64-NEXT:  .LBB16_10:
; RV64-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vi v2, v1, 2
; RV64-NEXT:    vsetvli zero, a1, e32, m4, ta, ma
; RV64-NEXT:    vmv1r.v v0, v3
; RV64-NEXT:    vnsrl.wi v8, v24, 0, v0.t
; RV64-NEXT:    addi a1, a4, -16
; RV64-NEXT:    sltu a4, a4, a1
; RV64-NEXT:    addiw a4, a4, -1
...
; RV64-NEXT:    li a7, 32
; RV64-NEXT:  .LBB16_12:
; RV64-NEXT:    vsetvli zero, a3, e32, m8, tu, ma
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a4, 48
...
; RV64-NEXT:    addi a1, a7, -16
; RV64-NEXT:    sltu a4, a7, a1
; RV64-NEXT:    addiw a4, a4, -1
; RV64-NEXT:    and a1, a4, a1
; RV64-NEXT:    vsetvli zero, a1, e32, m4, ta, ma
; RV64-NEXT:    vmv1r.v v0, v2
...
; RV32-LABEL: vtrunc_v32i32_v32i64:
; RV32:       # %bb.0:
; RV32-NEXT:    addi sp, sp, -16
; RV32-NEXT:    .cfi_def_cfa_offset 16
; RV32-NEXT:    csrr a1, vlenb
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vtrunc_v32i32_v32i64:
; RV64:       # %bb.0:
; RV64-NEXT:    addi sp, sp, -16
; RV64-NEXT:    .cfi_def_cfa_offset 16
; RV64-NEXT:    csrr a1, vlenb
