...
; RV32-NEXT:    vle64.v v16, (a3), v0.t
; RV32-NEXT:    li a2, 16
; RV32-NEXT:    bltu a1, a2, .LBB31_2
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    li a1, 16
; RV32-NEXT:  .LBB31_2:
...
; RV32-NEXT:    vle64.v v16, (a5), v0.t
; RV32-NEXT:    addi a4, a2, -32
; RV32-NEXT:    sltu a2, a2, a4
; RV32-NEXT:    addi a2, a2, -1
; RV32-NEXT:    and a4, a2, a4
; RV32-NEXT:    li a2, 16
; RV32-NEXT:    bltu a4, a2, .LBB32_4
; RV32-NEXT:  # %bb.3:
; RV32-NEXT:    li a4, 16
; RV32-NEXT:  .LBB32_4:
; RV32-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; RV32-NEXT:    vslidedown.vi v0, v8, 4
; RV32-NEXT:    addi a5, a1, 256
; RV32-NEXT:    vsetvli zero, a4, e64, m8, ta, ma
; RV32-NEXT:    vle64.v v24, (a5), v0.t
; RV32-NEXT:    bltu a3, a2, .LBB32_6
; RV32-NEXT:  # %bb.5:
; RV32-NEXT:    li a3, 16
; RV32-NEXT:  .LBB32_6:
...
; RV32-NEXT:    vse64.v v24, (a1)
; RV32-NEXT:    addi a0, a0, 128
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV32-NEXT:    vse64.v v16, (a0)
; RV32-NEXT:    ret
;
; RV64-LABEL: vpload_v33f64:
; RV64:       # %bb.0:
; RV64-NEXT:    li a4, 32
; RV64-NEXT:    vmv1r.v v8, v0
; RV64-NEXT:    mv a3, a2
; RV64-NEXT:    bltu a2, a4, .LBB32_2
; RV64-NEXT:  # %bb.1:
; RV64-NEXT:    li a3, 32
; RV64-NEXT:  .LBB32_2:
; RV64-NEXT:    addi a4, a3, -16
; RV64-NEXT:    sltu a5, a3, a4
...
; RV64-NEXT:    vle64.v v16, (a5), v0.t
; RV64-NEXT:    addi a4, a2, -32
; RV64-NEXT:    sltu a2, a2, a4
; RV64-NEXT:    addiw a2, a2, -1
; RV64-NEXT:    and a4, a2, a4
; RV64-NEXT:    li a2, 16
; RV64-NEXT:    bltu a4, a2, .LBB32_4
; RV64-NEXT:  # %bb.3:
; RV64-NEXT:    li a4, 16
; RV64-NEXT:  .LBB32_4:
; RV64-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; RV64-NEXT:    vslidedown.vi v0, v8, 4
; RV64-NEXT:    addi a5, a1, 256
; RV64-NEXT:    vsetvli zero, a4, e64, m8, ta, ma
; RV64-NEXT:    vle64.v v24, (a5), v0.t
; RV64-NEXT:    bltu a3, a2, .LBB32_6
; RV64-NEXT:  # %bb.5:
; RV64-NEXT:    li a3, 16
; RV64-NEXT:  .LBB32_6:
