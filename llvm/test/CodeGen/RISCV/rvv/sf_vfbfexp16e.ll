...
; RUN: sed 's/iXLen/i32/g' %s | llc -mtriple=riscv32 -mattr=+v,+xsfvfbfa,+xsfvfbfexp16e \
; RUN:   -verify-machineinstrs | FileCheck %s --check-prefixes=CHECK
; RUN: sed 's/iXLen/i64/g' %s | llc -mtriple=riscv64 -mattr=+v,+xsfvfbfa,+xsfvfbfexp16e \
; RUN:   -verify-machineinstrs | FileCheck %s --check-prefixes=CHECK

declare <vscale x 1 x bfloat> @llvm.riscv.sf.vfexp.nxv1bf16(
  <vscale x 1 x bfloat>,
  <vscale x 1 x bfloat>,
  iXLen);
...
declare <vscale x 2 x bfloat> @llvm.riscv.sf.vfexp.nxv2bf16(
  <vscale x 2 x bfloat>,
  <vscale x 2 x bfloat>,
  iXLen);
...
declare <vscale x 4 x bfloat> @llvm.riscv.sf.vfexp.nxv4bf16(
  <vscale x 4 x bfloat>,
  <vscale x 4 x bfloat>,
  iXLen);
...
declare <vscale x 8 x bfloat> @llvm.riscv.sf.vfexp.nxv8bf16(
  <vscale x 8 x bfloat>,
  <vscale x 8 x bfloat>,
  iXLen);
...
declare <vscale x 16 x bfloat> @llvm.riscv.sf.vfexp.nxv16bf16(
...
declare <vscale x 32 x bfloat> @llvm.riscv.sf.vfexp.nxv32bf16(
...
declare <vscale x 1 x bfloat> @llvm.riscv.sf.vfexp.mask.nxv1bf16(
  <vscale x 1 x bfloat>,
  <vscale x 1 x bfloat>,
  <vscale x 1 x i1>,
  iXLen,
...
declare <vscale x 2 x bfloat> @llvm.riscv.sf.vfexp.mask.nxv2bf16(
  <vscale x 2 x bfloat>,
  <vscale x 2 x bfloat>,
  <vscale x 2 x i1>,
  iXLen,
...
declare <vscale x 4 x bfloat> @llvm.riscv.sf.vfexp.mask.nxv4bf16(
  <vscale x 4 x bfloat>,
  <vscale x 4 x bfloat>,
  <vscale x 4 x i1>,
  iXLen,
...
declare <vscale x 8 x bfloat> @llvm.riscv.sf.vfexp.mask.nxv8bf16(
  <vscale x 8 x bfloat>,
  <vscale x 8 x bfloat>,
  <vscale x 8 x i1>,
  iXLen,
...
declare <vscale x 16 x bfloat> @llvm.riscv.sf.vfexp.mask.nxv16bf16(
  <vscale x 16 x bfloat>,
  <vscale x 16 x bfloat>,
  <vscale x 16 x i1>,
  iXLen,
...
declare <vscale x 32 x bfloat> @llvm.riscv.sf.vfexp.mask.nxv32bf16(
  <vscale x 32 x bfloat>,
  <vscale x 32 x bfloat>,
  <vscale x 32 x i1>,
  iXLen,
