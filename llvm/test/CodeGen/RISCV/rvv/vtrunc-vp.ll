...
; RV32-LABEL: vtrunc_nxv15i16_nxv15i64:
; RV32:       # %bb.0:
...
; RV32-NEXT:    vnsrl.wi v28, v16, 0, v0.t
; RV32-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; RV32-NEXT:    vnsrl.wi v18, v28, 0, v0.t
...
; RV32-NEXT:    vnsrl.wi v20, v8, 0, v0.t
; RV32-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; RV32-NEXT:    vnsrl.wi v16, v20, 0, v0.t
; RV32-NEXT:    vmv4r.v v8, v16
; RV32-NEXT:    ret
;
; RV64-LABEL: vtrunc_nxv15i16_nxv15i64:
; RV64:       # %bb.0:
...
; RV64-NEXT:    vnsrl.wi v28, v16, 0, v0.t
; RV64-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; RV64-NEXT:    vnsrl.wi v18, v28, 0, v0.t
...
; RV64-NEXT:    vnsrl.wi v20, v8, 0, v0.t
; RV64-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; RV64-NEXT:    vnsrl.wi v16, v20, 0, v0.t
...
; RV32-LABEL: vtrunc_nxv32i7_nxv32i32:
; RV32:       # %bb.0:
; RV32-NEXT:    vmv1r.v v24, v0
; RV32-NEXT:    csrr a1, vlenb
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vtrunc_nxv32i7_nxv32i32:
; RV64:       # %bb.0:
; RV64-NEXT:    vmv1r.v v24, v0
; RV64-NEXT:    csrr a1, vlenb
...
; RV32-LABEL: vtrunc_nxv32i8_nxv32i32:
; RV32:       # %bb.0:
; RV32-NEXT:    vmv1r.v v24, v0
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    srli a2, a1, 2
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vtrunc_nxv32i8_nxv32i32:
; RV64:       # %bb.0:
; RV64-NEXT:    vmv1r.v v24, v0
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    srli a2, a1, 2
...
; RV32-LABEL: vtrunc_nxv32i64_nxv32i32:
; RV32:       # %bb.0:
...
; RV32-NEXT:    vslidedown.vx v25, v0, a3
; RV32-NEXT:    vsetvli a3, zero, e8, mf4, ta, ma
...
; RV32-NEXT:    vslidedown.vx v0, v25, a5
; RV32-NEXT:    vsetvli zero, a6, e32, m4, ta, ma
; RV32-NEXT:    vnsrl.wi v20, v8, 0, v0.t
; RV32-NEXT:    bltu a4, a1, .LBB17_2
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    mv a4, a1
; RV32-NEXT:  .LBB17_2:
; RV32-NEXT:    vsetvli a0, zero, e8, mf4, ta, ma
; RV32-NEXT:    vslidedown.vx v26, v1, a5
...
; RV32-NEXT:    bltu a2, a3, .LBB17_4
; RV32-NEXT:  # %bb.3:
; RV32-NEXT:    mv a2, a3
; RV32-NEXT:  .LBB17_4:
; RV32-NEXT:    sub a0, a2, a1
...
; RV32-NEXT:    vnsrl.wi v12, v24, 0, v0.t
; RV32-NEXT:    bltu a2, a1, .LBB17_6
; RV32-NEXT:  # %bb.5:
; RV32-NEXT:    mv a2, a1
; RV32-NEXT:  .LBB17_6:
; RV32-NEXT:    vsetvli zero, a2, e32, m4, ta, ma
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vtrunc_nxv32i64_nxv32i32:
; RV64:       # %bb.0:
...
; RV64-NEXT:    vslidedown.vx v0, v25, a5
; RV64-NEXT:    vsetvli zero, a6, e32, m4, ta, ma
; RV64-NEXT:    vnsrl.wi v20, v8, 0, v0.t
; RV64-NEXT:    bltu a4, a1, .LBB17_2
; RV64-NEXT:  # %bb.1:
; RV64-NEXT:    mv a4, a1
; RV64-NEXT:  .LBB17_2:
; RV64-NEXT:    vsetvli a0, zero, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vx v26, v1, a5
...
; RV64-NEXT:    vnsrl.wi v12, v24, 0, v0.t
; RV64-NEXT:    bltu a2, a1, .LBB17_6
; RV64-NEXT:  # %bb.5:
; RV64-NEXT:    mv a2, a1
; RV64-NEXT:  .LBB17_6:
; RV64-NEXT:    vsetvli zero, a2, e32, m4, ta, ma
