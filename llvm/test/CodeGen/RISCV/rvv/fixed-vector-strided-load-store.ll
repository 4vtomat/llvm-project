...
; CHECK-ASM-ZVE32F-NEXT:    mul a6, a3, a5
; CHECK-ASM-ZVE32F-NEXT:    add a6, a0, a6
; CHECK-ASM-ZVE32F-NEXT:    mul a7, a2, a5
; CHECK-ASM-ZVE32F-NEXT:    add a7, a0, a7
; CHECK-ASM-ZVE32F-NEXT:    ld t0, 0(a1)
; CHECK-ASM-ZVE32F-NEXT:    ld t1, 8(a1)
; CHECK-ASM-ZVE32F-NEXT:    ld t2, 16(a1)
; CHECK-ASM-ZVE32F-NEXT:    ld t3, 24(a1)
; CHECK-ASM-ZVE32F-NEXT:    sd t0, 0(a7)
; CHECK-ASM-ZVE32F-NEXT:    sd t1, 0(a6)
; CHECK-ASM-ZVE32F-NEXT:    sd t2, 80(a7)
; CHECK-ASM-ZVE32F-NEXT:    sd t3, 80(a6)
; CHECK-ASM-ZVE32F-NEXT:    addi a2, a2, 4
; CHECK-ASM-ZVE32F-NEXT:    addi a3, a3, 4
; CHECK-ASM-ZVE32F-NEXT:    addi a4, a4, -4
