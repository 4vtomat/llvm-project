...
; RV32-NEXT:    li a1, 16
; RV32-NEXT:    vfsqrt.v v16, v16, v0.t
...
; RV32-NEXT:    vfsqrt.v v8, v8, v0.t
; RV32-NEXT:    ret
;
; RV64-LABEL: vfsqrt_vv_v32f64:
; RV64:       # %bb.0:
...
; RV64-NEXT:    li a1, 16
; RV64-NEXT:    vfsqrt.v v16, v16, v0.t
...
; RV32-LABEL: vfsqrt_vv_v32f64_unmasked:
; RV32:       # %bb.0:
; RV32-NEXT:    li a2, 16
; RV32-NEXT:    mv a1, a0
...
; RV32-NEXT:  .LBB27_2:
; RV32-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV32-NEXT:    vfsqrt.v v8, v8
; RV32-NEXT:    addi a1, a0, -16
; RV32-NEXT:    sltu a0, a0, a1
; RV32-NEXT:    addi a0, a0, -1
; RV32-NEXT:    and a0, a0, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; RV32-NEXT:    vfsqrt.v v16, v16
; RV32-NEXT:    ret
;
; RV64-LABEL: vfsqrt_vv_v32f64_unmasked:
; RV64:       # %bb.0:
; RV64-NEXT:    li a2, 16
; RV64-NEXT:    mv a1, a0
...
; RV64-NEXT:  .LBB27_2:
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vfsqrt.v v8, v8
; RV64-NEXT:    addi a1, a0, -16
; RV64-NEXT:    sltu a0, a0, a1
; RV64-NEXT:    addiw a0, a0, -1
; RV64-NEXT:    and a0, a0, a1
; RV64-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; RV64-NEXT:    vfsqrt.v v16, v16
; RV64-NEXT:    ret
