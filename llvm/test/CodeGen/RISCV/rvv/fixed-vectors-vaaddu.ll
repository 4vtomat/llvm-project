...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_v8i8_floor:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vx_v8i8_floor:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_v8i8_floor_sexti16:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; NOFIXED-NEXT:    vand.vv v10, v8, v9
; NOFIXED-NEXT:    vxor.vv v8, v8, v9
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_v8i8_floor_zexti32:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; NOFIXED-NEXT:    vand.vv v10, v8, v9
; NOFIXED-NEXT:    vxor.vv v8, v8, v9
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_v8i8_floor_lshr2:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_v8i16_floor:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; NOFIXED-NEXT:    vand.vv v10, v8, v9
; NOFIXED-NEXT:    vxor.vv v8, v8, v9
; NOFIXED-NEXT:    vsrl.vi v8, v8, 1
; NOFIXED-NEXT:    vadd.vv v8, v10, v8
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vx_v8i16_floor:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; NOFIXED-NEXT:    vand.vx v9, v8, a0
; NOFIXED-NEXT:    vxor.vx v8, v8, a0
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_v8i32_floor:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vx_v8i32_floor:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_v8i64_floor:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_v8i1_floor:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; NOFIXED-NEXT:    vmv.v.i v9, 0
; NOFIXED-NEXT:    vmerge.vim v10, v9, 1, v0
; NOFIXED-NEXT:    vmv1r.v v0, v8
; NOFIXED-NEXT:    vmerge.vim v8, v9, 1, v0
; NOFIXED-NEXT:    vand.vv v9, v10, v8
; NOFIXED-NEXT:    vxor.vv v8, v10, v8
; NOFIXED-NEXT:    vsrl.vi v8, v8, 1
; NOFIXED-NEXT:    vadd.vv v8, v9, v8
; NOFIXED-NEXT:    vand.vi v8, v8, 1
; NOFIXED-NEXT:    vmsne.vi v0, v8, 0
; NOFIXED-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_v8i8_ceil:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vx_v8i8_ceil:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_v8i8_ceil_sexti16:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; NOFIXED-NEXT:    vor.vv v10, v8, v9
; NOFIXED-NEXT:    vxor.vv v8, v8, v9
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_v8i8_ceil_zexti32:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; NOFIXED-NEXT:    vor.vv v10, v8, v9
; NOFIXED-NEXT:    vxor.vv v8, v8, v9
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_v8i8_ceil_lshr2:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; NOFIXED-NEXT:    vwaddu.vv v10, v8, v9
; NOFIXED-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; NOFIXED-NEXT:    vadd.vi v8, v10, 2
; NOFIXED-NEXT:    vsetvli zero, zero, e8, mf2, ta, ma
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_v8i8_ceil_add2:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; NOFIXED-NEXT:    vwaddu.vv v10, v8, v9
; NOFIXED-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; NOFIXED-NEXT:    vor.vi v8, v10, 1
; NOFIXED-NEXT:    vxor.vi v9, v10, 1
; NOFIXED-NEXT:    vsrl.vi v9, v9, 1
; NOFIXED-NEXT:    vsub.vv v8, v8, v9
; NOFIXED-NEXT:    vsetvli zero, zero, e8, mf2, ta, ma
; NOFIXED-NEXT:    vnsrl.wi v8, v8, 0
; NOFIXED-NEXT:    ret
  %xzv = zext <8 x i8> %x to <8 x i16>
  %yzv = zext <8 x i8> %y to <8 x i16>
  %add = add nuw nsw <8 x i16> %xzv, %yzv
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_v8i16_ceil:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; NOFIXED-NEXT:    vor.vv v10, v8, v9
; NOFIXED-NEXT:    vxor.vv v8, v8, v9
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vx_v8i16_ceil:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; NOFIXED-NEXT:    vor.vx v9, v8, a0
; NOFIXED-NEXT:    vxor.vx v8, v8, a0
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_v8i32_ceil:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vx_v8i32_ceil:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_v8i64_ceil:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
...
; CHECK-NEXT:    ret
;
; NOFIXED-LABEL: vaaddu_vv_v8i1_ceil:
; NOFIXED:       # %bb.0:
; NOFIXED-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; NOFIXED-NEXT:    vmv.v.i v9, 0
; NOFIXED-NEXT:    vmerge.vim v10, v9, 1, v0
