...
; RV32-NEXT:    fld ft0, %lo(.LCPI26_0)(a2)
; RV32-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV32-NEXT:    vmv1r.v v0, v25
; RV32-NEXT:    vfabs.v v16, v8, v0.t
; RV32-NEXT:    vsetvli zero, zero, e64, m8, ta, mu
; RV32-NEXT:    vmflt.vf v25, v16, ft0, v0.t
; RV32-NEXT:    fsrmi a1, 2
...
; RV32-NEXT:    vmflt.vf v1, v24, ft0, v0.t
...
; RV64-NEXT:    li a2, 16
; RV64-NEXT:    vslidedown.vi v1, v0, 2
; RV64-NEXT:    mv a1, a0
; RV64-NEXT:    bltu a0, a2, .LBB26_2
; RV64-NEXT:  # %bb.1:
; RV64-NEXT:    li a1, 16
; RV64-NEXT:  .LBB26_2:
; RV64-NEXT:    lui a2, %hi(.LCPI26_0)
; RV64-NEXT:    fld ft0, %lo(.LCPI26_0)(a2)
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vmv1r.v v0, v25
; RV64-NEXT:    vfabs.v v16, v8, v0.t
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, mu
; RV64-NEXT:    vmflt.vf v25, v16, ft0, v0.t
; RV64-NEXT:    fsrmi a1, 2
...
; RV64-NEXT:    vmflt.vf v1, v24, ft0, v0.t
...
; RV32-LABEL: vp_floor_v32f64_unmasked:
; RV32:       # %bb.0:
; RV32-NEXT:    vsetivli zero, 16, e8, m1, ta, ma
; RV32-NEXT:    li a2, 16
; RV32-NEXT:    vmset.m v1
; RV32-NEXT:    mv a1, a0
...
; RV32-NEXT:    fld ft0, %lo(.LCPI27_0)(a2)
; RV32-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV32-NEXT:    vmv1r.v v0, v1
; RV32-NEXT:    vfabs.v v24, v8, v0.t
; RV32-NEXT:    vsetvli zero, zero, e64, m8, ta, mu
; RV32-NEXT:    vmv1r.v v2, v1
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vp_floor_v32f64_unmasked:
; RV64:       # %bb.0:
; RV64-NEXT:    vsetivli zero, 16, e8, m1, ta, ma
; RV64-NEXT:    li a2, 16
; RV64-NEXT:    vmset.m v1
; RV64-NEXT:    mv a1, a0
...
; RV64-NEXT:    fld ft0, %lo(.LCPI27_0)(a2)
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vmv1r.v v0, v1
; RV64-NEXT:    vfabs.v v24, v8, v0.t
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, mu
; RV64-NEXT:    vmv1r.v v2, v1
