...
define void @test_sf_mm_f_f_w2_f32m8(iXLen %mtd, <vscale x 16 x float> %v1, <vscale x 16 x float> %v2, iXLen %tm, iXLen %tn, iXLen %tk) {
; CHECK-LABEL: test_sf_mm_f_f_w2_f32m8:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    sf.vsettnt zero, a2, e32, w2
; CHECK-NEXT:    sf.vsettm zero, a1
; CHECK-NEXT:    sf.vsettk zero, a3
; CHECK-NEXT:    sf.mm.f.f mt0, v8, v16
; CHECK-NEXT:    ret
  entry:
    call void @llvm.riscv.sf.mm.f.f.iXLen.nxv16f32(iXLen 0, <vscale x 16 x float> %v1, <vscale x 16 x float> %v2, iXLen %tm, iXLen %tn, iXLen %tk, iXLen 2)
    ret void
}
