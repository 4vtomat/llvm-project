...
; RV32-NEXT:    vsetvli zero, a1, e64, m8, tu, ma
; RV32-NEXT:    li a1, 16
; RV32-NEXT:    vfmerge.vfm v16, v16, fa0, v0
; RV32-NEXT:    bltu a0, a1, .LBB81_2
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    li a0, 16
; RV32-NEXT:  .LBB81_2:
; RV32-NEXT:    vsetvli zero, a0, e64, m8, tu, ma
; RV32-NEXT:    vmv1r.v v0, v24
; RV32-NEXT:    vfmerge.vfm v8, v8, fa0, v0
; RV32-NEXT:    ret
;
; RV64-LABEL: vpmerge_vf_v32f64:
; RV64:       # %bb.0:
...
; RV64-NEXT:    vsetvli zero, a1, e64, m8, tu, ma
; RV64-NEXT:    li a1, 16
; RV64-NEXT:    vfmerge.vfm v16, v16, fa0, v0
; RV64-NEXT:    bltu a0, a1, .LBB81_2
; RV64-NEXT:  # %bb.1:
; RV64-NEXT:    li a0, 16
; RV64-NEXT:  .LBB81_2:
