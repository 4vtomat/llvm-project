...
; RV32-NEXT:    li a0, 16
; RV32-NEXT:    vfsgnj.vv v16, v16, v8, v0.t
...
; RV32-NEXT:    vfsgnj.vv v8, v8, v24, v0.t
; RV32-NEXT:    csrr a0, vlenb
...
; RV64-NEXT:    li a0, 16
; RV64-NEXT:    vfsgnj.vv v16, v16, v8, v0.t
...
; RV64-NEXT:    vfsgnj.vv v8, v8, v24, v0.t
; RV64-NEXT:    csrr a0, vlenb
...
; RV32-LABEL: vfsgnj_vv_v32f64_unmasked:
; RV32:       # %bb.0:
; RV32-NEXT:    addi a1, a0, 128
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
...
; RV32-NEXT:    vfsgnj.vv v8, v8, v0
; RV32-NEXT:    addi a0, a2, -16
; RV32-NEXT:    sltu a1, a2, a0
; RV32-NEXT:    addi a1, a1, -1
; RV32-NEXT:    and a0, a1, a0
; RV32-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; RV32-NEXT:    vfsgnj.vv v16, v16, v24
; RV32-NEXT:    ret
;
; RV64-LABEL: vfsgnj_vv_v32f64_unmasked:
; RV64:       # %bb.0:
; RV64-NEXT:    addi a1, a0, 128
; RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
...
; RV64-NEXT:    vfsgnj.vv v8, v8, v0
; RV64-NEXT:    addi a0, a2, -16
; RV64-NEXT:    sltu a1, a2, a0
; RV64-NEXT:    addiw a1, a1, -1
; RV64-NEXT:    and a0, a1, a0
; RV64-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; RV64-NEXT:    vfsgnj.vv v16, v16, v24
; RV64-NEXT:    ret
