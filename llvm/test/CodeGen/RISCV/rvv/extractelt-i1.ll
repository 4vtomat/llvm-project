...
; SIFIVE
; RUN: llc -mtriple=riscv32 -mattr=+v -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,CHECK-32
; RUN: llc -mtriple=riscv64 -mattr=+v -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,CHECK-64
...
; CHECK-32-LABEL: extractelt_nxv128i1:
; CHECK-32:       # %bb.0:
; CHECK-32-NEXT:    csrr a2, vlenb
; CHECK-32-NEXT:    slli a3, a2, 4
; CHECK-32-NEXT:    addi a3, a3, -1
; CHECK-32-NEXT:    bltu a1, a3, .LBB7_2
; CHECK-32-NEXT:  # %bb.1:
; CHECK-32-NEXT:    mv a1, a3
; CHECK-32-NEXT:  .LBB7_2:
; CHECK-32-NEXT:    addi sp, sp, -64
; CHECK-32-NEXT:    addi s0, sp, 64
; CHECK-32-NEXT:    csrr a3, vlenb
; CHECK-32-NEXT:    slli a3, a3, 4
; CHECK-32-NEXT:    sub sp, sp, a3
; CHECK-32-NEXT:    andi sp, sp, -64
; CHECK-32-NEXT:    addi a3, sp, 64
; CHECK-32-NEXT:    slli a2, a2, 3
; CHECK-32-NEXT:    add a4, a0, a2
; CHECK-32-NEXT:    vl8r.v v16, (a4)
; CHECK-32-NEXT:    vl8r.v v24, (a0)
; CHECK-32-NEXT:    add a0, a3, a1
; CHECK-32-NEXT:    vsetvli a1, zero, e8, m8, ta, ma
; CHECK-32-NEXT:    vmseq.vi v8, v16, 0
; CHECK-32-NEXT:    vmseq.vi v0, v24, 0
; CHECK-32-NEXT:    vmv.v.i v16, 0
; CHECK-32-NEXT:    vmerge.vim v24, v16, 1, v0
; CHECK-32-NEXT:    vs8r.v v24, (a3)
; CHECK-32-NEXT:    add a1, a3, a2
; CHECK-32-NEXT:    vmv1r.v v0, v8
; CHECK-32-NEXT:    vmerge.vim v8, v16, 1, v0
; CHECK-32-NEXT:    vs8r.v v8, (a1)
; CHECK-32-NEXT:    lb a0, 0(a0)
; CHECK-32-NEXT:    addi sp, s0, -64
; CHECK-32-NEXT:    addi sp, sp, 64
; CHECK-32-NEXT:    ret
;
; CHECK-64-LABEL: extractelt_nxv128i1:
; CHECK-64:       # %bb.0:
; CHECK-64-NEXT:    csrr a2, vlenb
; CHECK-64-NEXT:    slliw a3, a2, 4
; CHECK-64-NEXT:    addiw a3, a3, -1
; CHECK-64-NEXT:    bltu a1, a3, .LBB7_2
; CHECK-64-NEXT:  # %bb.1:
; CHECK-64-NEXT:    mv a1, a3
; CHECK-64-NEXT:  .LBB7_2:
; CHECK-64-NEXT:    addi sp, sp, -64
; CHECK-64-NEXT:    addi s0, sp, 64
; CHECK-64-NEXT:    csrr a3, vlenb
; CHECK-64-NEXT:    slli a3, a3, 4
; CHECK-64-NEXT:    sub sp, sp, a3
; CHECK-64-NEXT:    andi sp, sp, -64
; CHECK-64-NEXT:    addi a3, sp, 64
; CHECK-64-NEXT:    slli a2, a2, 3
; CHECK-64-NEXT:    add a4, a0, a2
; CHECK-64-NEXT:    vl8r.v v16, (a4)
; CHECK-64-NEXT:    vl8r.v v24, (a0)
; CHECK-64-NEXT:    add a0, a3, a1
; CHECK-64-NEXT:    vsetvli a1, zero, e8, m8, ta, ma
; CHECK-64-NEXT:    vmseq.vi v8, v16, 0
; CHECK-64-NEXT:    vmseq.vi v0, v24, 0
; CHECK-64-NEXT:    vmv.v.i v16, 0
; CHECK-64-NEXT:    vmerge.vim v24, v16, 1, v0
; CHECK-64-NEXT:    vs8r.v v24, (a3)
; CHECK-64-NEXT:    add a1, a3, a2
; CHECK-64-NEXT:    vmv1r.v v0, v8
; CHECK-64-NEXT:    vmerge.vim v8, v16, 1, v0
; CHECK-64-NEXT:    vs8r.v v8, (a1)
; CHECK-64-NEXT:    lb a0, 0(a0)
; CHECK-64-NEXT:    addi sp, s0, -64
; CHECK-64-NEXT:    addi sp, sp, 64
; CHECK-64-NEXT:    ret
