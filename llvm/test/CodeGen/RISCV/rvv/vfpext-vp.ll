...
; SIFIVE
; RUN: llc -mtriple=riscv32 -mattr=+d,+zfh,+experimental-zvfh,+v -verify-machineinstrs < %s | FileCheck %s  --check-prefixes=CHECK,RV32
; RUN: llc -mtriple=riscv64 -mattr=+d,+zfh,+experimental-zvfh,+v -verify-machineinstrs < %s | FileCheck %s  --check-prefixes=CHECK,RV64
...
; RV32-LABEL: vfpext_nxv32f16_nxv32f32:
; RV32:       # %bb.0:
...
; RV32-NEXT:    vfwcvt.f.f.v v16, v12, v0.t
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vfpext_nxv32f16_nxv32f32:
; RV64:       # %bb.0:
...
; RV64-NEXT:    vfwcvt.f.f.v v16, v12, v0.t
