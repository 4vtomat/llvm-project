...
; RV32-LABEL: shuffle1:
; RV32:       # %bb.0:
; RV32-NEXT:    lbu a2, 260(a0)
; RV32-NEXT:    lbu a3, 261(a0)
; RV32-NEXT:    lbu a4, 262(a0)
; RV32-NEXT:    lbu a5, 263(a0)
; RV32-NEXT:    slli a3, a3, 8
; RV32-NEXT:    slli a4, a4, 16
; RV32-NEXT:    slli a5, a5, 24
; RV32-NEXT:    or a2, a3, a2
; RV32-NEXT:    or a4, a5, a4
; RV32-NEXT:    lbu a3, 256(a0)
; RV32-NEXT:    lbu a5, 257(a0)
...
; RV64-LABEL: shuffle1:
; RV64:       # %bb.0:
; RV64-NEXT:    lbu a2, 260(a0)
; RV64-NEXT:    lbu a3, 261(a0)
; RV64-NEXT:    lbu a4, 262(a0)
; RV64-NEXT:    lb a5, 263(a0)
; RV64-NEXT:    slli a3, a3, 8
; RV64-NEXT:    slli a4, a4, 16
; RV64-NEXT:    slli a5, a5, 24
; RV64-NEXT:    or a2, a3, a2
; RV64-NEXT:    or a4, a5, a4
; RV64-NEXT:    lbu a3, 256(a0)
; RV64-NEXT:    lbu a5, 257(a0)
