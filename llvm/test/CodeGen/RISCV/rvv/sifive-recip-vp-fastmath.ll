...
; CHECK-NEXT:    vfrec7.v v11, v8
; CHECK-NEXT:    vmv1r.v v9, v11
; CHECK-NEXT:    vfnmsub.vv v9, v8, v10, v0.t
; CHECK-NEXT:    vfmadd.vv v9, v11, v11, v0.t
...
; CHECK-NEXT:    vfmadd.vv v10, v14, v14, v0.t
...
; CHECK-NEXT:    vfnmsub.vv v8, v16, v24, v0.t
; CHECK-NEXT:    addi a0, sp, 16
; CHECK-NEXT:    vl8r.v v16, (a0) # Unknown-size Folded Reload
; CHECK-NEXT:    vfmadd.vv v8, v16, v16, v0.t
; CHECK-NEXT:    vs8r.v v8, (a0) # Unknown-size Folded Spill
...
; CHECK-NEXT:    addi a0, sp, 16
; CHECK-NEXT:    vl8r.v v8, (a0) # Unknown-size Folded Reload
; CHECK-NEXT:    vfmadd.vv v24, v8, v8, v0.t
