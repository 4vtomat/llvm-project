...
; RUN: llc < %s -mtriple=riscv32 -target-abi=ilp32d -mattr=+v,+m,+zfh,+experimental-zvfh,+f,+d -riscv-v-vector-bits-min=128 | FileCheck %s
; RUN: llc < %s -mtriple=riscv64 -target-abi=lp64d -mattr=+v,+m,+zfh,+experimental-zvfh,+f,+d -riscv-v-vector-bits-min=128 | FileCheck %s
...
; CHECK-NEXT:    vfmul.vf v14, v12, fa5, v0.t
; CHECK-NEXT:    vsetvli a1, zero, e16, m2, ta, ma
; CHECK-NEXT:    vfmv.v.f v16, fa5
; CHECK-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; CHECK-NEXT:    vmv2r.v v10, v14
; CHECK-NEXT:    vfnmsub.vv v10, v8, v16, v0.t
...
; CHECK-NEXT:    addi a0, a0, 16
; CHECK-NEXT:    vs8r.v v24, (a0) # Unknown-size Folded Spill
; CHECK-NEXT:    vfmul.vf v16, v24, fa5, v0.t
