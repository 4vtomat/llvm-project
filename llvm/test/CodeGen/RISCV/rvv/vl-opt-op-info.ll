...
; RUN: sed 's/iXLen/i32/g' %s | llc -mtriple=riscv32 -mattr=+v,+zvl512b -riscv-enable-vl-optimizer=false \
; RUN:   -verify-machineinstrs | FileCheck %s -check-prefixes=CHECK,NOVLOPT
; RUN: sed 's/iXLen/i64/g' %s | llc -mtriple=riscv64 -mattr=+v,+zvl512b -riscv-enable-vl-optimizer=false \
; RUN:   -verify-machineinstrs | FileCheck %s -check-prefixes=CHECK,NOVLOPT
