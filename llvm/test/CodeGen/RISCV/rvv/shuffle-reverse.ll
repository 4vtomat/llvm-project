...
; RV64-NEXT:    addi a1, a1, %lo(.LCPI7_0)
...
; RV64-NEXT:    addi a1, a1, %lo(.LCPI15_0)
...
; RV64-NEXT:    vsetivli zero, 1, e32, mf2, ta, ma
; RV64-NEXT:    vmv.s.x v0, a1
; RV64-NEXT:    vsetvli zero, a0, e16, m4, ta, mu
...
; RV64:       # %bb.0:
; RV64-NEXT:    li a0, 32
; RV64-NEXT:    lui a1, %hi(.LCPI23_0)
; RV64-NEXT:    addi a1, a1, %lo(.LCPI23_0)
...
; RV32-NEXT:    addi a0, a0, %lo(.LCPI35_0)
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetvli zero, a1, e16, m4, ta, ma
; RV32-NEXT:    vle16.v v12, (a0)
; RV32-NEXT:    vmv.v.i v16, 0
; RV32-NEXT:    vsetivli zero, 16, e16, m4, tu, ma
; RV32-NEXT:    vslideup.vi v16, v8, 0
; RV32-NEXT:    vsetvli zero, a1, e16, m4, ta, ma
; RV32-NEXT:    vrgather.vv v8, v16, v12
; RV32-NEXT:    ret
;
; RV64-LABEL: v16f16_2:
; RV64:       # %bb.0:
...
; RV64-NEXT:    addi a1, a1, %lo(.LCPI35_0)
; RV64-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
; RV64-NEXT:    vle16.v v12, (a1)
; RV64-NEXT:    vmv.v.i v16, 0
; RV64-NEXT:    vsetivli zero, 16, e16, m4, tu, ma
; RV64-NEXT:    vslideup.vi v16, v8, 0
; RV64-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
...
; RV64:       # %bb.0:
; RV64-NEXT:    li a0, 32
; RV64-NEXT:    lui a1, %hi(.LCPI46_0)
; RV64-NEXT:    addi a1, a1, %lo(.LCPI46_0)
; RV64-NEXT:    vsetvli zero, a0, e8, m2, ta, ma
; RV64-NEXT:    vle8.v v12, (a1)
; RV64-NEXT:    vrgather.vv v10, v8, v12
; RV64-NEXT:    vmv.v.v v8, v10
