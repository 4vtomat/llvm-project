...
<<<<<<< HEAD
; RUN:     -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,CHECK-32
; RUN: llc -mtriple=riscv64 -mattr=+d,+zfh,+experimental-zvfh,+v -target-abi=lp64d \
; RUN:     -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,CHECK-64
=======
...
; CHECK-32-LABEL: extractelt_nxv16f64_idx:
; CHECK-32:       # %bb.0:
; CHECK-32-NEXT:    csrr a1, vlenb
; CHECK-32-NEXT:    slli a2, a1, 1
; CHECK-32-NEXT:    addi a2, a2, -1
; CHECK-32-NEXT:    bltu a0, a2, .LBB54_2
; CHECK-32-NEXT:  # %bb.1:
; CHECK-32-NEXT:    mv a0, a2
; CHECK-32-NEXT:  .LBB54_2:
; CHECK-32-NEXT:    addi sp, sp, -64
; CHECK-32-NEXT:    .cfi_def_cfa_offset 64
; CHECK-32-NEXT:    addi s0, sp, 64
; CHECK-32-NEXT:    .cfi_def_cfa s0, 0
; CHECK-32-NEXT:    csrr a2, vlenb
; CHECK-32-NEXT:    slli a2, a2, 4
; CHECK-32-NEXT:    sub sp, sp, a2
; CHECK-32-NEXT:    andi sp, sp, -64
; CHECK-32-NEXT:    slli a0, a0, 3
; CHECK-32-NEXT:    addi a2, sp, 64
; CHECK-32-NEXT:    add a0, a2, a0
; CHECK-32-NEXT:    vs8r.v v8, (a2)
; CHECK-32-NEXT:    slli a1, a1, 3
; CHECK-32-NEXT:    add a1, a2, a1
; CHECK-32-NEXT:    vs8r.v v16, (a1)
; CHECK-32-NEXT:    fld fa0, 0(a0)
; CHECK-32-NEXT:    addi sp, s0, -64
; CHECK-32-NEXT:    addi sp, sp, 64
; CHECK-32-NEXT:    ret
;
; CHECK-64-LABEL: extractelt_nxv16f64_idx:
; CHECK-64:       # %bb.0:
; CHECK-64-NEXT:    csrr a1, vlenb
; CHECK-64-NEXT:    slliw a2, a1, 1
; CHECK-64-NEXT:    addiw a2, a2, -1
; CHECK-64-NEXT:    bltu a0, a2, .LBB54_2
; CHECK-64-NEXT:  # %bb.1:
; CHECK-64-NEXT:    mv a0, a2
; CHECK-64-NEXT:  .LBB54_2:
; CHECK-64-NEXT:    addi sp, sp, -64
; CHECK-64-NEXT:    .cfi_def_cfa_offset 64
; CHECK-64-NEXT:    addi s0, sp, 64
; CHECK-64-NEXT:    .cfi_def_cfa s0, 0
; CHECK-64-NEXT:    csrr a2, vlenb
; CHECK-64-NEXT:    slli a2, a2, 4
; CHECK-64-NEXT:    sub sp, sp, a2
; CHECK-64-NEXT:    andi sp, sp, -64
; CHECK-64-NEXT:    slli a0, a0, 3
; CHECK-64-NEXT:    addi a2, sp, 64
; CHECK-64-NEXT:    add a0, a2, a0
; CHECK-64-NEXT:    vs8r.v v8, (a2)
; CHECK-64-NEXT:    slli a1, a1, 3
; CHECK-64-NEXT:    add a1, a2, a1
; CHECK-64-NEXT:    vs8r.v v16, (a1)
; CHECK-64-NEXT:    fld fa0, 0(a0)
