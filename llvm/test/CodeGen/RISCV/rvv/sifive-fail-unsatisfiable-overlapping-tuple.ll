...
; SUBREG_LIVENESS-NEXT:    vmacc.vv v20, v8, v8
; SUBREG_LIVENESS-NEXT:    vsetvli a0, zero, e64, m4, ta, ma
; SUBREG_LIVENESS-NEXT:    vmv.v.i v8, 0
...
; SUBREG_LIVENESS-NEXT:    vand.vx v16, v8, a0
...
; SUBREG_LIVENESS-NEXT:    vnot.v v8, v20, v0.t
; SUBREG_LIVENESS-NEXT:    vxor.vx v16, v8, a1, v0.t
; SUBREG_LIVENESS-NEXT:    lui a1, %hi(.LCPI0_2)
; SUBREG_LIVENESS-NEXT:    vmv4r.v v20, v16
; SUBREG_LIVENESS-NEXT:    vmv4r.v v4, v16
; SUBREG_LIVENESS-NEXT:    vmv4r.v v8, v20
; SUBREG_LIVENESS-NEXT:    vluxseg2ei8.v v4, (a0), v24, v0.t
; SUBREG_LIVENESS-NEXT:    lui a0, %hi(.LCPI0_3)
; SUBREG_LIVENESS-NEXT:    ld a1, %lo(.LCPI0_2)(a1)
; SUBREG_LIVENESS-NEXT:    ld a0, %lo(.LCPI0_3)(a0)
; SUBREG_LIVENESS-NEXT:    csrwi vxrm, 3
; SUBREG_LIVENESS-NEXT:    vsetvli zero, zero, e64, m4, ta, ma
; SUBREG_LIVENESS-NEXT:    vaaddu.vv v8, v4, v16
; SUBREG_LIVENESS-NEXT:    vsetvli zero, zero, e64, m4, tu, mu
; SUBREG_LIVENESS-NEXT:    vremu.vx v8, v8, a1, v0.t
; SUBREG_LIVENESS-NEXT:    vmadd.vx v8, a0, v8, v0.t
...
entry:
  ...
  %9 = tail call <vscale x 4 x i64> @llvm.riscv.vaaddu.nxv4i64.nxv4i64.i64(<vscale x 4 x i64> undef, <vscale x 4 x i64> %8, <vscale x 4 x i64> %6, i64 3, i64 0)
  ...
  %13 = tail call <vscale x 4 x i64> @llvm.riscv.vaaddu.mask.nxv4i64.nxv4i64.i64(<vscale x 4 x i64> %10, <vscale x 4 x i64> %1, <vscale x 4 x i64> undef, <vscale x 4 x i1> undef, i64 3, i64 0, i64 0)
