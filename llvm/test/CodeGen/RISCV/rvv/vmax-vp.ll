...
; RV32-LABEL: vmax_vx_nxv128i8_unmasked:
; RV32:       # %bb.0:
...
; RV32-NEXT:    and a3, a4, a3
; RV32-NEXT:    vsetvli zero, a3, e8, m8, ta, ma
; RV32-NEXT:    vmax.vx v16, v16, a0
; RV32-NEXT:    bltu a1, a2, .LBB35_2
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    mv a1, a2
; RV32-NEXT:  .LBB35_2:
; RV32-NEXT:    vsetvli zero, a1, e8, m8, ta, ma
; RV32-NEXT:    vmax.vx v8, v8, a0
; RV32-NEXT:    ret
;
; RV64-LABEL: vmax_vx_nxv128i8_unmasked:
; RV64:       # %bb.0:
...
; RV32-LABEL: vmax_vx_nxv32i32_unmasked:
; RV32:       # %bb.0:
; RV32-NEXT:    csrr a2, vlenb
; RV32-NEXT:    slli a2, a2, 1
; RV32-NEXT:    sub a3, a1, a2
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vmax_vx_nxv32i32_unmasked:
; RV64:       # %bb.0:
; RV64-NEXT:    csrr a2, vlenb
; RV64-NEXT:    slli a2, a2, 1
; RV64-NEXT:    sub a3, a1, a2
