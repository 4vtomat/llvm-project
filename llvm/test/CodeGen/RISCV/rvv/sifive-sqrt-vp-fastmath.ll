...
; RUN: llc < %s -mtriple=riscv32 -target-abi=ilp32d -mattr=+m,+v,+zfh,+experimental-zvfh,+f,+d | FileCheck %s -check-prefix=RV32
; RUN: llc < %s -mtriple=riscv64 -target-abi=lp64d -mattr=+m,+v,+zfh,+experimental-zvfh,+f,+d | FileCheck %s -check-prefix=RV64
...
; RV32-NEXT:    addi a1, a1, %lo(.LCPI0_0)
; RV32-NEXT:    vsetvli a2, zero, e16, mf2, ta, ma
; RV32-NEXT:    vlse16.v v11, (a1), zero
...
; RV64-NEXT:    addi a1, a1, %lo(.LCPI0_0)
; RV64-NEXT:    vsetvli a2, zero, e16, mf2, ta, ma
; RV64-NEXT:    vlse16.v v11, (a1), zero
...
; RV64-NEXT:    addi a1, a1, %lo(.LCPI1_0)
...
; RV32-NEXT:    addi a1, a1, %lo(.LCPI2_0)
; RV32-NEXT:    vsetvli a2, zero, e16, m2, ta, ma
; RV32-NEXT:    vlse16.v v14, (a1), zero
...
; RV64-NEXT:    addi a1, a1, %lo(.LCPI2_0)
; RV64-NEXT:    vsetvli a2, zero, e16, m2, ta, ma
; RV64-NEXT:    vlse16.v v14, (a1), zero
...
; RV32-NEXT:    vmflt.vf v9, v9, fa5, v0.t
; RV32-NEXT:    vfrsqrt7.v v10, v8
; RV32-NEXT:    vfmul.vv v11, v8, v10, v0.t
...
; RV32-NEXT:    vmv1r.v v13, v10
; RV32-NEXT:    vfmadd.vv v13, v11, v12, v0.t
; RV32-NEXT:    lui a0, 782336
; RV32-NEXT:    fmv.w.x fa5, a0
; RV32-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; RV32-NEXT:    vfmul.vf v10, v10, fa5, v0.t
; RV32-NEXT:    vfmul.vv v10, v10, v13, v0.t
; RV32-NEXT:    vfmul.vv v8, v8, v10, v0.t
; RV32-NEXT:    vsetvli zero, zero, e32, m1, ta, mu
; RV32-NEXT:    vfmadd.vv v10, v8, v12, v0.t
; RV32-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; RV32-NEXT:    vfmul.vf v8, v8, fa5, v0.t
; RV32-NEXT:    vfmul.vv v8, v8, v10, v0.t
; RV32-NEXT:    vmv1r.v v0, v9
...
; RV64-NEXT:    vmflt.vf v9, v9, fa5, v0.t
; RV64-NEXT:    vfrsqrt7.v v10, v8
; RV64-NEXT:    vfmul.vv v11, v8, v10, v0.t
...
; RV64-NEXT:    vmv1r.v v13, v10
; RV64-NEXT:    vfmadd.vv v13, v11, v12, v0.t
; RV64-NEXT:    lui a0, 782336
; RV64-NEXT:    fmv.w.x fa5, a0
; RV64-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; RV64-NEXT:    vfmul.vf v10, v10, fa5, v0.t
; RV64-NEXT:    vfmul.vv v10, v10, v13, v0.t
; RV64-NEXT:    vfmul.vv v8, v8, v10, v0.t
; RV64-NEXT:    vsetvli zero, zero, e32, m1, ta, mu
; RV64-NEXT:    vfmadd.vv v10, v8, v12, v0.t
; RV64-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; RV64-NEXT:    vfmul.vf v8, v8, fa5, v0.t
; RV64-NEXT:    vfmul.vv v8, v8, v10, v0.t
; RV64-NEXT:    vmv1r.v v0, v9
...
; RV32-NEXT:    vfmadd.vv v18, v14, v16, v0.t
; RV32-NEXT:    lui a0, 782336
; RV32-NEXT:    fmv.w.x fa5, a0
; RV32-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; RV32-NEXT:    vfmul.vf v12, v12, fa5, v0.t
; RV32-NEXT:    vfmul.vv v12, v12, v18, v0.t
; RV32-NEXT:    vfmul.vv v8, v8, v12, v0.t
; RV32-NEXT:    vsetvli zero, zero, e32, m2, ta, mu
; RV32-NEXT:    vfmadd.vv v12, v8, v16, v0.t
; RV32-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; RV32-NEXT:    vfmul.vf v8, v8, fa5, v0.t
; RV32-NEXT:    vfmul.vv v8, v8, v12, v0.t
; RV32-NEXT:    vmv1r.v v0, v10
...
; RV64-NEXT:    vfmadd.vv v18, v14, v16, v0.t
; RV64-NEXT:    lui a0, 782336
; RV64-NEXT:    fmv.w.x fa5, a0
; RV64-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; RV64-NEXT:    vfmul.vf v12, v12, fa5, v0.t
; RV64-NEXT:    vfmul.vv v12, v12, v18, v0.t
; RV64-NEXT:    vfmul.vv v8, v8, v12, v0.t
; RV64-NEXT:    vsetvli zero, zero, e32, m2, ta, mu
; RV64-NEXT:    vfmadd.vv v12, v8, v16, v0.t
; RV64-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; RV64-NEXT:    vfmul.vf v8, v8, fa5, v0.t
; RV64-NEXT:    vfmul.vv v8, v8, v12, v0.t
; RV64-NEXT:    vmv1r.v v0, v10
...
; RV32-NEXT:    lui a1, 2048
; RV32-NEXT:    fmv.w.x fa5, a1
; RV32-NEXT:    vmflt.vf v12, v12, fa5, v0.t
; RV32-NEXT:    vfrsqrt7.v v20, v8
; RV32-NEXT:    vfmul.vv v24, v8, v20, v0.t
; RV32-NEXT:    lui a1, 787456
; RV32-NEXT:    vsetvli a2, zero, e32, m4, ta, ma
; RV32-NEXT:    vmv.v.x v16, a1
; RV32-NEXT:    vsetvli zero, a0, e32, m4, ta, mu
; RV32-NEXT:    vmv4r.v v28, v20
; RV32-NEXT:    vfmadd.vv v28, v24, v16, v0.t
; RV32-NEXT:    lui a0, 782336
; RV32-NEXT:    fmv.w.x fa5, a0
; RV32-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; RV32-NEXT:    vfmul.vf v20, v20, fa5, v0.t
; RV32-NEXT:    vfmul.vv v20, v20, v28, v0.t
; RV32-NEXT:    vfmul.vv v8, v8, v20, v0.t
; RV32-NEXT:    vsetvli zero, zero, e32, m4, ta, mu
; RV32-NEXT:    vfmadd.vv v20, v8, v16, v0.t
; RV32-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; RV32-NEXT:    vfmul.vf v8, v8, fa5, v0.t
; RV32-NEXT:    vfmul.vv v8, v8, v20, v0.t
...
; RV64-NEXT:    lui a1, 2048
; RV64-NEXT:    fmv.w.x fa5, a1
; RV64-NEXT:    vmflt.vf v12, v12, fa5, v0.t
; RV64-NEXT:    vfrsqrt7.v v20, v8
; RV64-NEXT:    vfmul.vv v24, v8, v20, v0.t
; RV64-NEXT:    lui a1, 787456
; RV64-NEXT:    vsetvli a2, zero, e32, m4, ta, ma
; RV64-NEXT:    vmv.v.x v16, a1
; RV64-NEXT:    vsetvli zero, a0, e32, m4, ta, mu
; RV64-NEXT:    vmv4r.v v28, v20
; RV64-NEXT:    vfmadd.vv v28, v24, v16, v0.t
; RV64-NEXT:    lui a0, 782336
; RV64-NEXT:    fmv.w.x fa5, a0
; RV64-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; RV64-NEXT:    vfmul.vf v20, v20, fa5, v0.t
; RV64-NEXT:    vfmul.vv v20, v20, v28, v0.t
; RV64-NEXT:    vfmul.vv v8, v8, v20, v0.t
; RV64-NEXT:    vsetvli zero, zero, e32, m4, ta, mu
; RV64-NEXT:    vfmadd.vv v20, v8, v16, v0.t
; RV64-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; RV64-NEXT:    vfmul.vf v8, v8, fa5, v0.t
; RV64-NEXT:    vfmul.vv v8, v8, v20, v0.t
...
; RV32-NEXT:    fld fa5, %lo(.LCPI6_1)(a1)
...
; RV32-NEXT:    vmflt.vf v0, v8, fa4, v0.t
...
; RV64-NEXT:    vmflt.vf v0, v8, fa4, v0.t
...
; RV32-NEXT:    fld fa5, %lo(.LCPI7_1)(a1)
...
; RV64-NEXT:    vlse64.v v12, (a1), zero
; RV64-NEXT:    lui a1, %hi(.LCPI7_1)
; RV64-NEXT:    fld fa5, %lo(.LCPI7_1)(a1)
...
; CHECK-NEXT:    addi a1, a1, 16
; CHECK-NEXT:    vs8r.v v16, (a1) # Unknown-size Folded Spill
; CHECK-NEXT:    fld fa5, %lo(.LCPI8_1)(a2)
; CHECK-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
...
; CHECK-NEXT:    vfmul.vv v24, v16, v8, v0.t
; CHECK-NEXT:    csrr a0, vlenb
; CHECK-NEXT:    slli a0, a0, 3
; CHECK-NEXT:    add a0, sp, a0
; CHECK-NEXT:    addi a0, a0, 16
...
; CHECK-NEXT:    vl8r.v v8, (a0) # Unknown-size Folded Reload
; CHECK-NEXT:    vfmul.vf v8, v8, fa5, v0.t
; CHECK-NEXT:    vfmul.vv v24, v8, v24, v0.t
; CHECK-NEXT:    csrr a0, vlenb
; CHECK-NEXT:    li a1, 24
; CHECK-NEXT:    mul a0, a0, a1
; CHECK-NEXT:    add a0, sp, a0
...
; CHECK-NEXT:    vmflt.vf v0, v16, fa4, v0.t
; CHECK-NEXT:    vmerge.vim v8, v8, 0, v0
; CHECK-NEXT:    csrr a0, vlenb
...
; RV64-NEXT:    vlse64.v v16, (a1), zero
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 24
...
; RV32-NEXT:    addi a1, a1, %lo(.LCPI25_0)
; RV32-NEXT:    vsetvli a2, zero, e64, m4, ta, ma
; RV32-NEXT:    vlse64.v v12, (a1), zero
...
; RV64-NEXT:    addi a1, a1, %lo(.LCPI25_0)
; RV64-NEXT:    vsetvli a2, zero, e64, m4, ta, ma
; RV64-NEXT:    vlse64.v v12, (a1), zero
...
; RV32-NEXT:    addi a1, a1, %lo(.LCPI26_0)
; RV32-NEXT:    vsetvli a2, zero, e64, m8, ta, ma
...
; RV64-NEXT:    addi a1, a1, %lo(.LCPI26_0)
; RV64-NEXT:    vsetvli a2, zero, e64, m8, ta, ma
