...
; RUN:   | FileCheck -check-prefix=RV32-NOCFILP %s
; RUN: llc -mtriple=riscv64 -verify-machineinstrs < %s \
; RUN:   | FileCheck -check-prefix=RV64-NOCFILP %s
; RUN: llc -mtriple=riscv32 -mattr=+experimental-zicfilp -verify-machineinstrs < %s \
; RUN:   | FileCheck -check-prefix=RV32-CFILP %s
; RUN: llc -mtriple=riscv64 -mattr=+experimental-zicfilp -verify-machineinstrs < %s \
; RUN:   | FileCheck -check-prefix=RV64-CFILP %s
; SIFIVE_CUSTOMIZATION

define fastcc i32 @callee(<16 x i32> %A) nounwind {
; RV32-NOCFILP-LABEL: callee:
; RV32-NOCFILP:       # %bb.0:
; RV32-NOCFILP-NEXT:    ret
;
; RV64-NOCFILP-LABEL: callee:
; RV64-NOCFILP:       # %bb.0:
; RV64-NOCFILP-NEXT:    ret
;
; RV32-CFILP-LABEL: callee:
; RV32-CFILP:       # %bb.0:
; RV32-CFILP-NEXT:    lpad 1
; RV32-CFILP-NEXT:    ret
;
; RV64-CFILP-LABEL: callee:
; RV64-CFILP:       # %bb.0:
; RV64-CFILP-NEXT:    lpad 1
; RV64-CFILP-NEXT:    ret
...
; RV32-NOCFILP-NEXT:    lw t3, 32(a0)
; RV32-NOCFILP-NEXT:    lw t4, 36(a0)
; RV32-NOCFILP-NEXT:    lw t5, 40(a0)
; RV32-NOCFILP-NEXT:    lw t6, 44(a0)
; RV32-NOCFILP-NEXT:    lw t1, 48(a0)
; RV32-NOCFILP-NEXT:    lw t2, 52(a0)
; RV32-NOCFILP-NEXT:    lw s0, 56(a0)
; RV32-NOCFILP-NEXT:    lw a0, 60(a0)
; RV32-NOCFILP-NEXT:    sw a0, 12(sp)
; RV32-NOCFILP-NEXT:    sw s0, 8(sp)
; RV32-NOCFILP-NEXT:    sw t2, 4(sp)
...
; RV64-NOCFILP-NEXT:    ld t3, 64(a0)
; RV64-NOCFILP-NEXT:    ld t4, 72(a0)
; RV64-NOCFILP-NEXT:    ld t5, 80(a0)
; RV64-NOCFILP-NEXT:    ld t6, 88(a0)
; RV64-NOCFILP-NEXT:    ld t1, 96(a0)
; RV64-NOCFILP-NEXT:    ld t2, 104(a0)
; RV64-NOCFILP-NEXT:    ld s0, 112(a0)
; RV64-NOCFILP-NEXT:    ld a0, 120(a0)
; RV64-NOCFILP-NEXT:    sd a0, 24(sp)
; RV64-NOCFILP-NEXT:    sd s0, 16(sp)
; RV64-NOCFILP-NEXT:    sd t2, 8(sp)
