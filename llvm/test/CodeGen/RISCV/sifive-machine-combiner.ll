...
; RUN:   -target-abi=lp64d -riscv-machine-combiner -mcpu=sifive-u74 \
; RUN:   -machine-combiner-verify-pattern-order=true \
; RUN:   | FileCheck %s --check-prefixes=CHECK,U74
; RUN: llc < %s -mtriple=riscv64 -mattr=+d,+zfh \
; RUN:   -target-abi=lp64d -riscv-machine-combiner -mcpu=sifive-p550 \
; RUN:   -machine-combiner-verify-pattern-order=true \
...
; RUN:   -target-abi=lp64d -riscv-machine-combiner -mcpu=sifive-u74 \
; RUN:   -machine-combiner-verify-pattern-order=true \
; RUN:   -machine-combiner-inc-threshold=0 \
; RUN:   | FileCheck %s --check-prefixes=CHECK,U74
; RUN: llc < %s -mtriple=riscv64 -mattr=+d,+zfh \
; RUN:   -target-abi=lp64d -riscv-machine-combiner -mcpu=sifive-p550 \
; RUN:   -machine-combiner-verify-pattern-order=true \
