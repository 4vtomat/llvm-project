...
; RUN: opt -experimental-riscv-simplifycfg-hoist-vector=false -simplifycfg -hoist-common-insts=true %s -S -mtriple=riscv64 -mattr=+d,+v | FileCheck %s --check-prefixes=CHECK-NO-HOIST
; RUN: opt -experimental-riscv-simplifycfg-hoist-vector=true -simplifycfg -hoist-common-insts=true %s -S -mtriple=riscv64 -mattr=+d,+v | FileCheck %s --check-prefixes=CHECK-HOIST
