...
; CHECK-NEXT:    subc.cc.s64 %rd67, %rd115, 0;
...
; CHECK-NEXT:    selp.b64 %rd124, 0, %rd4, %p13;
; CHECK-NEXT:    selp.b64 %rd123, 0, %rd3, %p13;
; CHECK-NEXT:    setp.gt.u64 %p14, %rd66, 126;
; CHECK-NEXT:    and.pred %p15, %p9, %p14;
; CHECK-NEXT:    or.pred %p16, %p15, %p11;
; CHECK-NEXT:    or.pred %p17, %p5, %p16;
; CHECK-NEXT:    @%p17 bra $L__BB0_5;
; CHECK-NEXT:  // %bb.3: // %udiv-bb1
; CHECK-NEXT:    add.cc.s64 %rd117, %rd66, 1;
; CHECK-NEXT:    addc.cc.s64 %rd118, %rd67, 0;
; CHECK-NEXT:    or.b64 %rd70, %rd117, %rd118;
; CHECK-NEXT:    setp.eq.s64 %p18, %rd70, 0;
; CHECK-NEXT:    cvt.u32.u64 %r5, %rd66;
; CHECK-NEXT:    sub.s32 %r6, 127, %r5;
; CHECK-NEXT:    shl.b64 %rd71, %rd4, %r6;
; CHECK-NEXT:    sub.s32 %r7, 64, %r6;
; CHECK-NEXT:    shr.u64 %rd72, %rd3, %r7;
; CHECK-NEXT:    or.b64 %rd73, %rd71, %rd72;
; CHECK-NEXT:    sub.s32 %r8, 63, %r5;
; CHECK-NEXT:    shl.b64 %rd74, %rd3, %r8;
; CHECK-NEXT:    setp.gt.s32 %p19, %r6, 63;
; CHECK-NEXT:    selp.b64 %rd122, %rd74, %rd73, %p19;
; CHECK-NEXT:    shl.b64 %rd121, %rd3, %r6;
; CHECK-NEXT:    mov.b64 %rd112, %rd115;
; CHECK-NEXT:    @%p18 bra $L__BB0_4;
; CHECK-NEXT:  // %bb.1: // %udiv-preheader
; CHECK-NEXT:    cvt.u32.u64 %r9, %rd117;
; CHECK-NEXT:    shr.u64 %rd77, %rd3, %r9;
; CHECK-NEXT:    sub.s32 %r10, 64, %r9;
; CHECK-NEXT:    shl.b64 %rd78, %rd4, %r10;
; CHECK-NEXT:    or.b64 %rd79, %rd77, %rd78;
; CHECK-NEXT:    add.s32 %r11, %r9, -64;
; CHECK-NEXT:    shr.u64 %rd80, %rd4, %r11;
; CHECK-NEXT:    setp.gt.s32 %p20, %r9, 63;
; CHECK-NEXT:    selp.b64 %rd119, %rd80, %rd79, %p20;
; CHECK-NEXT:    shr.u64 %rd120, %rd4, %r9;
; CHECK-NEXT:    add.cc.s64 %rd35, %rd5, -1;
; CHECK-NEXT:    addc.cc.s64 %rd36, %rd6, -1;
; CHECK-NEXT:    mov.b64 %rd112, 0;
; CHECK-NEXT:    mov.b64 %rd115, %rd112;
; CHECK-NEXT:  $L__BB0_2: // %udiv-do-while
; CHECK-NEXT:    // =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    shr.u64 %rd81, %rd119, 63;
; CHECK-NEXT:    shl.b64 %rd82, %rd120, 1;
; CHECK-NEXT:    or.b64 %rd83, %rd82, %rd81;
; CHECK-NEXT:    shl.b64 %rd84, %rd119, 1;
; CHECK-NEXT:    shr.u64 %rd85, %rd122, 63;
; CHECK-NEXT:    or.b64 %rd86, %rd84, %rd85;
; CHECK-NEXT:    shr.u64 %rd87, %rd121, 63;
; CHECK-NEXT:    shl.b64 %rd88, %rd122, 1;
; CHECK-NEXT:    or.b64 %rd89, %rd88, %rd87;
; CHECK-NEXT:    shl.b64 %rd90, %rd121, 1;
; CHECK-NEXT:    or.b64 %rd121, %rd115, %rd90;
; CHECK-NEXT:    or.b64 %rd122, %rd112, %rd89;
; CHECK-NEXT:    sub.cc.s64 %rd91, %rd35, %rd86;
; CHECK-NEXT:    subc.cc.s64 %rd92, %rd36, %rd83;
; CHECK-NEXT:    shr.s64 %rd93, %rd92, 63;
; CHECK-NEXT:    and.b64 %rd115, %rd93, 1;
; CHECK-NEXT:    and.b64 %rd94, %rd93, %rd5;
; CHECK-NEXT:    and.b64 %rd95, %rd93, %rd6;
; CHECK-NEXT:    sub.cc.s64 %rd119, %rd86, %rd94;
; CHECK-NEXT:    subc.cc.s64 %rd120, %rd83, %rd95;
; CHECK-NEXT:    add.cc.s64 %rd117, %rd117, -1;
; CHECK-NEXT:    addc.cc.s64 %rd118, %rd118, -1;
; CHECK-NEXT:    or.b64 %rd96, %rd117, %rd118;
; CHECK-NEXT:    setp.eq.s64 %p21, %rd96, 0;
; CHECK-NEXT:    @%p21 bra $L__BB0_4;
; CHECK-NEXT:    bra.uni $L__BB0_2;
; CHECK-NEXT:  $L__BB0_4: // %udiv-loop-exit
; CHECK-NEXT:    shr.u64 %rd97, %rd121, 63;
; CHECK-NEXT:    shl.b64 %rd98, %rd122, 1;
; CHECK-NEXT:    or.b64 %rd99, %rd98, %rd97;
; CHECK-NEXT:    shl.b64 %rd100, %rd121, 1;
; CHECK-NEXT:    or.b64 %rd123, %rd115, %rd100;
; CHECK-NEXT:    or.b64 %rd124, %rd112, %rd99;
; CHECK-NEXT:  $L__BB0_5: // %udiv-end
; CHECK-NEXT:    mul.hi.u64 %rd101, %rd5, %rd123;
; CHECK-NEXT:    mad.lo.s64 %rd102, %rd5, %rd124, %rd101;
; CHECK-NEXT:    mad.lo.s64 %rd103, %rd6, %rd123, %rd102;
...
; CHECK-NEXT:    st.param.v2.b64 [func_retval0], {%rd109, %rd110};
; CHECK-NEXT:    ret;
...
; CHECK-NEXT:    subc.cc.s64 %rd57, %rd101, 0;
...
; CHECK-NEXT:    selp.b64 %rd108, %rd64, %rd63, %p17;
...
; CHECK-NEXT:    selp.b64 %rd105, %rd70, %rd69, %p18;
...
; CHECK-NEXT:    setp.eq.s64 %p19, %rd86, 0;
...
; CHECK-NEXT:    or.pred %p12, %p10, %p11;
; CHECK-NEXT:    or.pred %p13, %p5, %p12;
; CHECK-NEXT:    selp.b64 %rd119, 0, %rd2, %p13;
; CHECK-NEXT:    selp.b64 %rd118, 0, %rd1, %p13;
; CHECK-NEXT:    setp.gt.u64 %p14, %rd67, 126;
; CHECK-NEXT:    and.pred %p15, %p9, %p14;
; CHECK-NEXT:    or.pred %p16, %p15, %p11;
; CHECK-NEXT:    or.pred %p17, %p5, %p16;
...
; CHECK-NEXT:    sub.s32 %r6, 127, %r5;
; CHECK-NEXT:    shl.b64 %rd72, %rd2, %r6;
; CHECK-NEXT:    sub.s32 %r7, 64, %r6;
; CHECK-NEXT:    shr.u64 %rd73, %rd1, %r7;
; CHECK-NEXT:    or.b64 %rd74, %rd72, %rd73;
; CHECK-NEXT:    sub.s32 %r8, 63, %r5;
; CHECK-NEXT:    shl.b64 %rd75, %rd1, %r8;
; CHECK-NEXT:    setp.gt.s32 %p19, %r6, 63;
; CHECK-NEXT:    selp.b64 %rd117, %rd75, %rd74, %p19;
; CHECK-NEXT:    shl.b64 %rd116, %rd1, %r6;
; CHECK-NEXT:    mov.b64 %rd107, %rd110;
; CHECK-NEXT:    @%p18 bra $L__BB4_4;
; CHECK-NEXT:  // %bb.1: // %udiv-preheader
; CHECK-NEXT:    cvt.u32.u64 %r9, %rd112;
; CHECK-NEXT:    shr.u64 %rd78, %rd1, %r9;
; CHECK-NEXT:    sub.s32 %r10, 64, %r9;
; CHECK-NEXT:    shl.b64 %rd79, %rd2, %r10;
; CHECK-NEXT:    or.b64 %rd80, %rd78, %rd79;
; CHECK-NEXT:    add.s32 %r11, %r9, -64;
; CHECK-NEXT:    shr.u64 %rd81, %rd2, %r11;
; CHECK-NEXT:    setp.gt.s32 %p20, %r9, 63;
; CHECK-NEXT:    selp.b64 %rd114, %rd81, %rd80, %p20;
; CHECK-NEXT:    shr.u64 %rd115, %rd2, %r9;
; CHECK-NEXT:    add.cc.s64 %rd35, %rd3, -1;
; CHECK-NEXT:    addc.cc.s64 %rd36, %rd4, -1;
; CHECK-NEXT:    mov.b64 %rd107, 0;
; CHECK-NEXT:    mov.b64 %rd110, %rd107;
...
; CHECK-NEXT:    shl.b64 %rd64, %rd41, %r8;
; CHECK-NEXT:    setp.gt.s32 %p17, %r6, 63;
; CHECK-NEXT:    selp.b64 %rd102, %rd64, %rd63, %p17;
...
; CHECK-NEXT:    shr.u64 %rd70, %rd42, %r11;
; CHECK-NEXT:    setp.gt.s32 %p18, %r9, 63;
; CHECK-NEXT:    selp.b64 %rd99, %rd70, %rd69, %p18;
