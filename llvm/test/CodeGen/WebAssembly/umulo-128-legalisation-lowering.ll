...
; WASM32-NEXT:    i32.const $push5=, 40
; WASM32-NEXT:    i32.add $push6=, $pop50, $pop5
; WASM32-NEXT:    i64.load $push31=, 0($pop6)
...
; WASM32-NEXT:    i64.add $push29=, $pop30, $pop4
...
; WASM32-NEXT:    i64.ne $push8=, $pop54, $pop27
; WASM32-NEXT:    local.get $push55=, 4
; WASM32-NEXT:    i64.const $push26=, 0
; WASM32-NEXT:    i64.ne $push7=, $pop55, $pop26
; WASM32-NEXT:    i32.and $push9=, $pop8, $pop7
; WASM32-NEXT:    local.get $push56=, 5
; WASM32-NEXT:    i64.load $push11=, 24($pop56)
; WASM32-NEXT:    local.get $push57=, 5
; WASM32-NEXT:    i64.load $push10=, 8($pop57)
; WASM32-NEXT:    i64.or $push12=, $pop11, $pop10
; WASM32-NEXT:    i64.const $push25=, 0
; WASM32-NEXT:    i64.ne $push13=, $pop12, $pop25
; WASM32-NEXT:    i32.or $push14=, $pop9, $pop13
; WASM32-NEXT:    local.get $push59=, 1
; WASM32-NEXT:    local.get $push58=, 3
; WASM32-NEXT:    i64.lt_u $push15=, $pop59, $pop58
; WASM32-NEXT:    i32.or $push16=, $pop14, $pop15
; WASM32-NEXT:    i32.store8 16($pop60), $pop16
; WASM32-NEXT:    local.get $push61=, 5
; WASM32-NEXT:    i32.const $push19=, 48
; WASM32-NEXT:    i32.add $push20=, $pop61, $pop19
; WASM32-NEXT:    global.set __stack_pointer, $pop20
