...
; RISCV64-NEXT:    loop:
; RISCV64-NEXT:      Memory dependences are safe with a maximum safe vector width of 6400 bits, with a maximum safe store-load forward width of 2048 bits
...
; RISCV64-NEXT:    loop:
; RISCV64-NEXT:      Memory dependences are safe with a maximum safe vector width of 576 bits, with a maximum safe store-load forward width of 512 bits
; RISCV64-NEXT:      Dependences:
; RISCV64-NEXT:        BackwardVectorizable:
; RISCV64-NEXT:            %v = load i64, ptr %a1, align 32 ->
; RISCV64-NEXT:            store i64 %v, ptr %a2, align 32
...
; RISCV64-NEXT:    loop:
; RISCV64-NEXT:      Memory dependences are safe with a maximum safe vector width of 640 bits, with a maximum safe store-load forward width of 512 bits
; RISCV64-NEXT:      Dependences:
; RISCV64-NEXT:        BackwardVectorizable:
; RISCV64-NEXT:            %v = load i64, ptr %a1, align 32 ->
; RISCV64-NEXT:            store i64 %v, ptr %a2, align 32
...
; RISCV64-LABEL: 'no_high_lmul_or_interleave'
; RISCV64-NEXT:    loop:
; RISCV64-NEXT:      Memory dependences are safe with a maximum safe vector width of 65536 bits, with a maximum safe store-load forward width of 4096 bits
; RISCV64-NEXT:      Dependences:
; RISCV64-NEXT:        BackwardVectorizable:
; RISCV64-NEXT:            %v = load i64, ptr %a1, align 32 ->
; RISCV64-NEXT:            store i64 %v, ptr %a2, align 32
...
; RISCV64-NEXT:      Expressions re-written:
;
; X86_64-LABEL: 'no_high_lmul_or_interleave'
; X86_64-NEXT:    loop:
; X86_64-NEXT:      Memory dependences are safe with a maximum safe vector width of 65536 bits
; X86_64-NEXT:      Dependences:
; X86_64-NEXT:        BackwardVectorizable:
; X86_64-NEXT:            %v = load i64, ptr %a1, align 32 ->
; X86_64-NEXT:            store i64 %v, ptr %a2, align 32
...
; RISCV64-NEXT:    loop:
; RISCV64-NEXT:      Memory dependences are safe with a maximum safe vector width of 96 bits, with a maximum safe store-load forward width of 64 bits
; RISCV64-NEXT:      Dependences:
