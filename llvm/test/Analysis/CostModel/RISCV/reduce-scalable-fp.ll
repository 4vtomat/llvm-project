...
; SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %red = call half @llvm.vector.reduce.fadd.nxv1f16(half %s, <vscale x 1 x half> %v)
; end SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %red
;
...
; SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %red = call half @llvm.vector.reduce.fadd.nxv2f16(half %s, <vscale x 2 x half> %v)
; end SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %red
;
...
; SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 5 for instruction: %red = call half @llvm.vector.reduce.fadd.nxv4f16(half %s, <vscale x 4 x half> %v)
; end SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %red
;
...
; SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %red = call float @llvm.vector.reduce.fadd.nxv1f32(float %s, <vscale x 1 x float> %v)
; end SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %red
;
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %e = fpext <vscale x 1 x half> %v to <vscale x 1 x float>
; SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %red = call float @llvm.vector.reduce.fadd.nxv1f32(float %s, <vscale x 1 x float> %e)
; end SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %red
;
  %e = fpext <vscale x 1 x half> %v to <vscale x 1 x float>
...
; SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %red = call float @llvm.vector.reduce.fadd.nxv2f32(float %s, <vscale x 2 x float> %v)
; end SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %red
;
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %e = fpext <vscale x 2 x half> %v to <vscale x 2 x float>
; SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %red = call float @llvm.vector.reduce.fadd.nxv2f32(float %s, <vscale x 2 x float> %e)
; end SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %red
;
  %e = fpext <vscale x 2 x half> %v to <vscale x 2 x float>
...
; SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 5 for instruction: %red = call float @llvm.vector.reduce.fadd.nxv4f32(float %s, <vscale x 4 x float> %v)
; end SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %red
;
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %e = fpext <vscale x 4 x half> %v to <vscale x 4 x float>
; SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 5 for instruction: %red = call float @llvm.vector.reduce.fadd.nxv4f32(float %s, <vscale x 4 x float> %e)
; end SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %red
;
  %e = fpext <vscale x 4 x half> %v to <vscale x 4 x float>
...
; SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %red = call double @llvm.vector.reduce.fadd.nxv1f64(double %s, <vscale x 1 x double> %v)
; end SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret double %red
;
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %e = fpext <vscale x 1 x float> %v to <vscale x 1 x double>
; SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %red = call double @llvm.vector.reduce.fadd.nxv1f64(double %s, <vscale x 1 x double> %e)
; end SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret double %red
;
  %e = fpext <vscale x 1 x float> %v to <vscale x 1 x double>
...
; SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %red = call double @llvm.vector.reduce.fadd.nxv2f64(double %s, <vscale x 2 x double> %v)
; end SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret double %red
;
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %e = fpext <vscale x 2 x float> %v to <vscale x 2 x double>
; SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %red = call double @llvm.vector.reduce.fadd.nxv2f64(double %s, <vscale x 2 x double> %e)
; end SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret double %red
;
  %e = fpext <vscale x 2 x float> %v to <vscale x 2 x double>
...
; SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 5 for instruction: %red = call double @llvm.vector.reduce.fadd.nxv4f64(double %s, <vscale x 4 x double> %v)
; end SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret double %red
;
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %e = fpext <vscale x 4 x float> %v to <vscale x 4 x double>
; SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 5 for instruction: %red = call double @llvm.vector.reduce.fadd.nxv4f64(double %s, <vscale x 4 x double> %e)
; end SIFIVE
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret double %red
;
  %e = fpext <vscale x 4 x float> %v to <vscale x 4 x double>
