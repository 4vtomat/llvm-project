...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %v16f16 = fcmp one <16 x half> undef, undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %nxv8f16 = fcmp one <vscale x 8 x half> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %nxv16f16 = fcmp one <vscale x 16 x half> undef, undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %v8f32 = fcmp one <8 x float> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %v16f32 = fcmp one <16 x float> undef, undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %nxv4f32 = fcmp one <vscale x 4 x float> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %nxv8f32 = fcmp one <vscale x 8 x float> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 24 for instruction: %nxv16f32 = fcmp one <vscale x 16 x float> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %v2f64 = fcmp one <2 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %v4f64 = fcmp one <4 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %v8f64 = fcmp one <8 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %nxv1f64 = fcmp one <vscale x 1 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %nxv2f64 = fcmp one <vscale x 2 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %nxv4f64 = fcmp one <vscale x 4 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 24 for instruction: %nxv8f64 = fcmp one <vscale x 8 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret void
;
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %v16f16 = fcmp ueq <16 x half> undef, undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %nxv8f16 = fcmp ueq <vscale x 8 x half> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %nxv16f16 = fcmp ueq <vscale x 16 x half> undef, undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %v8f32 = fcmp ueq <8 x float> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %v16f32 = fcmp ueq <16 x float> undef, undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %nxv4f32 = fcmp ueq <vscale x 4 x float> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %nxv8f32 = fcmp ueq <vscale x 8 x float> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 24 for instruction: %nxv16f32 = fcmp ueq <vscale x 16 x float> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %v2f64 = fcmp ueq <2 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %v4f64 = fcmp ueq <4 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %v8f64 = fcmp ueq <8 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %nxv1f64 = fcmp ueq <vscale x 1 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %nxv2f64 = fcmp ueq <vscale x 2 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %nxv4f64 = fcmp ueq <vscale x 4 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 24 for instruction: %nxv8f64 = fcmp ueq <vscale x 8 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret void
;
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %v16f16 = fcmp true <16 x half> undef, undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %nxv8f16 = fcmp true <vscale x 8 x half> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %nxv16f16 = fcmp true <vscale x 16 x half> undef, undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %v8f32 = fcmp true <8 x float> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %v16f32 = fcmp true <16 x float> undef, undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %nxv4f32 = fcmp true <vscale x 4 x float> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %nxv8f32 = fcmp true <vscale x 8 x float> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %nxv16f32 = fcmp true <vscale x 16 x float> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %v2f64 = fcmp true <2 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %v4f64 = fcmp true <4 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %v8f64 = fcmp true <8 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %nxv1f64 = fcmp true <vscale x 1 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %nxv2f64 = fcmp true <vscale x 2 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %nxv4f64 = fcmp true <vscale x 4 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %nxv8f64 = fcmp true <vscale x 8 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret void
;
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %v16f16 = fcmp false <16 x half> undef, undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %nxv8f16 = fcmp false <vscale x 8 x half> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %nxv16f16 = fcmp false <vscale x 16 x half> undef, undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %v8f32 = fcmp false <8 x float> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %v16f32 = fcmp false <16 x float> undef, undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %nxv4f32 = fcmp false <vscale x 4 x float> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %nxv8f32 = fcmp false <vscale x 8 x float> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %nxv16f32 = fcmp false <vscale x 16 x float> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %v2f64 = fcmp false <2 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %v4f64 = fcmp false <4 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %v8f64 = fcmp false <8 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %nxv1f64 = fcmp false <vscale x 1 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %nxv2f64 = fcmp false <vscale x 2 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %nxv4f64 = fcmp false <vscale x 4 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %nxv8f64 = fcmp false <vscale x 8 x double> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret void
;
