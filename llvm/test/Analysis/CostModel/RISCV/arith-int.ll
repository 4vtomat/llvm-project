...
; SIFIVE-X280-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %5 = add <4 x i32> splat (i32 1), undef
; SIFIVE-X280-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %6 = add <2 x i64> splat (i64 1), undef
; SIFIVE-X280-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %7 = add <4 x i32> splat (i32 4096), undef
