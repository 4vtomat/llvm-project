...
<<<<<<< HEAD
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %2 = sext <7 x i8> undef to <7 x i32>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %3 = sext <15 x i8> undef to <15 x i32>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %4 = zext <3 x i8> undef to <3 x i16>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %5 = zext <7 x i8> undef to <7 x i32>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %6 = zext <15 x i8> undef to <15 x i32>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %7 = trunc <3 x i32> undef to <3 x i8>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %8 = trunc <7 x i32> undef to <7 x i8>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %9 = trunc <15 x i32> undef to <15 x i8>
=======
