...
protected:
  ...
  std::unique_ptr<Module> createVPDeclarationModule() {
    const char *BinaryIntOpcodes[] = {"add",  "sub",  "mul", "sdiv", "srem",
                                      ...
                                      "ashr", "lshr", "shl", "smin", "smax", // SIFIVE
                                      "umin", "umax"}; // SIFIVE
    ...
    Str << " declare i32 @llvm.experimental.vp.popcount.v8i1(<8 x i1>, <8 x i1>, i32) ";
    Str << " declare <8 x i1> @llvm.experimental.vp.set.before.first.v8i1"
        << "(<8 x i1>, <8 x i1>, i32) ";
#endif // SIFIVE_CUSTOMIZATION
