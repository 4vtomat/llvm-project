//===- llvm/Analysis/SiFive_CSADescriptors.h - CSA Descriptors --*- C++ -*-===//
//
...
public:
  ...
  static CSADescriptor createCSADescriptor(PHINode *Phi, Loop *TheLoop);
  ...
  bool isValidCSA() const { return Phi && InitScalar && Assignment; }
